 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_BmwMsgSlot68Bas0Repn2BusFrChA_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <BmwMsgSlot68Bas0Repn2BusFrChA> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_BMWMSGSLOT68BAS0REPN2BUSFRCHA_TYPE_H
# define _RTE_BMWMSGSLOT68BAS0REPN2BUSFRCHA_TYPE_H
...
# ifndef BMWEPSDEACTVNCTRL_NODEACTVNEPSFCT
#  define BMWEPSDEACTVNCTRL_NODEACTVNEPSFCT (0U)
# endif

# ifndef BMWEPSDEACTVNCTRL_DEACTVNEPSFCTGROUP1
#  define BMWEPSDEACTVNCTRL_DEACTVNEPSFCTGROUP1 (1U)
# endif

# ifndef BMWEPSDEACTVNCTRL_DEACTVNEPSFCTGROUP2
#  define BMWEPSDEACTVNCTRL_DEACTVNEPSFCTGROUP2 (2U)
# endif

# ifndef BMWEPSDEACTVNCTRL_FCTIFNOTAVL
#  define BMWEPSDEACTVNCTRL_FCTIFNOTAVL (13U)
# endif

# ifndef BMWEPSDEACTVNCTRL_FCTRPRTERR
#  define BMWEPSDEACTVNCTRL_FCTRPRTERR (14U)
# endif

# ifndef BMWEPSDEACTVNCTRL_INVLDSIG
#  define BMWEPSDEACTVNCTRL_INVLDSIG (15U)
# endif
...
# ifndef CTR_DEAC_EPS_FNS_Keine_Deaktivierung_EPS_Funktionen
#  define CTR_DEAC_EPS_FNS_Keine_Deaktivierung_EPS_Funktionen (0U)
# endif

# ifndef Keine_Deaktivierung_EPS_Funktionen_BflMask
#  define Keine_Deaktivierung_EPS_Funktionen_BflMask 15U
# endif

# ifndef Keine_Deaktivierung_EPS_Funktionen_BflPn
#  define Keine_Deaktivierung_EPS_Funktionen_BflPn 0U
# endif

# ifndef Keine_Deaktivierung_EPS_Funktionen_BflLn
#  define Keine_Deaktivierung_EPS_Funktionen_BflLn 4U
# endif

# ifndef CTR_DEAC_EPS_FNS_Funktionsschnittstelle_ist_nicht_verfuegbar
#  define CTR_DEAC_EPS_FNS_Funktionsschnittstelle_ist_nicht_verfuegbar (13U)
# endif

# ifndef Funktionsschnittstelle_ist_nicht_verfuegbar_BflMask
#  define Funktionsschnittstelle_ist_nicht_verfuegbar_BflMask 15U
# endif

# ifndef Funktionsschnittstelle_ist_nicht_verfuegbar_BflPn
#  define Funktionsschnittstelle_ist_nicht_verfuegbar_BflPn 0U
# endif

# ifndef Funktionsschnittstelle_ist_nicht_verfuegbar_BflLn
#  define Funktionsschnittstelle_ist_nicht_verfuegbar_BflLn 4U
# endif

# ifndef CTR_DEAC_EPS_FNS_Funktion_meldet_Fehler
#  define CTR_DEAC_EPS_FNS_Funktion_meldet_Fehler (14U)
# endif

# ifndef Funktion_meldet_Fehler_BflMask
#  define Funktion_meldet_Fehler_BflMask 15U
# endif

# ifndef Funktion_meldet_Fehler_BflPn
#  define Funktion_meldet_Fehler_BflPn 0U
# endif

# ifndef Funktion_meldet_Fehler_BflLn
#  define Funktion_meldet_Fehler_BflLn 4U
# endif

# ifndef CTR_DEAC_EPS_FNS_Signal_unbefuellt
#  define CTR_DEAC_EPS_FNS_Signal_unbefuellt (15U)
# endif

# ifndef Signal_unbefuellt_BflMask
#  define Signal_unbefuellt_BflMask 15U
# endif
...
#  define Signal_unbefuellt_BflLn 4U
# endif

# ifndef CTR_DEAC_EPS_FNS_Deaktivierung_EPS_Funktionen_Funktionsgruppe_1
#  define CTR_DEAC_EPS_FNS_Deaktivierung_EPS_Funktionen_Funktionsgruppe_1 (1U)
# endif

# ifndef Deaktivierung_EPS_Funktionen_Funktionsgruppe_1_BflMask
#  define Deaktivierung_EPS_Funktionen_Funktionsgruppe_1_BflMask 9U
# endif

# ifndef CTR_DEAC_EPS_FNS_Deaktivierung_EPS_Funktionen_Funktionsgruppe_2
#  define CTR_DEAC_EPS_FNS_Deaktivierung_EPS_Funktionen_Funktionsgruppe_2 (2U)
# endif

# ifndef Deaktivierung_EPS_Funktionen_Funktionsgruppe_2_BflMask
#  define Deaktivierung_EPS_Funktionen_Funktionsgruppe_2_BflMask 10U
# endif

# ifndef FACT_DMPNG_ADDON_STMOM_FTAX_Reserviert
#  define FACT_DMPNG_ADDON_STMOM_FTAX_Reserviert (253U)
# endif

# ifndef FACT_DMPNG_ADDON_STMOM_FTAX_Reserviert_bne_5B8A124DE2884D68A663388C50F241EF_254
#  define FACT_DMPNG_ADDON_STMOM_FTAX_Reserviert_bne_5B8A124DE2884D68A663388C50F241EF_254 (254U)
# endif

# ifndef FACT_DMPNG_ADDON_STMOM_FTAX_Signal_unbefuellt
#  define FACT_DMPNG_ADDON_STMOM_FTAX_Signal_unbefuellt (255U)
# endif
...
# ifndef QU_TAR_DMPNG_ADDON_STMOM_FTAX_SollwertZusatzdaempfungNichtUmsetzen
#  define QU_TAR_DMPNG_ADDON_STMOM_FTAX_SollwertZusatzdaempfungNichtUmsetzen (1U)
# endif

# ifndef QU_TAR_DMPNG_ADDON_STMOM_FTAX_SollwertZusatzdaempfungUmsetzen
#  define QU_TAR_DMPNG_ADDON_STMOM_FTAX_SollwertZusatzdaempfungUmsetzen (2U)
# endif

# ifndef QU_TAR_DMPNG_ADDON_STMOM_FTAX_SignalUnbefuellt
#  define QU_TAR_DMPNG_ADDON_STMOM_FTAX_SignalUnbefuellt (15U)
# endif

# ifndef QU_TAR_FACT_STMOM_FTAX_SollwerteUmsetzen
#  define QU_TAR_FACT_STMOM_FTAX_SollwerteUmsetzen (2U)
# endif

# ifndef QU_TAR_FACT_STMOM_FTAX_SollwerteNichtVorhanden
#  define QU_TAR_FACT_STMOM_FTAX_SollwerteNichtVorhanden (7U)
# endif

# ifndef QU_TAR_FACT_STMOM_FTAX_StandbyColonSollwerteNichtUmsetzen
#  define QU_TAR_FACT_STMOM_FTAX_StandbyColonSollwerteNichtUmsetzen (14U)
# endif

# ifndef QU_TAR_FACT_STMOM_FTAX_SignalUngueltig
#  define QU_TAR_FACT_STMOM_FTAX_SignalUngueltig (15U)
# endif

# ifndef QU_TAR_QTA_STMOM_DV_SollwerteUmsetzen
#  define QU_TAR_QTA_STMOM_DV_SollwerteUmsetzen (2U)
# endif

# ifndef QU_TAR_QTA_STMOM_DV_SollwerteNichtVorhanden
#  define QU_TAR_QTA_STMOM_DV_SollwerteNichtVorhanden (7U)
# endif

# ifndef QU_TAR_QTA_STMOM_DV_SollwerteNichtUmsetzen_Standby
#  define QU_TAR_QTA_STMOM_DV_SollwerteNichtUmsetzen_Standby (14U)
# endif

# ifndef QU_TAR_QTA_STMOM_DV_SignalUngueltig
#  define QU_TAR_QTA_STMOM_DV_SignalUngueltig (15U)
# endif

# ifndef QU_TAR_STMOM_DV_ACT_SollwerteUmsetzen
#  define QU_TAR_STMOM_DV_ACT_SollwerteUmsetzen (2U)
# endif

# ifndef QU_TAR_STMOM_DV_ACT_SollwerteNichtVorhanden
#  define QU_TAR_STMOM_DV_ACT_SollwerteNichtVorhanden (7U)
# endif

# ifndef QU_TAR_STMOM_DV_ACT_StandbyColonSollwerteNichtUmsetzen
#  define QU_TAR_STMOM_DV_ACT_StandbyColonSollwerteNichtUmsetzen (14U)
# endif

# ifndef QU_TAR_STMOM_DV_ACT_SignalUngueltig
#  define QU_TAR_STMOM_DV_ACT_SignalUngueltig (15U)
# endif
...
#endif /* _RTE_BMWMSGSLOT68BAS0REPN2BUSFRCHA_TYPE_H */
