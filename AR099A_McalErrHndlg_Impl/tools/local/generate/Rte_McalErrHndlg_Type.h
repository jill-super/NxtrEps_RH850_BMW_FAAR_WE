 ...
 *
 *   Description:  Application types header file for SW-C <McalErrHndlg> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_MCALERRHNDLG_TYPE_H
# define _RTE_MCALERRHNDLG_TYPE_H
...
#endif /* _RTE_MCALERRHNDLG_TYPE_H */
