...
*
* Module File Name  : McalErrHndlg.c
 ...
 *********************************************************************************************************************/
	...
	if(*Rte_Pim_NonCritErrCod() == NOERR_CNT_U08)
	{
		(void)Rte_Call_SetNtcSts_Oper(NTCNR_0X01E, 0U, NTCSTS_PASSD, 0U);
	}

	if (*Rte_Pim_CritErrCod() == NOERR_CNT_U08)
	{
		(void)Rte_Call_SetNtcSts_Oper(NTCNR_0X01F, 0U, NTCSTS_PASSD, 0U);
	}
 ...
 *********************************************************************************************************************/
	...
	if (*Rte_Pim_NonCritErrCod() != NOERR_CNT_U08)
	{
		(void)Rte_Call_SetNtcSts_Oper(NTCNR_0X01E, *Rte_Pim_NonCritErrCod(), NTCSTS_FAILD, 0U);
	}

	/* -----[ Critical Responses ]----- */
	if (*Rte_Pim_CritErrCod() != NOERR_CNT_U08)
	{
		(void)Rte_Call_SetNtcSts_Oper(NTCNR_0X01F, *Rte_Pim_CritErrCod(), NTCSTS_FAILD, 0U);
	}
