 ...
 *
 *   Description:  Application types header file for SW-C <LrndRackCentr> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_LRNDRACKCENTR_TYPE_H
# define _RTE_LRNDRACKCENTR_TYPE_H
...
#endif /* _RTE_LRNDRACKCENTR_TYPE_H */
