...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\CM510A_MotAg3Meas_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\CM510A_MotAg3Meas_Impl
...
XCOPY ..\..\autosar\MotAg3Meas_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
