 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_BmwTqOvrlCdngAndDrvgDynFac_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <BmwTqOvrlCdngAndDrvgDynFac> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_BMWTQOVRLCDNGANDDRVGDYNFAC_TYPE_H
# define _RTE_BMWTQOVRLCDNGANDDRVGDYNFAC_TYPE_H
...
#endif /* _RTE_BMWTQOVRLCDNGANDDRVGDYNFAC_TYPE_H */
