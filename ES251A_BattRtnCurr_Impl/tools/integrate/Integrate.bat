...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ES251A_BattRtnCurr_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ES251A_BattRtnCurr_Impl
...
XCOPY ..\..\autosar\CDD_BattRtnCurr_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
