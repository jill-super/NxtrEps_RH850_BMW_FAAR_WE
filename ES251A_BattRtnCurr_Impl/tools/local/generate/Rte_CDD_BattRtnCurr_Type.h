 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_CDD_BattRtnCurr_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <CDD_BattRtnCurr> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CDD_BATTRTNCURR_TYPE_H
# define _RTE_CDD_BATTRTNCURR_TYPE_H
...
#endif /* _RTE_CDD_BATTRTNCURR_TYPE_H */
