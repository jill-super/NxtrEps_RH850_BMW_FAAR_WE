 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_DiagcMgrProxyAppl2_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <DiagcMgrProxyAppl2> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DIAGCMGRPROXYAPPL2_TYPE_H
# define _RTE_DIAGCMGRPROXYAPPL2_TYPE_H
...
#endif /* _RTE_DIAGCMGRPROXYAPPL2_TYPE_H */
