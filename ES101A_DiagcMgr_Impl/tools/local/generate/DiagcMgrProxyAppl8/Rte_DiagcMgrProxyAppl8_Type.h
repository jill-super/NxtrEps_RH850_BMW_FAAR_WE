 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_DiagcMgrProxyAppl8_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <DiagcMgrProxyAppl8> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DIAGCMGRPROXYAPPL8_TYPE_H
# define _RTE_DIAGCMGRPROXYAPPL8_TYPE_H
...
#endif /* _RTE_DIAGCMGRPROXYAPPL8_TYPE_H */
