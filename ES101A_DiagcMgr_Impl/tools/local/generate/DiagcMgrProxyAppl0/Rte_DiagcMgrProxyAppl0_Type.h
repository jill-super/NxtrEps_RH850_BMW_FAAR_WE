 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_DiagcMgrProxyAppl0_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <DiagcMgrProxyAppl0> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DIAGCMGRPROXYAPPL0_TYPE_H
# define _RTE_DIAGCMGRPROXYAPPL0_TYPE_H
...
#endif /* _RTE_DIAGCMGRPROXYAPPL0_TYPE_H */
