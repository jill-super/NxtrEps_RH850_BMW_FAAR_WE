 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_DiagcMgrProxyAppl4_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <DiagcMgrProxyAppl4> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DIAGCMGRPROXYAPPL4_TYPE_H
# define _RTE_DIAGCMGRPROXYAPPL4_TYPE_H
...
#endif /* _RTE_DIAGCMGRPROXYAPPL4_TYPE_H */
