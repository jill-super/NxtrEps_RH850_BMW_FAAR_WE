 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_DiagcMgrProxyAppl10_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <DiagcMgrProxyAppl10> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DIAGCMGRPROXYAPPL10_TYPE_H
# define _RTE_DIAGCMGRPROXYAPPL10_TYPE_H
...
#endif /* _RTE_DIAGCMGRPROXYAPPL10_TYPE_H */
