 ...
 *
 *   Description:  Application types header file for SW-C <DiagcMgr> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DIAGCMGR_TYPE_H
# define _RTE_DIAGCMGR_TYPE_H
