 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_DiagcMgrProxyAppl5_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <DiagcMgrProxyAppl5> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DIAGCMGRPROXYAPPL5_TYPE_H
# define _RTE_DIAGCMGRPROXYAPPL5_TYPE_H
...
#endif /* _RTE_DIAGCMGRPROXYAPPL5_TYPE_H */
