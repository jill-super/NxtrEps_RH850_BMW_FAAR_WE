...
{
  /* PIM Handles section */
  P2VAR(DiagcDataRec2, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_DiagcData5; /* PRQA S 0850 */ /* MD_MSR_19.8 */
  ...
  P2VAR(DiagcDataRec2, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_ProxySetNtcData5; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
# define Rte_Enter_DiagcMgrProxyAppl5 Rte_Enter_DiagcMgrProxyAppl5_DiagcMgrProxyAppl5 /* RteAnalyzer(ExclusiveArea, OS_INTERRUPT_BLOCKING) */
# define Rte_Exit_DiagcMgrProxyAppl5 Rte_Exit_DiagcMgrProxyAppl5_DiagcMgrProxyAppl5 /* RteAnalyzer(ExclusiveArea, OS_INTERRUPT_BLOCKING) */
...
# define RTE_RUNNABLE_SetNtcStsAndSnpshtData5_Oper SetNtcStsAndSnpshtData5_Oper
...
#include "Rte_DiagcMgrProxyAppl5_Stubs.h"