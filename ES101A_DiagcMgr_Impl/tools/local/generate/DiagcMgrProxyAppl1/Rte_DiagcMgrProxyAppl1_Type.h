 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_DiagcMgrProxyAppl1_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <DiagcMgrProxyAppl1> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DIAGCMGRPROXYAPPL1_TYPE_H
# define _RTE_DIAGCMGRPROXYAPPL1_TYPE_H
...
#endif /* _RTE_DIAGCMGRPROXYAPPL1_TYPE_H */
