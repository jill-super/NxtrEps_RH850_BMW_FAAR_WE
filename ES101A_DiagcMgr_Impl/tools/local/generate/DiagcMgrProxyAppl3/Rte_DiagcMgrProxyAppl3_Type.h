 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_DiagcMgrProxyAppl3_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <DiagcMgrProxyAppl3> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DIAGCMGRPROXYAPPL3_TYPE_H
# define _RTE_DIAGCMGRPROXYAPPL3_TYPE_H
...
#endif /* _RTE_DIAGCMGRPROXYAPPL3_TYPE_H */
