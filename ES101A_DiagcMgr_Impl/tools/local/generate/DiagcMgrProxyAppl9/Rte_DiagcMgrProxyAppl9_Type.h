 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_DiagcMgrProxyAppl9_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <DiagcMgrProxyAppl9> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DIAGCMGRPROXYAPPL9_TYPE_H
# define _RTE_DIAGCMGRPROXYAPPL9_TYPE_H
...
#endif /* _RTE_DIAGCMGRPROXYAPPL9_TYPE_H */
