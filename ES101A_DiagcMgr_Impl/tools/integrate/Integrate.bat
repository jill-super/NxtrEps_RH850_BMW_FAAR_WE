...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ES101A_DiagcMgr_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ES101A_DiagcMgr_Impl
...
XCOPY ..\..\autosar\DiagcMgr_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
