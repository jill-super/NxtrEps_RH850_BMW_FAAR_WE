 ...
 *  Generated at:  Fri Sep 29 09:25:33 2017
 *
...
#include "Rte_DiagcMgrProxyAppl2.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
#define PimDiagcMgrNtcInfo2Ary_rec              (*(Ary1D_NtcInfoRec4_DiagcMgrProxyAppl2 *)(Rte_Pim_DiagcMgrNtcInfo2Ary()))
 ...
 * Ary1D_NtcInfoRec4_DiagcMgrProxyAppl2: Array with 65535 element(s) of type NtcInfoRec4
 * Ary1D_s16_DiagcMgrProxyAppl2: Array with 65535 element(s) of type sint16
 ...
 *     Returnvalue: NtcInfoRec4* is of type Ary1D_NtcInfoRec4_DiagcMgrProxyAppl2
 *   sint16 *Rte_Pim_DiagcMgrNtcInfo2DebCntrAry(void)
 *     Returnvalue: sint16* is of type Ary1D_s16_DiagcMgrProxyAppl2
 *   DiagcDataRec2 *Rte_Pim_DiagcData2(void)
 *   DiagcDataRec2 *Rte_Pim_ProxySetNtcData2(void)
 *
 ...
 * Symbol: DiagcMgrProxyAppl2Init1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
     ...
     {
         if ((PrmDiagcMgrFltResp_u16[NTCNRARYAPPL2_CNT_U16[LoopCntr_Cnt_T_u16]] & FLTRESPDTCIDX_CNT_U16) > TOTNROFDTC_CNT_U08)
         {
     ...
     (void) Rte_Call_DiagcMgrIninCore_Oper(DIAGCMGR_APPLIDX2_CNT_U08, 
                                             (uint8)TblSize_m(PimDiagcMgrNtcInfo2Ary_rec), 
                                             PimDiagcMgrNtcInfo2Ary_rec, 
                                             Rte_Pim_DiagcData2(), 
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: DiagcMgrProxyAppl2Per1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
    ...
    {
        for (NtcInfoIdx_Cnt_T_u16 = 0U; NtcInfoIdx_Cnt_T_u16 < (uint16)TblSize_m(PimDiagcMgrNtcInfo2Ary_rec); NtcInfoIdx_Cnt_T_u16++) 
        {       
            /* Clear the NTCs that are active */
            if(((DIAGCMGRNTCPPTYARY_CNT_U08[NTCNRARYAPPL2_CNT_U16[NtcInfoIdx_Cnt_T_u16]] & NTCPPTYSTSLOCKDTHISIGNCYC_CNT_U08) != 0U) &&
                    ((PimDiagcMgrNtcInfo2Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08) == 0U) &&
                    ((PimDiagcMgrNtcInfo2Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr >= 1U) && 
                    (PimDiagcMgrNtcInfo2Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr <= MAXCYCINHIST_CNT_U08)))
            {
                /* Status 0, AC 255, DebCntr Same */
                PimDiagcMgrNtcInfo2Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts = 0U;
                PimDiagcMgrNtcInfo2Ary_rec[NtcInfoIdx_Cnt_T_u16].NtcStInfo = 0U;
                PimDiagcMgrNtcInfo2Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr = DFTAGICNTR_CNT_U08;
                
            }
            else if(((DIAGCMGRNTCPPTYARY_CNT_U08[NTCNRARYAPPL2_CNT_U16[NtcInfoIdx_Cnt_T_u16]] & NTCPPTYSTSLOCKDTHISIGNCYC_CNT_U08) != 0U) &&
               ((PimDiagcMgrNtcInfo2Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08) == 0U) &&
               ((PimDiagcMgrNtcInfo2Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr == 0U) || 
                (PimDiagcMgrNtcInfo2Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr == 255U)))
            {
                /* Do Nothing */
            }
            else
            ...
            PimDiagcMgrNtcInfo2Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts = DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08;                     
            PimDiagcMgrNtcInfo2Ary_rec[NtcInfoIdx_Cnt_T_u16].NtcStInfo = 0U;    
            PimDiagcMgrNtcInfo2Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr = DFTAGICNTR_CNT_U08;          
        ...
        Rte_Pim_DiagcData2()->DiagcSts = DIAGCSTSININVAL_CNT_U08;
        ...
        Rte_Pim_ProxySetNtcData2()->DiagcSts = DIAGCSTSININVAL_CNT_U08;
    ...
    else 
    {
        ...
        for (NtcInfoIdx_Cnt_T_u16 = 0U; NtcInfoIdx_Cnt_T_u16 < (uint16)TblSize_m(PimDiagcMgrNtcInfo2Ary_rec); NtcInfoIdx_Cnt_T_u16++) 
        {   
            if (((PimDiagcMgrNtcInfo2Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTFAILD_CNT_U08) != 0U) &&
                ((PimDiagcMgrNtcInfo2Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTFAILDTHISIGNCYC_CNT_U08) != 0U))
            {
                /* ProcessRampResponseAndDiagcSts */
                ProcProxyRampRespAndDiagcSts (NTCNRARYAPPL2_CNT_U16[NtcInfoIdx_Cnt_T_u16], &ProxyPerData_T_rec);           
            }
        }
        Rte_Enter_DiagcMgrProxyAppl2();
 ...
 * Runnable prototype:
 * ===================
 *   void GetDiagcDataAppl2_Oper(DiagcDataRec2 *DiagcData_Arg)
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetDiagcDataAppl2_Oper_doc
 *********************************************************************************************************************/
...
FUNC(void, DiagcMgrProxyAppl2_CODE) GetDiagcDataAppl2_Oper(P2VAR(DiagcDataRec2, AUTOMATIC, RTE_DIAGCMGRPROXYAPPL2_APPL_VAR) DiagcData_Arg) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcDebCntrAppl2_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcInfoAppl2_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcQlfrSts2_Oper_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
    ...
    {           
        ...
        RtnVal_Cnt_T_enum = Rte_Call_SetNtcStsCore_Oper( NtcNr_Arg,
                                                        ...
                                                        Rte_Pim_DiagcData2(),
                                                        Rte_Pim_ProxySetNtcData2(),
                                                        (&PimDiagcMgrNtcInfo2Ary_rec[DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].NtcInfoIdx]),
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: SetNtcStsAndSnpshtData2_Oper
 *
 * This runnable can be invoked concurrently (reentrant implementation).
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <Oper> of PortPrototype <SetNtcStsAndSnpshtData2>
 *
 **********************************************************************************************************************
 *
 * Client/Server Interfaces:
 ...
 * Runnable prototype:
 * ===================
 *   Std_ReturnType SetNtcStsAndSnpshtData2_Oper(NtcNr1 NtcNr_Arg, uint8 NtcStInfo_Arg, NtcSts1 NtcSts_Arg, uint16 DebStep_Arg, uint32 SpclSnpshtData0_Arg, uint32 SpclSnpshtData1_Arg, uint32 SpclSnpshtData2_Arg)
 *
 **********************************************************************************************************************
 *
 * Available Application Errors:
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: SetNtcStsAndSnpshtData2_Oper_doc
 *********************************************************************************************************************/
...
FUNC(Std_ReturnType, DiagcMgrProxyAppl2_CODE) SetNtcStsAndSnpshtData2_Oper(NtcNr1 NtcNr_Arg, uint8 NtcStInfo_Arg, NtcSts1 NtcSts_Arg, uint16 DebStep_Arg, uint32 SpclSnpshtData0_Arg, uint32 SpclSnpshtData1_Arg, uint32 SpclSnpshtData2_Arg) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: SetNtcStsAndSnpshtData2_Oper (returns application error)
 *********************************************************************************************************************/
    VAR (Std_ReturnType, AUTOMATIC) RtnVal_Cnt_T_enum;
#if (STD_ON == NXTRDET_DIAGCMGR)
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is out of range */
            (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX2_CNT_U08, 5U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx != DIAGCMGR_APPLIDX2_CNT_U08)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in this application */
            (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX2_CNT_U08, 5U, 1U);
    }           
    else
    {           
#endif
