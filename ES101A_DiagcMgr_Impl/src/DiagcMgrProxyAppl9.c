 ...
 *
 *   Description:  C-Code implementation template for SW-C <DiagcMgrProxyAppl9>
 *********************************************************************************************************************/
...
*
* Module File Name: DiagcMgrProxyAppl9.c
...
#include "Rte_DiagcMgrProxyAppl9.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
#define PimDiagcMgrNtcInfo9Ary_rec              (*(Ary1D_NtcInfoRec4_DiagcMgrProxyAppl9 *)(Rte_Pim_DiagcMgrNtcInfo9Ary()))  
#define PimDiagcMgrNtcInfo9DebCntrAry_s16       (*(Ary1D_s16_DiagcMgrProxyAppl9 *)(Rte_Pim_DiagcMgrNtcInfo9DebCntrAry()))  
 ...
 *     Returnvalue: NtcInfoRec4* is of type Ary1D_NtcInfoRec4_DiagcMgrProxyAppl9
 *   sint16 *Rte_Pim_DiagcMgrNtcInfo9DebCntrAry(void)
 *     Returnvalue: sint16* is of type Ary1D_s16_DiagcMgrProxyAppl9
 *   DiagcDataRec2 *Rte_Pim_DiagcData9(void)
 *   DiagcDataRec2 *Rte_Pim_ProxySetNtcData9(void)
 *
 ...
 * Symbol: DiagcMgrProxyAppl9Init1_doc
 *********************************************************************************************************************/
 ...
 * Symbol: DiagcMgrProxyAppl9Init1
 *********************************************************************************************************************/
     
	 VAR(uint16, AUTOMATIC) LoopCntr_Cnt_T_u16;
    
     #if ((STD_ON == NXTRDET_DIAGCMGR) && (STD_ON == DIAGCMGR_DEMCHK))
     for (LoopCntr_Cnt_T_u16=0U; LoopCntr_Cnt_T_u16<TblSize_m(NTCNRARYAPPL9_CNT_U16); LoopCntr_Cnt_T_u16++)
     {
         if ((PrmDiagcMgrFltResp_u16[NTCNRARYAPPL9_CNT_U16[LoopCntr_Cnt_T_u16]] & FLTRESPDTCIDX_CNT_U16) > TOTNROFDTC_CNT_U08)
         {
             ...
             (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX9_CNT_U08, 4U, 0U);
         }
     }       
     #endif
	 
     (void) Rte_Call_DiagcMgrIninCore_Oper(DIAGCMGR_APPLIDX9_CNT_U08, 
                                             (uint8)TblSize_m(PimDiagcMgrNtcInfo9Ary_rec), 
                                             PimDiagcMgrNtcInfo9Ary_rec, 
                                             Rte_Pim_DiagcData9(), 
                                             Rte_Pim_ProxySetNtcData9() );
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: DiagcMgrProxyAppl9Per1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
    ...
    if (ClrNtcFlg_Cnt_T_u08 != *Rte_Pim_PrevClrNtcFlg9())  
    {
        for (NtcInfoIdx_Cnt_T_u16 = 0U; NtcInfoIdx_Cnt_T_u16 < (uint16)TblSize_m(PimDiagcMgrNtcInfo9Ary_rec); NtcInfoIdx_Cnt_T_u16++) 
        {       
            /* Clear the NTCs that are active */
            if(((DIAGCMGRNTCPPTYARY_CNT_U08[NTCNRARYAPPL9_CNT_U16[NtcInfoIdx_Cnt_T_u16]] & NTCPPTYSTSLOCKDTHISIGNCYC_CNT_U08) != 0U) &&
                    ((PimDiagcMgrNtcInfo9Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08) == 0U) &&
                    ((PimDiagcMgrNtcInfo9Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr >= 1U) && 
                    (PimDiagcMgrNtcInfo9Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr <= MAXCYCINHIST_CNT_U08)))
            {
                /* Status 0, AC 255, DebCntr Same */
                PimDiagcMgrNtcInfo9Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts = 0U;
                PimDiagcMgrNtcInfo9Ary_rec[NtcInfoIdx_Cnt_T_u16].NtcStInfo = 0U;
                PimDiagcMgrNtcInfo9Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr = DFTAGICNTR_CNT_U08;
                
            }
            else if(((DIAGCMGRNTCPPTYARY_CNT_U08[NTCNRARYAPPL9_CNT_U16[NtcInfoIdx_Cnt_T_u16]] & NTCPPTYSTSLOCKDTHISIGNCYC_CNT_U08) != 0U) &&
               ((PimDiagcMgrNtcInfo9Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08) == 0U) &&
               ((PimDiagcMgrNtcInfo9Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr == 0U) || 
                (PimDiagcMgrNtcInfo9Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr == 255U)))
            {
                /* Do Nothing */
            } 
            else
            ...
            PimDiagcMgrNtcInfo9Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts = DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08;                     
            PimDiagcMgrNtcInfo9Ary_rec[NtcInfoIdx_Cnt_T_u16].NtcStInfo = 0U;    
            PimDiagcMgrNtcInfo9Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr = DFTAGICNTR_CNT_U08;          
                
                PimDiagcMgrNtcInfo9DebCntrAry_s16[DIAGCMGRNTCMAP_CNT_REC[NTCNRARYAPPL9_CNT_U16[NtcInfoIdx_Cnt_T_u16]].DebCntrIdx] = 0;                   
            }
        }
        Rte_Enter_DiagcMgrProxyAppl9();  
        Rte_Pim_DiagcData9()->ActvMotTqCmdSca = SCAMOTTQCMDTOONE_ULS_F32;   
        Rte_Pim_DiagcData9()->ActvRampRate = MINRAMPRATE_ULSPERSEC_F32; 
        Rte_Pim_DiagcData9()->DiagcSts = DIAGCSTSININVAL_CNT_U08;
        Rte_Pim_ProxySetNtcData9()->ActvMotTqCmdSca = SCAMOTTQCMDTOONE_ULS_F32; 
        Rte_Pim_ProxySetNtcData9()->ActvRampRate = MINRAMPRATE_ULSPERSEC_F32; 
        Rte_Pim_ProxySetNtcData9()->DiagcSts = DIAGCSTSININVAL_CNT_U08;
        Rte_Exit_DiagcMgrProxyAppl9();

        *Rte_Pim_PrevClrNtcFlg9() = ClrNtcFlg_Cnt_T_u08;
    }
    else 
    {
        Rte_Enter_DiagcMgrProxyAppl9();  
        ...
        for (NtcInfoIdx_Cnt_T_u16 = 0U; NtcInfoIdx_Cnt_T_u16 < (uint16)TblSize_m(PimDiagcMgrNtcInfo9Ary_rec); NtcInfoIdx_Cnt_T_u16++) 
        {   
            if (((PimDiagcMgrNtcInfo9Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTFAILD_CNT_U08) != 0U) &&
                ((PimDiagcMgrNtcInfo9Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTFAILDTHISIGNCYC_CNT_U08) != 0U))
            {
                /* ProcessRampResponseAndDiagcSts */
                ProcProxyRampRespAndDiagcSts (NTCNRARYAPPL9_CNT_U16[NtcInfoIdx_Cnt_T_u16], &ProxyPerData_T_rec);           
            }
        }
        Rte_Enter_DiagcMgrProxyAppl9();
        Rte_Pim_DiagcData9()->ActvMotTqCmdSca = Min_f32(ProxyPerData_T_rec.ActvMotTqCmdSca, Rte_Pim_ProxySetNtcData9()->ActvMotTqCmdSca);
        Rte_Pim_DiagcData9()->ActvRampRate = Max_f32(ProxyPerData_T_rec.ActvRampRate, Rte_Pim_ProxySetNtcData9()->ActvRampRate); 
        Rte_Pim_DiagcData9()->DiagcSts = ProxyPerData_T_rec.DiagcSts | Rte_Pim_ProxySetNtcData9()->DiagcSts;
        Rte_Exit_DiagcMgrProxyAppl9();
    } 
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << End of runnable implementation >>               DO NOT CHANGE THIS COMMENT!
 ...
 * Runnable prototype:
 * ===================
 *   void GetDiagcDataAppl9_Oper(DiagcDataRec2 *DiagcData_Arg)
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetDiagcDataAppl9_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetDiagcDataAppl9_Oper
 *********************************************************************************************************************/
    *DiagcData_Arg = *Rte_Pim_DiagcData9(); 
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcActv9_Oper (returns application error)
 *********************************************************************************************************************/
    ...
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        ...
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX9_CNT_U08, 3U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx == 0xFFU)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in any application */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX9_CNT_U08, 3U, 1U);
    }           
    else
    {           
#endif  
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcDebCntrAppl9_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcDebCntrAppl9_Oper
 *********************************************************************************************************************/

    *DebCntr_Arg = (Rte_Pim_DiagcMgrNtcInfo9DebCntrAry()[DebCntrIdx_Arg]);
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcInfoAppl9_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcInfoAppl9_Oper
 *********************************************************************************************************************/

    *NtcInfo_Arg = (Rte_Pim_DiagcMgrNtcInfo9Ary()[NtcInfoIdx_Arg]);
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcQlfrSts9_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcQlfrSts9_Oper (returns application error)
 *********************************************************************************************************************/
    ...
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is out of range */     
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX9_CNT_U08, 2U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx == 0xFFU)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in any application */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX9_CNT_U08, 2U, 1U);
    }           
    else
    {           
#endif  
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcSts9_Oper (returns application error)
 *********************************************************************************************************************/
    ...
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is out of range */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX9_CNT_U08, 1U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx == 0xFFU)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in any application */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX9_CNT_U08, 1U, 1U);
    }           
    else
    {           
#endif  
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: SetNtcSts9_Oper (returns application error)
 *********************************************************************************************************************/
    ...
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is out of range */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX9_CNT_U08, 0U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx != DIAGCMGR_APPLIDX9_CNT_U08)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in this application */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX9_CNT_U08, 0U, 1U);
    }           
    else
    {           
#endif  
        RtnVal_Cnt_T_enum = Rte_Call_SetNtcStsCore_Oper(NtcNr_Arg,
                                                        ...
                                                        Rte_Pim_DiagcData9(),
                                                        Rte_Pim_ProxySetNtcData9(),
                                                        (&PimDiagcMgrNtcInfo9Ary_rec[DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].NtcInfoIdx]),
                                                        (&PimDiagcMgrNtcInfo9DebCntrAry_s16[DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].DebCntrIdx]),
...
/**********************************************************************************************************************
 *
 * Runnable Entity Name: SetNtcStsAndSnpshtData9_Oper
 *
 * This runnable can be invoked concurrently (reentrant implementation).
 *
 *---------------------------------------------------------------------------------------------------------------------
 *
 * Executed if at least one of the following trigger conditions occurred:
 *   - triggered by server invocation for OperationPrototype <Oper> of PortPrototype <SetNtcStsAndSnpshtData9>
 *
 **********************************************************************************************************************
 *
 * Client/Server Interfaces:
 ...
 * Runnable prototype:
 * ===================
 *   Std_ReturnType SetNtcStsAndSnpshtData9_Oper(NtcNr1 NtcNr_Arg, uint8 NtcStInfo_Arg, NtcSts1 NtcSts_Arg, uint16 DebStep_Arg, uint32 SpclSnpshtData0_Arg, uint32 SpclSnpshtData1_Arg, uint32 SpclSnpshtData2_Arg)
 *
 **********************************************************************************************************************
 *
 * Available Application Errors:
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: SetNtcStsAndSnpshtData9_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: SetNtcStsAndSnpshtData9_Oper (returns application error)
 *********************************************************************************************************************/
    VAR (Std_ReturnType, AUTOMATIC) RtnVal_Cnt_T_enum;
#if (STD_ON == NXTRDET_DIAGCMGR)
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is out of range */
            (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX9_CNT_U08, 5U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx != DIAGCMGR_APPLIDX9_CNT_U08)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in this application */
            (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX9_CNT_U08, 5U, 1U);
    }           
    else
    {           
#endif
