 ...
 *
 *   Description:  C-Code implementation template for SW-C <DiagcMgrProxyAppl1>
 *********************************************************************************************************************/
...
*
* Module File Name: DiagcMgrProxyAppl1.c
...
#include "Rte_DiagcMgrProxyAppl1.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
#define PimDiagcMgrNtcInfo1Ary_rec              (*(Ary1D_NtcInfoRec4_DiagcMgrProxyAppl1 *)(Rte_Pim_DiagcMgrNtcInfo1Ary())) 
#define PimDiagcMgrNtcInfo1DebCntrAry_s16       (*(Ary1D_s16_DiagcMgrProxyAppl1 *)(Rte_Pim_DiagcMgrNtcInfo1DebCntrAry()))  
 ...
 * Ary1D_NtcInfoRec4_DiagcMgrProxyAppl1: Array with 65535 element(s) of type NtcInfoRec4
 * Ary1D_s16_DiagcMgrProxyAppl1: Array with 65535 element(s) of type sint16
 ...
 * Symbol: DiagcMgrProxyAppl1Init1_doc
 *********************************************************************************************************************/
 ...
 * Symbol: DiagcMgrProxyAppl1Init1
 *********************************************************************************************************************/
     
	 VAR(uint16, AUTOMATIC) LoopCntr_Cnt_T_u16;
    
     #if ((STD_ON == NXTRDET_DIAGCMGR) && (STD_ON == DIAGCMGR_DEMCHK))
     for (LoopCntr_Cnt_T_u16=0U; LoopCntr_Cnt_T_u16<TblSize_m(NTCNRARYAPPL1_CNT_U16); LoopCntr_Cnt_T_u16++)
     {
         if ((PrmDiagcMgrFltResp_u16[NTCNRARYAPPL1_CNT_U16[LoopCntr_Cnt_T_u16]] & FLTRESPDTCIDX_CNT_U16) > TOTNROFDTC_CNT_U08)
         {
             ...
             (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX1_CNT_U08, 4U, 0U);
         }
     }       
     #endif
	 
     (void) Rte_Call_DiagcMgrIninCore_Oper(DIAGCMGR_APPLIDX1_CNT_U08, 
                                             (uint8)TblSize_m(PimDiagcMgrNtcInfo1Ary_rec), 
                                             PimDiagcMgrNtcInfo1Ary_rec,
                                             Rte_Pim_DiagcData1(), 
                                             Rte_Pim_ProxySetNtcData1() );
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: DiagcMgrProxyAppl1Per1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
    ...
    if (ClrNtcFlg_Cnt_T_u08 != *Rte_Pim_PrevClrNtcFlg1())
    {
        for (NtcInfoIdx_Cnt_T_u16 = 0U; NtcInfoIdx_Cnt_T_u16 < (uint16)TblSize_m(PimDiagcMgrNtcInfo1Ary_rec); NtcInfoIdx_Cnt_T_u16++) 
        {       
            /* Clear the NTCs that are active */
            if(((DIAGCMGRNTCPPTYARY_CNT_U08[NTCNRARYAPPL1_CNT_U16[NtcInfoIdx_Cnt_T_u16]] & NTCPPTYSTSLOCKDTHISIGNCYC_CNT_U08) != 0U) &&
                    ((PimDiagcMgrNtcInfo1Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08) == 0U) &&
                    ((PimDiagcMgrNtcInfo1Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr >= 1U) && 
                    (PimDiagcMgrNtcInfo1Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr <= MAXCYCINHIST_CNT_U08)))
            {
                /* Status 0, AC 255, DebCntr Same */
                PimDiagcMgrNtcInfo1Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts = 0U;
                PimDiagcMgrNtcInfo1Ary_rec[NtcInfoIdx_Cnt_T_u16].NtcStInfo = 0U;
                PimDiagcMgrNtcInfo1Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr = DFTAGICNTR_CNT_U08;
                
            }
            else if(((DIAGCMGRNTCPPTYARY_CNT_U08[NTCNRARYAPPL1_CNT_U16[NtcInfoIdx_Cnt_T_u16]] & NTCPPTYSTSLOCKDTHISIGNCYC_CNT_U08) != 0U) &&
               ((PimDiagcMgrNtcInfo1Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08) == 0U) &&
               ((PimDiagcMgrNtcInfo1Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr == 0U) || 
                (PimDiagcMgrNtcInfo1Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr == 255U)))
            {
                /* Do Nothing */
            }
            else
            {
                ...
                PimDiagcMgrNtcInfo1Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts = DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08;                     
                PimDiagcMgrNtcInfo1Ary_rec[NtcInfoIdx_Cnt_T_u16].NtcStInfo = 0U;    
                PimDiagcMgrNtcInfo1Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr = DFTAGICNTR_CNT_U08;          
                
                PimDiagcMgrNtcInfo1DebCntrAry_s16[DIAGCMGRNTCMAP_CNT_REC[NTCNRARYAPPL1_CNT_U16[NtcInfoIdx_Cnt_T_u16]].DebCntrIdx] = 0;                   
            }
        }
        Rte_Enter_DiagcMgrProxyAppl1();  
        Rte_Pim_DiagcData1()->ActvMotTqCmdSca = SCAMOTTQCMDTOONE_ULS_F32;   
        Rte_Pim_DiagcData1()->ActvRampRate = MINRAMPRATE_ULSPERSEC_F32; 
        Rte_Pim_DiagcData1()->DiagcSts = DIAGCSTSININVAL_CNT_U08;
        Rte_Pim_ProxySetNtcData1()->ActvMotTqCmdSca = SCAMOTTQCMDTOONE_ULS_F32; 
        Rte_Pim_ProxySetNtcData1()->ActvRampRate = MINRAMPRATE_ULSPERSEC_F32; 
        Rte_Pim_ProxySetNtcData1()->DiagcSts = DIAGCSTSININVAL_CNT_U08;
        Rte_Exit_DiagcMgrProxyAppl1();

        *Rte_Pim_PrevClrNtcFlg1() = ClrNtcFlg_Cnt_T_u08;
    }
    else 
    {
        Rte_Enter_DiagcMgrProxyAppl1();
        ...
        for (NtcInfoIdx_Cnt_T_u16 = 0U; NtcInfoIdx_Cnt_T_u16 < (uint16)TblSize_m(PimDiagcMgrNtcInfo1Ary_rec); NtcInfoIdx_Cnt_T_u16++) 
        {   
            if (((PimDiagcMgrNtcInfo1Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTFAILD_CNT_U08) != 0U) &&
                ((PimDiagcMgrNtcInfo1Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTFAILDTHISIGNCYC_CNT_U08) != 0U))
            {
                /* ProcessRampResponseAndDiagcSts */
                ProcProxyRampRespAndDiagcSts (NTCNRARYAPPL1_CNT_U16[NtcInfoIdx_Cnt_T_u16], &ProxyPerData_T_rec);           
            }
        }
        Rte_Enter_DiagcMgrProxyAppl1();
        Rte_Pim_DiagcData1()->ActvMotTqCmdSca = Min_f32(ProxyPerData_T_rec.ActvMotTqCmdSca, Rte_Pim_ProxySetNtcData1()->ActvMotTqCmdSca);
        Rte_Pim_DiagcData1()->ActvRampRate = Max_f32(ProxyPerData_T_rec.ActvRampRate, Rte_Pim_ProxySetNtcData1()->ActvRampRate); 
        Rte_Pim_DiagcData1()->DiagcSts = ProxyPerData_T_rec.DiagcSts | Rte_Pim_ProxySetNtcData1()->DiagcSts;
        Rte_Exit_DiagcMgrProxyAppl1();
    }
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << End of runnable implementation >>               DO NOT CHANGE THIS COMMENT!
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetDiagcDataAppl1_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetDiagcDataAppl1_Oper
 *********************************************************************************************************************/
    *DiagcData_Arg = *Rte_Pim_DiagcData1();
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcActv1_Oper (returns application error)
 *********************************************************************************************************************/
    ...
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        ...
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX1_CNT_U08, 3U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx == 0xFFU)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in any application */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX1_CNT_U08, 3U, 1U);
    }           
    else
    {           
#endif  
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcDebCntrAppl1_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcDebCntrAppl1_Oper
 *********************************************************************************************************************/

    *DebCntr_Arg = (Rte_Pim_DiagcMgrNtcInfo1DebCntrAry()[DebCntrIdx_Arg]);
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcInfoAppl1_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcInfoAppl1_Oper
 *********************************************************************************************************************/

    *NtcInfo_Arg = (Rte_Pim_DiagcMgrNtcInfo1Ary()[NtcInfoIdx_Arg]);
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcQlfrSts1_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcQlfrSts1_Oper (returns application error)
 *********************************************************************************************************************/
    ...
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is out of range */     
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX1_CNT_U08, 2U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx == 0xFFU)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in any application */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX1_CNT_U08, 2U, 1U);
    }           
    else
    {           
#endif  
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcSts1_Oper (returns application error)
 *********************************************************************************************************************/
    ...
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is out of range */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX1_CNT_U08, 1U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx == 0xFFU)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in any application */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX1_CNT_U08, 1U, 1U);
    }           
    else
    {           
#endif  
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: SetNtcSts1_Oper (returns application error)
 *********************************************************************************************************************/
    ...
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is out of range */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX1_CNT_U08, 0U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx != DIAGCMGR_APPLIDX1_CNT_U08)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in this application */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX1_CNT_U08, 0U, 1U);
    }           
    else
    {           
#endif  
    RtnVal_Cnt_T_enum = Rte_Call_SetNtcStsCore_Oper(NtcNr_Arg,
                                                    ...
                                                    Rte_Pim_DiagcData1(),
                                                    Rte_Pim_ProxySetNtcData1(),
                                                    (&PimDiagcMgrNtcInfo1Ary_rec[DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].NtcInfoIdx]),
                                                    (&PimDiagcMgrNtcInfo1DebCntrAry_s16[DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].DebCntrIdx]),
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: SetNtcStsAndSnpshtData1_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: SetNtcStsAndSnpshtData1_Oper (returns application error)
 *********************************************************************************************************************/
    VAR (Std_ReturnType, AUTOMATIC) RtnVal_Cnt_T_enum;
#if (STD_ON == NXTRDET_DIAGCMGR)
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is out of range */
            (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX1_CNT_U08, 5U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx != DIAGCMGR_APPLIDX1_CNT_U08)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in this application */
            (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX1_CNT_U08, 5U, 1U);
    }           
    else
    {           
#endif
