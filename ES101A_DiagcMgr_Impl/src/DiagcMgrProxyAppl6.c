 ...
 *
 *   Description:  C-Code implementation template for SW-C <DiagcMgrProxyAppl6>
 *********************************************************************************************************************/
...
*
* Module File Name: DiagcMgrProxyAppl6.c
...
#include "Rte_DiagcMgrProxyAppl6.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
#define PimDiagcMgrNtcInfo6Ary_rec              (*(Ary1D_NtcInfoRec4_DiagcMgrProxyAppl6 *)(Rte_Pim_DiagcMgrNtcInfo6Ary()))  
#define PimDiagcMgrNtcInfo6DebCntrAry_s16       (*(Ary1D_s16_DiagcMgrProxyAppl6 *)(Rte_Pim_DiagcMgrNtcInfo6DebCntrAry()))  
 ...
 * Symbol: DiagcMgrProxyAppl6Init1_doc
 *********************************************************************************************************************/
 ...
 * Symbol: DiagcMgrProxyAppl6Init1
 *********************************************************************************************************************/
     
	 VAR(uint16, AUTOMATIC) LoopCntr_Cnt_T_u16;
    
     #if ((STD_ON == NXTRDET_DIAGCMGR) && (STD_ON == DIAGCMGR_DEMCHK))
     for (LoopCntr_Cnt_T_u16=0U; LoopCntr_Cnt_T_u16<TblSize_m(NTCNRARYAPPL6_CNT_U16); LoopCntr_Cnt_T_u16++)
     {
         if ((PrmDiagcMgrFltResp_u16[NTCNRARYAPPL6_CNT_U16[LoopCntr_Cnt_T_u16]] & FLTRESPDTCIDX_CNT_U16) > TOTNROFDTC_CNT_U08)
         {
             ...
             (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX6_CNT_U08, 4U, 0U);
         }
     }       
     #endif
	 
     (void) Rte_Call_DiagcMgrIninCore_Oper(DIAGCMGR_APPLIDX6_CNT_U08, 
                                             (uint8)TblSize_m(PimDiagcMgrNtcInfo6Ary_rec), 
                                             PimDiagcMgrNtcInfo6Ary_rec, 
                                             Rte_Pim_DiagcData6(), 
                                             Rte_Pim_ProxySetNtcData6() );
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: DiagcMgrProxyAppl6Per1_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
    ...
    if (ClrNtcFlg_Cnt_T_u08 != *Rte_Pim_PrevClrNtcFlg6())
    {
        for (NtcInfoIdx_Cnt_T_u16 = 0U; NtcInfoIdx_Cnt_T_u16 < (uint16)TblSize_m(PimDiagcMgrNtcInfo6Ary_rec); NtcInfoIdx_Cnt_T_u16++) 
        {       
            /* Clear the NTCs that are active */
            if(((DIAGCMGRNTCPPTYARY_CNT_U08[NTCNRARYAPPL6_CNT_U16[NtcInfoIdx_Cnt_T_u16]] & NTCPPTYSTSLOCKDTHISIGNCYC_CNT_U08) != 0U) &&
                    ((PimDiagcMgrNtcInfo6Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08) == 0U) &&
                    ((PimDiagcMgrNtcInfo6Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr >= 1U) && 
                    (PimDiagcMgrNtcInfo6Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr <= MAXCYCINHIST_CNT_U08)))
            {
                /* Status 0, AC 255, DebCntr Same */
                PimDiagcMgrNtcInfo6Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts = 0U;
                PimDiagcMgrNtcInfo6Ary_rec[NtcInfoIdx_Cnt_T_u16].NtcStInfo = 0U;
                PimDiagcMgrNtcInfo6Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr = DFTAGICNTR_CNT_U08;                
            }
            else if(((DIAGCMGRNTCPPTYARY_CNT_U08[NTCNRARYAPPL6_CNT_U16[NtcInfoIdx_Cnt_T_u16]] & NTCPPTYSTSLOCKDTHISIGNCYC_CNT_U08) != 0U) &&
               ((PimDiagcMgrNtcInfo6Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08) == 0U) &&
               ((PimDiagcMgrNtcInfo6Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr == 0U) || 
                (PimDiagcMgrNtcInfo6Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr == 255U)))
            {
                /* Do Nothing */
            }
            else
            ...
            PimDiagcMgrNtcInfo6Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts = DIAGCMGR_NTCINFOSTSTESTNOTCMPLTHISIGNCYC_CNT_U08;                     
            PimDiagcMgrNtcInfo6Ary_rec[NtcInfoIdx_Cnt_T_u16].NtcStInfo = 0U;    
            PimDiagcMgrNtcInfo6Ary_rec[NtcInfoIdx_Cnt_T_u16].AgiCntr = DFTAGICNTR_CNT_U08;          
                
                PimDiagcMgrNtcInfo6DebCntrAry_s16[DIAGCMGRNTCMAP_CNT_REC[NTCNRARYAPPL6_CNT_U16[NtcInfoIdx_Cnt_T_u16]].DebCntrIdx] = 0;                   
            }    
        }
        Rte_Enter_DiagcMgrProxyAppl6();  
        Rte_Pim_DiagcData6()->ActvMotTqCmdSca = SCAMOTTQCMDTOONE_ULS_F32;   
        Rte_Pim_DiagcData6()->ActvRampRate = MINRAMPRATE_ULSPERSEC_F32; 
        Rte_Pim_DiagcData6()->DiagcSts = DIAGCSTSININVAL_CNT_U08;
        Rte_Pim_ProxySetNtcData6()->ActvMotTqCmdSca = SCAMOTTQCMDTOONE_ULS_F32; 
        Rte_Pim_ProxySetNtcData6()->ActvRampRate = MINRAMPRATE_ULSPERSEC_F32; 
        Rte_Pim_ProxySetNtcData6()->DiagcSts = DIAGCSTSININVAL_CNT_U08;
        Rte_Exit_DiagcMgrProxyAppl6();

        *Rte_Pim_PrevClrNtcFlg6() = ClrNtcFlg_Cnt_T_u08;
    } 
    else 
    {      
        Rte_Enter_DiagcMgrProxyAppl6();  
        ...
        for (NtcInfoIdx_Cnt_T_u16 = 0U; NtcInfoIdx_Cnt_T_u16 < (uint16)TblSize_m(PimDiagcMgrNtcInfo6Ary_rec); NtcInfoIdx_Cnt_T_u16++) 
        {   
            if (((PimDiagcMgrNtcInfo6Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTFAILD_CNT_U08) != 0U) &&
                ((PimDiagcMgrNtcInfo6Ary_rec[NtcInfoIdx_Cnt_T_u16].Sts & DIAGCMGR_NTCINFOSTSTESTFAILDTHISIGNCYC_CNT_U08) != 0U))
            {
                /* ProcessRampResponseAndDiagcSts */
                ProcProxyRampRespAndDiagcSts (NTCNRARYAPPL6_CNT_U16[NtcInfoIdx_Cnt_T_u16], &ProxyPerData_T_rec);           
            }
        }
        Rte_Enter_DiagcMgrProxyAppl6();
        Rte_Pim_DiagcData6()->ActvMotTqCmdSca = Min_f32(ProxyPerData_T_rec.ActvMotTqCmdSca, Rte_Pim_ProxySetNtcData6()->ActvMotTqCmdSca);
        Rte_Pim_DiagcData6()->ActvRampRate = Max_f32(ProxyPerData_T_rec.ActvRampRate, Rte_Pim_ProxySetNtcData6()->ActvRampRate); 
        Rte_Pim_DiagcData6()->DiagcSts = ProxyPerData_T_rec.DiagcSts | Rte_Pim_ProxySetNtcData6()->DiagcSts;
        Rte_Exit_DiagcMgrProxyAppl6();
    }
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << End of runnable implementation >>               DO NOT CHANGE THIS COMMENT!
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetDiagcDataAppl6_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetDiagcDataAppl6_Oper
 *********************************************************************************************************************/
    *DiagcData_Arg = *Rte_Pim_DiagcData6();
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcActv6_Oper (returns application error)
 *********************************************************************************************************************/
    ...
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        ...
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX6_CNT_U08, 3U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx == 0xFFU)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in any application */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX6_CNT_U08, 3U, 1U);
    }           
    else
    {           
#endif  
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcDebCntrAppl6_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcDebCntrAppl6_Oper
 *********************************************************************************************************************/

    *DebCntr_Arg = (Rte_Pim_DiagcMgrNtcInfo6DebCntrAry()[DebCntrIdx_Arg]);
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcInfoAppl6_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcInfoAppl6_Oper
 *********************************************************************************************************************/

    *NtcInfo_Arg = (Rte_Pim_DiagcMgrNtcInfo6Ary()[NtcInfoIdx_Arg]);
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcQlfrSts6_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcQlfrSts6_Oper (returns application error)
 *********************************************************************************************************************/
    ...
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is out of range */     
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX6_CNT_U08, 2U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx == 0xFFU)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in any application */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX6_CNT_U08, 2U, 1U);
    }           
    else
    {           
#endif  
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetNtcSts6_Oper (returns application error)
 *********************************************************************************************************************/
    ...
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is out of range */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX6_CNT_U08, 1U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx == 0xFFU)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in any application */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX6_CNT_U08, 1U, 1U);
    }           
    else
    {           
#endif  
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: SetNtcSts6_Oper (returns application error)
 *********************************************************************************************************************/
    ...
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is out of range */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX6_CNT_U08, 0U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx != DIAGCMGR_APPLIDX6_CNT_U08)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in this application */
        (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX6_CNT_U08, 0U, 1U);
    }           
    else
    {           
#endif  
        RtnVal_Cnt_T_enum = Rte_Call_SetNtcStsCore_Oper(NtcNr_Arg,
                                                        ...
                                                        Rte_Pim_DiagcData6(),
                                                        Rte_Pim_ProxySetNtcData6(),
                                                        (&PimDiagcMgrNtcInfo6Ary_rec[DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].NtcInfoIdx]),
                                                        (&PimDiagcMgrNtcInfo6DebCntrAry_s16[DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].DebCntrIdx]),
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: SetNtcStsAndSnpshtData6_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: SetNtcStsAndSnpshtData6_Oper (returns application error)
 *********************************************************************************************************************/
    VAR (Std_ReturnType, AUTOMATIC) RtnVal_Cnt_T_enum;
#if (STD_ON == NXTRDET_DIAGCMGR)
    if((NtcNr_Arg < NTCNR_0X001) || (NtcNr_Arg > NTCNR_0X1FF))
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is out of range */
            (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX6_CNT_U08, 5U, 0U);
    }   
    else if(DIAGCMGRNTCMAP_CNT_REC[NtcNr_Arg].ApplIdx != DIAGCMGR_APPLIDX6_CNT_U08)
    {
        RtnVal_Cnt_T_enum = E_NOT_OK;
        /* NtcNr is not configured in this application */
            (void)Det_ReportError(NXTRDET_DIAGCMGRMODID_CNT_U16, DIAGCMGR_APPLIDX6_CNT_U08, 5U, 1U);
    }           
    else
    {           
#endif
