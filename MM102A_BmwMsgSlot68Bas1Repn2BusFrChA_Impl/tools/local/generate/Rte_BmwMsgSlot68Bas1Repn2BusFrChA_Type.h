 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_BmwMsgSlot68Bas1Repn2BusFrChA_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <BmwMsgSlot68Bas1Repn2BusFrChA> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_BMWMSGSLOT68BAS1REPN2BUSFRCHA_TYPE_H
# define _RTE_BMWMSGSLOT68BAS1REPN2BUSFRCHA_TYPE_H
...
# ifndef BMWMAXCURRLIMRSTS_VLD
#  define BMWMAXCURRLIMRSTS_VLD (1U)
# endif

# ifndef BMWMAXCURRLIMRSTS_FCTIFNOTAVL
#  define BMWMAXCURRLIMRSTS_FCTIFNOTAVL (2U)
# endif

# ifndef BMWMAXCURRLIMRSTS_FCTRPRTERR
#  define BMWMAXCURRLIMRSTS_FCTRPRTERR (3U)
# endif

# ifndef BMWMAXCURRLIMRSTS_INVLD
#  define BMWMAXCURRLIMRSTS_INVLD (4U)
# endif

# ifndef BMWRQRDCURRLIMEPSSFTY_NOCURRLIM
#  define BMWRQRDCURRLIMEPSSFTY_NOCURRLIM (0U)
# endif

# ifndef BMWRQRDCURRLIMEPSSFTY_CMFTCURRLIM
#  define BMWRQRDCURRLIMEPSSFTY_CMFTCURRLIM (1U)
# endif

# ifndef BMWRQRDCURRLIMEPSSFTY_MAXCURRLIM
#  define BMWRQRDCURRLIMEPSSFTY_MAXCURRLIM (10U)
# endif

# ifndef BMWRQRDCURRLIMEPSSFTY_RESDNOTAVL
#  define BMWRQRDCURRLIMEPSSFTY_RESDNOTAVL (13U)
# endif

# ifndef BMWRQRDCURRLIMEPSSFTY_RESDERR
#  define BMWRQRDCURRLIMEPSSFTY_RESDERR (14U)
# endif

# ifndef BMWRQRDCURRLIMEPSSFTY_INVLDSIG
#  define BMWRQRDCURRLIMEPSSFTY_INVLDSIG (15U)
# endif

# ifndef ENERG_AVAI_ARS_Funktionsschnittstelle_ist_nicht_verfuegbar
#  define ENERG_AVAI_ARS_Funktionsschnittstelle_ist_nicht_verfuegbar (253U)
# endif

# ifndef ENERG_AVAI_ARS_Funktion_meldet_Fehler
#  define ENERG_AVAI_ARS_Funktion_meldet_Fehler (254U)
# endif

# ifndef ENERG_AVAI_ARS_Signal_unbefuellt
#  define ENERG_AVAI_ARS_Signal_unbefuellt (255U)
# endif

# ifndef I_SPEC_ARS_Funktionsschnittstelle_ist_nicht_verfuegbar
#  define I_SPEC_ARS_Funktionsschnittstelle_ist_nicht_verfuegbar (253U)
# endif

# ifndef I_SPEC_ARS_Funktion_meldet_Fehler
#  define I_SPEC_ARS_Funktion_meldet_Fehler (254U)
# endif

# ifndef I_SPEC_ARS_Signal_unbefuellt
#  define I_SPEC_ARS_Signal_unbefuellt (255U)
# endif

# ifndef MIN_I_SPEC_ARS_Funktionsschnittstelle_ist_nicht_verfuegbar
#  define MIN_I_SPEC_ARS_Funktionsschnittstelle_ist_nicht_verfuegbar (253U)
# endif

# ifndef MIN_I_SPEC_ARS_Funktion_meldet_Fehler
#  define MIN_I_SPEC_ARS_Funktion_meldet_Fehler (254U)
# endif

# ifndef MIN_I_SPEC_ARS_Signal_unbefuellt
#  define MIN_I_SPEC_ARS_Signal_unbefuellt (255U)
# endif
...
# ifndef QU_DGR_AISP_ENERG_Degradationsstufe0
#  define QU_DGR_AISP_ENERG_Degradationsstufe0 (0U)
# endif

# ifndef QU_DGR_AISP_ENERG_Degradationsstufe1
#  define QU_DGR_AISP_ENERG_Degradationsstufe1 (1U)
# endif

# ifndef QU_DGR_AISP_ENERG_Degradationsstufe2
#  define QU_DGR_AISP_ENERG_Degradationsstufe2 (2U)
# endif

# ifndef QU_DGR_AISP_ENERG_Degradationsstufe3
#  define QU_DGR_AISP_ENERG_Degradationsstufe3 (3U)
# endif

# ifndef QU_DGR_AISP_ENERG_Degradationsstufe4
#  define QU_DGR_AISP_ENERG_Degradationsstufe4 (4U)
# endif

# ifndef QU_DGR_AISP_ENERG_SignalUngueltig
#  define QU_DGR_AISP_ENERG_SignalUngueltig (15U)
# endif

# ifndef RQ_CULI_EST_SFY_Keine_Strombegrenzung
#  define RQ_CULI_EST_SFY_Keine_Strombegrenzung (0U)
# endif

# ifndef RQ_CULI_EST_SFY_Komfort_Strombegrenzung
#  define RQ_CULI_EST_SFY_Komfort_Strombegrenzung (1U)
# endif

# ifndef RQ_CULI_EST_SFY_Maximale_Strombegrenzung
#  define RQ_CULI_EST_SFY_Maximale_Strombegrenzung (10U)
# endif

# ifndef RQ_CULI_EST_SFY_Reserviert_nicht_verfuegbar
#  define RQ_CULI_EST_SFY_Reserviert_nicht_verfuegbar (13U)
# endif

# ifndef RQ_CULI_EST_SFY_Reserviert_Fehler
#  define RQ_CULI_EST_SFY_Reserviert_Fehler (14U)
# endif

# ifndef RQ_CULI_EST_SFY_Signal_unbefuellt
#  define RQ_CULI_EST_SFY_Signal_unbefuellt (15U)
# endif
...
#endif /* _RTE_BMWMSGSLOT68BAS1REPN2BUSFRCHA_TYPE_H */
