...
<polyspace_project name="Polyspace" language="C" author="Nexteer" version="1.0" date="05/10/2016" path="file:/${polyspace_dir}/Polyspace.psprj" source="Code Prover" rev="1.4">
  <source>
