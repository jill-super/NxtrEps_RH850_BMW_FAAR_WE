 ...
 *
 *   Description:  Application types header file for SW-C <TmplMonr> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_TMPLMONR_TYPE_H
# define _RTE_TMPLMONR_TYPE_H
