...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ES104B_XcpIf_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ES104B_XcpIf_Impl
...
XCOPY ..\..\autosar\XcpIf_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
