...
/* XCP User Functions */
#define XCPIF_RESPBUF_CNT_U08(x)    Xcp_ChannelInfo[XCP_CHANNEL_IDX].ResponseFrame.b[x]
#define XCPIF_RESPBUFLEN_CNT_U08    Xcp_ChannelInfo[XCP_CHANNEL_IDX].ResponseFrameLength
