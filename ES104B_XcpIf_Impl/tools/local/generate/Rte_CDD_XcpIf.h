...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_CDD_XcpIf_ActvIninOptSetAIdx_Val(P2VAR(uint8, AUTOMATIC, RTE_CDD_XCPIF_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_CDD_XcpIf_CustXcpEna_Logl(P2VAR(boolean, AUTOMATIC, RTE_CDD_XCPIF_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_CDD_XcpIf_GetRefTmr1MicroSec32bit_Oper(P2VAR(uint32, AUTOMATIC, RTE_CDD_XCPIF_APPL_VAR) RefTmr_Arg); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
# define Rte_Call_GetRefTmr1MicroSec32bit_Oper Rte_Call_CDD_XcpIf_GetRefTmr1MicroSec32bit_Oper
