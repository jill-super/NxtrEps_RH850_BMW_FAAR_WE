...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ES210A_EcuTMeas_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ES210A_EcuTMeas_Impl
...
XCOPY ..\..\autosar\EcuTMeas_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
