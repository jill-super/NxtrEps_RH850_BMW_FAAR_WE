...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ES311A_GateDrv0Ctrl_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ES311A_GateDrv0Ctrl_Impl
...
XCOPY ..\..\autosar\GateDrv0Ctrl_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
