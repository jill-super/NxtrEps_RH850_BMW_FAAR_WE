 ...
 *
 *   Description:  Application types header file for SW-C <RvsBattProtn> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_RVSBATTPROTN_TYPE_H
# define _RTE_RVSBATTPROTN_TYPE_H
...
#endif /* _RTE_RVSBATTPROTN_TYPE_H */
