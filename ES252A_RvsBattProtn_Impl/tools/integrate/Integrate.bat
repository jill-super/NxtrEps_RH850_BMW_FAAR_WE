...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ES252A_RvsBattProtn_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ES252A_RvsBattProtn_Impl
...
XCOPY ..\..\autosar\RvsBattProtn_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
