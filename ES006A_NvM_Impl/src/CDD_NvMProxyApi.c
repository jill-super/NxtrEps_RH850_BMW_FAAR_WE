...
* 07/07/17  3        KJS       Added support for new OS versions with non trusted function calls               EA4#11819
**********************************************************************************************************************/
...
/* The following elements in the structures do not follow Nexteer's EA4 naming conventions. To help with readability 
...
/* The following function arguments in the functions below do not follow Nexteer's EA4 naming conventions. 
...
FUNC(Std_ReturnType, CDD_NvMProxy_CODE) NvMProxy_EraseNvBlock( NvM_BlockIdType BlockId )
{
    ...
    else
    {
        ...
        (void)Os_CallNonTrustedFunction((Os_NonTrustedFunctionIndexType)NtWrapS_NvM_EraseNvBlock, &Prm_Cnt_T_str);
                                                               ...
                                                               P2VAR(uint8, AUTOMATIC, AUTOMATIC) DataIndexPtr )
{
    ...
    else
    {
        /* Caller is not in the same application as NvM, context switch required */
        Prm_Cnt_T_str.BlockId = BlockId;
        (void)Os_CallNonTrustedFunction((Os_NonTrustedFunctionIndexType)NtWrapS_NvM_GetDataIndex, &Prm_Cnt_T_str);
                                                                 ...
                                                                 P2VAR(uint8, AUTOMATIC, AUTOMATIC) RequestResultPtr )
{
    ...
    else
    {
        /* Caller is not in the same application as NvM, context switch required */
        Prm_Cnt_T_str.BlockId = BlockId;
        (void)Os_CallNonTrustedFunction((Os_NonTrustedFunctionIndexType)NtWrapS_NvM_GetErrorStatus, &Prm_Cnt_T_str);
...
FUNC(Std_ReturnType, CDD_NvMProxy_CODE) NvMProxy_InvalidateNvBlock( NvM_BlockIdType BlockId )
{
    ...
    else
    {
        /* Caller is not in the same application as NvM, context switch required */
        Prm_Cnt_T_str.BlockId = BlockId;
        (void)Os_CallNonTrustedFunction((Os_NonTrustedFunctionIndexType)NtWrapS_NvM_InvalidateNvBlock, &Prm_Cnt_T_str);
                                                            ...
                                                            P2VAR(uint8, AUTOMATIC, AUTOMATIC) NvM_DstPtr )
{
    ...
    else
    {
        ...
        (void)Os_CallNonTrustedFunction((Os_NonTrustedFunctionIndexType)NtWrapS_NvM_WriteBlock, &Prm_Cnt_T_str);
                                                                     ...
                                                                     VAR(boolean, AUTOMATIC) ProtectionEnabled )
{
    ...
    else
    {
        ...
        (void)Os_CallNonTrustedFunction((Os_NonTrustedFunctionIndexType)NtWrapS_NvM_SetBlockProtection, &Prm_Cnt_T_str);
                                                               ...
                                                               VAR(uint8, AUTOMATIC) DataIndex )
{
    ...
    else
    {
        ...
        (void)Os_CallNonTrustedFunction((Os_NonTrustedFunctionIndexType)NtWrapS_NvM_SetDataIndex, &Prm_Cnt_T_str);
                                                                    ...
                                                                    VAR(boolean, AUTOMATIC) BlockChanged )
{
    ...
    else
    {
        ...
        (void)Os_CallNonTrustedFunction((Os_NonTrustedFunctionIndexType)NtWrapS_NvM_SetRamBlockStatus, &Prm_Cnt_T_str);
...
* Usage Notes: 
**********************************************************************************************************************/
FUNC(void, CDD_NvMProxy_CODE) NONTRUSTED_NtWrapS_NvM_EraseNvBlock(Os_NonTrustedFunctionIndexType FunctionIndex, Os_NonTrustedFunctionParameterRefType FunctionParams)
{
...
* Usage Notes: 
**********************************************************************************************************************/
FUNC(void, CDD_NvMProxy_CODE) NONTRUSTED_NtWrapS_NvM_GetErrorStatus(Os_NonTrustedFunctionIndexType FunctionIndex, Os_NonTrustedFunctionParameterRefType FunctionParams)
{
...
* Usage Notes: 
**********************************************************************************************************************/
FUNC(void, CDD_NvMProxy_CODE) NONTRUSTED_NtWrapS_NvM_InvalidateNvBlock(Os_NonTrustedFunctionIndexType FunctionIndex, Os_NonTrustedFunctionParameterRefType FunctionParams)
{
...
* Usage Notes: 
**********************************************************************************************************************/
FUNC(void, CDD_NvMProxy_CODE) NONTRUSTED_NtWrapS_NvM_ReadBlock(Os_NonTrustedFunctionIndexType FunctionIndex, Os_NonTrustedFunctionParameterRefType FunctionParams)
{
...
* Usage Notes: 
**********************************************************************************************************************/
FUNC(void, CDD_NvMProxy_CODE) NONTRUSTED_NtWrapS_NvM_SetBlockProtection(Os_NonTrustedFunctionIndexType FunctionIndex, Os_NonTrustedFunctionParameterRefType FunctionParams)
{
...
* Usage Notes: 
**********************************************************************************************************************/
FUNC(void, CDD_NvMProxy_CODE) NONTRUSTED_NtWrapS_NvM_SetRamBlockStatus(Os_NonTrustedFunctionIndexType FunctionIndex, Os_NonTrustedFunctionParameterRefType FunctionParams)
{
...
* Usage Notes: 
**********************************************************************************************************************/
FUNC(void, CDD_NvMProxy_CODE) NONTRUSTED_NtWrapS_NvM_SetDataIndex(Os_NonTrustedFunctionIndexType FunctionIndex, Os_NonTrustedFunctionParameterRefType FunctionParams)
{
...
* Usage Notes: 
**********************************************************************************************************************/
FUNC(void, CDD_NvMProxy_CODE) NONTRUSTED_NtWrapS_NvM_GetDataIndex(Os_NonTrustedFunctionIndexType FunctionIndex, Os_NonTrustedFunctionParameterRefType FunctionParams)
{
...
* Usage Notes: 
**********************************************************************************************************************/
FUNC(void, CDD_NvMProxy_CODE) NONTRUSTED_NtWrapS_NvM_WriteBlock(Os_NonTrustedFunctionIndexType FunctionIndex, Os_NonTrustedFunctionParameterRefType FunctionParams)
{
