 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_BattVltgCorrln_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <BattVltgCorrln> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_BATTVLTGCORRLN_TYPE_H
# define _RTE_BATTVLTGCORRLN_TYPE_H
...
#endif /* _RTE_BATTVLTGCORRLN_TYPE_H */
