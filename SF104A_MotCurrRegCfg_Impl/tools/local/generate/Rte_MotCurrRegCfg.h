...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_MotCurrRegCfg_MotAndThermProtnLoaMod_Val(P2VAR(uint8, AUTOMATIC, RTE_MOTCURRREGCFG_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
