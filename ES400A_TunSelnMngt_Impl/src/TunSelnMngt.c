 ...
 *  Generated at:  Wed May 16 10:51:34 2018
 *
 ...
 *********************************************************************************************************************/
/**********************************************************************************************************************
* Copyright 2015, 2016, 2017, 2018 Nexteer 
...
* 11/29/17  5        KJS        Updated to match version 2.0.0 of the design. NTC numbers updated.             	EA4#17809
* 04/26/18  6        KJS        Updated to match version 3.0.0 of the design.                                  	EA4#23002
*                                - Added DesIninOptSetAIdx input
*                                - Added RtIdxChgSts output
*                                - Variable name cleanup for readability
* 07/13/18  7        PHJ        Updated source for anomaly EA4#25950 correction. Refer to changes in the
*								anomaly for details. 												            EA4#25998
**********************************************************************************************************************/
...
#include "Rte_TunSelnMngt.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
/* MISRA-C:2004 Rule 11.3 [NXTRDEV 11.3.4]: Cast of a variable address to an integer type is required for address range checking directly in component code and for addresses returned over XCP for external range checking. */
...
/* MISRA-C 2004 Rule 11.5 [NXTRDEV 11.5.1]: Const is removed due to limitation of function arguments generated by Davinci Developer. */
/* MISRA-C 2004 Rule 16.10 [NXTRDEV 16.10.1]: There is no appropriate action to take on the return value for [Rte Reads, Rte Writes, SetNtcSts, Calc32BitCrc]. */
...
/* The data type TunSelnRamTblRec1 is made of elements that are generated by the RTE,  and cannot be created in the 
 * Rte_UserTypes.h because of their dynamic nature and the fact that the RTE is the owner of those data types. */
static VAR(TunSelnRamTblRec1, AUTOMATIC) MngtRamTbl_M[2];
 ...
 *   RTIDXCHGSTS_IDLE (0U)
 *   RTIDXCHGSTS_PNDTUNSELNAUTHY (1U)
 *   RTIDXCHGSTS_DFTMODCHGCMPL (2U)
 *   RTIDXCHGSTS_ONLINECALRAMMODCHGCMPL (3U)
 *   RTIDXCHGSTS_ONLINECALFLSMODCHGCMPL (4U)
 *   RTIDXCHGSTS_FLTACTV (5U)
 *
 * Array Types:
 * ============
 ...
 *   uint8 *Rte_Pim_PrevActvIninOptSetAIdx(void)
 *   uint8 *Rte_Pim_PrevActvRtIdx(void)
 *   uint8 *Rte_Pim_PrevRamPageAcs(void)
 *   RtIdxChgSts1 *Rte_Pim_PrevRtIdxChgSts(void)
 *   uint8 *Rte_Pim_RamTblSwt(void)
 *   OnlineCalStsRec2 *Rte_Pim_OnlineCalSts(void)
 *
 *********************************************************************************************************************/
 ...
 * Symbol: CopyCalPageReq_Oper_doc
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
    ...
    if(XCPIF_MAXCALSEG_CNT_U08 > Seg_Arg )
    {
        ...
        (*Rte_Pim_OnlineCalSts()).ActvIninOptSetA = *Rte_Pim_PrevActvIninOptSetAIdx();
 ...
 *********************************************************************************************************************/
    ...
    if ( (Mod_Arg & (uint8)XCPIF_ONLINECALXCPANDECUACS_CNT_U08) != 0U)
    {
        if( XCPIF_MAXCALSEG_CNT_U08 > Seg_Arg )
        {
            ...
            do
            {
                ...
                if( (Mod_Arg & (*Rte_Pim_OnlineCalSts()).Seg[Seg_Arg].Page[Idx_Cnt_T_u08].PageAcs) > 0U)
                {
                    ...
                    *Rtn_Arg = (uint8)XCPIF_CMDOK_CNT_U08;
                    CalPageFound_Cnt_T_logl = TRUE;
                }
                else
                {
                    /* Mode was not found on any page */
                    *Rtn_Arg = (uint8)XCPIF_RTNPAGEMODNOTVLD_CNT_U08;
                }
        ...
        {
            /* Segment was invalid */
            *Rtn_Arg = (uint8)XCPIF_RTNSEGNOTVLD_CNT_U08;
        }
    }
    else
    {
 ...
 *********************************************************************************************************************/
    ...
    if( XCPIF_MAXCALSEG_CNT_U08 > Seg_Arg )
    {
        switch(Mod_Arg)
        {
            ...
            break;
            default:
                *Rtn_Arg = (uint8)XCPIF_CMDOUTOFRNG_CNT_U08;
            break;
        }
    }
    else
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: OnlineTunRamAdrMpg_Oper_doc
 *********************************************************************************************************************/
 ...
 *   Std_ReturnType Rte_Read_DesIninOptSetAIdx_Val(uint8 *data)
 ...
 *   Std_ReturnType Rte_Write_ActvIninOptSetAIdx_Val(uint8 data)
 *   Std_ReturnType Rte_Write_ActvRtIdx_Val(uint8 data)
 *   Std_ReturnType Rte_Write_CalCopySts_Val(CalCopySts1 data)
 *   Std_ReturnType Rte_Write_RtIdxChgSts_Val(RtIdxChgSts1 data)
 *
 ...
 *********************************************************************************************************************/
    ...
    VAR(uint8, AUTOMATIC) IninFltPrmByte_Cnt_T_u08 = 0U;
    VAR(boolean, AUTOMATIC) IninIdxFound_Cnt_T_logl = FALSE;
    VAR(boolean, AUTOMATIC) IninOptSetAIdxFound_Cnt_T_logl = FALSE;
    ...
    *Rte_Pim_PrevRtIdxChgSts() = RTIDXCHGSTS_IDLE;
    ...
    (*Rte_Pim_OnlineCalSts()).ActvIninOptSetA = 0U;
    ...
    MemCopy32Bit(&MngtRamTbl_M[0].PrmRefTblPtr, RteParameterRefTab, PRMPTRTBLSIZEINWORD_CNT_U16);
    MemCopy32Bit(&MngtRamTbl_M[1].PrmRefTblPtr, RteParameterRefTab, PRMPTRTBLSIZEINWORD_CNT_U16);
    /* ENDREQ: ES400A #50 I */
    ...
    (void)Rte_Call_Calc32BitCrc_u32_Oper( (uint32 *)&(RteParameterRefTab[0]), PRMPTRTBLSIZEINWORD_CNT_U16, 
                                          0U, TRUE, &(MngtRamTbl_M[0].PrmTblCrc_u32) );
    MngtRamTbl_M[1].PrmTblCrc_u32 = MngtRamTbl_M[0].PrmTblCrc_u32;
    /* ENDREQ: ES400A #51 I */
    ...
    {
        IninIdxFound_Cnt_T_logl = IdxChgMngt( DesIninIdx_Cnt_T_u08, MAXININIDXCNT_CNT_U08,
                                              ININCALCFGTBL_REC);
                                              
        /* Update previous values and output ports */
        if(TRUE == IninIdxFound_Cnt_T_logl)
        {
            /* Index was found, assign index */
            *Rte_Pim_PrevActvIninIdx() = DesIninIdx_Cnt_T_u08;
            (void)Rte_Write_ActvIninIdx_Val(DesIninIdx_Cnt_T_u08);
        }
        else
        {
            /* Index was not found, do not update ports or PIMs and set parameter byte */
            IninFltPrmByte_Cnt_T_u08 |= 0x01U;
        }
    }
    else
    {
    ...
    /* Inin Optional Set A Selection */
    if(DesIninOptSetAIdx_Cnt_T_u08 != *Rte_Pim_PrevActvIninOptSetAIdx())
    {
        IninOptSetAIdxFound_Cnt_T_logl = IdxChgMngt( DesIninOptSetAIdx_Cnt_T_u08, MAXININOPTSETAIDXCNT_CNT_U08,
                                                     ININOPTSETACALCFGTBL_REC);
                                              
        /* Update previous values and output ports */
        if(TRUE == IninOptSetAIdxFound_Cnt_T_logl)
        {
            /* Optional Set A Index was found, assign index */
            *Rte_Pim_PrevActvIninOptSetAIdx() = DesIninOptSetAIdx_Cnt_T_u08;
            (void)Rte_Write_ActvIninOptSetAIdx_Val(DesIninOptSetAIdx_Cnt_T_u08);
        }
        else
        {
            /* Index was not found, do not update ports or PIMs and set parameter byte */
            IninFltPrmByte_Cnt_T_u08 |= 0x02U;
        }
    }
    else
    {
    ...
    if ( IninFltPrmByte_Cnt_T_u08 == 0U )
    {
        (void)Rte_Call_SetNtcSts_Oper(NTCNR_0X01C, 0x00U, NTCSTS_PASSD, 0U);
        *Rte_Pim_PrevRtIdxChgSts() = RTIDXCHGSTS_DFTMODCHGCMPL;
    }
    else
    {
        (void)Rte_Call_SetNtcSts_Oper(NTCNR_0X01C, IninFltPrmByte_Cnt_T_u08, NTCSTS_FAILD, 0U);
        *Rte_Pim_PrevRtIdxChgSts() = RTIDXCHGSTS_FLTACTV;
    }
    ...
    if(DesRtIdx_Cnt_T_u08 != *Rte_Pim_PrevActvRtIdx())
    {
        ...
        {
            /* Fault passed */
            (void)Rte_Call_SetNtcSts_Oper(NTCNR_0X015, 0x00U, NTCSTS_PASSD, 0U);
        ...
        else
        {
            ...
            (void)Rte_Call_SetNtcSts_Oper(NTCNR_0X015, 0x01U, NTCSTS_FAILD, 0U);
            *Rte_Pim_PrevRtIdxChgSts() = RTIDXCHGSTS_FLTACTV;
        }
    }
    else
    ...
    if( (TRUE == IninIdxFound_Cnt_T_logl) || (TRUE == RtIdxFound_Cnt_T_logl) || (TRUE == IninOptSetAIdxFound_Cnt_T_logl))
    {
    ...
    /* Update remaining outputs with known defaults */
    (void)Rte_Write_ActvGroup_Val(0U);
    (void)Rte_Write_CalCopySts_Val(CALCOPYSTS_NOTRDY);
    (void)Rte_Write_RtIdxChgSts_Val(*Rte_Pim_PrevRtIdxChgSts());
 ...
 *********************************************************************************************************************/
    ...
    (void)Rte_Call_Calc32BitCrc_u32_Oper( (uint32 *)(MngtRamTbl_M[*Rte_Pim_RamTblSwt()].PrmRefTblPtr),
                                          PRMPTRTBLSIZEINWORD_CNT_U16, 0U, TRUE, &CrcVal_Cnt_T_u32 );
    /* ENDREQ: ES400A #51 I */

    /* REQ: ES400A #69 I */ /* REQ: ES400A #71 I */ /* REQ: ES400A #77 I */
    if( CrcVal_Cnt_T_u32 != MngtRamTbl_M[*Rte_Pim_RamTblSwt()].PrmTblCrc_u32 )
    {
        /* Set fault 0x014 - Used Table */
        (void)Rte_Call_SetNtcSts_Oper(NTCNR_0X014, 0x01U, NTCSTS_FAILD, 0U);
        *Rte_Pim_PrevRtIdxChgSts() = RTIDXCHGSTS_FLTACTV;
    ...
    {
        /* Pass Fault 0x014 */
        (void)Rte_Call_SetNtcSts_Oper(NTCNR_0X014, 0x00U, NTCSTS_PASSD, 0U);
        ...
        for( OnlineCalTblIdx_Cnt_T_u08 = 0U; OnlineCalTblIdx_Cnt_T_u08 < MAXONLINECALCFGCNT_CNT_U08; OnlineCalTblIdx_Cnt_T_u08++ )
        {
            ...
            if((*Rte_Pim_OnlineCalSts()).ActvGroup == ONLINECALCFGTBL_REC[OnlineCalTblIdx_Cnt_T_u08].GroupIdx_u08)
            {
                ...
                MemCopy8Bit( (uint8 *)(ONLINECALCFGTBL_REC[OnlineCalTblIdx_Cnt_T_u08].RamStructPtr_u08),
                                         (const uint8 *)(MngtRamTbl_M[Swt_Cnt_T_u08].PrmRefTblPtr[ONLINECALCFGTBL_REC[OnlineCalTblIdx_Cnt_T_u08].TblIdx_u16]),
     ...
     * 4) The online calibration mode has changed AND the calibrations have been written to RAM (CALCOPYSTS_COPYCMPL) */
    /* REQ: ES400A #18 I */
    if ( CrcFltActv_Cnt_T_logl == FALSE )
    {
        ...
        {
            if ( (*Rte_Pim_PrevActvRtIdx() == DesRtIdx_Cnt_T_u08) && 
                 ((*Rte_Pim_OnlineCalSts()).Seg[(*Rte_Pim_OnlineCalSts()).ActvGroup].Page[XCPIF_RAMPAGE_CNT_U08].PageAcs == *Rte_Pim_PrevRamPageAcs()) )
            {
                *Rte_Pim_PrevRtIdxChgSts() = RTIDXCHGSTS_IDLE;
            }
            ...
            {
                *Rte_Pim_PrevRtIdxChgSts() = RTIDXCHGSTS_PNDTUNSELNAUTHY;
            }
        }
    }
    else
...
static FUNC(void, TunSelnMngt_CODE) SwtCalIdx( void )
{
    ...
    RteParameterBase = &(MngtRamTbl_M[Swt_Cnt_T_u08].PrmRefTblPtr[0]);

    /* Copy new table to replace older one, note the switch has not been assigned to the PIM yet. */
    MemCopy32Bit( &MngtRamTbl_M[*Rte_Pim_RamTblSwt()].PrmRefTblPtr, 
                  &MngtRamTbl_M[Swt_Cnt_T_u08].PrmRefTblPtr, PRMPTRTBLSIZEINWORD_CNT_U16 );
    
    /* Assign the newly calculated CRC in the unused table to the current table. */
    MngtRamTbl_M[*Rte_Pim_RamTblSwt()].PrmTblCrc_u32 = MngtRamTbl_M[Swt_Cnt_T_u08].PrmTblCrc_u32;
                                                    ...
                                                    P2CONST(TunSelnIdxTblRec1, AUTOMATIC, AUTOMATIC) GendCalTbl_T_rec )
{
    ...
    VAR(uint8, AUTOMATIC) IninOptSetACalTblIdx_Cnt_T_u08;
    VAR(boolean, AUTOMATIC) XcpRamAcs_Cnt_logl = FALSE; 
    ...
    (void)Rte_Call_Calc32BitCrc_u32_Oper( (uint32 *)(MngtRamTbl_M[Swt_Cnt_T_u08].PrmRefTblPtr),
                                          PRMPTRTBLSIZEINWORD_CNT_U16, 0U, TRUE, &CalcCrcVal_Cnt_T_u32 );
    /* ENDREQ: ES400A #51 I */
    
    /* REQ: ES400A #69 I */ /* REQ: ES400A #71 I */ /* REQ: ES400A #77 I */
    if ( CalcCrcVal_Cnt_T_u32 != MngtRamTbl_M[Swt_Cnt_T_u08].PrmTblCrc_u32 )
    {
        /* Set fault 0x1F8 - Not Used Table */
        (void)Rte_Call_SetNtcSts_Oper(NTCNR_0X014, 0x02U, NTCSTS_FAILD, 0U);
        *Rte_Pim_PrevRtIdxChgSts() = RTIDXCHGSTS_FLTACTV;
    }
    /* ENDREQ: ES400A #69 I */ /* ENDREQ: ES400A #71 I */ /* ENDREQ: ES400A #77 I */
    else
    {
        /* Set the status to flash by default, but this will be over ruled if XCP moves data to RAM, or if there is an error after the function */
        *Rte_Pim_PrevRtIdxChgSts() = RTIDXCHGSTS_DFTMODCHGCMPL;
        ...
        if ( (CALCOPYSTS_COPYCMPL == (*Rte_Pim_OnlineCalSts()).CopySts) && 
             ((*Rte_Pim_OnlineCalSts()).Seg[(*Rte_Pim_OnlineCalSts()).ActvGroup].Page[XCPIF_RAMPAGE_CNT_U08].PageAcs != *Rte_Pim_PrevRamPageAcs() ) )
        {
            *Rte_Pim_PrevRtIdxChgSts() = RTIDXCHGSTS_ONLINECALFLSMODCHGCMPL;
            
            /* Check to see if the ECU Page is set to RAM, if so, move the pointer to RAM */
            if ( XcpRamAcs_Cnt_logl == TRUE )
            {
                ...
                for (OnlineCalTblIdx_Cnt_T_u08 = 0U; OnlineCalTblIdx_Cnt_T_u08 < MAXONLINECALCFGCNT_CNT_U08; OnlineCalTblIdx_Cnt_T_u08++)
                {
                    ...
                    if((*Rte_Pim_OnlineCalSts()).ActvGroup == ONLINECALCFGTBL_REC[OnlineCalTblIdx_Cnt_T_u08].GroupIdx_u08)
                    {
                        /* Since there are indexes being moved to RAM, update the status to say RAM is active */
                        *Rte_Pim_PrevRtIdxChgSts() = RTIDXCHGSTS_ONLINECALRAMMODCHGCMPL;

                        /* Move RAM pointer into the main table */
                        MemCopy32Bit( &MngtRamTbl_M[Swt_Cnt_T_u08].PrmRefTblPtr[ONLINECALCFGTBL_REC[OnlineCalTblIdx_Cnt_T_u08].TblIdx_u16],
            ...
            else
            {
                ...
                MemCopy32Bit(&MngtRamTbl_M[Swt_Cnt_T_u08].PrmRefTblPtr, RteParameterRefTab, PRMPTRTBLSIZEINWORD_CNT_U16);

                /* Place the init cal pointers back to what was initialized at start up */
                for( IninCalTblIdx_Cnt_T_u08 = 0U; IninCalTblIdx_Cnt_T_u08 < MAXININIDXCNT_CNT_U08; IninCalTblIdx_Cnt_T_u08++)
                {
                    if( (*Rte_Pim_OnlineCalSts()).ActvInin == ININCALCFGTBL_REC[IninCalTblIdx_Cnt_T_u08].SigIdx_u08 )
                    {
                        MemCopy32Bit( &MngtRamTbl_M[Swt_Cnt_T_u08].PrmRefTblPtr[ININCALCFGTBL_REC[IninCalTblIdx_Cnt_T_u08].DestIdx_u16],
                                      &RteParameterRefTab[ININCALCFGTBL_REC[IninCalTblIdx_Cnt_T_u08].SrcIdx_u16], 1U);
                    }
                }
                
                for( IninOptSetACalTblIdx_Cnt_T_u08 = 0U; IninOptSetACalTblIdx_Cnt_T_u08 < MAXININOPTSETAIDXCNT_CNT_U08; IninOptSetACalTblIdx_Cnt_T_u08++)
                {
                    if( (*Rte_Pim_OnlineCalSts()).ActvIninOptSetA == ININOPTSETACALCFGTBL_REC[IninOptSetACalTblIdx_Cnt_T_u08].SigIdx_u08 )
                    {
                        MemCopy32Bit( &MngtRamTbl_M[Swt_Cnt_T_u08].PrmRefTblPtr[ININOPTSETACALCFGTBL_REC[IninOptSetACalTblIdx_Cnt_T_u08].DestIdx_u16],
                                      &RteParameterRefTab[ININOPTSETACALCFGTBL_REC[IninOptSetACalTblIdx_Cnt_T_u08].SrcIdx_u16], 1U);
                    }
                }
            }
        }
        ...
        /* Change tuning */
        if( (CALCOPYSTS_COPYCMPL == (*Rte_Pim_OnlineCalSts()).CopySts) && (XcpRamAcs_Cnt_logl == TRUE) )
        {
        ...
        for (GendTblIdx_Cnt_T_u08 = 0U; GendTblIdx_Cnt_T_u08 < GendCalTblSize_Cnt_T_u08; GendTblIdx_Cnt_T_u08++)
        {
            if(GendCalTbl_T_rec[GendTblIdx_Cnt_T_u08].SigIdx_u08 == SeldIdx_Cnt_T_u08)
            {
                ...
                else
                {
                    ...
                    if( MngtRamTbl_M[Swt_Cnt_T_u08].PrmRefTblPtr[GendCalTbl_T_rec[GendTblIdx_Cnt_T_u08].DestIdx_u16] == 
                        MngtRamTbl_M[Swt_Cnt_T_u08].PrmRefTblPtr[GendCalTbl_T_rec[GendTblIdx_Cnt_T_u08].SrcIdx_u16])
                    {
                        /* If the source and destination addresses are the same, use the flash value as this is the RTE default */
                        MemCopy32Bit( &MngtRamTbl_M[Swt_Cnt_T_u08].PrmRefTblPtr[GendCalTbl_T_rec[GendTblIdx_Cnt_T_u08].DestIdx_u16], 
                    ...
                    else
                    {
                        ...
                        MemCopy32Bit( &MngtRamTbl_M[Swt_Cnt_T_u08].PrmRefTblPtr[GendCalTbl_T_rec[GendTblIdx_Cnt_T_u08].DestIdx_u16], 
                                      &MngtRamTbl_M[Swt_Cnt_T_u08].PrmRefTblPtr[GendCalTbl_T_rec[GendTblIdx_Cnt_T_u08].SrcIdx_u16], 1U);
                    }
                }
        ...
        if (IdxFound_Cnt_T_logl == TRUE)
        {
            ...
            (void)Rte_Call_Calc32BitCrc_u32_Oper( (uint32 *)(MngtRamTbl_M[Swt_Cnt_T_u08].PrmRefTblPtr),
                                                  PRMPTRTBLSIZEINWORD_CNT_U16, 0U, TRUE, &(MngtRamTbl_M[Swt_Cnt_T_u08].PrmTblCrc_u32) );
            /* ENDREQ: ES400A #51 I */
        }
    }
                                                    ...
                                                    P2VAR(uint8, AUTOMATIC, RTE_TUNSELNMNGT_APPL_VAR) RespLen_Arg)
{
    ...
    switch(SegInfo_Arg)
    {
        ...
        default:
            /* Do nothing, return error*/
            Rtn_Cnt_T_u08 = (uint8)XCPIF_CMDOUTOFRNG_CNT_U08;
        break;
    }
    
    if((uint8)XCPIF_CMDOK_CNT_U08 == Rtn_Cnt_T_u08)
    {
        /* Populate response */
        Resp_Arg[0] = 0xFFU;
...
static FUNC(uint8, TunSElnMngt_CODE) SegModAdrMpg( uint8 Seg_Arg, GetSegModMpgIdx1 MpgIdxInfo_Arg, uint8 MpgIdx_Arg,
                                                   ...
                                                   P2VAR(uint8, AUTOMATIC, RTE_TUNSELNMNGT_APPL_VAR) RespLen_Arg)
{
    VAR(uint8, AUTOMATIC) Rtn_Cnt_T_u08 = (uint8)XCPIF_CMDOUTOFRNG_CNT_U08;
    VAR(uint8, AUTOMATIC) Idx_Cnt_T_u08;
    VAR(uint8, AUTOMATIC) Cntr_Cnt_T_u08;
    VAR(uint32, AUTOMATIC) Data_Cnt_T_u32;
