...
/**************************************************** Type defs ******************************************************/
#define MAXININIDXCNT_CNT_U08           6U
#define MAXININOPTSETAIDXCNT_CNT_U08    6U
#define MAXRTIDXCNT_CNT_U08             4U
#define MAXONLINECALCFGCNT_CNT_U08      5U
...
typedef struct
{
    ...
    Rte_Calprm_CalRegn01Rt00GroupA_DEFAULT_RTE_CALPRM_GROUP_Type    CalRegn01Rt00GroupA;
} GroupATyp;

typedef struct
{
    Rte_Calprm_CalRegn02Inin00GroupB_DEFAULT_RTE_CALPRM_GROUP_Type    CalRegn02Inin00GroupB;
} GroupBTyp;

typedef struct
{
    Rte_Calprm_CalRegn03IninOptSetA00GroupC_DEFAULT_RTE_CALPRM_GROUP_Type    CalRegn03IninOptSetA00GroupC;
} GroupCTyp;
