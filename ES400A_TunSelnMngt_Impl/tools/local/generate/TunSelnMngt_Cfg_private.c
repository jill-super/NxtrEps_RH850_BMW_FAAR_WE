...
const VAR(TunSelnIdxTblRec1, AUTOMATIC) ININCALCFGTBL_REC[MAXININIDXCNT_CNT_U08] = {
    ...
    {(uint16)Rte_CalprmElementGroup_CalRegn02Inin01GroupB_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn02Inin00GroupB_DEFAULT_RTE_CALPRM_GROUP, 0x01U }  /*IninIdx01 */
};
...
const VAR(TunSelnIdxTblRec1, AUTOMATIC) ININOPTSETACALCFGTBL_REC[MAXININOPTSETAIDXCNT_CNT_U08] = {
    ...
    {(uint16)Rte_CalprmElementGroup_CalRegn03IninOptSetA00GroupC_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn03IninOptSetA00GroupC_DEFAULT_RTE_CALPRM_GROUP, 0x00U }, /*IninOptSetAIdx00 */
    ...
    {(uint16)Rte_CalprmElementGroup_CalRegn03IninOptSetA01GroupC_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn03IninOptSetA00GroupC_DEFAULT_RTE_CALPRM_GROUP, 0x01U }, /*IninOptSetAIdx01 */
    ...
    {(uint16)Rte_CalprmElementGroup_CalRegn03IninOptSetA02GroupC_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn03IninOptSetA00GroupC_DEFAULT_RTE_CALPRM_GROUP, 0x02U }  /*IninOptSetAIdx02 */
};
...
const VAR(TunSelnIdxTblRec1, AUTOMATIC) RTCALCFGTBL_REC[MAXRTIDXCNT_CNT_U08] = {
    ...
    {(uint16)Rte_CalprmElementGroup_CalRegn01Rt01GroupA_DEFAULT_RTE_CALPRM_GROUP, (uint16)Rte_CalprmElementGroup_CalRegn01Rt00GroupA_DEFAULT_RTE_CALPRM_GROUP, 0x01U }  /*RtIdx01 */
};
...
const VAR(TunSelnOnlineCalIdxTblRec1, AUTOMATIC) ONLINECALCFGTBL_REC[MAXONLINECALCFGCNT_CNT_U08] = {
    ...
    {(uint8 *)(&OnlineRamCalTbl_C.GroupC.CalRegn03IninOptSetA00GroupC), sizeof(OnlineRamCalTbl_C.GroupC.CalRegn03IninOptSetA00GroupC), (uint16)Rte_CalprmElementGroup_CalRegn03IninOptSetA00GroupC_DEFAULT_RTE_CALPRM_GROUP, 0x02U}, /*GroupC */
};
...
FUNC(boolean, TunSelnMngt_CODE) TunSelnMngt_ChkXcpWrAcs(uint32 ReqAdr_Cnt_T_u32)
{
    ...
    if( ( (ReqAdr_Cnt_T_u32 >= (uint32)&(OnlineRamCalTbl_C.byte[0])) && (ReqAdr_Cnt_T_u32 <= (uint32)&(OnlineRamCalTbl_C.byte[(ONLINECALRAMTBL_CNT_U16-1U)]))) ||
        ( (ReqAdr_Cnt_T_u32 >= (uint32)(0x00000000UL)) && (ReqAdr_Cnt_T_u32 <= (uint32)(0x00000064UL))) )
#else
