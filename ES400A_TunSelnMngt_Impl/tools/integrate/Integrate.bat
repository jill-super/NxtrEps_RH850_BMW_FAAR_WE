...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ES400A_TunSelnMngt_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ES400A_TunSelnMngt_Impl
...
XCOPY ..\..\autosar\TunSelnMngt_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
