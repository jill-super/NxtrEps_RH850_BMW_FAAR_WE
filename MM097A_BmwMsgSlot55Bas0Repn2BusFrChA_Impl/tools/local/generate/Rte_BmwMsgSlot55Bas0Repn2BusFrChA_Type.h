 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_BmwMsgSlot55Bas0Repn2BusFrChA_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <BmwMsgSlot55Bas0Repn2BusFrChA> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_BMWMSGSLOT55BAS0REPN2BUSFRCHA_TYPE_H
# define _RTE_BMWMSGSLOT55BAS0REPN2BUSFRCHA_TYPE_H
...
# ifndef BMWVEHLATAQLFR_SIGVALVLDANDPLAUS
#  define BMWVEHLATAQLFR_SIGVALVLDANDPLAUS (1U)
# endif

# ifndef BMWVEHLATAQLFR_SIGVALVLD
#  define BMWVEHLATAQLFR_SIGVALVLD (2U)
# endif

# ifndef BMWVEHLATAQLFR_SIGQLTMONRSTRCTD
#  define BMWVEHLATAQLFR_SIGQLTMONRSTRCTD (3U)
# endif

# ifndef BMWVEHLATAQLFR_RESD1
#  define BMWVEHLATAQLFR_RESD1 (4U)
# endif

# ifndef BMWVEHLATAQLFR_SIGVALINVLD
#  define BMWVEHLATAQLFR_SIGVALINVLD (6U)
# endif

# ifndef BMWVEHLATAQLFR_RESD2
#  define BMWVEHLATAQLFR_RESD2 (7U)
# endif

# ifndef BMWVEHLATAQLFR_ININ
#  define BMWVEHLATAQLFR_ININ (8U)
# endif

# ifndef BMWVEHLATAQLFR_SIGVALTMPVLDANDSECUR
#  define BMWVEHLATAQLFR_SIGVALTMPVLDANDSECUR (9U)
# endif

# ifndef BMWVEHLATAQLFR_SIGVALTMPVLD
#  define BMWVEHLATAQLFR_SIGVALTMPVLD (10U)
# endif

# ifndef BMWVEHLATAQLFR_SIGQLTMONTMPRSTRCTD
#  define BMWVEHLATAQLFR_SIGQLTMONTMPRSTRCTD (11U)
# endif

# ifndef BMWVEHLATAQLFR_SIGSUBVALVLDTMP
#  define BMWVEHLATAQLFR_SIGSUBVALVLDTMP (12U)
# endif

# ifndef BMWVEHLATAQLFR_SIGVALTMPINVLD
#  define BMWVEHLATAQLFR_SIGVALTMPINVLD (14U)
# endif

# ifndef BMWVEHLATAQLFR_INVLDSIG
#  define BMWVEHLATAQLFR_INVLDSIG (15U)
# endif
...
# ifndef QU_ACLNY_COG_Initialisierung
#  define QU_ACLNY_COG_Initialisierung (8U)
# endif

# ifndef QU_ACLNY_COG_SignalwertIstGueltigUndAbgesichertUndPlausibilisiert
#  define QU_ACLNY_COG_SignalwertIstGueltigUndAbgesichertUndPlausibilisiert (1U)
# endif

# ifndef QU_ACLNY_COG_SignalwertIstGueltigUndAbgesichertZustandSlashStatusTemporaer
#  define QU_ACLNY_COG_SignalwertIstGueltigUndAbgesichertZustandSlashStatusTemporaer (9U)
# endif

# ifndef QU_ACLNY_COG_SignalwertIstGueltig
#  define QU_ACLNY_COG_SignalwertIstGueltig (2U)
# endif

# ifndef QU_ACLNY_COG_SignalwertIstGueltigZustandSlashStatusTemporaer
#  define QU_ACLNY_COG_SignalwertIstGueltigZustandSlashStatusTemporaer (10U)
# endif

# ifndef QU_ACLNY_COG_SignalqualitaetBzwDotUeberwachungEingeschraenkt
#  define QU_ACLNY_COG_SignalqualitaetBzwDotUeberwachungEingeschraenkt (3U)
# endif

# ifndef QU_ACLNY_COG_SignalqualitaetBzwDotUeberwachungEingeschraenktZustandSlashStatusTemporaer
#  define QU_ACLNY_COG_SignalqualitaetBzwDotUeberwachungEingeschraenktZustandSlashStatusTemporaer (11U)
# endif

# ifndef QU_ACLNY_COG_Reserved
#  define QU_ACLNY_COG_Reserved (4U)
# endif

# ifndef QU_ACLNY_COG_ErsatzwertIstImNutzsignalGesetztZustandSlashStatusTemporaer
#  define QU_ACLNY_COG_ErsatzwertIstImNutzsignalGesetztZustandSlashStatusTemporaer (12U)
# endif

# ifndef QU_ACLNY_COG_SignalwertIstUngueltig
#  define QU_ACLNY_COG_SignalwertIstUngueltig (6U)
# endif

# ifndef QU_ACLNY_COG_SignalwertIstUngueltigZustandSlashStatusTemporaer
#  define QU_ACLNY_COG_SignalwertIstUngueltigZustandSlashStatusTemporaer (14U)
# endif

# ifndef QU_ACLNY_COG_Reserved_bne_18ACE6A1DACA4F44BAB0F4D6BBE8870D_7
#  define QU_ACLNY_COG_Reserved_bne_18ACE6A1DACA4F44BAB0F4D6BBE8870D_7 (7U)
# endif

# ifndef QU_ACLNY_COG_SignalUngueltig
#  define QU_ACLNY_COG_SignalUngueltig (15U)
# endif
...
#endif /* _RTE_BMWMSGSLOT55BAS0REPN2BUSFRCHA_TYPE_H */
