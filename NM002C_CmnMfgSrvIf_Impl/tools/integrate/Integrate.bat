...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\NM002C_CmnMfgSrvIf_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\NM002C_CmnMfgSrvIf_Impl
...
XCOPY ..\..\autosar\CmnMfgSrvIf_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
