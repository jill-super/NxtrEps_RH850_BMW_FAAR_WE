...
NM002C.Description = [...
  'Interface between DCM component and NM001A to provide Nexteer common m' ...
  'anufacturing services to programs that must put Nexteer services throu' ...
...
CmnMfgSrvMaiFct.Description = [...
  ...
  ' entry point for invoking Nexteer manufacturing services.'];
