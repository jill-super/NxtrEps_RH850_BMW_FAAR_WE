...
# DaVinci Configurator.  The generated file contains all of the settings necessary to configure Nexteer manufacturing
...
if __name__ == "__main__":
    description = "Nexteer ODX to DCM ECUC ARXML Utility - EA4 Manufacturing Services"
