...
* 08/28/17  7        SPP        Changed PIM name to match DataDict                                             EA4#13909	
************************************************************************************************************************/
...
{   
	...
	{	/* DeltaCalc */
        /* Overflow check: MotCtrlMotAgMecl is u0p16 range 0 to .9999847412 cast to sint32;
		MotAgCmpMotCtrlMotAgMeclPrev PIM is s15p16 with range -32768 to 32767.99998 (ver 7) but should have same range as MotCtrlMotAgMecl; 
		No overflow is possible. Range issue might cause PolySpace warning in ver 7 of this c file but addressed in ICR EA4#15131 */
		
		Delta1_MotRev_T_s15p16 = (sint32)MOTCTRLMGR_MotCtrlMotAgMecl - *Rte_Pim_MotAgCmpMotCtrlMotAgMeclPrev();    
   
		if(Delta1_MotRev_T_s15p16 > (sint32)MOTAGMAXDELTA_MOTREV_U0P16)    /* Constant .5 */ 
		{
			/* > 180 */
    ...
    /* Overflow not possible. Range issue might cause PolySpace warning in ver 7 of this c file but addressed in ICR EA4#15131 */   
    Delta2_MotRev_T_s15p16 = Delta1_MotRev_T_s15p16 + *Rte_Pim_MotAgCmpMotCtrlMotAgCumvAlgndMrfRevPrev();
    ...
    *Rte_Pim_MotAgCmpMotCtrlMotAgCumvAlgndMrfRevPrev() = MOTCTRLMGR_MotCtrlMotAgCumvAlgndMrfRev;                              
