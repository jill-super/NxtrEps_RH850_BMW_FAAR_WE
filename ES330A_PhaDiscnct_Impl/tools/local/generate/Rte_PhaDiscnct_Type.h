 ...
 *
 *   Description:  Application types header file for SW-C <PhaDiscnct> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_PHADISCNCT_TYPE_H
# define _RTE_PHADISCNCT_TYPE_H
