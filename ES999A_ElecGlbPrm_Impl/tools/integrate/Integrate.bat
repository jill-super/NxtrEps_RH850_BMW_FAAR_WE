...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ES999A_ElecGlbPrm_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ES999A_ElecGlbPrm_Impl
...
XCOPY ..\..\autosar\ElecGlbPrm_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
