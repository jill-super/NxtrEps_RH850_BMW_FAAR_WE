...
#define NROFCRCHWUNIT_CNT_U08       8U
#define NROFACTVCRCHWUNIT_CNT_U08   8U
...
NXTR_PRAGMA_IOREG(DATACRCREGCH1, 0xFFD70000, NXTR_PRAGMA_READWRREG, DataCrcRegRec1);
NXTR_PRAGMA_IOREG(DATACRCREGCH2, 0xFFD51000, NXTR_PRAGMA_READWRREG, DataCrcRegRec1);
NXTR_PRAGMA_IOREG(DATACRCREGCH3, 0xFFD71000, NXTR_PRAGMA_READWRREG, DataCrcRegRec1);
NXTR_PRAGMA_IOREG(DATACRCREGCH4, 0xFFD52000, NXTR_PRAGMA_READWRREG, DataCrcRegRec1);
NXTR_PRAGMA_IOREG(DATACRCREGCH5, 0xFFD72000, NXTR_PRAGMA_READWRREG, DataCrcRegRec1);
NXTR_PRAGMA_IOREG(DATACRCREGCH6, 0xFFD53000, NXTR_PRAGMA_READWRREG, DataCrcRegRec1);
NXTR_PRAGMA_IOREG(DATACRCREGCH7, 0xFFD73000, NXTR_PRAGMA_READWRREG, DataCrcRegRec1);

/* Default values for static constants */
#define CRCRESVIDDFTVAL_CNT_U32     {0xFFFFFFFFUL, 0xFFFFFFFEUL, 0xFFFFFFFDUL, 0xFFFFFFFCUL, 0xFFFFFFFBUL, 0xFFFFFFFAUL, 0xFFFFFFF9UL, 0xFFFFFFF8UL}
#define CRCREGDFTVAL_REC            {{&DATACRCREGCH0}, {&DATACRCREGCH1}, {&DATACRCREGCH2}, {&DATACRCREGCH3}, {&DATACRCREGCH4}, {&DATACRCREGCH5}, {&DATACRCREGCH6}, {&DATACRCREGCH7}}
