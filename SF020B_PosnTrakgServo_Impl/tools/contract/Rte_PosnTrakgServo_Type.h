 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_PosnTrakgServo_Type.h
...
#ifndef _RTE_POSNTRAKGSERVO_TYPE_H
# define _RTE_POSNTRAKGSERVO_TYPE_H
...
#    error "The magic number of the generated file <C:/component/SF020B_PosnTrakgServo_Impl/tools/contract/Rte_PosnTrakgServo_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
...
#endif /* _RTE_POSNTRAKGSERVO_TYPE_H */
