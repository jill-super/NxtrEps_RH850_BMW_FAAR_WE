---
title: 'CM510A_MotAg3Meas_Impl — MotAg3Meas_MDD'
description: 'Converted Word (.docx) document MotAg3Meas_MDD.docx from module CM510A_MotAg3Meas_Impl.'
sidebar:
  hidden: true
---

> **Source:** `MotAg3Meas_MDD.docx` (Word (.docx), 97 KB, in-module path `doc/`)
>
...
2MotAg3Meas & High-Level Description5

3Design details of software module6

3.1Graphical representation of MotAg3Meas6
...
5.1.1Init: MotAg3MeasInit18

5.1.2Per: None8

5.2Server Runables8

5.2.1GetMotAg3Mecl_Oper8
...
MOTAG3_SNSRRLVBITWIDTHEXP_CNT_U08 is a config param which is defined as an extern. This is defined in “CDD_MotAg3Meas_Cfg.h” tools/local/include folder. The range of this config param shall be tested.
