---
title: 'CM106A_McuCoreCfgAndDiagc_Impl — McuCoreCfgAndDiagc Module Design Document'
description: 'Converted Word (.docx) document McuCoreCfgAndDiagc Module Design Document.docx from module CM106A_McuCoreCfgAndDiagc_Impl.'
sidebar:
  hidden: true
---

> **Source:** `McuCoreCfgAndDiagc Module Design Document.docx` (Word (.docx), 96 KB, in-module path `doc/`)
>
