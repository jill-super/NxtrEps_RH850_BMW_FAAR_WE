---
title: 'CM340A_AdcDiagc_Impl — AdcDiagc_IntegrationManual'
description: 'Converted .doc document AdcDiagc_IntegrationManual.doc from module CM340A_AdcDiagc_Impl.'
sidebar:
  hidden: true
---

> **Source:** `AdcDiagc_IntegrationManual.doc` (.doc, 145 KB, in-module path `doc/`)
>
...
Updated to include build time config parameter for micro diag special build
