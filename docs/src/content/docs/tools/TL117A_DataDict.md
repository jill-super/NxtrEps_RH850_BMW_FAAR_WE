---
title: 'TL117A DataDict'
description: 'TL117A_DataDict (TOOLS). Host-side tool / generator package: TL117A_DataDict.'
---
...
Host-side tool / generator package: TL117A_DataDict.

*Repository path:* `TL117A_DataDict/` · *AUTOSAR layer:* [Tools & Support](../) · *Implementation tag:* `Impl (implementation package)`
