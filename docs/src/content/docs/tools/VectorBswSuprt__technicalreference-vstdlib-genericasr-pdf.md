---
title: 'VectorBswSuprt — TechnicalReference_VStdLib_GenericAsr'
description: 'Converted PDF document TechnicalReference_VStdLib_GenericAsr.pdf from module VectorBswSuprt.'
sidebar:
  hidden: true
---

> **Source:** `TechnicalReference_VStdLib_GenericAsr.pdf` (PDF, 716 KB, in-module path `doc/`)
>
