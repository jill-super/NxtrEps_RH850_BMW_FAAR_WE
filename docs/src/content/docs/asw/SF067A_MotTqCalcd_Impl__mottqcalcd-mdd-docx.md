---
title: 'SF067A_MotTqCalcd_Impl — MotTqCalcd_MDD'
description: 'Converted Word (.docx) document MotTqCalcd_MDD.docx from module SF067A_MotTqCalcd_Impl.'
sidebar:
  hidden: true
---

> **Source:** `MotTqCalcd_MDD.docx` (Word (.docx), 103 KB, in-module path `doc/`)
>
...
2MotTqCalcd & High-Level Description5

3Design details of software module6

3.1Graphical representation of MotTqCalcd6
...
5.1.1Init: MotTqCalcdInit18

5.1.2Init: MotTqCalcd_Init8

5.1.3Per: MotTqCalcdPer18
