---
title: 'AR100A_NxtrMath_Impl — Optimized SinCos Algorithm Rev 001'
description: 'Converted Word (.docx) document Optimized SinCos Algorithm Rev 001.docx from module AR100A_NxtrMath_Impl.'
sidebar:
  hidden: true
---

> **Source:** `Optimized SinCos Algorithm Rev 001.docx` (Word (.docx), 147 KB, in-module path `doc/`)
>
> Converted from OOXML (`word/document.xml`); headings, lists and tables preserved. Embedded objects and images are inventoried below.
>
> props: {'title': '', 'creator': 'Windows User', 'subject': '', 'keywords': '', 'description': ''}; embedded images: 2 (emf, png); OLE embeddings: 1; tables converted: 1
