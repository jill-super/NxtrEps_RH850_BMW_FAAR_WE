---
title: 'AR103A_NxtrFixdPt_Impl — NxtrFixdPt Integration Manual'
description: 'Converted .doc document NxtrFixdPt Integration Manual.doc from module AR103A_NxtrFixdPt_Impl.'
sidebar:
  hidden: true
---

> **Source:** `NxtrFixdPt Integration Manual.doc` (.doc, 146 KB, in-module path `doc/`)
>
