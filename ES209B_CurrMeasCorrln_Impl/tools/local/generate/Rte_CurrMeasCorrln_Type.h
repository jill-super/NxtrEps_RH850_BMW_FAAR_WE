 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_CurrMeasCorrln_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <CurrMeasCorrln> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CURRMEASCORRLN_TYPE_H
# define _RTE_CURRMEASCORRLN_TYPE_H
...
#endif /* _RTE_CURRMEASCORRLN_TYPE_H */
