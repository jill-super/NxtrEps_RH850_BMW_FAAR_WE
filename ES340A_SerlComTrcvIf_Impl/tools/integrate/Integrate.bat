...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ES340A_SerlComTrcvIf_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ES340A_SerlComTrcvIf_Impl
...
XCOPY ..\..\autosar\SerlComTrcvIf_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
