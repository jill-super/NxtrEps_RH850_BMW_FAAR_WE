 ...
 *
 *   Description:  Application types header file for SW-C <SerlComTrcvIf> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_SERLCOMTRCVIF_TYPE_H
# define _RTE_SERLCOMTRCVIF_TYPE_H
...
#endif /* _RTE_SERLCOMTRCVIF_TYPE_H */
