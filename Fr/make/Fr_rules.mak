...
# 2008/01/08   1.01     Jsr  Added support of AUTOSAR Fr                      #
# 2008/03/05   1.02     Jsr  New version                                      #
# 2008/05/05   1.02     fbg  Changes for ASR library support                  #
# 2008/06/27   1.03     jsr  Fr_Irq.c added                                   #
# 2009/04/01   1.04     ssr  ESCAN00034232 Remove Fr_Irq.c from libs          #
# 2009/04/01   1.05     ssr  synchronize version to alm                       #
# 2012/07/19    1.06     ssr  add makefile for cfg5                        #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += Fr
Fr_FILES                = Fr\Fr.c Fr\Fr_Timer.c 

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Fr\Fr.c
CC_FILES_TO_BUILD       += Fr\Fr_Timer.c
CC_FILES_TO_BUILD       += Fr\Fr_Irq.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Fr_PBcfg.c $(GENDATA_DIR)\Fr_Lcfg.c
