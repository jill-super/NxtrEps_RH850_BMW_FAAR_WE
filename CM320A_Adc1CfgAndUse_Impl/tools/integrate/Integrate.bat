...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\CM320A_Adc1CfgAndUse_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\CM320A_Adc1CfgAndUse_Impl
...
XCOPY ..\..\autosar\CDD_Adc1CfgAndUse_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
