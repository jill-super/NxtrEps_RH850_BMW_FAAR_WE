...
* Module Description: Nexteer ADC1 
* Project           : CBD
...
* 11/16/17  7        SPP        Removed application data types                                               EA4#17531
**********************************************************************************************************************/
...
/* MISRA-C:2004 Rule 16.10 [NXTRDEV 16.10.1]: There is no appropriate action to take on the return values for Rte_Read_* */
