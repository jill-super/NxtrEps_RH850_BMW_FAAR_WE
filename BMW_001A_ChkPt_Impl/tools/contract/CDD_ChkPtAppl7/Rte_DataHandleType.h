...
#    error "The magic number of the generated file <C:/Component/BMW_001A_ChkPt_Impl/tools/contract/CDD_ChkPtAppl7/Rte_DataHandleType.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
