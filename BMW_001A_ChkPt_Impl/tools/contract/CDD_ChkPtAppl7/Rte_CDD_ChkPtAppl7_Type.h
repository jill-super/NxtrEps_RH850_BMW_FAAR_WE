 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_CDD_ChkPtAppl7_Type.h
...
#ifndef _RTE_CDD_CHKPTAPPL7_TYPE_H
# define _RTE_CDD_CHKPTAPPL7_TYPE_H
...
#    error "The magic number of the generated file <C:/Component/BMW_001A_ChkPt_Impl/tools/contract/CDD_ChkPtAppl7/Rte_CDD_ChkPtAppl7_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
...
#endif /* _RTE_CDD_CHKPTAPPL7_TYPE_H */
