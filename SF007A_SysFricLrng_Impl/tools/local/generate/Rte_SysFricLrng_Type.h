 ...
 *
 *   Description:  Application types header file for SW-C <SysFricLrng> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_SYSFRICLRNG_TYPE_H
# define _RTE_SYSFRICLRNG_TYPE_H
