...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_CONST_DEFAULT_RTE_CALPRM_GROUP)  */
...
#    error "The magic number of the generated file <C:/Workspace/_EA4/_Components/NM001A_CmnMfgSrv_Impl-kzdyfh/NM001A_CmnMfgSrv_Impl/tools/contract/Rte_Compiler_Cfg.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
