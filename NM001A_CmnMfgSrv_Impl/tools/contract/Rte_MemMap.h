...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_STOP_SEC_CONST_DEFAULT_RTE_CALPRM_GROUP_UNSPECIFIED)  */
...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_START_SEC_CONST_DEFAULT_RTE_CALPRM_GROUP_UNSPECIFIED)  */
...
#   error "The magic number of the generated file <C:/Workspace/_EA4/_Components/NM001A_CmnMfgSrv_Impl-kzdyfh/NM001A_CmnMfgSrv_Impl/tools/contract/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
