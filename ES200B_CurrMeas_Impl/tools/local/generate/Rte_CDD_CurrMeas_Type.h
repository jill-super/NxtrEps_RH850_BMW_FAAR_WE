 ...
 *
 *   Description:  Application types header file for SW-C <CDD_CurrMeas> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CDD_CURRMEAS_TYPE_H
# define _RTE_CDD_CURRMEAS_TYPE_H
...
#endif /* _RTE_CDD_CURRMEAS_TYPE_H */
