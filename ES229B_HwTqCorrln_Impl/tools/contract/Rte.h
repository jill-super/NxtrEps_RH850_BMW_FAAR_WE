...
#    error "The magic number of the generated file <C:/component/ES229B_HwTqCorrln_Impl/tools/contract/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
