...
#    error "The magic number of the generated file <C:/Component/ES249B_MotAgCorrln_Impl/tools/contract/Rte_DataHandleType.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
