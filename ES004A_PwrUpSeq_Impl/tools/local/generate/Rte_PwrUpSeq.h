...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_PwrUpSeq_PhaDiscnctWrmIninTestCmpl_Logl(P2VAR(boolean, AUTOMATIC, RTE_PWRUPSEQ_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
