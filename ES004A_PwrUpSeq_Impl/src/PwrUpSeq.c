 ...
 *     SW-C Type:  PwrUpSeq
 *  Generated at:  Thu Nov  9 14:33:04 2017
 *
...
* 06/19/17   5       SPP          Remove application data types                                               EA4#12439
* 11/06/17   6       RMG(TATA)    Update to add spot in sequence for phase disconnect-Implementation          EA4#14643
**********************************************************************************************************************/
...
/* MISRA-C:2004 Rule 16.10 [NXTRDEV 16.10.1]: There is no appropriate action to take on the return value for Rte_Read and Rte_Write and Rte_Call_IoHwAb_SetGpioPwrTurnOffCtrl_Oper */ 

#define PWRTURNOFFCTRLTHD_CNT_U08		                           (2U)
#define PINSTHI_CNT_U08					                           (1U)
#define STRTUPSTENGMIN_CNT_U08                                      (0U)
 ...
 *   Std_ReturnType Rte_Read_PhaDiscnctWrmIninTestCmpl_Logl(boolean *data)
 ...
 *********************************************************************************************************************/
	...
	VAR(boolean, AUTOMATIC)  PhaDiscnctWrmIninTestCmpl_Cnt_T_logl;
	...
	(void) Rte_Read_PhaDiscnctWrmIninTestCmpl_Logl(&PhaDiscnctWrmIninTestCmpl_Cnt_T_logl);
	...
	*/
	...
	switch( SysSt_Cnt_T_enum )
	{
		...
		case SYSST_WRMININ:
				...
				else if(FALSE == PhaDiscnctWrmIninTestCmpl_Cnt_T_logl)
				{
				    StrtUpSt_Cnt_T_u08 = ELECGLBPRM_STRTUPSTPHADISCNCTWRMININSTRT_CNT_U08;
					SysStWrmIninCmpl_Cnt_T_lgc = FALSE;
				}
	...
	StrtUpSt_Cnt_T_u08 = Lim_u08(StrtUpSt_Cnt_T_u08, STRTUPSTENGMIN_CNT_U08, ELECGLBPRM_STRTUPSTDI_CNT_U08);
	
	*Rte_Pim_PwrTurnOffCtrlPrev() = *Rte_Pim_PwrTurnOffCtrlPrev() + 1U;
