 ...
 *  Generated at:  Wed Aug 16 14:32:49 2017
 *
 *     Generator:  MICROSAR RTE Generator Version 4.13.0
 *                 RTE Core Version 1.13.0
 *       License:  Unlimited license CBD1400351 for Nexteer Automotive Corporation
 *
 *   Description:  C-Code implementation template for SW-C <CDD_NxtrTi>
 *********************************************************************************************************************/
...
*
* Module File Name: CDD_NxtrTi.c
* Module Description: Implementation of Nexteer Time Complex Driver
* Project           : CBD 
...
* 04/11/15  2        KMC       Import latest standard definitions and make associated code updates             EA4#101
* 05/01/17  3        SPP       Remove Application Data Types                                                   EA4#11045
* 08/16/17  4        AJM       Error injecton code for NTC 0x039                                               EA4#14482
**********************************************************************************************************************/
/**********************************************************************************************************************
...
#include "Rte_CDD_NxtrTi.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
 ...
 * Symbol: GetRefTmr100MicroSec32bit_Oper_doc
 *********************************************************************************************************************/
 ...
 * Symbol: GetRefTmr100MicroSec32bit_Oper
 *********************************************************************************************************************/

 	*RefTmr_Arg = TAUJ1CNT3;
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetRefTmr1MicroSec32bit_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetRefTmr1MicroSec32bit_Oper
 *********************************************************************************************************************/

	*RefTmr_Arg = TAUJ2CNT3;
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetTiSpan100MicroSec32bit_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetTiSpan100MicroSec32bit_Oper
 *********************************************************************************************************************/

	/* Rollover in the following line of code is expected for the subtract operation */
	*TiSpan_Arg = (uint32)(TAUJ1CNT3 - RefTmr_Arg);
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: GetTiSpan1MicroSec32bit_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: GetTiSpan1MicroSec32bit_Oper
 *********************************************************************************************************************/

    /* Rollover in the following line of code is expected for the subtract operation */
    *TiSpan_Arg = (uint32)(TAUJ2CNT3 - RefTmr_Arg);
 ...
 *********************************************************************************************************************/
    ...
    VAR(uint32, AUTOMATIC) Timer1uS_Cnt_T_u32;
    VAR(uint32, AUTOMATIC) Timer100uS_Cnt_T_u32;
    VAR(sint32, AUTOMATIC) DeltaTime1uS_Cnt_T_s32;
    #if (MCUDIAGCERRINJ == STD_ON)
    VAR(uint32, AUTOMATIC) ErrId_Cnt_T_u32;
    (void)Rte_Call_ReadErrInjReg_Oper (&ErrId_Cnt_T_u32); 
    
    if(ErrId_Cnt_T_u32 == MCUERRINJ_NTC0039BIT00CASE01_CNT_U32)
    {
        /* 1uS reduced freqency */
        (void)Rte_Call_ClrErrInjReg_Oper();
        TAUJ2TT03 = 1U;
        TAUJ2PRS3 = 0x6U;
        TAUJ2TS03 = 0x1U;
    }
    else if(ErrId_Cnt_T_u32 == MCUERRINJ_NTC0039BIT00CASE02_CNT_U32)
    {
        /* 100uS reduced freqency */
        (void)Rte_Call_ClrErrInjReg_Oper();
        TAUJ1TT03 = 1U;
        TAUJ1PRS3 = 0x8U;
        TAUJ1TS03 = 0x1U;
    }
    else if(ErrId_Cnt_T_u32 == MCUERRINJ_NTC0039BIT00CASE03_CNT_U32)
    {
        /* 1uS increased freqency */
        (void)Rte_Call_ClrErrInjReg_Oper();
        TAUJ2TT03 = 1U;
        TAUJ2BRS = 40U;
        TAUJ2TS03 = 0x1U;
    }
    else if(ErrId_Cnt_T_u32 == MCUERRINJ_NTC0039BIT00CASE04_CNT_U32)
    {
        /* 100uS increased freqency */
        (void)Rte_Call_ClrErrInjReg_Oper();
        TAUJ1TT03 = 1U;
        TAUJ1PRS3 = 0x4U;
        TAUJ1TS03 = 0x1U;
    ...
    Rte_Enter_NxtrTiExclusiveArea();
 
    Timer100uS_Cnt_T_u32 = TAUJ1CNT3;
    Timer1uS_Cnt_T_u32 = TAUJ2CNT3;
    
    Rte_Exit_NxtrTiExclusiveArea();
    
    /* Rollover in the following line of code is expected both for the multiply and the subtract operation */
    DeltaTime1uS_Cnt_T_s32 = (sint32)Timer1uS_Cnt_T_u32 - (sint32)(uint32)(Timer100uS_Cnt_T_u32 * 100U);
    
    if (Abslt_u32_s32(DeltaTime1uS_Cnt_T_s32) > TMRFLTTHD_CNT_U32)
    {
        /* MISRA-C:2004 Rule 16.10 [NXTRDEV 16.10.1]: There is no appropriate action to take on the return value */ 
        (void)Rte_Call_SetNtcSts_Oper(NTCNR_0X039, 0x01U, NTCSTS_FAILD, 0U);
    }
    else
    {
        /* MISRA-C:2004 Rule 16.10 [NXTRDEV 16.10.1]: There is no appropriate action to take on the return value */ 
        (void)Rte_Call_SetNtcSts_Oper(NTCNR_0X039, 0x00U, NTCSTS_PASSD, 0U);
    }
