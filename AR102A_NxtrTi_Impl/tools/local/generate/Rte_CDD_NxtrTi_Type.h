 ...
 *
 *   Description:  Application types header file for SW-C <CDD_NxtrTi> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CDD_NXTRTI_TYPE_H
# define _RTE_CDD_NXTRTI_TYPE_H
