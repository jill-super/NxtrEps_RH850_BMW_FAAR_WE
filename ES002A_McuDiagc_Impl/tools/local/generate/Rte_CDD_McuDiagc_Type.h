 ...
 *
 *   Description:  Application types header file for SW-C <CDD_McuDiagc> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CDD_MCUDIAGC_TYPE_H
# define _RTE_CDD_MCUDIAGC_TYPE_H
...
#endif /* _RTE_CDD_MCUDIAGC_TYPE_H */
