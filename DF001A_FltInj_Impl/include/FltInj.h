 ...
 * 03/22/18  5        KByrski   Added missing defines (as per Design 2.4.0)                                   EA4#21816
 *********************************************************************************************************************/
...
/* Fault Injection Handwheel Torque 8 Measurement Handwheel Torque 8 */
#define FLTINJ_HWTQ8MEAS_HWTQ8                                  (43U)

/* Fault Injection Handwheel Torque 8 Measurement TestOk 0 */
#define FLTINJ_HWTQ8MEAS_TESTOK0                                (44U)

/* Fault Injection Handwheel Torque 1 Measurement Handwheel Torque 1 */
#define FLTINJ_HWTQ1MEAS_HWTQ1                                  (45U)

/* Fault Injection Handwheel Torque 3 Measurement Handwheel Torque 3 */
#define FLTINJ_HWTQ3MEAS_HWTQ3                                  (46U)

/* Fault Injection Handwheel Torque Arbitration Handwheel Torque */
#define FLTINJ_HWTQARBN_HWTQ                                    (47U)

/* Fault Injection Motor Angle 1 Measurement Motor Angle 1 Mechanical */
#define FLTINJ_MOTAG1MEAS_MOTAG1MECL                            (48U)

/* Fault Injection Motor Angle 1 Measurement Motor Angle 1 Parity Fault */
#define FLTINJ_MOTAG1MEAS_MOTAG1PARFLT                          (49U)

/* Fault Injection Motor Angle 2 Measurement Motor Angle 2 Voltage Squared */
#define FLTINJ_MOTAG2MEAS_MOTAG2VLTGSQD                         (50U)

/* Fault Injection Motor Angle 1 Measurement Handwheel Angle 1 */
#define FLTINJ_HWAG1MEAS_HWAG1                                  (51U)

/* Fault Injection Handwheel Angle Arbitration Handwheel Angle */
#define FLTINJ_HWAGARBN_HWAG                                    (52U)

/* Fault Injection Gate Drive 0 Control Gate Drive 0 Phase A */
#define FLTINJ_GATEDRV0CTRL_GATEDRV0PHAA                        (53U)

/* Fault Injection Gate Drive 0 Control Gate Drive 0 Phase B */
#define FLTINJ_GATEDRV0CTRL_GATEDRV0PHAB                        (54U)

/* Fault Injection Gate Drive 0 Control Gate Drive 0 Phase C */
#define FLTINJ_GATEDRV0CTRL_GATEDRV0PHAC                        (55U)

/* Fault Injection Gate Drive 1 Control Gate Drive 1 Phase D */
#define FLTINJ_GATEDRV1CTRL_GATEDRV1PHAD                        (56U)

/* Fault Injection Gate Drive 1 Control Gate Drive 1 Phase E */
#define FLTINJ_GATEDRV1CTRL_GATEDRV1PHAE                        (57U)

/* Fault Injection Gate Drive 1 Control Gate Drive 1 Phase F */
#define FLTINJ_GATEDRV1CTRL_GATEDRV1PHAF                        (58U)

/* Fault Injection Pull Compensation Active Pull Compensation Command */
#define FLTINJ_PULLCMPACTV_PULLCMPCMD                           (59U)

/* Fault Injection BMW Output Torque Overlay Command */
