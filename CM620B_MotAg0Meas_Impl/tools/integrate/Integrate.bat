...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\CM620B_MotAg0Meas_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\CM620B_MotAg0Meas_Impl
...
XCOPY ..\..\autosar\CDD_MotAg0Meas_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
