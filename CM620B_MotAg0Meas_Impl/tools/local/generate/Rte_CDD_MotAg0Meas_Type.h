 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_CDD_MotAg0Meas_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <CDD_MotAg0Meas> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CDD_MOTAG0MEAS_TYPE_H
# define _RTE_CDD_MOTAG0MEAS_TYPE_H
...
# ifndef EGYMODST_NORM
#  define EGYMODST_NORM (0U)
# endif

# ifndef EGYMODST_PRDN
#  define EGYMODST_PRDN (1U)
# endif

# ifndef EGYMODST_TRANSPT
#  define EGYMODST_TRANSPT (2U)
# endif

# ifndef EGYMODST_FLS
#  define EGYMODST_FLS (3U)
# endif

# ifndef MOTAGSNSRCFGST_RSTERR
#  define MOTAGSNSRCFGST_RSTERR (0U)
# endif

# ifndef MOTAGSNSRCFGST_RSTTURNCNTR
#  define MOTAGSNSRCFGST_RSTTURNCNTR (1U)
# endif

# ifndef MOTAGSNSRCFGST_CMDTRANSPT
#  define MOTAGSNSRCFGST_CMDTRANSPT (2U)
# endif
...
#endif /* _RTE_CDD_MOTAG0MEAS_TYPE_H */
