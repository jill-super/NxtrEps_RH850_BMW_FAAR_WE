...
/* PRQA S 0777 LongInfixName */ /* MD_MSR_5.1_777 */
 ...
 *********************************************************************************************************************/
/*!
 * \brief      Returns end address of instance
 * \details    Returns end address of instance, including potential padding bytes. End Address is aligned to page size.
 * \param[in]  Instance
 * \return     Instance End Address
 * \pre        Pointer to parameter Instance of type Fee_30_SmallSector_Ih_InstanceType is valid
 * \context    TASK
 * \reentrant  TRUE
 * \synchronous TRUE
 ...
 *********************************************************************************************************************/
/*!
 * \brief      Returns state of instance's last page
 * \details    Returns state of instance's last page
 * \param[in]  Instance
 * \return     State of instance's last page
 * \pre        Pointer to parameter Instance of type Fee_30_SmallSector_Ih_InstanceType is valid
 * \context    TASK
 * \reentrant  FALSE
 * \synchronous TRUE
 ...
 *********************************************************************************************************************/
/*!
 * \brief      Sets state of last page of passed instance
 * \details    Sets state of last page of passed instance
 * \param[in]  Instance
 * \param[in]  status
 * \pre        Pointer to parameter Instance of type Fee_30_SmallSector_Ih_InstanceType is valid
 * \context    TASK
 ...
 *********************************************************************************************************************/
/*!
 * \brief      Determine state of last page by checking recently read content of buffer
 * \details    Determine state of last page by checking recently read content of buffer
 * \return     State of last page (either blank or inconsistent)
 * \pre        -
 * \context    TASK
 * \reentrant  FALSE
 * \synchronous TRUE
 ...
 *********************************************************************************************************************/
/*!
 * \brief      Checks if last page of instance is blank
 * \details    Checks if last page of instance is blank
 * \param[in]  Instance
 * \return     E_OK: Request to FLS driver was successful
 * \return     E_NOT_OK: Request to FLS driver failed
 * \pre        -
 ...
 *********************************************************************************************************************/
/*!
 * \brief      Requests reading of last page of Instance
 * \details    Requests reading of last page of Instance
 * \param[in]  Instance
 * \return     E_OK: Request to FLS driver was successful
 * \return     E_NOT_OK: Request to FLS driver failed
 * \pre        -
