 ...
 *
 *      \details  The Flash Flash Emulation abstracts from the device specific addressing scheme and segmentation and
    ...
    Fee_30_SmallSector_VarDataPtrType DataBufferPtr,uint16 Length)
{
  ...
  if (Fee_30_SmallSector_DetChkDataPointerOk(DataBufferPtr) == E_NOT_OK) /* SBSW_FEE_30_SMALLSECTOR_03 */
  {
  ...
  {
    /* ----- Implementation ------------------------------------------------------------------------------*/
    Fee_30_SmallSector_SetUserParameter(BlockNumber, BlockOffset, DataBufferPtr, Length, FEE_30_SMALLSECTOR_READ_JOB); /* SBSW_FEE_30_SMALLSECTOR_03 */
    Fee_30_SmallSector_SetJobParameter();
...
#else
  FEE_DUMMY_STATEMENT(errorId); /* PRQA S 3112 */ /* MD_MSR_14.2 */
#endif
...
/* ----- UNINIT CHECK --------------------------------------------------------------------------------*/
  ...
  {
    /* ----- Implementation ------------------------------------------------------------------------------*/
    Fee_30_SmallSector_SetUserParameter(BlockNumber, 0x0000U, DataBufferPtr, Fee_30_SmallSector_Bh_GetDataLength(BlockNumber), FEE_30_SMALLSECTOR_WRITE_JOB); /* SBSW_FEE_30_SMALLSECTOR_03 */
    Fee_30_SmallSector_SetJobParameter();
...
FUNC(Std_ReturnType, FEE_30_SMALLSECTOR_PUBLIC_CODE) Fee_30_SmallSector_InvalidateBlock(uint16 BlockNumber)
{
  ...
  {
    /* ----- Implementation ------------------------------------------------------------------------------*/
    Fee_30_SmallSector_SetUserParameter(BlockNumber, 0x0000U, NULL_PTR, 0x0000U, FEE_30_SMALLSECTOR_INVALIDATE_JOB); /* SBSW_FEE_30_SMALLSECTOR_04 */
    Fee_30_SmallSector_SetJobParameter();
...
FUNC(Std_ReturnType, FEE_30_SMALLSECTOR_PUBLIC_CODE) Fee_30_SmallSector_EraseImmediateBlock(uint16 BlockNumber)
{
  ...
  {
  /* ----- Implementation ------------------------------------------------------------------------------*/
    Fee_30_SmallSector_SetUserParameter(BlockNumber, 0x0000U, NULL_PTR, 0x0000U, FEE_30_SMALLSECTOR_ERASE_JOB); /* SBSW_FEE_30_SMALLSECTOR_04 */
    Fee_30_SmallSector_SetJobParameter();
...
# if (FEE_30_SMALLSECTOR_DEV_ERROR_DETECT == STD_ON) /* COV_FEE_30_SMALLSECTOR_DET_NEVER_ON */
  ...
  if (Fee_30_SmallSector_DetChkDataPointerOk((void *)VersionInfoPtr) == E_NOT_OK) /* SBSW_FEE_30_SMALLSECTOR_01 */
  {
    errorId = FEE_30_SMALLSECTOR_E_INVALID_DATA_POINTER;
  }
  else
 ...
 *
 */
FUNC(void, FEE_30_SMALLSECTOR_PUBLIC_CODE) Fee_30_SmallSector_SetMode(MemIf_ModeType Mode) /* PRQA S 3206 */ /* MD_MSR_14.2 */
{
  /* #10 Implementation intentionally left empty - See design decisions */
  FEE_DUMMY_STATEMENT(Mode); /* PRQA S 3112 */ /* MD_MSR_14.2 */
}
