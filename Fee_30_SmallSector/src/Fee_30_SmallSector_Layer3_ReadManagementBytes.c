 ...
 **********************************************************************************************************************/
/*!
 * \brief      Processes WaitForBlankCheck of Last Page state of ReadManagementBytes sub-component
 * \details    Processes WaitForBlankCheck of Instance's Last Page state of ReadManagementBytes sub-component
 * \pre        -
 * \context    TASK
 * \reentrant  FALSE
 * \synchronous TRUE
 ...
 **********************************************************************************************************************/
/*!
 * \brief      Processes WaitForLastPage state of ReadManagementBytes sub-component
 * \details    Processes WaitForLastPage state of ReadManagementBytes sub-component
 * \pre        -
 * \context    TASK
 * \reentrant  FALSE
 * \synchronous TRUE
...
FEE_30_SMALLSECTOR_LOCAL FUNC(void, FEE_30_SMALLSECTOR_PRIVATE_CODE) Fee_30_SmallSector_RdMgmt_ProcessIdleState(void)
{
  ...
  Fee_30_SmallSector_Ih_SetLastPageState(Fee_30_SmallSector_RdMgmt_Instance, FEE_30_SMALLSECTOR_PATTERN_INIT); /* SBSW_FEE_30_SMALLSECTOR_51 */
  ...
  {
    /* #30 Read last page of instance */
    if (Fee_30_SmallSector_Ih_ReadLastPage(Fee_30_SmallSector_RdMgmt_Instance) == E_OK) /* SBSW_FEE_30_SMALLSECTOR_51 */
    {
...
FEE_30_SMALLSECTOR_LOCAL FUNC(void, FEE_30_SMALLSECTOR_PRIVATE_CODE) Fee_30_SmallSector_RdMgmt_ProcessWaitForEndBlankCheckState(void)
{
  if (Fee_30_SmallSector_Fls_GetJobResult() != MEMIF_JOB_FAILED){
    ...
    /* #40 Perform blank check on last page of the instance */
    if (Fee_30_SmallSector_Ih_BlankCheckLastPage(Fee_30_SmallSector_RdMgmt_Instance) == E_OK) /* SBSW_FEE_30_SMALLSECTOR_51 */
    {
...
FEE_30_SMALLSECTOR_LOCAL FUNC(void, FEE_30_SMALLSECTOR_PRIVATE_CODE) Fee_30_SmallSector_RdMgmt_ProcessWaitForLastBlankCheckState(void)
{
  ...
  boolean IsWp1Inconsistent = (boolean) (Fee_30_SmallSector_Ih_GetWP1State(Fee_30_SmallSector_RdMgmt_Instance) == FEE_30_SMALLSECTOR_PATTERN_INCONSISTENT); /* SBSW_FEE_30_SMALLSECTOR_51 */
  boolean IsWp2Inconsistent = (boolean) (Fee_30_SmallSector_Ih_GetWP2State(Fee_30_SmallSector_RdMgmt_Instance) == FEE_30_SMALLSECTOR_PATTERN_INCONSISTENT); /* SBSW_FEE_30_SMALLSECTOR_51 */

  switch (currentJobResult)
  {
  case MEMIF_JOB_OK:
    /* #20 Instance's last page was successfully checked blank. */
    Fee_30_SmallSector_Ih_SetLastPageState(Fee_30_SmallSector_RdMgmt_Instance, FEE_30_SMALLSECTOR_PATTERN_BLANK); /* SBSW_FEE_30_SMALLSECTOR_51 */
    break;

  case MEMIF_BLOCK_INCONSISTENT:
    /* #30 Instance's last page was successfully checked to be not blank. */
    Fee_30_SmallSector_Ih_SetLastPageState(Fee_30_SmallSector_RdMgmt_Instance, FEE_30_SMALLSECTOR_PATTERN_INCONSISTENT); /* SBSW_FEE_30_SMALLSECTOR_51 */
    break;

  default:
    /* #40 BlankCheck returned with an incorrect job result, e.g. MEMIF_JOB_FAILED, MEMIF_JOB_PENDING, MEMIF_JOB_CANCELED. Thus finish ReadManagement job */
    Fee_30_SmallSector_RdMgmt_FinishJob(MEMIF_JOB_FAILED);
    break;
  }

  /* #50 Perform read of management information in case one of the write pattern pages is not blank */
  /* #51 Only if both patterns are blank, it is assumed that the instance is either erased or blank */
  /* #52 Due to hardware properties it may happen that the second write pattern seems to be blank although it was written some time ago */
  if (IsWp1Inconsistent || IsWp2Inconsistent)
  {
    /* #55 Read both write patterns and Management info byte */
  ...
  {
    /* #56 Return successfully, because BlankChecks were performed successfully and it's not necessary to read any management information */
...
FEE_30_SMALLSECTOR_LOCAL FUNC(void, FEE_30_SMALLSECTOR_PRIVATE_CODE) Fee_30_SmallSector_RdMgmt_ProcessWaitForReadLastPage(void)
{
  if (Fee_30_SmallSector_Fls_GetJobResult() == MEMIF_JOB_OK){
    ...
    /* #10 Set state of last page according to buffer content */
    Fee_30_SmallSector_Ih_SetLastPageState(Fee_30_SmallSector_RdMgmt_Instance, Fee_30_SmallSector_Ih_GetPageStatusFromBuffer()); /* SBSW_FEE_30_SMALLSECTOR_51 */ /* SBSW_FEE_30_SMALLSECTOR_51 */

    /* #20 Read both write patterns and management info byte */
    if (Fee_30_SmallSector_Ih_ReadAllMgmt(Fee_30_SmallSector_RdMgmt_Instance) == E_OK) /* SBSW_FEE_30_SMALLSECTOR_51 */
    {
      Fee_30_SmallSector_RdMgmt_ComponentParameter.StateMachine = FEE_30_SMALLSECTOR_RDMGMT_STATE_WAIT_FOR_READ_ALL;
    }
...
#   endif
    ...
    /* #50 Finish ReadManagement job with successful result */
    Fee_30_SmallSector_RdMgmt_FinishJob(MEMIF_JOB_OK);
  }
  else
  {
