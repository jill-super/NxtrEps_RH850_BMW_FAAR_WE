...
/* PRQA S 0779 LongInfixName */ /* MD_MSR_5.1_779 */
...
FUNC(boolean, FEE_30_SMALLSECTOR_PUBLIC_CODE) Fee_30_SmallSector_Ih_IsLastPageNecessary(Fee_30_SmallSector_Ih_InstanceConstPointerType Instance)
{
  ...
  return (boolean) ((Fee_30_SmallSector_Ih_GetInstanceDataLength(Instance) + FEE_30_SMALLSECTOR_MANAGEMENT_SIZE) % Fee_30_SmallSector_Ph_GetPartitionWriteAlignment()) != 0; /* SBSW_FEE_30_SMALLSECTOR_29 */
}
        ...
        Fee_30_SmallSector_AddressType InstanceStartAddress, uint16 DataLength)
{
  ...
  Instance->MgmtAddress = InstanceStartAddress + (Fee_30_SmallSector_AddressType) (2 * Fee_30_SmallSector_Ph_GetPartitionWriteAlignment()); /* SBSW_FEE_30_SMALLSECTOR_21 */
  ...
  Instance->LastPageState = FEE_30_SMALLSECTOR_PATTERN_INIT; /* SBSW_FEE_30_SMALLSECTOR_21 */
...
/**********************************************************************************************************************
 *  Fee_30_SmallSector_Ih_GetEndAddress()
 *********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  /* #10 EndAddress = MgmtAddress + MgmtSize + DataLength (Payload) --> Aligned to page size / write alignment */
  return Fee_30_SmallSector_AlignValue(Fee_30_SmallSector_Ih_GetManagementAddress(Instance) + FEE_30_SMALLSECTOR_MANAGEMENT_SIZE + Fee_30_SmallSector_Ih_GetInstanceDataLength(Instance),
      Fee_30_SmallSector_Ph_GetPartitionWriteAlignment()); /* SBSW_FEE_30_SMALLSECTOR_29 */ /* SBSW_FEE_30_SMALLSECTOR_29 */
}
...
/**********************************************************************************************************************
 *  Fee_30_SmallSector_Ih_GetLastPageState()
 *********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
...
FUNC(void, FEE_30_SMALLSECTOR_PUBLIC_CODE) Fee_30_SmallSector_Ih_StoreMgmtValueFromBuffer(Fee_30_SmallSector_Ih_InstanceVarPointerType Instance)
{
  ...
  Instance->MgmtValue = Fee_30_SmallSector_Ih_ReadBuffer[2 * Fee_30_SmallSector_Ph_GetPartitionWriteAlignment()]; /* SBSW_FEE_30_SMALLSECTOR_21 */
}
...
/**********************************************************************************************************************
 *  Fee_30_SmallSector_Ih_SetLastPageState()
 *********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  Instance->LastPageState = state; /* SBSW_FEE_30_SMALLSECTOR_21 */
}
        ...
        Fee_30_SmallSector_AddressType StartAddress)
{
  ...
  Instance->MgmtAddress = StartAddress + (Fee_30_SmallSector_AddressType) (2 * Fee_30_SmallSector_Ph_GetPartitionWriteAlignment()); /* SBSW_FEE_30_SMALLSECTOR_21 */
...
FUNC (void, FEE_30_SMALLSECTOR_PUBLIC_CODE) Fee_30_SmallSector_Ih_DetermineInstanceStatus(Fee_30_SmallSector_Ih_InstanceVarPointerType Instance)
{
  ...
  Fee_30_SmallSector_StaticPatternState lastPageState = Fee_30_SmallSector_Ih_GetLastPageState(Instance); /* SBSW_FEE_30_SMALLSECTOR_29 */
            ...
            (wp2State == FEE_30_SMALLSECTOR_PATTERN_VALID) )
  {
    ...
    /* #31 Management value is equal to the valid value and last page is not blank --> Status: OK */
    /* #32 Last page is either INCONSISTENT (BlankCheck enabled) or INIT (BlankCheck disabled) */
    if ((Fee_30_SmallSector_Ih_IsValidManagement(mgmtValue) == TRUE) &&
        (lastPageState != FEE_30_SMALLSECTOR_PATTERN_BLANK))
    {
      status = INSTANCE_STATUS_OK;
    }
    /* #33 Management value is equal to the invalid value --> Status: INVALID */
    /* #34 Value of last page does not matter, because it could be anything depending on instance size and BlankCheck-Enable switch */
    else if (Fee_30_SmallSector_Ih_IsInvalidManagement(mgmtValue) == TRUE)
    {
      status = INSTANCE_STATUS_INVALID;
    }
    /* #35 Instance is assumed to be INCONSISTENT in every other case */
    else
    {
  ...
  /* #41 Static pattern pages are valid, but last page of instance is blank --> Status: INCONSISTENT */
  else
  {
    status = INSTANCE_STATUS_INCONSISTENT;
  }
...
/**********************************************************************************************************************
 *  Fee_30_SmallSector_Ih_GetPageStatusFromBuffer()
 *********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
...
FUNC (Fee_30_SmallSector_StaticPatternState, FEE_30_SMALLSECTOR_PUBLIC_CODE) Fee_30_SmallSector_Ih_GetPageStatusFromBuffer(void)
{
  ...
  /* #10 Get status of recently read page: */
  /* #11 If entire page is equal to erase value of flash, status PATTERN_BLANK is returned */
  /* #12 Otherwise PATTERN_INCONSISTENT is returned */
  for (LoopCounter = 0; LoopCounter < Fee_30_SmallSector_Ph_GetPartitionWriteAlignment(); LoopCounter++)
  {
    /* #20 Check if current value differs from erase value of FLS */
...
/**********************************************************************************************************************
 *  Fee_30_SmallSector_Ih_BlankCheckLastPage()
 *********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  /* #10 Perform BlankCheck on last page of instance: LastPageAddress = EndAddress - PageSize */
  return Fee_30_SmallSector_Fls_BlankCheck(Fee_30_SmallSector_Ih_GetEndAddress(Instance) - Fee_30_SmallSector_Ph_GetPartitionWriteAlignment(), Fee_30_SmallSector_Ph_GetPartitionWriteAlignment()); /* SBSW_FEE_30_SMALLSECTOR_29 */
}

/**********************************************************************************************************************
 *  Fee_30_SmallSector_Ih_ReadLastPage()
 *********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
...
{
  /* #10 Read last page of the instance */
  return Fee_30_SmallSector_Fls_Read(Fee_30_SmallSector_Ih_GetEndAddress(Instance) - Fee_30_SmallSector_Ph_GetPartitionWriteAlignment(), Fee_30_SmallSector_Ih_ReadBuffer, Fee_30_SmallSector_Ph_GetPartitionWriteAlignment()); /* SBSW_FEE_30_SMALLSECTOR_29 */ /* SBSW_FEE_30_SMALLSECTOR_27 */
}
        ...
        Fee_30_SmallSector_UserJobParameterType UserJobParameter, Fee_30_SmallSector_Ih_CompareParameterPointerType CompareParameter)
{
  ...
  /* #20 BufferIndex starts from the position, WriteManagementPage function stopped before */
  uint16 BufferIndex = (uint16) (pageSize - FEE_30_SMALLSECTOR_MANAGEMENT_SIZE);

  /* #30 The amount of BufferIndex bytes were already written. */
  /* #31 In this step only full pages of payload will be written */
  /* #32 If data is not aligned to page size, there will still be some bytes left, which need to be written within another step */
  uint16 length = ((Fee_30_SmallSector_Ih_GetInstanceDataLength(Instance) - BufferIndex) / pageSize) * pageSize; /* SBSW_FEE_30_SMALLSECTOR_29 */
  ...
  CompareParameter->Fee_30_SmallSector_Ih_CompareBufferPtr = &(UserJobParameter.DataBufferPtr[BufferIndex]); /* SBSW_FEE_30_SMALLSECTOR_25 */
  CompareParameter->Fee_30_SmallSector_Ih_CompareLength = length; /* SBSW_FEE_30_SMALLSECTOR_25 */
