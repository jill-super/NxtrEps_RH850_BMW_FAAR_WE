...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\CM102A_FlsMem_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\CM102A_FlsMem_Impl
...
XCOPY ..\..\autosar\FlsMem_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
