...
#define NROFFLSCRCREGNS_CNT_U08		(5U)

#define APPLCRCREGNNR_CNT_U08		(3U)
...
extern uint8 CCT_Range_04_Start[];
extern uint8 CCT_Range_04_Address[];
extern uint8 CCT_Range_04_Length[];
