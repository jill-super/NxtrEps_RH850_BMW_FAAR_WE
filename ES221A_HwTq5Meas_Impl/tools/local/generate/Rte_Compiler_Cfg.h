...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:HwTq5Meas_CONST)  ********************/

/* used for global or static SWC specific constants */
# define HwTq5Meas_CONST

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:HwTq5Meas_CODE)  *********************/

/* used for SWC specific code */
# define HwTq5Meas_CODE

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_HWTQ5MEAS_APPL)  *****************/

/* used for references on application variables */
# define RTE_HWTQ5MEAS_APPL_VAR

/* used for references on application data (constants or variables) */
# define RTE_HWTQ5MEAS_APPL_DATA

/* used for references on application functions */
# define RTE_HWTQ5MEAS_APPL_CODE

/* used for references on application constants */
# define RTE_HWTQ5MEAS_APPL_CONST

/***  End of saved code  ************************************************************************************/
#endif

#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:HwTq5Meas_VAR)  **********************/

/* used for all global or static SWC specific variables that are not initialized by the startup code of the compiler */
# define HwTq5Meas_VAR_NOINIT

/* used for global or static SWC specific variables that are initialized by the startup code of the compiler */
# define HwTq5Meas_VAR_INIT

/* used for global or static SWC specific variables that are initialized with zero by the startup code of the compiler */
# define HwTq5Meas_VAR_ZERO_INIT
