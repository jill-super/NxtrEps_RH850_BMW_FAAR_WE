 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_BmwTunSetHndlr_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <BmwTunSetHndlr> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_BMWTUNSETHNDLR_TYPE_H
# define _RTE_BMWTUNSETHNDLR_TYPE_H
...
#endif /* _RTE_BMWTUNSETHNDLR_TYPE_H */
