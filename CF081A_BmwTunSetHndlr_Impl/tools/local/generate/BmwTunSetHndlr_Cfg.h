 ...
 * Generation Time   : 17.05.2018 16:39:24
 **********************************************************************************************************************
 * Version Control:
 * %version:          2 %
 * %derived_by:       nz2999 %
...
/****************************************************** Macros *******************************************************/
#define BMWTUNSETHNDLR_DESININIDXNOTPRSNT_CNT_ENUM         (NTCNR_0X1E5)
#define BMWTUNSETHNDLR_DESININOPTSETAISXNOTPRSNT_CNT_ENUM  (NTCNR_0X1E6)
