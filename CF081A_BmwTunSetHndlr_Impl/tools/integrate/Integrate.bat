...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\CF081A_BmwTunSetHndlr_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\CF081A_BmwTunSetHndlr_Impl
...
XCOPY ..\..\autosar\BmwTunSetHndlr_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
