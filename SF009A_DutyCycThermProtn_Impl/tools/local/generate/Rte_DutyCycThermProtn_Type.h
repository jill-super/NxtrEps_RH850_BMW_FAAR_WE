 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_DutyCycThermProtn_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <DutyCycThermProtn> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DUTYCYCTHERMPROTN_TYPE_H
# define _RTE_DUTYCYCTHERMPROTN_TYPE_H
...
#endif /* _RTE_DUTYCYCTHERMPROTN_TYPE_H */
