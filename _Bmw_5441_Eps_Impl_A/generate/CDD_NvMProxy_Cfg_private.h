...
#define NROFNVMBLKS_CNT_U08        91U /* Number of NvM Blocks */
#define NROFCRCNVMBLKS_CNT_U08     49U /* Number of NvM Blocks using a CRC */
#define NROFCRCPROXYBLKS_CNT_U08   47U /* Number of NvM CRC checks configured for NvM Proxy Init */
