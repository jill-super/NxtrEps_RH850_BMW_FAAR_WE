...
#  define Rte_Read_PwrUpSeq_MotDrvr1IninTestCmpl_Logl(data) (*(data) = Rte_CDD_Bmw5441McuCfg_MotDrvr1IninTestCmpl_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_PhaDiscnctWrmIninTestCmpl_Logl Rte_Read_PwrUpSeq_PhaDiscnctWrmIninTestCmpl_Logl
#  define Rte_Read_PwrUpSeq_PhaDiscnctWrmIninTestCmpl_Logl(data) (*(data) = Rte_PhaDiscnct_PhaDiscnctWrmIninTestCmpl_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
