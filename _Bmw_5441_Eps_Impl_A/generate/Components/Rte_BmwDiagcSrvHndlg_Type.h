 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_BmwDiagcSrvHndlg_Type.h
 *        Config:  EPS.dpa
 *   ECU-Project:  EPS
 *
 ...
 *
 *   Description:  Application types header file for SW-C <BmwDiagcSrvHndlg>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_BMWDIAGCSRVHNDLG_TYPE_H
# define _RTE_BMWDIAGCSRVHNDLG_TYPE_H
...
#endif /* _RTE_BMWDIAGCSRVHNDLG_TYPE_H */
