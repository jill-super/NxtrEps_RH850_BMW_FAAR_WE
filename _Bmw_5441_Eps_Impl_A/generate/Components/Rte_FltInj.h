 ...
 *
 *   Description:  Application header file for SW-C <FltInj>
 *********************************************************************************************************************/
...
#  define Rte_Read_FltInj_HwVel_Val(data) (*(data) = Rte_SysKineAndEff_HwVel_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
FUNC(void, FltInj_CODE) FltInjPer1(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
