...
FUNC(Std_ReturnType, NvMProxy_CODE) NvMProxy_GetDataIndex(NvM_BlockIdType parg0, P2VAR(uint8, AUTOMATIC, RTE_NVMPROXY_APPL_VAR) DataIndex_Arg); /* PRQA S 0850, 1330, 3451 */ /* MD_MSR_19.8, MD_Rte_1330, MD_Rte_3451 */
...
FUNC(Std_ReturnType, NvMProxy_CODE) NvM_SetDataIndex(NvM_BlockIdType parg0, uint8 DataIndex_Arg); /* PRQA S 0850, 1330, 3451 */ /* MD_MSR_19.8, MD_Rte_1330, MD_Rte_3451 */
