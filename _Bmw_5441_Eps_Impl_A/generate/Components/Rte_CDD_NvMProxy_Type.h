 ...
 *
 *   Description:  Application types header file for SW-C <CDD_NvMProxy>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CDD_NVMPROXY_TYPE_H
# define _RTE_CDD_NVMPROXY_TYPE_H
...
#endif /* _RTE_CDD_NVMPROXY_TYPE_H */
