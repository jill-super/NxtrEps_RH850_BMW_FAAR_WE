...
extern VAR(float32, RTE_VAR_INIT) Rte_VehSigCdng_VehLgtASerlCom_Val; /* PRQA S 0850 */ /* MD_MSR_19.8 */
extern VAR(boolean, RTE_VAR_INIT) Rte_VehSigCdng_VehLgtAVldSerlCom_Logl; /* PRQA S 0850 */ /* MD_MSR_19.8 */
extern VAR(float32, RTE_VAR_INIT) Rte_VehSigCdng_VehSpdOvrd_Val; /* PRQA S 0850 */ /* MD_MSR_19.8 */
extern VAR(boolean, RTE_VAR_INIT) Rte_VehSigCdng_VehSpdOvrdEna_Logl; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_Read_VehSigCdng_HwTq_Val(data) (*(data) = Rte_HwTqArbn_HwTq_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_VehLatASerlCom_Val Rte_Read_VehSigCdng_VehLatASerlCom_Val
#  define Rte_Read_VehSigCdng_VehLatASerlCom_Val(data) (*(data) = Rte_BmwMsgSlot55Bas0Repn2BusFrChA_BmwVehLatA_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_VehLatAVldSerlCom_Logl Rte_Read_VehSigCdng_VehLatAVldSerlCom_Logl
#  define Rte_Read_VehSigCdng_VehLatAVldSerlCom_Logl(data) (*(data) = Rte_BmwMsgSlot55Bas0Repn2BusFrChA_BmwVehLatAVld_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_VehLgtASerlCom_Val Rte_Read_VehSigCdng_VehLgtASerlCom_Val
#  define Rte_Read_VehSigCdng_VehLgtASerlCom_Val(data) (*(data) = Rte_VehSigCdng_VehLgtASerlCom_Val, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_VehSigCdng_VehSpdOvrd_Val(data) (*(data) = Rte_VehSigCdng_VehSpdOvrd_Val, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_VehSpdOvrdEna_Logl Rte_Read_VehSigCdng_VehSpdOvrdEna_Logl
#  define Rte_Read_VehSigCdng_VehSpdOvrdEna_Logl(data) (*(data) = Rte_VehSigCdng_VehSpdOvrdEna_Logl, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_VehSpdSerlCom_Val Rte_Read_VehSigCdng_VehSpdSerlCom_Val
#  define Rte_Read_VehSigCdng_VehSpdSerlCom_Val(data) (*(data) = Rte_BmwVehSpd_VehSpd_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_VehSpdVldSerlCom_Logl Rte_Read_VehSigCdng_VehSpdVldSerlCom_Logl
#  define Rte_Read_VehSigCdng_VehSpdVldSerlCom_Logl(data) (*(data) = Rte_BmwVehSpd_VehSpdVld_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_VehYawRateSerlCom_Val Rte_Read_VehSigCdng_VehYawRateSerlCom_Val
#  define Rte_Read_VehSigCdng_VehYawRateSerlCom_Val(data) (*(data) = Rte_BmwMsgSlot56Bas0Repn2BusFrChA_BmwVehYawRate_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_VehYawRateVldSerlCom_Logl Rte_Read_VehSigCdng_VehYawRateVldSerlCom_Logl
#  define Rte_Read_VehSigCdng_VehYawRateVldSerlCom_Logl(data) (*(data) = Rte_BmwMsgSlot56Bas0Repn2BusFrChA_BmwVehYawRateVld_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Prm_VehSigCdngLatASlewRate_Val() (((P2CONST(Rte_Calprm_CalRegn01Cmn_DEFAULT_RTE_CALPRM_GROUP_Type, AUTOMATIC, RTE_CONST))RteParameterBase[Rte_CalprmElementGroup_CalRegn01Cmn_DEFAULT_RTE_CALPRM_GROUP])->VehSigCdngLatASlewRate_Val) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Prm_VehSigCdngLtgASlewRate_Val() (((P2CONST(Rte_Calprm_CalRegn01Cmn_DEFAULT_RTE_CALPRM_GROUP_Type, AUTOMATIC, RTE_CONST))RteParameterBase[Rte_CalprmElementGroup_CalRegn01Cmn_DEFAULT_RTE_CALPRM_GROUP])->VehSigCdngLtgASlewRate_Val) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Prm_VehSigCdngVehSpdSlewRate_Val() (((P2CONST(Rte_Calprm_CalRegn01Cmn_DEFAULT_RTE_CALPRM_GROUP_Type, AUTOMATIC, RTE_CONST))RteParameterBase[Rte_CalprmElementGroup_CalRegn01Cmn_DEFAULT_RTE_CALPRM_GROUP])->VehSigCdngVehSpdSlewRate_Val) /* PRQA S 3453 */ /* MD_MSR_19.7 */
