...
extern VAR(uint8, RTE_VAR_INIT) Rte_TunSelnMngt_ActvIninOptSetAIdx_Val; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
extern VAR(RtIdxChgSts1, RTE_VAR_INIT) Rte_TunSelnMngt_RtIdxChgSts_Val; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_Read_TunSelnMngt_DesIninIdx_Val(data) (*(data) = Rte_BmwTunSetHndlr_DesIninIdx_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_DesIninOptSetAIdx_Val Rte_Read_TunSelnMngt_DesIninOptSetAIdx_Val
#  define Rte_Read_TunSelnMngt_DesIninOptSetAIdx_Val(data) (*(data) = Rte_BmwTunSetHndlr_DesIninOptSetAIdx_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_DesRtIdx_Val Rte_Read_TunSelnMngt_DesRtIdx_Val
#  define Rte_Read_TunSelnMngt_DesRtIdx_Val(data) (*(data) = Rte_BmwTunSetHndlr_DesRtIdx_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Write_TunSelnMngt_ActvIninOptSetAIdx_Val(data) (Rte_TunSelnMngt_ActvIninOptSetAIdx_Val = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Write_TunSelnMngt_RtIdxChgSts_Val(data) (Rte_TunSelnMngt_RtIdxChgSts_Val = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Enter_TunSelnMngtIntDataProtnExclsvArea() /* RteAnalyzer(ExclusiveArea, ALL_INTERRUPT_BLOCKING) */

#  define Rte_Exit_TunSelnMngtIntDataProtnExclsvArea() /* RteAnalyzer(ExclusiveArea, ALL_INTERRUPT_BLOCKING) */
...
#  define Rte_Pim_PrevActvIninOptSetAIdx() \
  (&Rte_TunSelnMngt_PrevActvIninOptSetAIdx) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Pim_PrevRtIdxChgSts() \
  (&Rte_TunSelnMngt_PrevRtIdxChgSts) /* PRQA S 3453 */ /* MD_MSR_19.7 */
