...
#  define Rte_Read_VehSpdLimr_HwAg_Val(data) (*(data) = Rte_BmwHwAgArbnAndEotPosn_PinionAg_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_HwAgAuthy_Val Rte_Read_VehSpdLimr_HwAgAuthy_Val
#  define Rte_Read_VehSpdLimr_HwAgAuthy_Val(data) (*(data) = Rte_BmwHwAgArbnAndEotPosn_PinionAgConf_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_HwAgEotCcw_Val Rte_Read_VehSpdLimr_HwAgEotCcw_Val
#  define Rte_Read_VehSpdLimr_HwAgEotCcw_Val(data) (*(data) = Rte_BmwHwAgArbnAndEotPosn_HwAgEotCcw_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_HwAgEotCw_Val Rte_Read_VehSpdLimr_HwAgEotCw_Val
#  define Rte_Read_VehSpdLimr_HwAgEotCw_Val(data) (*(data) = Rte_BmwHwAgArbnAndEotPosn_HwAgEotCw_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_VehSpd_Val Rte_Read_VehSpdLimr_VehSpd_Val
#  define Rte_Read_VehSpdLimr_VehSpd_Val(data) (*(data) = Rte_BmwVehSpd_VehSpd_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Prm_VehSpdLimrPosMaxOffs2_Val() (((P2CONST(Rte_Calprm_CalRegn01IninOptSetA00_DEFAULT_RTE_CALPRM_GROUP_Type, AUTOMATIC, RTE_CONST))RteParameterBase[Rte_CalprmElementGroup_CalRegn01IninOptSetA00_DEFAULT_RTE_CALPRM_GROUP])->VehSpdLimrPosMaxOffs2_Val) /* PRQA S 3453 */ /* MD_MSR_19.7 */
