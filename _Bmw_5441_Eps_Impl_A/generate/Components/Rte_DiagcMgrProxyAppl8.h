 ...
 *
 *   Description:  Application header file for SW-C <DiagcMgrProxyAppl8>
 *********************************************************************************************************************/
...
#  define Rte_Read_DiagcMgrProxyAppl8_ClrDiagcFlgProxy_Val(data) (*(data) = Rte_DiagcMgr_ClrDiagcFlgProxy_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Enter_DiagcMgrProxyAppl8() SuspendOSInterrupts()  /* RteAnalyzer(ExclusiveArea, OS_INTERRUPT_BLOCKING) */

#  define Rte_Exit_DiagcMgrProxyAppl8() ResumeOSInterrupts()  /* RteAnalyzer(ExclusiveArea, OS_INTERRUPT_BLOCKING) */
...
#  define Rte_Pim_PrevClrNtcFlg8() \
  (&Rte_DiagcMgrProxyAppl8_PrevClrNtcFlg8) /* PRQA S 3453 */ /* MD_MSR_19.7 */

#  ifdef RTE_PTR2ARRAYBASETYPE_PASSING
#   define Rte_Pim_DiagcMgrNtcInfo8Ary() (&((*RtePim_DiagcMgrNtcInfo8Ary())[0]))
#  else
#   define Rte_Pim_DiagcMgrNtcInfo8Ary() RtePim_DiagcMgrNtcInfo8Ary()
#  endif
#  define RtePim_DiagcMgrNtcInfo8Ary() \
  (&Rte_DiagcMgrProxyAppl8_DiagcMgrNtcInfo8Ary) /* PRQA S 3453 */ /* MD_MSR_19.7 */

#  ifdef RTE_PTR2ARRAYBASETYPE_PASSING
#   define Rte_Pim_DiagcMgrNtcInfo8DebCntrAry() (&((*RtePim_DiagcMgrNtcInfo8DebCntrAry())[0]))
#  else
#   define Rte_Pim_DiagcMgrNtcInfo8DebCntrAry() RtePim_DiagcMgrNtcInfo8DebCntrAry()
#  endif
#  define RtePim_DiagcMgrNtcInfo8DebCntrAry() \
  (&Rte_DiagcMgrProxyAppl8_DiagcMgrNtcInfo8DebCntrAry) /* PRQA S 3453 */ /* MD_MSR_19.7 */

#  define Rte_Pim_DiagcData8() \
  (&Rte_DiagcMgrProxyAppl8_DiagcData8) /* PRQA S 3453 */ /* MD_MSR_19.7 */

#  define Rte_Pim_ProxySetNtcData8() \
  (&Rte_DiagcMgrProxyAppl8_ProxySetNtcData8) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
FUNC(void, DiagcMgrProxyAppl8_CODE) DiagcMgrProxyAppl8Init1(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
FUNC(void, DiagcMgrProxyAppl8_CODE) DiagcMgrProxyAppl8Per1(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
