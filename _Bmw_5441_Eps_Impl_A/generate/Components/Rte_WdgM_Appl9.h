 ...
 *
 *   Description:  Application header file for SW-C <WdgM_Appl9>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_WDGM_APPL9_H
# define _RTE_WDGM_APPL9_H
...
FUNC(Std_ReturnType, WdgM_Appl9_CODE) WdgM_CheckpointReached(WdgM_SupervisedEntityIdType parg0, WdgM_CheckpointIdType parg1); /* PRQA S 0850, 1330, 3451 */ /* MD_MSR_19.8, MD_Rte_1330, MD_Rte_3451 */
FUNC(Std_ReturnType, WdgM_Appl9_CODE) WdgM_GetLocalStatus(WdgM_SupervisedEntityIdType parg0, P2VAR(WdgM_LocalStatusType, AUTOMATIC, RTE_WDGM_APPL9_APPL_VAR) Status); /* PRQA S 0850, 1330, 3451 */ /* MD_MSR_19.8, MD_Rte_1330, MD_Rte_3451 */
