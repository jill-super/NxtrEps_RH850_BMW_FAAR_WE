...
extern VAR(boolean, RTE_VAR_INIT) Rte_CDD_XcpIf_CustXcpEna_Logl; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_Read_ActvIninOptSetAIdx_Val Rte_Read_CDD_XcpIf_ActvIninOptSetAIdx_Val
#  define Rte_Read_CDD_XcpIf_ActvIninOptSetAIdx_Val(data) (*(data) = Rte_TunSelnMngt_ActvIninOptSetAIdx_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Read_CustXcpEna_Logl Rte_Read_CDD_XcpIf_CustXcpEna_Logl
#  define Rte_Read_CDD_XcpIf_CustXcpEna_Logl(data) (*(data) = Rte_CDD_XcpIf_CustXcpEna_Logl, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define RTE_RUNNABLE_CDD_XcpIfPer1 CDD_XcpIfPer1
# endif
...
FUNC(void, CDD_XcpIf_CODE) CDD_XcpIfPer1(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
