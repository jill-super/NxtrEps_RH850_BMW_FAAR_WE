...
#  define Rte_Read_BattVltg_BattVltg_Val(data) (*(data) = Rte_CDD_MotCtrlMgr_BattVltgAdc_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_BattVltgSwd1_Val Rte_Read_BattVltg_BattVltgSwd1_Val
#  define Rte_Read_BattVltg_BattVltgSwd1_Val(data) (*(data) = Rte_CDD_Bmw5441McuCfg_BattVltgSwd1_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
# ifndef RTE_CORE
#  define RTE_RUNNABLE_BattVltgInit1 BattVltgInit1
#  define RTE_RUNNABLE_BattVltgPer1 BattVltgPer1
# endif

FUNC(void, BattVltg_CODE) BattVltgInit1(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
