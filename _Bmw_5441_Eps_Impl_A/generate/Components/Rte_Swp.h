...
#  define Rte_Read_Swp_HwTq_Val(data) (*(data) = Rte_HwTqArbn_HwTq_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_MotTqCmd_Val Rte_Read_Swp_MotTqCmd_Val
#  define Rte_Read_Swp_MotTqCmd_Val(data) (*(data) = Rte_SteerCmdArbnAndLim_ArbdMotTqCmd_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_VehSpd_Val Rte_Read_Swp_VehSpd_Val
#  define Rte_Read_Swp_VehSpd_Val(data) (*(data) = Rte_BmwVehSpd_VehSpd_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_VehSpdVld_Logl Rte_Read_Swp_VehSpdVld_Logl
#  define Rte_Read_Swp_VehSpdVld_Logl(data) (*(data) = Rte_BmwVehSpd_VehSpdVld_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
