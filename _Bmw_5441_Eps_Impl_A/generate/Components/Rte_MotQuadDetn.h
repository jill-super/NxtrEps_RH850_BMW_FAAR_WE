...
#  define Rte_Pim_MotAgCumvPrev() \
  (&Rte_MotQuadDetn_MotAgCumvPrev) /* PRQA S 3453 */ /* MD_MSR_19.7 */

#  define Rte_Pim_dMotQuadDetnMotAgCumvDelta() \
  (&Rte_MotQuadDetn_dMotQuadDetnMotAgCumvDelta) /* PRQA S 3453 */ /* MD_MSR_19.7 */
