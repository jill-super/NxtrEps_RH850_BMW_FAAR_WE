 ...
 *
 *   Description:  Application header file for SW-C <CDD_DataAndAdrPar>
 *********************************************************************************************************************/
...
FUNC(void, CDD_DataAndAdrPar_CODE) CDD_DataAndAdrPar_Init2(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
