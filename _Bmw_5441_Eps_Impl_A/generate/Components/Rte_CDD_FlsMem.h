...
#  define Rte_Write_CDD_FlsMem_SwApplCrc_Val(data) (Rte_CDD_FlsMem_SwApplCrc_Val = (data), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Pim_CodFlsDummyRead1() \
  (&Rte_CDD_FlsMem_CodFlsDummyRead1) /* PRQA S 3453 */ /* MD_MSR_19.7 */

#  define Rte_Pim_CodFlsDummyRead2() \
  (&Rte_CDD_FlsMem_CodFlsDummyRead2) /* PRQA S 3453 */ /* MD_MSR_19.7 */

#  define Rte_Pim_CodFlsDummyRead3() \
  (&Rte_CDD_FlsMem_CodFlsDummyRead3) /* PRQA S 3453 */ /* MD_MSR_19.7 */

#  define Rte_Pim_CodFlsDummyRead4() \
  (&Rte_CDD_FlsMem_CodFlsDummyRead4) /* PRQA S 3453 */ /* MD_MSR_19.7 */
