...
extern VAR(boolean, RTE_VAR_INIT) Rte_MotCurrPeakEstimn_DualEcuMotCtrlMtgtnEna_Logl; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_Read_MotCurrPeakEstimn_DualEcuMotCtrlMtgtnEna_Logl(data) (*(data) = Rte_MotCurrPeakEstimn_DualEcuMotCtrlMtgtnEna_Logl, ((Std_ReturnType)RTE_E_UNCONNECTED)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_MotAndThermProtnLoaMod_Val Rte_Read_MotCurrPeakEstimn_MotAndThermProtnLoaMod_Val
#  define Rte_Read_MotCurrPeakEstimn_MotAndThermProtnLoaMod_Val(data) (*(data) = Rte_LoaMgr_MotAndThermProtnLoaMod_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Prm_MotCurrPeakEstimnCurrFilFrq_Val() (((P2CONST(Rte_Calprm_CalRegn01IninOptSetA00_DEFAULT_RTE_CALPRM_GROUP_Type, AUTOMATIC, RTE_CONST))RteParameterBase[Rte_CalprmElementGroup_CalRegn01IninOptSetA00_DEFAULT_RTE_CALPRM_GROUP])->MotCurrPeakEstimnCurrFilFrq_Val) /* PRQA S 3453 */ /* MD_MSR_19.7 */

#  define Rte_Prm_MotCurrPeakEstimnCurrPeakEstimdFilFrq_Val() (((P2CONST(Rte_Calprm_CalRegn01IninOptSetA00_DEFAULT_RTE_CALPRM_GROUP_Type, AUTOMATIC, RTE_CONST))RteParameterBase[Rte_CalprmElementGroup_CalRegn01IninOptSetA00_DEFAULT_RTE_CALPRM_GROUP])->MotCurrPeakEstimnCurrPeakEstimdFilFrq_Val) /* PRQA S 3453 */ /* MD_MSR_19.7 */
