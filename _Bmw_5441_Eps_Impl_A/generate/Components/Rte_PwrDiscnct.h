...
#  define Rte_Read_PwrDiscnct_BattVltg_Val(data) (*(data) = Rte_CDD_MotCtrlMgr_BattVltgAdc_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#  define Rte_Read_BattVltgSwd1_Val Rte_Read_PwrDiscnct_BattVltgSwd1_Val
#  define Rte_Read_PwrDiscnct_BattVltgSwd1_Val(data) (*(data) = Rte_CDD_Bmw5441McuCfg_BattVltgSwd1_Val, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Prm_BattVltgSwdMax_Val() (16.0F) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
#  define Rte_Pim_PwrDiscnctATestCmplPrev() \
  (&Rte_PwrDiscnct_PwrDiscnctATestCmplPrev) /* PRQA S 3453 */ /* MD_MSR_19.7 */
