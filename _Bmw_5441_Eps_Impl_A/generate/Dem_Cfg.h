...
#define DEM_CFG_GEN_PATCH_VERSION                                     2
#define DEM_CFG_GEN_COMPATIBILITY_VERSION                             92975UL
...
/* Generator Internal Version                                         11.06.02 (Cfg5.16.x compatible, Release AR4-19), Revision: 92975, Variant: Bmw (Vector) */
...
#define DEM_CFG_AGING_00_START_TESTS_TFTOC                                 STD_ON       /* Autodetected - STD_ON: DemAgingBehavior == (DEM_AGING_TYPE_2 | DEM_AGING_TYPE_3 | DEM_AGING_TYPE_5),  STD_OFF: /Dem/DemGeneral/DemAgingBehavior == (DEM_AGING_TYPE_1 | DEM_AGING_TYPE_4 | DEM_AGING_TYPE_6) */ 
#define DEM_CFG_AGING_00_START_TRIGGER_PASSED                              STD_OFF      /* Autodetected - STD_ON: DemAgingBehavior == (DEM_AGING_TYPE_1 | DEM_AGING_TYPE_4 | DEM_AGING_TYPE_5 | DEM_AGING_TYPE_6),  STD_OFF: /Dem/DemGeneral/DemAgingBehavior == (DEM_AGING_TYPE_2 | DEM_AGING_TYPE_3) */ 
...
#define DEM_CFG_AGING_NEXT_TESTS_TFTOC                                     STD_ON       /* Autodetected - STD_ON: DemAgingBehavior == (DEM_AGING_TYPE_3 | DEM_AGING_TYPE_5 | DEM_AGING_TYPE_6),  STD_OFF: /Dem/DemGeneral/DemAgingBehavior == (DEM_AGING_TYPE_1 | DEM_AGING_TYPE_2 | DEM_AGING_TYPE_4) */ 
#define DEM_CFG_AGING_NEXT_TESTS_TNCTOC                                    STD_ON       /* Autodetected - STD_ON: DemAgingBehavior == (DEM_AGING_TYPE_3 | DEM_AGING_TYPE_4 | DEM_AGING_TYPE_5 | DEM_AGING_TYPE_6),  STD_OFF: /Dem/DemGeneral/DemAgingBehavior == (DEM_AGING_TYPE_1 | DEM_AGING_TYPE_2) */ 
...
#define DEM_CFG_AGING_START_TESTS_TFTOC                                    STD_ON       /* Autodetected - STD_ON: DemAgingBehavior == (DEM_AGING_TYPE_2 | DEM_AGING_TYPE_3 | DEM_AGING_TYPE_5 | DEM_AGING_TYPE_6),  STD_OFF: /Dem/DemGeneral/DemAgingBehavior == (DEM_AGING_TYPE_1 | DEM_AGING_TYPE_4) */ 
#define DEM_CFG_AGING_START_TRIGGER_PASSED                                 STD_OFF      /* Autodetected - STD_ON: DemAgingBehavior == (DEM_AGING_TYPE_1 | DEM_AGING_TYPE_4 | DEM_AGING_TYPE_6),  STD_OFF: /Dem/DemGeneral/DemAgingBehavior == (DEM_AGING_TYPE_2 | DEM_AGING_TYPE_3 | DEM_AGING_TYPE_5) */ 
...
#define DEM_CFG_DISPLACEMENT_TNCTOC_IS_PASSIVE                             STD_ON       /* Autodetected - via /Dem/DemGeneral/DemEventDisplacementStrategy == DEM_DISPLACEMENT_FULL */ 
...
#define DEM_CFG_NOTIFY_EVENT_STATUS                                        STD_ON       /* Autodetected - STD_ON: /Dem/DemConfigSet/DemEventParameter/DemCallbackEventStatusChanged container(s) exist, STD_OFF: no such container */ 
#define DEM_CFG_NOTIFY_FIM                                                 STD_OFF      /* /Dem/DemGeneral/DemTriggerFiMReports */ 
#define DEM_CFG_NOTIFY_GENERAL_DATA                                        STD_ON       /* Overwritten by Vector extension - /Dem/DemGeneral/DemTriggerGlobalEventDataChangedCallback */ 
...
#define DEM_CFG_NOTIFY_GENERAL_STATUS                                      STD_OFF      /* Overwritten by Vector extension - /Dem/DemGeneral/DemTriggerGlobalEventStatusChangedCallback */ 
...
#define DEM_CFG_PROCESS_TFSLC_CLEARONLY                                    STD_OFF      /* Autodetected - via /Dem/DemGeneral/DemStatusBitHandlingTestFailedSinceLastClear == DEM_STATUS_BIT_NORMAL */ 
#define DEM_CFG_PROCESS_TFSLC_STOREDONLY                                   STD_ON       /* Autodetected - via /Dem/DemGeneral/DemStatusBitHandlingTestFailedSinceLastClear == DEM_STATUS_BIT_AGING_AND_DISPLACEMENT */ 
...
#define DEM_CFG_SAFE_BSW_MODE                                              STD_ON       /* Vector extension - /Dem/DemGeneral/DemSafeBswChecks */ 
...
#define DEM_CFG_SUPPORT_CYCLE_POWER                                        STD_ON       /* Autodetected - STD_ON: cycle type is referenced by any *CycleRef or the /Dem/DemGeneral/DemRestartCycleOnInitRef parameter, STD_OFF: cycle type is not referenced. The '*CycleRef' params are (here 83 refs): /Dem/DemConfigSet/DemEventParameter/DemEventClass/DemAgingCycleRef, ~/DemOperationCycleRef, ~/DemIndicatorAttribute/DemIndicatorFailureCycleRef and ~/DemIndicatorAttribute/DemIndicatorHealingCycleRef. */ 
...
#define DEM_CFG_SUPPORT_DISABLED_COMBINATION                               STD_OFF      /* Autodetected - via /Dem/DemGeneral/DemEventCombinationSupport == DEM_EVCOMB_DISABLED */ 
...
#define DEM_CFG_SUPPORT_EVENT_QUEUE                                        STD_ON       /* Autodetected - via /Dem/DemGeneral/DemBswErrorBufferSize > 0 */ 
...
#define DEM_CFG_SUPPORT_SECONDARY                                          STD_ON       /* Autodetected - via /Dem/DemGeneral/DemMaxNumberEventEntrySecondary > 0 */ 
...
#define DEM_CFG_SUPPORT_TYPE1_COMBINATION                                  STD_ON       /* Autodetected - via /Dem/DemGeneral/DemEventCombinationSupport == DEM_EVCOMB_TYPE1 */ 
...
#define DEM_CFG_SUPPORT_USER_INDICATORS                                    STD_ON       /* Autodetected - STD_ON: any event has a user (non-special) indicator, STD_OFF: no event has standard user indicator (but some events may have a special indicators like MIL or any J1939 Lamp) */ 
...
#endif
#ifndef DEM_PROCESSOR_RH850_1363
#define DEM_PROCESSOR_RH850_1363
#endif
...
#define DEM_CFG_DIAGNOSTIC_OEM                                        DEM_OEM_BMW
...
#endif  /* DEM_CFG_H */
/**********************************************************************************************************************
  END OF FILE: Dem_Cfg.h     [Bmw (Vector), VARIANT-PRE-COMPILE, 11.06.02.92975]
**********************************************************************************************************************/
