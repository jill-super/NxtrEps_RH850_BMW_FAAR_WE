...
* Generation Time   : 31.07.2018 16:25:38
***********************************************************************************************************************
* Version Control:
* %version:          20 %
* %derived_by:       tzyksv %
...
{
		  { 0xfff8840cU, 0x98U, 0xffffU}, /* CLMA0CMPH */
		  { 0xfff88408U, 0x6cU, 0xffffU}, /* CLMA0CMPL */
		  { 0xfff8842cU, 0xb6U, 0xffffU}, /* CLMA1CMPH */
		  { 0xfff88428U, 0x8cU, 0xffffU}, /* CLMA1CMPL */
		  { 0xfff8844cU, 0x97U, 0xffffU}, /* CLMA2CMPH */
		  { 0xfff88448U, 0x6bU, 0xffffU}, /* CLMA2CMPL */
		  { 0xfff8846cU, 0x16aU, 0xffffU}, /* CLMA3CMPH */
		  { 0xfff88468U, 0x11aU, 0xffffU}, /* CLMA3CMPL */
...
CONST(NonSysCritRegRec1, AUTOMATIC) IninCritReg32BitChk_rec[NROFININCRITREG32BIT_CNT_U16]=
{
		  ...
		  { 0xffd62020U, 0x200005b4U, 0x200007f7U}, /* ECMEMK1 */
		  { 0xffd62014U, 0x2U, 0xfdffdff3U}, /* ECMIRCFG0 */
		  { 0xffd62018U, 0x0U, 0x200007f7U}, /* ECMIRCFG1 */
		  { 0xffd62004U, 0x0U, 0xfdffdff3U}, /* ECMMICFG0 */
		  { 0xffd62008U, 0x14U, 0x7f7U}, /* ECMMICFG1 */
		  { 0xffd6200cU, 0x21e00ff1U, 0xfdffdff3U}, /* ECMNMICFG0 */
		  { 0xffd62010U, 0x43U, 0x7f7U}, /* ECMNMICFG1 */
...
CONST(NonSysCritRegRec1, AUTOMATIC) PerCritReg8BitChk_rec[NROFPERCRITREG8BIT_CNT_U16]=
{
		  ...
		  { 0xffe80014U, 0x1U, 0xffU}, /* ENCA0TE */
		  { 0xffe81014U, 0x1U, 0xffU}, /* ENCA1TE */
...
CONST(NonSysCritRegRec1, AUTOMATIC) PerCritReg32BitChk_rec[NROFPERCRITREG32BIT_CNT_U16]=
{
		  ...
		  { 0xffc62204U, 0x7U, 0xffffffffU}, /* CFERRINT_VCI */
		  ...
		  { 0xffcd0030U, 0x7fcffffbU, 0xffffffffU}, /* OPBT0 */
