 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  BmwMsgSlot68Bas1Repn2BusFrChA.c
 *        Config:  EPS.dpa
 ...
 *
 *   Description:  C-Code implementation template for SW-C <BmwMsgSlot68Bas1Repn2BusFrChA>
 *********************************************************************************************************************/
...
#include "Rte_BmwMsgSlot68Bas1Repn2BusFrChA.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void BmwMsgSlot68Bas1Repn2BusFrChA_TestDefines(void);
 ...
 *   BMWMAXCURRLIMRSTS_VLD (1U)
 *   BMWMAXCURRLIMRSTS_FCTIFNOTAVL (2U)
 *   BMWMAXCURRLIMRSTS_FCTRPRTERR (3U)
 *   BMWMAXCURRLIMRSTS_INVLD (4U)
 * BmwRqrdCurrLimEpsSfty1: Enumeration of integer in interval [0...255] with enumerators
 *   BMWRQRDCURRLIMEPSSFTY_NOCURRLIM (0U)
 *   BMWRQRDCURRLIMEPSSFTY_CMFTCURRLIM (1U)
 *   BMWRQRDCURRLIMEPSSFTY_MAXCURRLIM (10U)
 *   BMWRQRDCURRLIMEPSSFTY_RESDNOTAVL (13U)
 *   BMWRQRDCURRLIMEPSSFTY_RESDERR (14U)
 *   BMWRQRDCURRLIMEPSSFTY_INVLDSIG (15U)
 * ENERG_AVAI_ARS1: Enumeration of integer in interval [0...255] with enumerators
 *   ENERG_AVAI_ARS_Funktionsschnittstelle_ist_nicht_verfuegbar (253U)
 *   ENERG_AVAI_ARS_Funktion_meldet_Fehler (254U)
 *   ENERG_AVAI_ARS_Signal_unbefuellt (255U)
 *   Factor: 1, Offset: 0
 ...
 *   MIN_I_SPEC_ARS_Funktionsschnittstelle_ist_nicht_verfuegbar (253U)
 *   MIN_I_SPEC_ARS_Funktion_meldet_Fehler (254U)
 *   MIN_I_SPEC_ARS_Signal_unbefuellt (255U)
 ...
 *   QU_DGR_AISP_ENERG_Degradationsstufe0 (0U)
 *   QU_DGR_AISP_ENERG_Degradationsstufe1 (1U)
 *   QU_DGR_AISP_ENERG_Degradationsstufe2 (2U)
 *   QU_DGR_AISP_ENERG_Degradationsstufe3 (3U)
 *   QU_DGR_AISP_ENERG_Degradationsstufe4 (4U)
 *   QU_DGR_AISP_ENERG_SignalUngueltig (15U)
 * RQ_CULI_EST_SFY1: Enumeration of integer in interval [0...255] with enumerators
 *   RQ_CULI_EST_SFY_Keine_Strombegrenzung (0U)
 *   RQ_CULI_EST_SFY_Komfort_Strombegrenzung (1U)
 *   RQ_CULI_EST_SFY_Maximale_Strombegrenzung (10U)
 *   RQ_CULI_EST_SFY_Reserviert_nicht_verfuegbar (13U)
 *   RQ_CULI_EST_SFY_Reserviert_Fehler (14U)
 *   RQ_CULI_EST_SFY_Signal_unbefuellt (15U)
 *
 * Record Types:
 * =============
 ...
 * Symbol: BmwMsgSlot68Bas1Repn2BusFrChAInit1_doc
 *********************************************************************************************************************/
 ...
 * Symbol: BmwMsgSlot68Bas1Repn2BusFrChAInit1
 *********************************************************************************************************************/

  Std_ReturnType fct_status;
  boolean fct_error = 0;

  float32 PimBmwMaxCurrLimrPrev;
  uint8 PimAlvFaildCnt;
  uint8 PimAlvPassdCnt;
  uint8 PimBmwRqrdCurrLimEpsSftyPrev;
  uint8 PimCrcFaildCnt;
  uint8 PimCrcPassdCnt;
  uint8 PimMaxCurrSpecEPSFaildCnt;
  uint8 PimMaxCurrSpecEPSPassdCnt;
  uint8 PimMissingMsgCnt;
  uint8 PimRqCuliEstSfyFaildCnt;
  uint8 PimRqCuliEstSfyPassdCnt;
  uint8 PimRxdMsgCnt;
  ...
  *************************************************/
  ...
  PimBmwMaxCurrLimrPrev = *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_BmwMaxCurrLimrPrev();
  *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_BmwMaxCurrLimrPrev() = PimBmwMaxCurrLimrPrev;
  PimAlvFaildCnt = *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_AlvFaildCnt();
  *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_AlvFaildCnt() = PimAlvFaildCnt;
  PimAlvPassdCnt = *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_AlvPassdCnt();
  *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_AlvPassdCnt() = PimAlvPassdCnt;
  PimBmwRqrdCurrLimEpsSftyPrev = *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_BmwRqrdCurrLimEpsSftyPrev();
  *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_BmwRqrdCurrLimEpsSftyPrev() = PimBmwRqrdCurrLimEpsSftyPrev;
  PimCrcFaildCnt = *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_CrcFaildCnt();
  *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_CrcFaildCnt() = PimCrcFaildCnt;
  PimCrcPassdCnt = *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_CrcPassdCnt();
  *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_CrcPassdCnt() = PimCrcPassdCnt;
  PimMaxCurrSpecEPSFaildCnt = *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_MaxCurrSpecEPSFaildCnt();
  *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_MaxCurrSpecEPSFaildCnt() = PimMaxCurrSpecEPSFaildCnt;
  PimMaxCurrSpecEPSPassdCnt = *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_MaxCurrSpecEPSPassdCnt();
  *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_MaxCurrSpecEPSPassdCnt() = PimMaxCurrSpecEPSPassdCnt;
  PimMissingMsgCnt = *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_MissingMsgCnt();
  *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_MissingMsgCnt() = PimMissingMsgCnt;
  PimRqCuliEstSfyFaildCnt = *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_RqCuliEstSfyFaildCnt();
  *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_RqCuliEstSfyFaildCnt() = PimRqCuliEstSfyFaildCnt;
  PimRqCuliEstSfyPassdCnt = *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_RqCuliEstSfyPassdCnt();
  *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_RqCuliEstSfyPassdCnt() = PimRqCuliEstSfyPassdCnt;
  PimRxdMsgCnt = *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_RxdMsgCnt();
  *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_RxdMsgCnt() = PimRxdMsgCnt;

  fct_status = TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  BmwMsgSlot68Bas1Repn2BusFrChA_TestDefines();
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: ENERG_DGR_DRDY_Missing_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: ENERG_DGR_DRDY_Missing_Oper
 *********************************************************************************************************************/
  ...
  float32 Write_BmwMaxCurrLimr_Val;
  ...
  *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_RxdMsgCnt() = PimRxdMsgCnt;
  ...
  fct_status = TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Read_FltCodEnad_Logl(&Read_FltCodEnad_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  (void)memset(&Write_BmwMaxCurrLimr_Val, 0, sizeof(Write_BmwMaxCurrLimr_Val));
  fct_status = TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Write_BmwMaxCurrLimr_Val(Write_BmwMaxCurrLimr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Write_BmwMaxCurrLimrSts_Val(Rte_InitValue_BmwMaxCurrLimrSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Write_BmwRqrdCurrLimEpsSfty_Val(Rte_InitValue_BmwRqrdCurrLimEpsSfty_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Write_BmwRqrdCurrLimEpsSftyVld_Logl(Rte_InitValue_BmwRqrdCurrLimEpsSftyVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *   boolean Rte_IsUpdated_sigGroup_ENERG_DGR_DRDY_sigGroup_ENERG_DGR_DRDY(void)
 *
 *   E2E Protection Wrapper API:
 *   ---------------------------
 *   uint32 E2EPW_Read_sigGroup_ENERG_DGR_DRDY_sigGroup_ENERG_DGR_DRDY(sigGroup_ENERG_DGR_DRDY1 *data)
 *
 * Output Interfaces:
 * ==================
 *   Explicit S/R API:
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: ENERG_DGR_DRDY_Received_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: ENERG_DGR_DRDY_Received_Oper
 *********************************************************************************************************************/
  ...
  boolean Read_FltCodEnad_Logl;
  sigGroup_ENERG_DGR_DRDY1 Read_sigGroup_ENERG_DGR_DRDY_sigGroup_ENERG_DGR_DRDY;
  boolean IsUpdated_sigGroup_ENERG_DGR_DRDY_sigGroup_ENERG_DGR_DRDY;
  ...
  *TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Pim_RxdMsgCnt() = PimRxdMsgCnt;
  ...
  IsUpdated_sigGroup_ENERG_DGR_DRDY_sigGroup_ENERG_DGR_DRDY = TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_IsUpdated_sigGroup_ENERG_DGR_DRDY_sigGroup_ENERG_DGR_DRDY();
  ...
  fct_status = TSC_BmwMsgSlot68Bas1Repn2BusFrChA_Rte_Read_sigGroup_ENERG_DGR_DRDY_sigGroup_ENERG_DGR_DRDY(&Read_sigGroup_ENERG_DGR_DRDY_sigGroup_ENERG_DGR_DRDY);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
static void BmwMsgSlot68Bas1Repn2BusFrChA_TestDefines(void)
{
  ...
  BmwMaxCurrLimrSts1 Test_BmwMaxCurrLimrSts1_V_1 = BMWMAXCURRLIMRSTS_VLD;
  BmwMaxCurrLimrSts1 Test_BmwMaxCurrLimrSts1_V_2 = BMWMAXCURRLIMRSTS_FCTIFNOTAVL;
  BmwMaxCurrLimrSts1 Test_BmwMaxCurrLimrSts1_V_3 = BMWMAXCURRLIMRSTS_FCTRPRTERR;
  BmwMaxCurrLimrSts1 Test_BmwMaxCurrLimrSts1_V_4 = BMWMAXCURRLIMRSTS_INVLD;

  BmwRqrdCurrLimEpsSfty1 Test_BmwRqrdCurrLimEpsSfty1_V_1 = BMWRQRDCURRLIMEPSSFTY_NOCURRLIM;
  BmwRqrdCurrLimEpsSfty1 Test_BmwRqrdCurrLimEpsSfty1_V_2 = BMWRQRDCURRLIMEPSSFTY_CMFTCURRLIM;
  BmwRqrdCurrLimEpsSfty1 Test_BmwRqrdCurrLimEpsSfty1_V_3 = BMWRQRDCURRLIMEPSSFTY_MAXCURRLIM;
  BmwRqrdCurrLimEpsSfty1 Test_BmwRqrdCurrLimEpsSfty1_V_4 = BMWRQRDCURRLIMEPSSFTY_RESDNOTAVL;
  BmwRqrdCurrLimEpsSfty1 Test_BmwRqrdCurrLimEpsSfty1_V_5 = BMWRQRDCURRLIMEPSSFTY_RESDERR;
  BmwRqrdCurrLimEpsSfty1 Test_BmwRqrdCurrLimEpsSfty1_V_6 = BMWRQRDCURRLIMEPSSFTY_INVLDSIG;

  ENERG_AVAI_ARS1 Test_ENERG_AVAI_ARS1_V_1 = ENERG_AVAI_ARS_Funktionsschnittstelle_ist_nicht_verfuegbar;
  ENERG_AVAI_ARS1 Test_ENERG_AVAI_ARS1_V_2 = ENERG_AVAI_ARS_Funktion_meldet_Fehler;
  ENERG_AVAI_ARS1 Test_ENERG_AVAI_ARS1_V_3 = ENERG_AVAI_ARS_Signal_unbefuellt;

  MAX_I_LD_SPEC_ARS1 Test_MAX_I_LD_SPEC_ARS1_V_1 = I_SPEC_ARS_Funktionsschnittstelle_ist_nicht_verfuegbar;
  MAX_I_LD_SPEC_ARS1 Test_MAX_I_LD_SPEC_ARS1_V_2 = I_SPEC_ARS_Funktion_meldet_Fehler;
  MAX_I_LD_SPEC_ARS1 Test_MAX_I_LD_SPEC_ARS1_V_3 = I_SPEC_ARS_Signal_unbefuellt;

  MAX_I_RECUP_SPEC_ARS1 Test_MAX_I_RECUP_SPEC_ARS1_V_1 = MIN_I_SPEC_ARS_Funktionsschnittstelle_ist_nicht_verfuegbar;
  MAX_I_RECUP_SPEC_ARS1 Test_MAX_I_RECUP_SPEC_ARS1_V_2 = MIN_I_SPEC_ARS_Funktion_meldet_Fehler;
  MAX_I_RECUP_SPEC_ARS1 Test_MAX_I_RECUP_SPEC_ARS1_V_3 = MIN_I_SPEC_ARS_Signal_unbefuellt;

  MAX_I_SPEC_BAX_STE1 Test_MAX_I_SPEC_BAX_STE1_V_1 = I_SPEC_ARS_Funktionsschnittstelle_ist_nicht_verfuegbar;
  MAX_I_SPEC_BAX_STE1 Test_MAX_I_SPEC_BAX_STE1_V_2 = I_SPEC_ARS_Funktion_meldet_Fehler;
  MAX_I_SPEC_BAX_STE1 Test_MAX_I_SPEC_BAX_STE1_V_3 = I_SPEC_ARS_Signal_unbefuellt;

  MAX_I_SPEC_EPS1 Test_MAX_I_SPEC_EPS1_V_1 = I_SPEC_ARS_Funktionsschnittstelle_ist_nicht_verfuegbar;
  MAX_I_SPEC_EPS1 Test_MAX_I_SPEC_EPS1_V_2 = I_SPEC_ARS_Funktion_meldet_Fehler;
  MAX_I_SPEC_EPS1 Test_MAX_I_SPEC_EPS1_V_3 = I_SPEC_ARS_Signal_unbefuellt;
  ...
  QU_DGR_AISP_ENERG1 Test_QU_DGR_AISP_ENERG1_V_1 = QU_DGR_AISP_ENERG_Degradationsstufe0;
  QU_DGR_AISP_ENERG1 Test_QU_DGR_AISP_ENERG1_V_2 = QU_DGR_AISP_ENERG_Degradationsstufe1;
  QU_DGR_AISP_ENERG1 Test_QU_DGR_AISP_ENERG1_V_3 = QU_DGR_AISP_ENERG_Degradationsstufe2;
  QU_DGR_AISP_ENERG1 Test_QU_DGR_AISP_ENERG1_V_4 = QU_DGR_AISP_ENERG_Degradationsstufe3;
  QU_DGR_AISP_ENERG1 Test_QU_DGR_AISP_ENERG1_V_5 = QU_DGR_AISP_ENERG_Degradationsstufe4;
  QU_DGR_AISP_ENERG1 Test_QU_DGR_AISP_ENERG1_V_6 = QU_DGR_AISP_ENERG_SignalUngueltig;

  RQ_CULI_EST_SFY1 Test_RQ_CULI_EST_SFY1_V_1 = RQ_CULI_EST_SFY_Keine_Strombegrenzung;
  RQ_CULI_EST_SFY1 Test_RQ_CULI_EST_SFY1_V_2 = RQ_CULI_EST_SFY_Komfort_Strombegrenzung;
  RQ_CULI_EST_SFY1 Test_RQ_CULI_EST_SFY1_V_3 = RQ_CULI_EST_SFY_Maximale_Strombegrenzung;
  RQ_CULI_EST_SFY1 Test_RQ_CULI_EST_SFY1_V_4 = RQ_CULI_EST_SFY_Reserviert_nicht_verfuegbar;
  RQ_CULI_EST_SFY1 Test_RQ_CULI_EST_SFY1_V_5 = RQ_CULI_EST_SFY_Reserviert_Fehler;
  RQ_CULI_EST_SFY1 Test_RQ_CULI_EST_SFY1_V_6 = RQ_CULI_EST_SFY_Signal_unbefuellt;
}
