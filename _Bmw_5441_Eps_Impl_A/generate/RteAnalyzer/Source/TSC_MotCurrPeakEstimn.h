...
Std_ReturnType TSC_MotCurrPeakEstimn_Rte_Read_DualEcuMotCtrlMtgtnEna_Logl(boolean *data);
Std_ReturnType TSC_MotCurrPeakEstimn_Rte_Read_MotAndThermProtnLoaMod_Val(uint8 *data);
