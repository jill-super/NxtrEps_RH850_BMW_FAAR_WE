...
static void SteerCmdArbnAndLim_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  float32 PimSteerCmdArbnAndLimDebStFalbck;
  uint32 PimSteerCmdArbnAndLimDebStFw;
  uint8 PimSteerCmdArbnAndLimSt;
  boolean PimFalbckDebStVari;
  boolean PimFwDebStVari;

  uint16 SteerCmdArbnAndLimFalbckTiThd_Val_data;
  uint16 SteerCmdArbnAndLimFwTiThd_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimSteerCmdArbnAndLimDebStFalbck = *TSC_SteerCmdArbnAndLim_Rte_Pim_SteerCmdArbnAndLimDebStFalbck();
  *TSC_SteerCmdArbnAndLim_Rte_Pim_SteerCmdArbnAndLimDebStFalbck() = PimSteerCmdArbnAndLimDebStFalbck;
  PimSteerCmdArbnAndLimDebStFw = *TSC_SteerCmdArbnAndLim_Rte_Pim_SteerCmdArbnAndLimDebStFw();
  *TSC_SteerCmdArbnAndLim_Rte_Pim_SteerCmdArbnAndLimDebStFw() = PimSteerCmdArbnAndLimDebStFw;
  PimSteerCmdArbnAndLimSt = *TSC_SteerCmdArbnAndLim_Rte_Pim_SteerCmdArbnAndLimSt();
  *TSC_SteerCmdArbnAndLim_Rte_Pim_SteerCmdArbnAndLimSt() = PimSteerCmdArbnAndLimSt;
  PimFalbckDebStVari = *TSC_SteerCmdArbnAndLim_Rte_Pim_FalbckDebStVari();
  *TSC_SteerCmdArbnAndLim_Rte_Pim_FalbckDebStVari() = PimFalbckDebStVari;
  PimFwDebStVari = *TSC_SteerCmdArbnAndLim_Rte_Pim_FwDebStVari();
  *TSC_SteerCmdArbnAndLim_Rte_Pim_FwDebStVari() = PimFwDebStVari;

  SteerCmdArbnAndLimFalbckTiThd_Val_data = TSC_SteerCmdArbnAndLim_Rte_Prm_SteerCmdArbnAndLimFalbckTiThd_Val();
  SteerCmdArbnAndLimFwTiThd_Val_data = TSC_SteerCmdArbnAndLim_Rte_Prm_SteerCmdArbnAndLimFwTiThd_Val();

  fct_status = TSC_SteerCmdArbnAndLim_Rte_Read_VehSpd_Val(&Read_VehSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  TSC_SteerCmdArbnAndLim_Rte_IrvWrite_SetManTqCmd_Oper_ProcdManTqCmd(0.0F);
  TSC_SteerCmdArbnAndLim_Rte_IrvWrite_SetManTqCmd_Oper_ProcdManTqCmdEna(FALSE);

  SteerCmdArbnAndLim_TestDefines();
 ...
 *********************************************************************************************************************/
  ...
  float32 Read_FalbckAssiMotTqCmd_Val;
  float32 Read_HwTq_Val;
  float32 Read_LimdMotTqCmd_Val;
  float32 Read_MotTqCmd_Val;
  boolean Read_MotTqCmdLimDi_Logl;
  ...
  float32 SteerCmdArbnAndLimPer1_ProcdManTqCmd;
  boolean SteerCmdArbnAndLimPer1_ProcdManTqCmdEna;
  ...
  *TSC_SteerCmdArbnAndLim_Rte_Pim_FwDebStVari() = PimFwDebStVari;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Read_AssiLnrGain_Val(&Read_AssiLnrGain_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Read_AssiLnrGainEna_Logl(&Read_AssiLnrGainEna_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Read_EotCtrlSca_Val(&Read_EotCtrlSca_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Read_FalbckAssiMotTqCmd_Val(&Read_FalbckAssiMotTqCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Read_HwTq_Val(&Read_HwTq_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Read_LimdMotTqCmd_Val(&Read_LimdMotTqCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Read_MotTqCmd_Val(&Read_MotTqCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Read_MotTqCmdLimDi_Logl(&Read_MotTqCmdLimDi_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Read_StallMotTqLim_Val(&Read_StallMotTqLim_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Read_SysMotTqCmdSca_Val(&Read_SysMotTqCmdSca_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Read_ThermMotTqLim_Val(&Read_ThermMotTqLim_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Read_VehSpdMotTqLim_Val(&Read_VehSpdMotTqLim_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Write_ArbdMotTqCmd_Val(Rte_InitValue_ArbdMotTqCmd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Write_MotTqCmdLimdPreStall_Val(Rte_InitValue_MotTqCmdLimdPreStall_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  SteerCmdArbnAndLimPer1_ProcdManTqCmd = TSC_SteerCmdArbnAndLim_Rte_IrvRead_SteerCmdArbnAndLimPer1_ProcdManTqCmd();
  SteerCmdArbnAndLimPer1_ProcdManTqCmdEna = TSC_SteerCmdArbnAndLim_Rte_IrvRead_SteerCmdArbnAndLimPer1_ProcdManTqCmdEna();

  fct_status = TSC_SteerCmdArbnAndLim_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_SteerCmdArbnAndLim_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
