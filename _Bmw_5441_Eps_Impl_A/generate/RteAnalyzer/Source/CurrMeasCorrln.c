...
static void CurrMeasCorrln_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint8 PimSnsr0RollgCntPrev;
  uint8 PimSnsr0StallCntPrev;
  boolean PimLongTermCorrlnStsABC;

  float32 CurrMeasCorrlnMaxErrCurr_Val_data;
  uint16 CurrMeasCorrlnNtc0x04DFailStep_Val_data;
  uint16 CurrMeasCorrlnNtc0x04DPassStep_Val_data;
  uint8 CurrMeasCorrlnMaxStallCntr_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimSnsr0RollgCntPrev = *TSC_CurrMeasCorrln_Rte_Pim_Snsr0RollgCntPrev();
  *TSC_CurrMeasCorrln_Rte_Pim_Snsr0RollgCntPrev() = PimSnsr0RollgCntPrev;
  PimSnsr0StallCntPrev = *TSC_CurrMeasCorrln_Rte_Pim_Snsr0StallCntPrev();
  *TSC_CurrMeasCorrln_Rte_Pim_Snsr0StallCntPrev() = PimSnsr0StallCntPrev;
  PimLongTermCorrlnStsABC = *TSC_CurrMeasCorrln_Rte_Pim_LongTermCorrlnStsABC();
  *TSC_CurrMeasCorrln_Rte_Pim_LongTermCorrlnStsABC() = PimLongTermCorrlnStsABC;

  CurrMeasCorrlnMaxErrCurr_Val_data = TSC_CurrMeasCorrln_Rte_Prm_CurrMeasCorrlnMaxErrCurr_Val();
  CurrMeasCorrlnNtc0x04DFailStep_Val_data = TSC_CurrMeasCorrln_Rte_Prm_CurrMeasCorrlnNtc0x04DFailStep_Val();
  CurrMeasCorrlnNtc0x04DPassStep_Val_data = TSC_CurrMeasCorrln_Rte_Prm_CurrMeasCorrlnNtc0x04DPassStep_Val();
  CurrMeasCorrlnMaxStallCntr_Val_data = TSC_CurrMeasCorrln_Rte_Prm_CurrMeasCorrlnMaxStallCntr_Val();

  CurrMeasCorrln_TestDefines();
 ...
 *********************************************************************************************************************/
  ...
  uint8 Read_MotCurrRollgCntr1_Val;
  ...
  *TSC_CurrMeasCorrln_Rte_Pim_LongTermCorrlnStsABC() = PimLongTermCorrlnStsABC;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Read_DiagcStsIvtr1Inactv_Logl(&Read_DiagcStsIvtr1Inactv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Read_MotCurrCorrdA_Val(&Read_MotCurrCorrdA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Read_MotCurrCorrdB_Val(&Read_MotCurrCorrdB_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Read_MotCurrCorrdC_Val(&Read_MotCurrCorrdC_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Read_MotCurrEolCalSt_Val(&Read_MotCurrEolCalSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Read_MotCurrRollgCntr1_Val(&Read_MotCurrRollgCntr1_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Read_SysSt_Val(&Read_SysSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Write_CurrMeasCorrlnSts_Val(Rte_InitValue_CurrMeasCorrlnSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Write_CurrMeasIdptSig_Val(Rte_InitValue_CurrMeasIdptSig_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Write_CurrMotSumABC_Val(Rte_InitValue_CurrMotSumABC_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Call_FltInj_u08_Oper(&Call_FltInj_u08_Oper_SigPah_Arg, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CurrMeasCorrln_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
