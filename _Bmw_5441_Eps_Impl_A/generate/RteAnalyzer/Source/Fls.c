 ...
 *********************************************************************************************************************/
  ...
  TSC_Fls_SchM_Enter_Fls_FLS_CODE_FLASH_DISABLED();
  TSC_Fls_SchM_Exit_Fls_FLS_CODE_FLASH_DISABLED();
  TSC_Fls_SchM_Enter_Fls_FLS_DRIVERSTATE_DATA_PROTECTION();
  TSC_Fls_SchM_Exit_Fls_FLS_DRIVERSTATE_DATA_PROTECTION();
  TSC_Fls_SchM_Enter_Fls_FLS_REGISTER_PROTECTION();
  TSC_Fls_SchM_Exit_Fls_FLS_REGISTER_PROTECTION();
