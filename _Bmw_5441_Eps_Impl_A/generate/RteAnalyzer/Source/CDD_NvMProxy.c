 ...
 *
 *   Description:  C-Code implementation template for SW-C <CDD_NvMProxy>
 *********************************************************************************************************************/
...
#include "Rte_CDD_NvMProxy.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void CDD_NvMProxy_TestDefines(void);
 ...
 *     Returnvalue: BlkFltTblRec1* is of type Ary1D_BlkFltTblRec1_5
 *   CmdRtnBufRec1 *Rte_Pim_CmdRtnBuf(void)
 *     Returnvalue: CmdRtnBufRec1* is of type Ary1D_CmdRtnBufRec1_NvMProxy1
 *   boolean *Rte_Pim_NvmBlkActv(void)
 *     Returnvalue: boolean* is of type Ary1D_boolean_NvMProxy1
 *
 *********************************************************************************************************************/
 ...
 * Symbol: NvMProxyInit1
 *********************************************************************************************************************/

  Std_ReturnType fct_status;
  boolean fct_error = 0;

  uint32 PimShtdwnClsChk;
  boolean PimNvmStsCollctd;
  Ary1D_BlkFltTblRec1_5 PimBlkFltTbl;
  Ary1D_CmdRtnBufRec1_NvMProxy1 PimCmdRtnBuf;
  Ary1D_boolean_NvMProxy1 PimNvmBlkActv;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimShtdwnClsChk = *TSC_CDD_NvMProxy_Rte_Pim_ShtdwnClsChk();
  *TSC_CDD_NvMProxy_Rte_Pim_ShtdwnClsChk() = PimShtdwnClsChk;
  PimNvmStsCollctd = *TSC_CDD_NvMProxy_Rte_Pim_NvmStsCollctd();
  *TSC_CDD_NvMProxy_Rte_Pim_NvmStsCollctd() = PimNvmStsCollctd;

  (void)memcpy(PimBlkFltTbl, TSC_CDD_NvMProxy_Rte_Pim_BlkFltTbl(), sizeof(Ary1D_BlkFltTblRec1_5));
  (void)memcpy(TSC_CDD_NvMProxy_Rte_Pim_BlkFltTbl(), PimBlkFltTbl, sizeof(Ary1D_BlkFltTblRec1_5));


  (void)memcpy(PimCmdRtnBuf, TSC_CDD_NvMProxy_Rte_Pim_CmdRtnBuf(), sizeof(Ary1D_CmdRtnBufRec1_NvMProxy1));
  (void)memcpy(TSC_CDD_NvMProxy_Rte_Pim_CmdRtnBuf(), PimCmdRtnBuf, sizeof(Ary1D_CmdRtnBufRec1_NvMProxy1));


  (void)memcpy(PimNvmBlkActv, TSC_CDD_NvMProxy_Rte_Pim_NvmBlkActv(), sizeof(Ary1D_boolean_NvMProxy1));
  (void)memcpy(TSC_CDD_NvMProxy_Rte_Pim_NvmBlkActv(), PimNvmBlkActv, sizeof(Ary1D_boolean_NvMProxy1));


  fct_status = TSC_CDD_NvMProxy_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
