...
static void RvsBattProtn_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  float32 Read_RvsBattDiagcGndAdc_Val;
  boolean Read_RvsBattDiagcGndAdcFaild_Logl;
  float32 Read_RvsBattDiagcRtnAdc_Val;
  boolean Read_RvsBattDiagcRtnAdcFaild_Logl;
  ...
  *************************************************/
  ...
  fct_status = TSC_RvsBattProtn_Rte_Read_RvsBattDiagcGndAdc_Val(&Read_RvsBattDiagcGndAdc_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_RvsBattProtn_Rte_Read_RvsBattDiagcGndAdcFaild_Logl(&Read_RvsBattDiagcGndAdcFaild_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_RvsBattProtn_Rte_Read_RvsBattDiagcRtnAdc_Val(&Read_RvsBattDiagcRtnAdc_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_RvsBattProtn_Rte_Read_RvsBattDiagcRtnAdcFaild_Logl(&Read_RvsBattDiagcRtnAdcFaild_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_RvsBattProtn_Rte_Write_RvsBattProtnStsQlfr_Val(Rte_InitValue_RvsBattProtnStsQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_RvsBattProtn_Rte_Call_CnvSnpshtData_f32_Oper(&Call_CnvSnpshtData_f32_Oper_SnpshtDataCnvd_Arg, 0.0F);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_RvsBattProtn_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_RvsBattProtn_Rte_Call_SetNtcStsAndSnpshtData_Oper(0U, 0U, 0U, 0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
