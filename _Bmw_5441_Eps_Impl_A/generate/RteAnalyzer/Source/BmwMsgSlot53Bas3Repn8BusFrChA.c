...
static void BmwMsgSlot53Bas3Repn8BusFrChA_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  FACT_MO_STE_SO_DXP1 Read_FACT_MO_STE_SO_DXP_FACT_MO_STE_SO_DXP;
  boolean IsUpdated_FACT_MO_STE_SO_DXP_FACT_MO_STE_SO_DXP;
  boolean Read_FltCodEnad_Logl;
  SU_CLU_STMOM_SFE_DXP1 Read_SU_CLU_STMOM_SFE_DXP_SU_CLU_STMOM_SFE_DXP;

  float32 PimBmwSteerMdfnFacPrev;
  BmwRtIdx1 PimBmwRtIdxPrev;
  BmwSteerMdfnFacSts1 PimBmwSteerMdfnFacStsPrev;
  uint8 PimFactMoSteSoDxpVldFaild;
  uint8 PimFactMoSteSoDxpVldPassd;
  uint8 PimMissMsgFaild;
  uint8 PimMissMsgPassd;
  uint8 PimSuCluStmomSfeDxpVldFaild;
  uint8 PimSuCluStmomSfeDxpVldPassd;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimBmwSteerMdfnFacPrev = *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_BmwSteerMdfnFacPrev();
  *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_BmwSteerMdfnFacPrev() = PimBmwSteerMdfnFacPrev;
  PimBmwRtIdxPrev = *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_BmwRtIdxPrev();
  *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_BmwRtIdxPrev() = PimBmwRtIdxPrev;
  PimBmwSteerMdfnFacStsPrev = *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_BmwSteerMdfnFacStsPrev();
  *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_BmwSteerMdfnFacStsPrev() = PimBmwSteerMdfnFacStsPrev;
  PimFactMoSteSoDxpVldFaild = *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_FactMoSteSoDxpVldFaild();
  *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_FactMoSteSoDxpVldFaild() = PimFactMoSteSoDxpVldFaild;
  PimFactMoSteSoDxpVldPassd = *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_FactMoSteSoDxpVldPassd();
  *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_FactMoSteSoDxpVldPassd() = PimFactMoSteSoDxpVldPassd;
  PimMissMsgFaild = *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_MissMsgFaild();
  *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_MissMsgFaild() = PimMissMsgFaild;
  PimMissMsgPassd = *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_MissMsgPassd();
  *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_MissMsgPassd() = PimMissMsgPassd;
  PimSuCluStmomSfeDxpVldFaild = *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_SuCluStmomSfeDxpVldFaild();
  *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_SuCluStmomSfeDxpVldFaild() = PimSuCluStmomSfeDxpVldFaild;
  PimSuCluStmomSfeDxpVldPassd = *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_SuCluStmomSfeDxpVldPassd();
  *TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Pim_SuCluStmomSfeDxpVldPassd() = PimSuCluStmomSfeDxpVldPassd;

  IsUpdated_FACT_MO_STE_SO_DXP_FACT_MO_STE_SO_DXP = TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_IsUpdated_FACT_MO_STE_SO_DXP_FACT_MO_STE_SO_DXP();

  fct_status = TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Read_FACT_MO_STE_SO_DXP_FACT_MO_STE_SO_DXP(&Read_FACT_MO_STE_SO_DXP_FACT_MO_STE_SO_DXP);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Read_FltCodEnad_Logl(&Read_FltCodEnad_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Read_SU_CLU_STMOM_SFE_DXP_SU_CLU_STMOM_SFE_DXP(&Read_SU_CLU_STMOM_SFE_DXP_SU_CLU_STMOM_SFE_DXP);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Write_BmwRtIdx_Val(Rte_InitValue_BmwRtIdx_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Write_BmwRtIdxVld_Logl(Rte_InitValue_BmwRtIdxVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Write_BmwSteerMdfnFac_Val(Rte_InitValue_BmwSteerMdfnFac_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Write_BmwSteerMdfnFacSts_Val(Rte_InitValue_BmwSteerMdfnFacSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot53Bas3Repn8BusFrChA_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  BmwMsgSlot53Bas3Repn8BusFrChA_TestDefines();
...
static void BmwMsgSlot53Bas3Repn8BusFrChA_TestDefines(void)
{
  ...
  BmwRtIdx1 Test_BmwRtIdx1_V_1 = BMWRTIDX_ULTRAHARD;
  BmwRtIdx1 Test_BmwRtIdx1_V_2 = BMWRTIDX_SPTBAL;
  BmwRtIdx1 Test_BmwRtIdx1_V_3 = BMWRTIDX_BAL;
  BmwRtIdx1 Test_BmwRtIdx1_V_4 = BMWRTIDX_SOFT;
  BmwRtIdx1 Test_BmwRtIdx1_V_5 = BMWRTIDX_FCTLIFNOTAVL;
  BmwRtIdx1 Test_BmwRtIdx1_V_6 = BMWRTIDX_FCTRPTERR;
  BmwRtIdx1 Test_BmwRtIdx1_V_7 = BMWRTIDX_INVLD;

  BmwSteerMdfnFacSts1 Test_BmwSteerMdfnFacSts1_V_1 = BMWSTEERMDFNFACSTS_OUTOFRNG;
  BmwSteerMdfnFacSts1 Test_BmwSteerMdfnFacSts1_V_2 = BMWSTEERMDFNFACSTS_VLD;
  BmwSteerMdfnFacSts1 Test_BmwSteerMdfnFacSts1_V_3 = BMWSTEERMDFNFACSTS_FCTIFNOTAVL;
  BmwSteerMdfnFacSts1 Test_BmwSteerMdfnFacSts1_V_4 = BMWSTEERMDFNFACSTS_FCTRPRTERR;
  BmwSteerMdfnFacSts1 Test_BmwSteerMdfnFacSts1_V_5 = BMWSTEERMDFNFACSTS_INVLDSIG;

  FACT_MO_STE_SO_DXP1 Test_FACT_MO_STE_SO_DXP1_IV_1 = InvalidValue_FACT_MO_STE_SO_DXP1;
  FACT_MO_STE_SO_DXP1 Test_FACT_MO_STE_SO_DXP1_V_1 = FACT_MO_STE_SO_DXP_Funktionsschnittstelle_ist_nicht_verfuegbar;
  FACT_MO_STE_SO_DXP1 Test_FACT_MO_STE_SO_DXP1_V_2 = FACT_MO_STE_SO_DXP_Funktion_meldet_Fehler;
  FACT_MO_STE_SO_DXP1 Test_FACT_MO_STE_SO_DXP1_V_3 = FACT_MO_STE_SO_DXP_Signal_unbefuellt;
  ...
  SU_CLU_STMOM_SFE_DXP1 Test_SU_CLU_STMOM_SFE_DXP1_IV_1 = InvalidValue_SU_CLU_STMOM_SFE_DXP1;
  SU_CLU_STMOM_SFE_DXP1 Test_SU_CLU_STMOM_SFE_DXP1_V_1 = SU_CLU_STMOM_SFE_DXP_Ultrahart;
  SU_CLU_STMOM_SFE_DXP1 Test_SU_CLU_STMOM_SFE_DXP1_V_2 = SU_CLU_STMOM_SFE_DXP_SportlichAusgewogen;
  SU_CLU_STMOM_SFE_DXP1 Test_SU_CLU_STMOM_SFE_DXP1_V_3 = SU_CLU_STMOM_SFE_DXP_Ausgewogen;
  SU_CLU_STMOM_SFE_DXP1 Test_SU_CLU_STMOM_SFE_DXP1_V_4 = SU_CLU_STMOM_SFE_DXP_Weich;
  SU_CLU_STMOM_SFE_DXP1 Test_SU_CLU_STMOM_SFE_DXP1_V_5 = SU_CLU_STMOM_SFE_DXP_Funktionsschnittstelle_ist_nicht_verfuegbar;
  SU_CLU_STMOM_SFE_DXP1 Test_SU_CLU_STMOM_SFE_DXP1_V_6 = SU_CLU_STMOM_SFE_DXP_Funktion_meldet_Fehler;
  SU_CLU_STMOM_SFE_DXP1 Test_SU_CLU_STMOM_SFE_DXP1_V_7 = SU_CLU_STMOM_SFE_DXP_Signal_unbefuellt;
}
