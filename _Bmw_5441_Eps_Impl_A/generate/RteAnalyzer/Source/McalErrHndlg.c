 ...
 *
 *   Description:  C-Code implementation template for SW-C <McalErrHndlg>
 *********************************************************************************************************************/
...
#include "Rte_McalErrHndlg.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void McalErrHndlg_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint8 PimCritErrCod;
  uint8 PimNonCritErrCod;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimCritErrCod = *TSC_McalErrHndlg_Rte_Pim_CritErrCod();
  *TSC_McalErrHndlg_Rte_Pim_CritErrCod() = PimCritErrCod;
  PimNonCritErrCod = *TSC_McalErrHndlg_Rte_Pim_NonCritErrCod();
  *TSC_McalErrHndlg_Rte_Pim_NonCritErrCod() = PimNonCritErrCod;

  fct_status = TSC_McalErrHndlg_Rte_Call_MCalReadVrfyFailFltInfo_Oper(0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_McalErrHndlg_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
