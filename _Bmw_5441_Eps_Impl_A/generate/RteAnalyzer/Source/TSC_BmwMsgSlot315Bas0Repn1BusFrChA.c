 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  TSC_BmwMsgSlot315Bas0Repn1BusFrChA.c
 *        Config:  EPS.dpa
 *   ECU-Project:  EPS
 *
...
{
  return Rte_Read_MotTqCmdPreLim_Val(data);
}
...
{
  return Rte_Write_BATT_VLTG_EPS_BATT_VLTG_EPS(data);
}
...
{
  return Rte_Write_DBG_EPS_BS_MOD_58_BYTE_ID2_DBG_EPS_BS_MOD_58_BYTE_ID2(data);
}

Std_ReturnType TSC_BmwMsgSlot315Bas0Repn1BusFrChA_Rte_Write_ECU_TEMP_EPS_ECU_TEMP_EPS(ECU_TEMP_EPS data)
{
  return Rte_Write_ECU_TEMP_EPS_ECU_TEMP_EPS(data);
}
...
{
  return Rte_Write_PRIM_HW_TQ_SNSR_VLTG_EPS_PRIM_HW_TQ_SNSR_VLTG_EPS(data);
}
