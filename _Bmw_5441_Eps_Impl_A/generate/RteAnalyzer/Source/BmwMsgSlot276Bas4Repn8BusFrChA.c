...
static void BmwMsgSlot276Bas4Repn8BusFrChA_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  MILE_KM1 Read_MILE_KM_MILE_KM;

  uint32 PimBmwOdomDstPrev;
  uint8 PimKiloMtrStandFaildCnt;
  uint8 PimKiloMtrStandPassdCnt;
  ...
  *************************************************/
  ...
  PimBmwOdomDstPrev = *TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Pim_BmwOdomDstPrev();
  *TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Pim_BmwOdomDstPrev() = PimBmwOdomDstPrev;
  PimKiloMtrStandFaildCnt = *TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Pim_KiloMtrStandFaildCnt();
  *TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Pim_KiloMtrStandFaildCnt() = PimKiloMtrStandFaildCnt;
  PimKiloMtrStandPassdCnt = *TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Pim_KiloMtrStandPassdCnt();
  *TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Pim_KiloMtrStandPassdCnt() = PimKiloMtrStandPassdCnt;
  PimMissingMsgCnt = *TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Pim_MissingMsgCnt();
  *TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Pim_MissingMsgCnt() = PimMissingMsgCnt;
  PimRxMsgCnt = *TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Pim_RxMsgCnt();
  *TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Pim_RxMsgCnt() = PimRxMsgCnt;

  fct_status = TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Read_FltCodEnad_Logl(&Read_FltCodEnad_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Read_MILE_KM_MILE_KM(&Read_MILE_KM_MILE_KM);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Write_BmwOdomDst_Val(Rte_InitValue_BmwOdomDst_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Write_BmwOdomDstVld_Logl(Rte_InitValue_BmwOdomDstVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot276Bas4Repn8BusFrChA_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  BmwMsgSlot276Bas4Repn8BusFrChA_TestDefines();
...
static void BmwMsgSlot276Bas4Repn8BusFrChA_TestDefines(void)
{
  ...
  MILE_KM1 Test_MILE_KM1_IV_1 = InvalidValue_MILE_KM1;
