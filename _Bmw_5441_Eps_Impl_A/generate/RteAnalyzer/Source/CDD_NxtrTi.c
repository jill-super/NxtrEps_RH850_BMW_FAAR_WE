...
static void CDD_NxtrTi_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  *************************************************/
  ...
  fct_status = TSC_CDD_NxtrTi_Rte_Call_ClrErrInjReg_Oper();
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_NxtrTi_Rte_Call_ReadErrInjReg_Oper(&Call_ReadErrInjReg_Oper_ErrId_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_NxtrTi_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  TSC_CDD_NxtrTi_Rte_Enter_NxtrTiExclusiveArea();
  TSC_CDD_NxtrTi_Rte_Exit_NxtrTiExclusiveArea();
