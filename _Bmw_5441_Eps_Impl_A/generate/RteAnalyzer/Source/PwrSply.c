...
#include "Rte_PwrSply.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void PwrSply_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint16 PimSpiTrsmErrCntr;
  boolean PimReadWrOrderFlg1;
  boolean PimReadWrOrderFlg2;
  boolean PimStrtUpSelfTestCmpl;

  uint16 PwrSplyNtc0x07BFailStep_Val_data;
  uint16 PwrSplyNtc0x07BPassStep_Val_data;
  uint16 PwrSplyNtc0x07CFailStep_Val_data;
  uint16 PwrSplyNtc0x07CPassStep_Val_data;
  uint16 PwrSplyNtc0x07DFailStep_Val_data;
  uint16 PwrSplyNtc0x07DPassStep_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimSpiTrsmErrCntr = *TSC_PwrSply_Rte_Pim_SpiTrsmErrCntr();
  *TSC_PwrSply_Rte_Pim_SpiTrsmErrCntr() = PimSpiTrsmErrCntr;
  PimReadWrOrderFlg1 = *TSC_PwrSply_Rte_Pim_ReadWrOrderFlg1();
  *TSC_PwrSply_Rte_Pim_ReadWrOrderFlg1() = PimReadWrOrderFlg1;
  PimReadWrOrderFlg2 = *TSC_PwrSply_Rte_Pim_ReadWrOrderFlg2();
  *TSC_PwrSply_Rte_Pim_ReadWrOrderFlg2() = PimReadWrOrderFlg2;
  PimStrtUpSelfTestCmpl = *TSC_PwrSply_Rte_Pim_StrtUpSelfTestCmpl();
  *TSC_PwrSply_Rte_Pim_StrtUpSelfTestCmpl() = PimStrtUpSelfTestCmpl;

  PwrSplyNtc0x07BFailStep_Val_data = TSC_PwrSply_Rte_Prm_PwrSplyNtc0x07BFailStep_Val();
  PwrSplyNtc0x07BPassStep_Val_data = TSC_PwrSply_Rte_Prm_PwrSplyNtc0x07BPassStep_Val();
  PwrSplyNtc0x07CFailStep_Val_data = TSC_PwrSply_Rte_Prm_PwrSplyNtc0x07CFailStep_Val();
  PwrSplyNtc0x07CPassStep_Val_data = TSC_PwrSply_Rte_Prm_PwrSplyNtc0x07CPassStep_Val();
  PwrSplyNtc0x07DFailStep_Val_data = TSC_PwrSply_Rte_Prm_PwrSplyNtc0x07DFailStep_Val();
  PwrSplyNtc0x07DPassStep_Val_data = TSC_PwrSply_Rte_Prm_PwrSplyNtc0x07DPassStep_Val();
 ...
 *********************************************************************************************************************/
  ...
  *TSC_PwrSply_Rte_Pim_StrtUpSelfTestCmpl() = PimStrtUpSelfTestCmpl;
  ...
  fct_status = TSC_PwrSply_Rte_Read_SysSt_Val(&Read_SysSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrSply_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
