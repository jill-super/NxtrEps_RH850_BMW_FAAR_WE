...
static void TmplMonr_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint32 PimAvrgElpdTiMicroSec;
  uint16 PimTrsmErrCntr;
  uint8 PimTmplMonrIninCntr;
  uint8 PimTmplMonrNtc40PrmByte;
  uint8 PimTmplMonrWdgRstrtCnt;
  uint8 PimTrsmErrNtcThd;
  boolean PimTmplMonrIninTestCmplFlg;
  boolean PimTmplMonrSpiReadWrOrderFlg1;
  boolean PimTmplMonrSpiReadWrOrderFlg2;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimAvrgElpdTiMicroSec = *TSC_TmplMonr_Rte_Pim_AvrgElpdTiMicroSec();
  *TSC_TmplMonr_Rte_Pim_AvrgElpdTiMicroSec() = PimAvrgElpdTiMicroSec;
  PimTrsmErrCntr = *TSC_TmplMonr_Rte_Pim_TrsmErrCntr();
  *TSC_TmplMonr_Rte_Pim_TrsmErrCntr() = PimTrsmErrCntr;
  PimTmplMonrIninCntr = *TSC_TmplMonr_Rte_Pim_TmplMonrIninCntr();
  *TSC_TmplMonr_Rte_Pim_TmplMonrIninCntr() = PimTmplMonrIninCntr;
  PimTmplMonrNtc40PrmByte = *TSC_TmplMonr_Rte_Pim_TmplMonrNtc40PrmByte();
  *TSC_TmplMonr_Rte_Pim_TmplMonrNtc40PrmByte() = PimTmplMonrNtc40PrmByte;
  PimTmplMonrWdgRstrtCnt = *TSC_TmplMonr_Rte_Pim_TmplMonrWdgRstrtCnt();
  *TSC_TmplMonr_Rte_Pim_TmplMonrWdgRstrtCnt() = PimTmplMonrWdgRstrtCnt;
  PimTrsmErrNtcThd = *TSC_TmplMonr_Rte_Pim_TrsmErrNtcThd();
  *TSC_TmplMonr_Rte_Pim_TrsmErrNtcThd() = PimTrsmErrNtcThd;
  PimTmplMonrIninTestCmplFlg = *TSC_TmplMonr_Rte_Pim_TmplMonrIninTestCmplFlg();
  *TSC_TmplMonr_Rte_Pim_TmplMonrIninTestCmplFlg() = PimTmplMonrIninTestCmplFlg;
  PimTmplMonrSpiReadWrOrderFlg1 = *TSC_TmplMonr_Rte_Pim_TmplMonrSpiReadWrOrderFlg1();
  *TSC_TmplMonr_Rte_Pim_TmplMonrSpiReadWrOrderFlg1() = PimTmplMonrSpiReadWrOrderFlg1;
  PimTmplMonrSpiReadWrOrderFlg2 = *TSC_TmplMonr_Rte_Pim_TmplMonrSpiReadWrOrderFlg2();
  *TSC_TmplMonr_Rte_Pim_TmplMonrSpiReadWrOrderFlg2() = PimTmplMonrSpiReadWrOrderFlg2;

  fct_status = TSC_TmplMonr_Rte_Write_TmplMonrIninTestCmpl_Logl(Rte_InitValue_TmplMonrIninTestCmpl_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  boolean Call_IoHwAb_GetGpioPwrOutpEnaFb_Oper_PinSt_Arg = FALSE;
  ...
  *TSC_TmplMonr_Rte_Pim_TmplMonrSpiReadWrOrderFlg2() = PimTmplMonrSpiReadWrOrderFlg2;
  ...
  fct_status = TSC_TmplMonr_Rte_Read_StrtUpSt_Val(&Read_StrtUpSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  TSC_TmplMonr_Rte_IrvWrite_TmplMonrPer1_ElpdTiMicroSec(0U);

  fct_status = TSC_TmplMonr_Rte_Call_CtrlErrOut_Oper(FALSE, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TmplMonr_Rte_Call_GetRefTmr1MicroSec32bit_Oper(&Call_GetRefTmr1MicroSec32bit_Oper_RefTmr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TmplMonr_Rte_Call_IoHwAb_GetGpioPwrOutpEnaFb_Oper(&Call_IoHwAb_GetGpioPwrOutpEnaFb_Oper_PinSt_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TmplMonr_Rte_Call_IoHwAb_SetGpioTmplMonrWdg_Oper(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TmplMonr_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  uint32 TmplMonrPer2_ElpdTiMicroSec;
  ...
  *TSC_TmplMonr_Rte_Pim_TmplMonrSpiReadWrOrderFlg2() = PimTmplMonrSpiReadWrOrderFlg2;
  ...
  TmplMonrPer2_ElpdTiMicroSec = TSC_TmplMonr_Rte_IrvRead_TmplMonrPer2_ElpdTiMicroSec();

  fct_status = TSC_TmplMonr_Rte_Call_GetTiSpan1MicroSec32bit_Oper(0U, &Call_GetTiSpan1MicroSec32bit_Oper_TiSpan_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  *TSC_TmplMonr_Rte_Pim_TmplMonrSpiReadWrOrderFlg2() = PimTmplMonrSpiReadWrOrderFlg2;
  ...
  fct_status = TSC_TmplMonr_Rte_Read_SysSt_Val(&Read_SysSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
