...
static void EcuTMeas_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  float32 Read_EcuT_Val;

  float32 PimdEcuTMeasEcuTCalcd;
  FilLpRec1 PimEcuTFilStVari;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimdEcuTMeasEcuTCalcd = *TSC_EcuTMeas_Rte_Pim_dEcuTMeasEcuTCalcd();
  *TSC_EcuTMeas_Rte_Pim_dEcuTMeasEcuTCalcd() = PimdEcuTMeasEcuTCalcd;
  PimEcuTFilStVari = *TSC_EcuTMeas_Rte_Pim_EcuTFilStVari();
  *TSC_EcuTMeas_Rte_Pim_EcuTFilStVari() = PimEcuTFilStVari;

  fct_status = TSC_EcuTMeas_Rte_Read_EcuT_Val(&Read_EcuT_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EcuTMeas_Rte_Write_EcuTFild_Val(Rte_InitValue_EcuTFild_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  float32 Read_EcuT_Val;
  boolean Read_EcuTAdcFaild_Logl;

  float32 PimdEcuTMeasEcuTCalcd;
  FilLpRec1 PimEcuTFilStVari;

  uint32 Call_CnvSnpshtData_f32_Oper_SnpshtDataCnvd_Arg = 0U;
  uint32 Call_CnvSnpshtData_logl_Oper_SnpshtDataCnvd_Arg = 0U;
  ...
  *TSC_EcuTMeas_Rte_Pim_EcuTFilStVari() = PimEcuTFilStVari;
  ...
  fct_status = TSC_EcuTMeas_Rte_Read_EcuTAdcFaild_Logl(&Read_EcuTAdcFaild_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EcuTMeas_Rte_Write_DiagcStsLimdTPrfmnc_Logl(Rte_InitValue_DiagcStsLimdTPrfmnc_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EcuTMeas_Rte_Call_CnvSnpshtData_f32_Oper(&Call_CnvSnpshtData_f32_Oper_SnpshtDataCnvd_Arg, 0.0F);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EcuTMeas_Rte_Call_CnvSnpshtData_logl_Oper(&Call_CnvSnpshtData_logl_Oper_SnpshtDataCnvd_Arg, FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EcuTMeas_Rte_Call_GetNtcActv_Oper(0U, &Call_GetNtcActv_Oper_NtcActv);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_EcuTMeas_Rte_Call_SetNtcStsAndSnpshtData_Oper(0U, 0U, 0U, 0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
