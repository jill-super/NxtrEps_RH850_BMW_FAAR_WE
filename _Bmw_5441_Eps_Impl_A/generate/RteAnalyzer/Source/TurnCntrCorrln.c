...
static void TurnCntrCorrln_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint8 PimMotAgATurnCntrRollgCntPrev;
  uint8 PimMotAgATurnCntrStallCntPrev;
  uint8 PimMotAgBTurnCntrRollgCntPrev;
  uint8 PimMotAgBTurnCntrStallCntPrev;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimMotAgATurnCntrRollgCntPrev = *TSC_TurnCntrCorrln_Rte_Pim_MotAgATurnCntrRollgCntPrev();
  *TSC_TurnCntrCorrln_Rte_Pim_MotAgATurnCntrRollgCntPrev() = PimMotAgATurnCntrRollgCntPrev;
  PimMotAgATurnCntrStallCntPrev = *TSC_TurnCntrCorrln_Rte_Pim_MotAgATurnCntrStallCntPrev();
  *TSC_TurnCntrCorrln_Rte_Pim_MotAgATurnCntrStallCntPrev() = PimMotAgATurnCntrStallCntPrev;
  PimMotAgBTurnCntrRollgCntPrev = *TSC_TurnCntrCorrln_Rte_Pim_MotAgBTurnCntrRollgCntPrev();
  *TSC_TurnCntrCorrln_Rte_Pim_MotAgBTurnCntrRollgCntPrev() = PimMotAgBTurnCntrRollgCntPrev;
  PimMotAgBTurnCntrStallCntPrev = *TSC_TurnCntrCorrln_Rte_Pim_MotAgBTurnCntrStallCntPrev();
  *TSC_TurnCntrCorrln_Rte_Pim_MotAgBTurnCntrStallCntPrev() = PimMotAgBTurnCntrStallCntPrev;

  TurnCntrCorrln_TestDefines();
 ...
 *********************************************************************************************************************/
  ...
  float32 Read_MotAgATurnCntr_Val;
  SigQlfr1 Read_MotAgATurnCntrQlfr_Val;
  uint8 Read_MotAgATurnCntrRollgCntr_Val;
  float32 Read_MotAgBTurnCntr_Val;
  SigQlfr1 Read_MotAgBTurnCntrQlfr_Val;
  uint8 Read_MotAgBTurnCntrRollgCntr_Val;
  ...
  *TSC_TurnCntrCorrln_Rte_Pim_MotAgBTurnCntrStallCntPrev() = PimMotAgBTurnCntrStallCntPrev;
  ...
  fct_status = TSC_TurnCntrCorrln_Rte_Read_MotAgATurnCntr_Val(&Read_MotAgATurnCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TurnCntrCorrln_Rte_Read_MotAgATurnCntrQlfr_Val(&Read_MotAgATurnCntrQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TurnCntrCorrln_Rte_Read_MotAgATurnCntrRollgCntr_Val(&Read_MotAgATurnCntrRollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TurnCntrCorrln_Rte_Read_MotAgBTurnCntr_Val(&Read_MotAgBTurnCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TurnCntrCorrln_Rte_Read_MotAgBTurnCntrQlfr_Val(&Read_MotAgBTurnCntrQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TurnCntrCorrln_Rte_Read_MotAgBTurnCntrRollgCntr_Val(&Read_MotAgBTurnCntrRollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TurnCntrCorrln_Rte_Write_TurnCntrCorrlnSts_Val(Rte_InitValue_TurnCntrCorrlnSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TurnCntrCorrln_Rte_Write_TurnCntrIdptSig_Val(Rte_InitValue_TurnCntrIdptSig_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TurnCntrCorrln_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TurnCntrCorrln_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
