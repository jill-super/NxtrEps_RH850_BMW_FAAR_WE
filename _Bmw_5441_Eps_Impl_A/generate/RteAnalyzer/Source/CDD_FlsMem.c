...
static void CDD_FlsMem_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint32 PimCodFlsCrcChkStrtTi;
  uint32 PimCodFlsDummyRead1;
  uint32 PimCodFlsDummyRead2;
  uint32 PimCodFlsDummyRead3;
  uint32 PimCodFlsDummyRead4;
  uint32 PimCrcHwIdxKey;
  boolean PimCodFlsSngBitErr;
  boolean PimCrcChkCmpl;
  boolean PimPwrOnRstCrcChkCmpl;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimCodFlsCrcChkStrtTi = *TSC_CDD_FlsMem_Rte_Pim_CodFlsCrcChkStrtTi();
  *TSC_CDD_FlsMem_Rte_Pim_CodFlsCrcChkStrtTi() = PimCodFlsCrcChkStrtTi;
  PimCodFlsDummyRead1 = *TSC_CDD_FlsMem_Rte_Pim_CodFlsDummyRead1();
  *TSC_CDD_FlsMem_Rte_Pim_CodFlsDummyRead1() = PimCodFlsDummyRead1;
  PimCodFlsDummyRead2 = *TSC_CDD_FlsMem_Rte_Pim_CodFlsDummyRead2();
  *TSC_CDD_FlsMem_Rte_Pim_CodFlsDummyRead2() = PimCodFlsDummyRead2;
  PimCodFlsDummyRead3 = *TSC_CDD_FlsMem_Rte_Pim_CodFlsDummyRead3();
  *TSC_CDD_FlsMem_Rte_Pim_CodFlsDummyRead3() = PimCodFlsDummyRead3;
  PimCodFlsDummyRead4 = *TSC_CDD_FlsMem_Rte_Pim_CodFlsDummyRead4();
  *TSC_CDD_FlsMem_Rte_Pim_CodFlsDummyRead4() = PimCodFlsDummyRead4;
  PimCrcHwIdxKey = *TSC_CDD_FlsMem_Rte_Pim_CrcHwIdxKey();
  *TSC_CDD_FlsMem_Rte_Pim_CrcHwIdxKey() = PimCrcHwIdxKey;
  PimCodFlsSngBitErr = *TSC_CDD_FlsMem_Rte_Pim_CodFlsSngBitErr();
  *TSC_CDD_FlsMem_Rte_Pim_CodFlsSngBitErr() = PimCodFlsSngBitErr;
  PimCrcChkCmpl = *TSC_CDD_FlsMem_Rte_Pim_CrcChkCmpl();
  *TSC_CDD_FlsMem_Rte_Pim_CrcChkCmpl() = PimCrcChkCmpl;
  PimPwrOnRstCrcChkCmpl = *TSC_CDD_FlsMem_Rte_Pim_PwrOnRstCrcChkCmpl();
  *TSC_CDD_FlsMem_Rte_Pim_PwrOnRstCrcChkCmpl() = PimPwrOnRstCrcChkCmpl;

  fct_status = TSC_CDD_FlsMem_Rte_Write_SwApplCrc_Val(Rte_InitValue_SwApplCrc_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  uint32 Call_ResvCrcHwUnit_Oper_CrcHwInRegAdr_Arg = 0U;
  uint32 Call_ResvCrcHwUnit_Oper_CrcHwOutRegAdr_Arg = 0U;
  uint32 Call_ResvCrcHwUnit_Oper_ResvKey_Arg = 0U;
  ...
  *TSC_CDD_FlsMem_Rte_Pim_PwrOnRstCrcChkCmpl() = PimPwrOnRstCrcChkCmpl;
  ...
  fct_status = TSC_CDD_FlsMem_Rte_Write_CodFlsCrcChkCmpl_Logl(Rte_InitValue_CodFlsCrcChkCmpl_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_FlsMem_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_FlsMem_Rte_Call_ResvCrcHwUnit_Oper(0U, 0U, &Call_ResvCrcHwUnit_Oper_CrcHwInRegAdr_Arg, &Call_ResvCrcHwUnit_Oper_CrcHwOutRegAdr_Arg, 0U, &Call_ResvCrcHwUnit_Oper_ResvKey_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_ResvCrcHwUnit_PortIf2_E_NOT_OK:
      fct_error = 1;
      break;
  }

  fct_status = TSC_CDD_FlsMem_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
