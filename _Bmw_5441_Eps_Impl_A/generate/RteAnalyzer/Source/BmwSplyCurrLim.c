...
static void BmwSplyCurrLim_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  float32 PimBmwMaxCurrLimGrdt;
  float32 PimSplyCurrLimGrdt;
  float32 PimVltgDptCurrLimGrdt;
  float32 PimdBmwSplyCurrLimBmwMaxCurrLim;
  float32 PimdBmwSplyCurrLimCurrLim;
  float32 PimdBmwSplyCurrLimCurrLimPrel;
  float32 PimdBmwSplyCurrLimGlbLim;
  float32 PimdBmwSplyCurrLimSplyCurrLim;
  float32 PimdBmwSplyCurrLimVehSpdDptCurrLim;
  float32 PimdBmwSplyCurrLimVltgDptCurrLim;

  float32 BmwSplyCurrLimBmwMaxCurrLimMax_Val_data;
  float32 BmwSplyCurrLimBmwMaxCurrLimMin_Val_data;
  float32 BmwSplyCurrLimBmwMaxCurrLimrGrdt_Val_data;
  float32 BmwSplyCurrLimEpsCpbyOffs_Val_data;
  float32 BmwSplyCurrLimEpsMaxGrdt_Val_data;
  float32 BmwSplyCurrLimEpsMinGrdt_Val_data;
  float32 BmwSplyCurrLimMaxCurrLim_Val_data;
  float32 BmwSplyCurrLimRemCtrlPrkgLim_Val_data;
  float32 BmwSplyCurrLimVltgDptCurrLimFltThd_Val_data;
  float32 BmwSplyCurrLimVrntMaxCurr_Val_data;
  Ary1D_u6p10_8 BmwSplyCurrLimDegradedVltgMaxCurrX_Ary1D_data;
  Ary1D_u8p8_8 BmwSplyCurrLimDegradedVltgMaxCurrY_Ary1D_data;
  Ary1D_u6p10_8 BmwSplyCurrLimNormVltgMaxCurrX_Ary1D_data;
  Ary1D_u8p8_8 BmwSplyCurrLimNormVltgMaxCurrY_Ary1D_data;
  Ary1D_u9p7_6 BmwSplyCurrLimVehSpdDptCurrLimX_Ary1D_data;
  Ary1D_u8p8_6 BmwSplyCurrLimVehSpdDptCurrLimY_Ary1D_data;
  Ary1D_u6p10_8 BmwSplyCurrLimVltgDptCurrGrdtDecX_Ary1D_data;
  Ary1D_u16p0_8 BmwSplyCurrLimVltgDptCurrGrdtDecY_Ary1D_data;
  Ary1D_u6p10_8 BmwSplyCurrLimVltgDptCurrGrdtIncX_Ary1D_data;
  Ary1D_u16p0_8 BmwSplyCurrLimVltgDptCurrGrdtIncY_Ary1D_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimBmwMaxCurrLimGrdt = *TSC_BmwSplyCurrLim_Rte_Pim_BmwMaxCurrLimGrdt();
  *TSC_BmwSplyCurrLim_Rte_Pim_BmwMaxCurrLimGrdt() = PimBmwMaxCurrLimGrdt;
  PimSplyCurrLimGrdt = *TSC_BmwSplyCurrLim_Rte_Pim_SplyCurrLimGrdt();
  *TSC_BmwSplyCurrLim_Rte_Pim_SplyCurrLimGrdt() = PimSplyCurrLimGrdt;
  PimVltgDptCurrLimGrdt = *TSC_BmwSplyCurrLim_Rte_Pim_VltgDptCurrLimGrdt();
  *TSC_BmwSplyCurrLim_Rte_Pim_VltgDptCurrLimGrdt() = PimVltgDptCurrLimGrdt;
  PimdBmwSplyCurrLimBmwMaxCurrLim = *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimBmwMaxCurrLim();
  *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimBmwMaxCurrLim() = PimdBmwSplyCurrLimBmwMaxCurrLim;
  PimdBmwSplyCurrLimCurrLim = *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimCurrLim();
  *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimCurrLim() = PimdBmwSplyCurrLimCurrLim;
  PimdBmwSplyCurrLimCurrLimPrel = *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimCurrLimPrel();
  *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimCurrLimPrel() = PimdBmwSplyCurrLimCurrLimPrel;
  PimdBmwSplyCurrLimGlbLim = *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimGlbLim();
  *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimGlbLim() = PimdBmwSplyCurrLimGlbLim;
  PimdBmwSplyCurrLimSplyCurrLim = *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimSplyCurrLim();
  *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimSplyCurrLim() = PimdBmwSplyCurrLimSplyCurrLim;
  PimdBmwSplyCurrLimVehSpdDptCurrLim = *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimVehSpdDptCurrLim();
  *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimVehSpdDptCurrLim() = PimdBmwSplyCurrLimVehSpdDptCurrLim;
  PimdBmwSplyCurrLimVltgDptCurrLim = *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimVltgDptCurrLim();
  *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimVltgDptCurrLim() = PimdBmwSplyCurrLimVltgDptCurrLim;

  BmwSplyCurrLimBmwMaxCurrLimMax_Val_data = TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimBmwMaxCurrLimMax_Val();
  BmwSplyCurrLimBmwMaxCurrLimMin_Val_data = TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimBmwMaxCurrLimMin_Val();
  BmwSplyCurrLimBmwMaxCurrLimrGrdt_Val_data = TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimBmwMaxCurrLimrGrdt_Val();
  BmwSplyCurrLimEpsCpbyOffs_Val_data = TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimEpsCpbyOffs_Val();
  BmwSplyCurrLimEpsMaxGrdt_Val_data = TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimEpsMaxGrdt_Val();
  BmwSplyCurrLimEpsMinGrdt_Val_data = TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimEpsMinGrdt_Val();
  BmwSplyCurrLimMaxCurrLim_Val_data = TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimMaxCurrLim_Val();
  BmwSplyCurrLimRemCtrlPrkgLim_Val_data = TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimRemCtrlPrkgLim_Val();
  BmwSplyCurrLimVltgDptCurrLimFltThd_Val_data = TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimVltgDptCurrLimFltThd_Val();
  BmwSplyCurrLimVrntMaxCurr_Val_data = TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimVrntMaxCurr_Val();
  (void)memcpy(BmwSplyCurrLimDegradedVltgMaxCurrX_Ary1D_data, TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimDegradedVltgMaxCurrX_Ary1D(), sizeof(Ary1D_u6p10_8));
  (void)memcpy(BmwSplyCurrLimDegradedVltgMaxCurrY_Ary1D_data, TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimDegradedVltgMaxCurrY_Ary1D(), sizeof(Ary1D_u8p8_8));
  (void)memcpy(BmwSplyCurrLimNormVltgMaxCurrX_Ary1D_data, TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimNormVltgMaxCurrX_Ary1D(), sizeof(Ary1D_u6p10_8));
  (void)memcpy(BmwSplyCurrLimNormVltgMaxCurrY_Ary1D_data, TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimNormVltgMaxCurrY_Ary1D(), sizeof(Ary1D_u8p8_8));
  (void)memcpy(BmwSplyCurrLimVehSpdDptCurrLimX_Ary1D_data, TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimVehSpdDptCurrLimX_Ary1D(), sizeof(Ary1D_u9p7_6));
  (void)memcpy(BmwSplyCurrLimVehSpdDptCurrLimY_Ary1D_data, TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimVehSpdDptCurrLimY_Ary1D(), sizeof(Ary1D_u8p8_6));
  (void)memcpy(BmwSplyCurrLimVltgDptCurrGrdtDecX_Ary1D_data, TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimVltgDptCurrGrdtDecX_Ary1D(), sizeof(Ary1D_u6p10_8));
  (void)memcpy(BmwSplyCurrLimVltgDptCurrGrdtDecY_Ary1D_data, TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimVltgDptCurrGrdtDecY_Ary1D(), sizeof(Ary1D_u16p0_8));
  (void)memcpy(BmwSplyCurrLimVltgDptCurrGrdtIncX_Ary1D_data, TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimVltgDptCurrGrdtIncX_Ary1D(), sizeof(Ary1D_u6p10_8));
  (void)memcpy(BmwSplyCurrLimVltgDptCurrGrdtIncY_Ary1D_data, TSC_BmwSplyCurrLim_Rte_Prm_BmwSplyCurrLimVltgDptCurrGrdtIncY_Ary1D(), sizeof(Ary1D_u16p0_8));

  BmwSplyCurrLim_TestDefines();
 ...
 *********************************************************************************************************************/
  ...
  float32 Read_BmwMaxCurrLimr_Val;
  BmwMaxCurrLimrSts1 Read_BmwMaxCurrLimrSts_Val;
  float32 Read_BmwStrtStopLim_Val;
  boolean Read_BmwStrtStopMsgActv_Logl;
  float32 Read_BrdgVltg_Val;
  float32 Read_MaxCurrAtHiSpd_Val;
  float32 Read_MaxCurrAtLoSpd_Val;
  boolean Read_RemCtrlPrkgEna_Logl;
  ...
  *TSC_BmwSplyCurrLim_Rte_Pim_dBmwSplyCurrLimVltgDptCurrLim() = PimdBmwSplyCurrLimVltgDptCurrLim;
  ...
  fct_status = TSC_BmwSplyCurrLim_Rte_Read_BmwMaxCurrLimr_Val(&Read_BmwMaxCurrLimr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwSplyCurrLim_Rte_Read_BmwMaxCurrLimrSts_Val(&Read_BmwMaxCurrLimrSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwSplyCurrLim_Rte_Read_BmwStrtStopLim_Val(&Read_BmwStrtStopLim_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwSplyCurrLim_Rte_Read_BmwStrtStopMsgActv_Logl(&Read_BmwStrtStopMsgActv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwSplyCurrLim_Rte_Read_BrdgVltg_Val(&Read_BrdgVltg_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwSplyCurrLim_Rte_Read_MaxCurrAtHiSpd_Val(&Read_MaxCurrAtHiSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwSplyCurrLim_Rte_Read_MaxCurrAtLoSpd_Val(&Read_MaxCurrAtLoSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwSplyCurrLim_Rte_Read_RemCtrlPrkgEna_Logl(&Read_RemCtrlPrkgEna_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwSplyCurrLim_Rte_Read_SysMotTqCmdSca_Val(&Read_SysMotTqCmdSca_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwSplyCurrLim_Rte_Read_VehSpd_Val(&Read_VehSpd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwSplyCurrLim_Rte_Write_SplyCurrLim_Val(Rte_InitValue_SplyCurrLim_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwSplyCurrLim_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
