...
static void BmwMsgSlot108Bas0Repn2BusFrChA_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  float32 PimBmwPinionAgOffsPrev;
  uint8 PimAvlSteaPniOffsFaildCnt;
  uint8 PimAvlSteaPniOffsPassdCnt;
  ...
  *************************************************/
  ...
  PimBmwPinionAgOffsPrev = *TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Pim_BmwPinionAgOffsPrev();
  *TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Pim_BmwPinionAgOffsPrev() = PimBmwPinionAgOffsPrev;
  PimAvlSteaPniOffsFaildCnt = *TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Pim_AvlSteaPniOffsFaildCnt();
  *TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Pim_AvlSteaPniOffsFaildCnt() = PimAvlSteaPniOffsFaildCnt;
  PimAvlSteaPniOffsPassdCnt = *TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Pim_AvlSteaPniOffsPassdCnt();
  *TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Pim_AvlSteaPniOffsPassdCnt() = PimAvlSteaPniOffsPassdCnt;
  PimMissingMsgCnt = *TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Pim_MissingMsgCnt();
  *TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Pim_MissingMsgCnt() = PimMissingMsgCnt;
  PimRxMsgCnt = *TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Pim_RxMsgCnt();
  *TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Pim_RxMsgCnt() = PimRxMsgCnt;

  BmwMsgSlot108Bas0Repn2BusFrChABmwSteerPolarity_Val_data = TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Prm_BmwMsgSlot108Bas0Repn2BusFrChABmwSteerPolarity_Val();

  fct_status = TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  BmwMsgSlot108Bas0Repn2BusFrChA_TestDefines();
 ...
 *********************************************************************************************************************/
  ...
  *TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Pim_RxMsgCnt() = PimRxMsgCnt;
  ...
  fct_status = TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Read_FltCodEnad_Logl(&Read_FltCodEnad_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Write_BmwPinionAgOffs_Val(Rte_InitValue_BmwPinionAgOffs_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Write_BmwPinionAgOffsSts_Val(Rte_InitValue_BmwPinionAgOffsSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *   Std_ReturnType Rte_Read_FltCodEnad_Logl(boolean *data)
 *   boolean Rte_IsUpdated_AVL_STEA_PNI_OFFS_AVL_STEA_PNI_OFFS(void)
 *
 * Output Interfaces:
 * ==================
 *   Explicit S/R API:
 ...
 *********************************************************************************************************************/
  ...
  AVL_STEA_PNI_OFFS1 Read_AVL_STEA_PNI_OFFS_AVL_STEA_PNI_OFFS;
  boolean IsUpdated_AVL_STEA_PNI_OFFS_AVL_STEA_PNI_OFFS;
  boolean Read_FltCodEnad_Logl;
  ...
  *TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Pim_RxMsgCnt() = PimRxMsgCnt;
  ...
  IsUpdated_AVL_STEA_PNI_OFFS_AVL_STEA_PNI_OFFS = TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_IsUpdated_AVL_STEA_PNI_OFFS_AVL_STEA_PNI_OFFS();

  fct_status = TSC_BmwMsgSlot108Bas0Repn2BusFrChA_Rte_Read_AVL_STEA_PNI_OFFS_AVL_STEA_PNI_OFFS(&Read_AVL_STEA_PNI_OFFS_AVL_STEA_PNI_OFFS);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
static void BmwMsgSlot108Bas0Repn2BusFrChA_TestDefines(void)
{
  ...
  AVL_STEA_PNI_OFFS1 Test_AVL_STEA_PNI_OFFS1_IV_1 = InvalidValue_AVL_STEA_PNI_OFFS1;
  AVL_STEA_PNI_OFFS1 Test_AVL_STEA_PNI_OFFS1_V_1 = AVL_STEA_PNI_OFFS_Funktionsschnittstelle_ist_nicht_verfuegbar;
  AVL_STEA_PNI_OFFS1 Test_AVL_STEA_PNI_OFFS1_V_2 = AVL_STEA_PNI_OFFS_Funktion_meldet_Fehler;
  AVL_STEA_PNI_OFFS1 Test_AVL_STEA_PNI_OFFS1_V_3 = AVL_STEA_PNI_OFFS_Signal_unbefuellt;
