...
static void CDD_BattRtnCurr_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  float32 PimdBattRtnCurrBfrSatn;
  FilLpRec1 PimBattCurrEstimDifLpFil;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimdBattRtnCurrBfrSatn = *TSC_CDD_BattRtnCurr_Rte_Pim_dBattRtnCurrBfrSatn();
  *TSC_CDD_BattRtnCurr_Rte_Pim_dBattRtnCurrBfrSatn() = PimdBattRtnCurrBfrSatn;
  PimBattCurrEstimDifLpFil = *TSC_CDD_BattRtnCurr_Rte_Pim_BattCurrEstimDifLpFil();
  *TSC_CDD_BattRtnCurr_Rte_Pim_BattCurrEstimDifLpFil() = PimBattCurrEstimDifLpFil;

  CDD_BattRtnCurr_TestDefines();
 ...
 *********************************************************************************************************************/
  ...
  float32 Read_BattRtnCurrAdc_Val;
  boolean Read_BattRtnCurrAdcFaild_Logl;
  float32 Read_SplyCurrEstim_Val;
  SysSt1 Read_SysSt_Val;

  float32 PimdBattRtnCurrBfrSatn;
  FilLpRec1 PimBattCurrEstimDifLpFil;

  uint32 Call_CnvSnpshtData_f32_Oper_SnpshtDataCnvd_Arg = 0U;
  uint32 Call_CnvSnpshtData_u08_Oper_SnpshtDataCnvd_Arg = 0U;
  ...
  *TSC_CDD_BattRtnCurr_Rte_Pim_BattCurrEstimDifLpFil() = PimBattCurrEstimDifLpFil;
  ...
  fct_status = TSC_CDD_BattRtnCurr_Rte_Read_BattRtnCurrAdc_Val(&Read_BattRtnCurrAdc_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_BattRtnCurr_Rte_Read_BattRtnCurrAdcFaild_Logl(&Read_BattRtnCurrAdcFaild_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_BattRtnCurr_Rte_Read_SplyCurrEstim_Val(&Read_SplyCurrEstim_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_BattRtnCurr_Rte_Read_SysSt_Val(&Read_SysSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_BattRtnCurr_Rte_Write_BattRtnCurrAmpr_Val(Rte_InitValue_BattRtnCurrAmpr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_BattRtnCurr_Rte_Write_BattRtnCurrStsQlfr_Val(Rte_InitValue_BattRtnCurrStsQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_BattRtnCurr_Rte_Call_CnvSnpshtData_f32_Oper(&Call_CnvSnpshtData_f32_Oper_SnpshtDataCnvd_Arg, 0.0F);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_BattRtnCurr_Rte_Call_CnvSnpshtData_u08_Oper(&Call_CnvSnpshtData_u08_Oper_SnpshtDataCnvd_Arg, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_BattRtnCurr_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_BattRtnCurr_Rte_Call_SetNtcStsAndSnpshtData_Oper(0U, 0U, 0U, 0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
