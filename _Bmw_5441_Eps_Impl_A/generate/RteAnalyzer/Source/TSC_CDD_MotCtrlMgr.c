...
{
  return Rte_Call_DmaWaitForMotCtrlTo2MilliSecTrf_Oper();
}
...
{
  return Rte_Read_AdcDiagcEndPtrOutp_Val(data);
}

Std_ReturnType TSC_CDD_MotCtrlMgr_Rte_Read_AdcDiagcStrtPtrOutp_Val(uint8 *data)
{
  return Rte_Read_AdcDiagcStrtPtrOutp_Val(data);
}
...
{
  return Rte_Read_CurrMeasCorrlnSts_Val(data);
}
...
{
  return Rte_Read_MotCurrDaxMax_Val(data);
}
...
{
  return Rte_Read_MotDampgDax_Val(data);
}

Std_ReturnType TSC_CDD_MotCtrlMgr_Rte_Read_MotDampgQax_Val(float32 *data)
{
  return Rte_Read_MotDampgQax_Val(data);
}
...
{
  return Rte_Read_MotReacncDax_Val(data);
}

Std_ReturnType TSC_CDD_MotCtrlMgr_Rte_Read_MotReacncQax_Val(float32 *data)
{
  return Rte_Read_MotReacncQax_Val(data);
}
...
{
  return Rte_Call_DmaEna2MilliSecToMotCtrlTrf_Oper();
}
