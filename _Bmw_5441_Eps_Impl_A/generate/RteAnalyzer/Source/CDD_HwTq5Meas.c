...
static void CDD_HwTq5Meas_TestDefines(void);
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_HwTq5Offs_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 ...
 *********************************************************************************************************************/
  ...
  float32 PimHwTq5PrevHwTq5;
  uint8 PimHwTq5PrevRollgCntr;
  uint8 PimHwTq5RawFastAdcIdxCntr;
  HwTqOffsRec1 PimHwTq5Offs;
  AnHwTqScaFacRec1 PimHwTq5Sca;

  float32 HwTq5MeasHwTqRngHiLim_Val_data;
  float32 HwTq5MeasHwTqRngLoLim_Val_data;
  uint16 HwTq5MeasHwTq5PrtclFltFailStep_Val_data;
  uint16 HwTq5MeasHwTq5PrtclFltPassStep_Val_data;
  boolean HwTq5MeasMovgAvrgFilEna_Logl_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimHwTq5PrevHwTq5 = *TSC_CDD_HwTq5Meas_Rte_Pim_HwTq5PrevHwTq5();
  *TSC_CDD_HwTq5Meas_Rte_Pim_HwTq5PrevHwTq5() = PimHwTq5PrevHwTq5;
  PimHwTq5PrevRollgCntr = *TSC_CDD_HwTq5Meas_Rte_Pim_HwTq5PrevRollgCntr();
  *TSC_CDD_HwTq5Meas_Rte_Pim_HwTq5PrevRollgCntr() = PimHwTq5PrevRollgCntr;
  PimHwTq5RawFastAdcIdxCntr = *TSC_CDD_HwTq5Meas_Rte_Pim_HwTq5RawFastAdcIdxCntr();
  *TSC_CDD_HwTq5Meas_Rte_Pim_HwTq5RawFastAdcIdxCntr() = PimHwTq5RawFastAdcIdxCntr;
  PimHwTq5Offs = *TSC_CDD_HwTq5Meas_Rte_Pim_HwTq5Offs();
  *TSC_CDD_HwTq5Meas_Rte_Pim_HwTq5Offs() = PimHwTq5Offs;
  PimHwTq5Sca = *TSC_CDD_HwTq5Meas_Rte_Pim_HwTq5Sca();
  *TSC_CDD_HwTq5Meas_Rte_Pim_HwTq5Sca() = PimHwTq5Sca;

  HwTq5MeasHwTqRngHiLim_Val_data = TSC_CDD_HwTq5Meas_Rte_Prm_HwTq5MeasHwTqRngHiLim_Val();
  HwTq5MeasHwTqRngLoLim_Val_data = TSC_CDD_HwTq5Meas_Rte_Prm_HwTq5MeasHwTqRngLoLim_Val();
  HwTq5MeasHwTq5PrtclFltFailStep_Val_data = TSC_CDD_HwTq5Meas_Rte_Prm_HwTq5MeasHwTq5PrtclFltFailStep_Val();
  HwTq5MeasHwTq5PrtclFltPassStep_Val_data = TSC_CDD_HwTq5Meas_Rte_Prm_HwTq5MeasHwTq5PrtclFltPassStep_Val();
  HwTq5MeasMovgAvrgFilEna_Logl_data = TSC_CDD_HwTq5Meas_Rte_Prm_HwTq5MeasMovgAvrgFilEna_Logl();

  fct_status = TSC_CDD_HwTq5Meas_Rte_Call_HwTq5Offs_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_HwTq5Sca_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
 *
 **********************************************************************************************************************
 ...
 *********************************************************************************************************************/
  ...
  *TSC_CDD_HwTq5Meas_Rte_Pim_HwTq5Sca() = PimHwTq5Sca;
  ...
  fct_status = TSC_CDD_HwTq5Meas_Rte_Call_HwTq5Sca_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_HwTq5Offs_GetErrorStatus(NvM_RequestResultType *ErrorStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
 *   Std_ReturnType Rte_Call_HwTq5Sca_GetErrorStatus(NvM_RequestResultType *ErrorStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
 *
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  NvM_RequestResultType Call_HwTq5Offs_GetErrorStatus_ErrorStatus_Arg = 0U;
  NvM_RequestResultType Call_HwTq5Sca_GetErrorStatus_ErrorStatus_Arg = 0U;
  ...
  *TSC_CDD_HwTq5Meas_Rte_Pim_HwTq5Sca() = PimHwTq5Sca;
  ...
  fct_status = TSC_CDD_HwTq5Meas_Rte_Call_HwTq5Offs_GetErrorStatus(&Call_HwTq5Offs_GetErrorStatus_ErrorStatus_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq5Meas_Rte_Call_HwTq5Sca_GetErrorStatus(&Call_HwTq5Sca_GetErrorStatus_ErrorStatus_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  sint8 Read_HwTq5Polarity_Val;
  float32 Read_HwTq5RawAdc_Val;
  boolean Read_HwTq5RawAdcAdcFaild_Logl;
  boolean Read_HwTq5RawFastAdcAdcFaild_Logl;
  Ary1D_f32_8 Read_HwTq5RawFastAdcBuf_Ary1D;
  ...
  *TSC_CDD_HwTq5Meas_Rte_Pim_HwTq5Sca() = PimHwTq5Sca;
  ...
  fct_status = TSC_CDD_HwTq5Meas_Rte_Read_HwTq5Polarity_Val(&Read_HwTq5Polarity_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq5Meas_Rte_Read_HwTq5RawAdc_Val(&Read_HwTq5RawAdc_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq5Meas_Rte_Read_HwTq5RawAdcAdcFaild_Logl(&Read_HwTq5RawAdcAdcFaild_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq5Meas_Rte_Read_HwTq5RawFastAdcAdcFaild_Logl(&Read_HwTq5RawFastAdcAdcFaild_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq5Meas_Rte_Read_HwTq5RawFastAdcBuf_Ary1D(Read_HwTq5RawFastAdcBuf_Ary1D);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq5Meas_Rte_Write_HwTq5_Val(Rte_InitValue_HwTq5_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq5Meas_Rte_Write_HwTq5Qlfr_Val(Rte_InitValue_HwTq5Qlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq5Meas_Rte_Write_HwTq5RollgCntr_Val(Rte_InitValue_HwTq5RollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq5Meas_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq5Meas_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
