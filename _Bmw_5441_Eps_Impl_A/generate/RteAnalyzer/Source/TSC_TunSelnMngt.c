...
{
  return Rte_Read_DesIninOptSetAIdx_Val(data);
}
...
{
  return Rte_Write_ActvIninOptSetAIdx_Val(data);
}
...
{
  return Rte_Write_RtIdxChgSts_Val(data);
}
...
{
  return Rte_Pim_PrevActvIninOptSetAIdx();
}
...
{
  return Rte_Pim_PrevRtIdxChgSts();
}
