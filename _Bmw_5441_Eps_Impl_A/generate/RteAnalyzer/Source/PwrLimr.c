...
static void PwrLimr_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  float32 PimBrdgVltgRateLim;
  float32 PimOutpVelOffsRateLimd;
  float32 PimdPwrLimrFildMotVel;
  float32 PimdPwrLimrLimDif;
  float32 PimdPwrLimrMinStdOperLim;
  float32 PimdPwrLimrMotEnvlpSpd;
  float32 PimdPwrLimrMotTqCmdIvtrLoaSca;
  float32 PimdPwrLimrOutpVelOffs;
  float32 PimdPwrLimrSpdAdj;
  float32 PimdPwrLimrSplyCurrLimOffs;
  float32 PimdPwrLimrTLimMaxCurr;
  float32 PimdPwrLimrTqEnvlpLim1;
  float32 PimdPwrLimrTqEnvlpLim4;
  float32 PimdPwrLimrTqLim;
  float32 PimdPwrLimrTqLim1;
  float32 PimdPwrLimrTqLim4;
  uint32 PimRefTmr;
  uint32 PimRefTmrPrev;
  boolean PimLimdAssiLoVltgPrev;
  FilLpRec1 PimMotVelLpFil;
  FilLpRec1 PimTqLimLpFil;
  ...
  Ary1D_u12p4_10 PwrLimrSplyCurrLimTblX_Ary1D_data;
  Ary1D_u11p5_10 PwrLimrSplyCurrLimTblY_Ary1D_data;
  ...
  *************************************************/
  ...
  PimBrdgVltgRateLim = *TSC_PwrLimr_Rte_Pim_BrdgVltgRateLim();
  *TSC_PwrLimr_Rte_Pim_BrdgVltgRateLim() = PimBrdgVltgRateLim;
  PimOutpVelOffsRateLimd = *TSC_PwrLimr_Rte_Pim_OutpVelOffsRateLimd();
  *TSC_PwrLimr_Rte_Pim_OutpVelOffsRateLimd() = PimOutpVelOffsRateLimd;
  PimdPwrLimrFildMotVel = *TSC_PwrLimr_Rte_Pim_dPwrLimrFildMotVel();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrFildMotVel() = PimdPwrLimrFildMotVel;
  PimdPwrLimrLimDif = *TSC_PwrLimr_Rte_Pim_dPwrLimrLimDif();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrLimDif() = PimdPwrLimrLimDif;
  PimdPwrLimrMinStdOperLim = *TSC_PwrLimr_Rte_Pim_dPwrLimrMinStdOperLim();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrMinStdOperLim() = PimdPwrLimrMinStdOperLim;
  PimdPwrLimrMotEnvlpSpd = *TSC_PwrLimr_Rte_Pim_dPwrLimrMotEnvlpSpd();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrMotEnvlpSpd() = PimdPwrLimrMotEnvlpSpd;
  PimdPwrLimrMotTqCmdIvtrLoaSca = *TSC_PwrLimr_Rte_Pim_dPwrLimrMotTqCmdIvtrLoaSca();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrMotTqCmdIvtrLoaSca() = PimdPwrLimrMotTqCmdIvtrLoaSca;
  PimdPwrLimrOutpVelOffs = *TSC_PwrLimr_Rte_Pim_dPwrLimrOutpVelOffs();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrOutpVelOffs() = PimdPwrLimrOutpVelOffs;
  PimdPwrLimrSpdAdj = *TSC_PwrLimr_Rte_Pim_dPwrLimrSpdAdj();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrSpdAdj() = PimdPwrLimrSpdAdj;
  PimdPwrLimrSplyCurrLimOffs = *TSC_PwrLimr_Rte_Pim_dPwrLimrSplyCurrLimOffs();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrSplyCurrLimOffs() = PimdPwrLimrSplyCurrLimOffs;
  PimdPwrLimrTLimMaxCurr = *TSC_PwrLimr_Rte_Pim_dPwrLimrTLimMaxCurr();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrTLimMaxCurr() = PimdPwrLimrTLimMaxCurr;
  PimdPwrLimrTqEnvlpLim1 = *TSC_PwrLimr_Rte_Pim_dPwrLimrTqEnvlpLim1();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrTqEnvlpLim1() = PimdPwrLimrTqEnvlpLim1;
  PimdPwrLimrTqEnvlpLim4 = *TSC_PwrLimr_Rte_Pim_dPwrLimrTqEnvlpLim4();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrTqEnvlpLim4() = PimdPwrLimrTqEnvlpLim4;
  PimdPwrLimrTqLim = *TSC_PwrLimr_Rte_Pim_dPwrLimrTqLim();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrTqLim() = PimdPwrLimrTqLim;
  PimdPwrLimrTqLim1 = *TSC_PwrLimr_Rte_Pim_dPwrLimrTqLim1();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrTqLim1() = PimdPwrLimrTqLim1;
  PimdPwrLimrTqLim4 = *TSC_PwrLimr_Rte_Pim_dPwrLimrTqLim4();
  *TSC_PwrLimr_Rte_Pim_dPwrLimrTqLim4() = PimdPwrLimrTqLim4;
  PimRefTmr = *TSC_PwrLimr_Rte_Pim_RefTmr();
  *TSC_PwrLimr_Rte_Pim_RefTmr() = PimRefTmr;
  PimRefTmrPrev = *TSC_PwrLimr_Rte_Pim_RefTmrPrev();
  *TSC_PwrLimr_Rte_Pim_RefTmrPrev() = PimRefTmrPrev;
  PimLimdAssiLoVltgPrev = *TSC_PwrLimr_Rte_Pim_LimdAssiLoVltgPrev();
  *TSC_PwrLimr_Rte_Pim_LimdAssiLoVltgPrev() = PimLimdAssiLoVltgPrev;
  PimMotVelLpFil = *TSC_PwrLimr_Rte_Pim_MotVelLpFil();
  *TSC_PwrLimr_Rte_Pim_MotVelLpFil() = PimMotVelLpFil;
  PimTqLimLpFil = *TSC_PwrLimr_Rte_Pim_TqLimLpFil();
  *TSC_PwrLimr_Rte_Pim_TqLimLpFil() = PimTqLimLpFil;

  PwrLimrAssiRednLpFilFrq_Val_data = TSC_PwrLimr_Rte_Prm_PwrLimrAssiRednLpFilFrq_Val();
  PwrLimrBackEmfConStdT_Val_data = TSC_PwrLimr_Rte_Prm_PwrLimrBackEmfConStdT_Val();
  PwrLimrBrdgVltgAdjSlew_Val_data = TSC_PwrLimr_Rte_Prm_PwrLimrBrdgVltgAdjSlew_Val();
  PwrLimrBrdgVltgAltFltAdj_Val_data = TSC_PwrLimr_Rte_Prm_PwrLimrBrdgVltgAltFltAdj_Val();
  PwrLimrFilAssiRednThd_Val_data = TSC_PwrLimr_Rte_Prm_PwrLimrFilAssiRednThd_Val();
  PwrLimrLoVoltAssiRcvrThd_Val_data = TSC_PwrLimr_Rte_Prm_PwrLimrLoVoltAssiRcvrThd_Val();
  PwrLimrMotVelLpFilFrq_Val_data = TSC_PwrLimr_Rte_Prm_PwrLimrMotVelLpFilFrq_Val();
  PwrLimrSpdAdjSlewDec_Val_data = TSC_PwrLimr_Rte_Prm_PwrLimrSpdAdjSlewDec_Val();
  PwrLimrSpdAdjSlewInc_Val_data = TSC_PwrLimr_Rte_Prm_PwrLimrSpdAdjSlewInc_Val();
  PwrLimrLoVoltAssiRcvrTi_Val_data = TSC_PwrLimr_Rte_Prm_PwrLimrLoVoltAssiRcvrTi_Val();
  PwrLimrSpdAdjSlewEna_Logl_data = TSC_PwrLimr_Rte_Prm_PwrLimrSpdAdjSlewEna_Logl();
  (void)memcpy(PwrLimrMotEnvlpX_Ary1D_data, TSC_PwrLimr_Rte_Prm_PwrLimrMotEnvlpX_Ary1D(), sizeof(Ary1D_s11p4_14));
  (void)memcpy(PwrLimrMotEnvlpY_Ary1D_data, TSC_PwrLimr_Rte_Prm_PwrLimrMotEnvlpY_Ary1D(), sizeof(Ary1D_u5p11_14));
  (void)memcpy(PwrLimrSplyCurrLimTblX_Ary1D_data, TSC_PwrLimr_Rte_Prm_PwrLimrSplyCurrLimTblX_Ary1D(), sizeof(Ary1D_u12p4_10));
  (void)memcpy(PwrLimrSplyCurrLimTblY_Ary1D_data, TSC_PwrLimr_Rte_Prm_PwrLimrSplyCurrLimTblY_Ary1D(), sizeof(Ary1D_u11p5_10));
  (void)memcpy(PwrLimrStdOperMotEnvlpX_Ary1D_data, TSC_PwrLimr_Rte_Prm_PwrLimrStdOperMotEnvlpX_Ary1D(), sizeof(Ary1D_u11p5_6));
  (void)memcpy(PwrLimrStdOperMotEnvlpY_Ary1D_data, TSC_PwrLimr_Rte_Prm_PwrLimrStdOperMotEnvlpY_Ary1D(), sizeof(Ary1D_u4p12_6));
  (void)memcpy(PwrLimrVltgDptMotVelOffsX_Ary1D_data, TSC_PwrLimr_Rte_Prm_PwrLimrVltgDptMotVelOffsX_Ary1D(), sizeof(Ary1D_u5p11_10));
  (void)memcpy(PwrLimrVltgDptMotVelOffsY_Ary1D_data, TSC_PwrLimr_Rte_Prm_PwrLimrVltgDptMotVelOffsY_Ary1D(), sizeof(Ary1D_u11p5_10));

  fct_status = TSC_PwrLimr_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  boolean Read_AltFltActv_Logl;
  float32 Read_BrdgVltg_Val;
  float32 Read_DualEcuFltMtgtnSca_Val;
  ...
  *TSC_PwrLimr_Rte_Pim_TqLimLpFil() = PimTqLimLpFil;
  ...
  fct_status = TSC_PwrLimr_Rte_Read_AltFltActv_Logl(&Read_AltFltActv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrLimr_Rte_Read_BrdgVltg_Val(&Read_BrdgVltg_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrLimr_Rte_Read_DualEcuFltMtgtnSca_Val(&Read_DualEcuFltMtgtnSca_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrLimr_Rte_Read_MotAndThermProtnLoaMod_Val(&Read_MotAndThermProtnLoaMod_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrLimr_Rte_Read_MotBackEmfConEstimd_Val(&Read_MotBackEmfConEstimd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrLimr_Rte_Read_MotTqCmdMrf_Val(&Read_MotTqCmdMrf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrLimr_Rte_Read_MotVelMrf_Val(&Read_MotVelMrf_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrLimr_Rte_Read_SplyCurrLim_Val(&Read_SplyCurrLim_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrLimr_Rte_Write_MotTqCmdPwrLimd_Val(Rte_InitValue_MotTqCmdPwrLimd_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  TSC_PwrLimr_Rte_IrvWrite_PwrLimrPer1_MinStdOperLim(0.0F);
  TSC_PwrLimr_Rte_IrvWrite_PwrLimrPer1_MotEnvlpSpd(0.0F);
  TSC_PwrLimr_Rte_IrvWrite_PwrLimrPer1_TqEnvlpLim1(0.0F);
 ...
 *********************************************************************************************************************/
  ...
  float32 PwrLimrPer2_MinStdOperLim;
  float32 PwrLimrPer2_MotEnvlpSpd;
  float32 PwrLimrPer2_TqEnvlpLim1;
  ...
  *TSC_PwrLimr_Rte_Pim_TqLimLpFil() = PimTqLimLpFil;
  ...
  fct_status = TSC_PwrLimr_Rte_Write_PwrLimrRednFac_Val(Rte_InitValue_PwrLimrRednFac_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  PwrLimrPer2_MinStdOperLim = TSC_PwrLimr_Rte_IrvRead_PwrLimrPer2_MinStdOperLim();
  PwrLimrPer2_MotEnvlpSpd = TSC_PwrLimr_Rte_IrvRead_PwrLimrPer2_MotEnvlpSpd();
  PwrLimrPer2_TqEnvlpLim1 = TSC_PwrLimr_Rte_IrvRead_PwrLimrPer2_TqEnvlpLim1();
  ...
  fct_status = TSC_PwrLimr_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrLimr_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
