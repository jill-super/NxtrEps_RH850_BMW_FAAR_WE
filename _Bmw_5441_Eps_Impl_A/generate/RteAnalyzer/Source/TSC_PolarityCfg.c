...
{
  return Rte_Call_PolarityCfgSaved_SetRamBlockStatus(RamBlockStatus_Arg);
}
...
{
  return (uint32 ) Rte_CData_PolarityCfgSavedDft();
}
...
{
  return Rte_Pim_PolarityCfgSaved();
}
