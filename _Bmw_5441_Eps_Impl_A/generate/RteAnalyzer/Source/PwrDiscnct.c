...
static void PwrDiscnct_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  boolean PimPwrDiscnctATestCmplPrev;
  ...
  *************************************************/
  ...
  PimPwrDiscnctATestCmplPrev = *TSC_PwrDiscnct_Rte_Pim_PwrDiscnctATestCmplPrev();
  *TSC_PwrDiscnct_Rte_Pim_PwrDiscnctATestCmplPrev() = PimPwrDiscnctATestCmplPrev;

  BattVltgSwdMax_Val_data = TSC_PwrDiscnct_Rte_Prm_BattVltgSwdMax_Val();

  PwrDiscnct_TestDefines();
 ...
 *********************************************************************************************************************/
  ...
  *TSC_PwrDiscnct_Rte_Pim_PwrDiscnctATestCmplPrev() = PimPwrDiscnctATestCmplPrev;
  ...
  fct_status = TSC_PwrDiscnct_Rte_Read_BattVltg_Val(&Read_BattVltg_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrDiscnct_Rte_Read_BattVltgSwd1_Val(&Read_BattVltgSwd1_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrDiscnct_Rte_Read_StrtUpSt_Val(&Read_StrtUpSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrDiscnct_Rte_Write_PwrDiscnctATestCmpl_Logl(Rte_InitValue_PwrDiscnctATestCmpl_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrDiscnct_Rte_Write_PwrDiscnctBTestCmpl_Logl(Rte_InitValue_PwrDiscnctBTestCmpl_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrDiscnct_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PwrDiscnct_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
