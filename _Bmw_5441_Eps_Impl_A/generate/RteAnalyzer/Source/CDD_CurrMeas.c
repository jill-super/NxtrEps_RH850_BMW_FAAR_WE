 ...
 *********************************************************************************************************************/
  ...
  float32 PimBrdgVltgSumPrev;
  float32 PimEolOffsHiBrdgVltg;
  float32 PimMotCurrEolGainA;
  float32 PimMotCurrEolGainB;
  float32 PimMotCurrEolGainC;
  float32 PimMotCurrOffsDeltaA;
  float32 PimMotCurrOffsDeltaB;
  float32 PimMotCurrOffsDeltaC;
  float32 PimMotCurrOffsHiAvrgA;
  float32 PimMotCurrOffsHiAvrgB;
  float32 PimMotCurrOffsHiAvrgC;
  float32 PimMotCurrOffsLoAvrgA;
  float32 PimMotCurrOffsLoAvrgB;
  float32 PimMotCurrOffsLoAvrgC;
  float32 PimMotCurrOffsZeroAvrgA;
  float32 PimMotCurrOffsZeroAvrgB;
  float32 PimMotCurrOffsZeroAvrgC;
  float32 PimMotCurrSumAPrev;
  float32 PimMotCurrSumBPrev;
  float32 PimMotCurrSumCPrev;
  float32 PimTmpMotCurrAdcVlySum1Prev;
  uint16 PimGainEolAvrgCntrPrev;
  uint16 PimMotCtrlNtc5DErrCntPrev;
  uint16 PimNtc5DErrCnt2MilliSecPrev;
  uint16 PimOffsEolAvrgCntrPrev;
  uint16 PimPhaOnTiErrCntPrev;
  uint8 PimEolGainSts;
  uint8 PimEolGainTranCntrPrev;
  uint8 PimEolOffsSts;
  uint8 PimEolOffsTranCntrPrev;
  MotCurrEolCalSt2 PimMotCurrEolCalStPrev;
  uint8 PimMotCurrRollgCnt1Prev;
  boolean PimMotCurrEolOffsProcFlg;
  boolean PimWrmIninTestCmplPrev;
  CurrMeasEolGainCal3PhaRec1 PimCurrMeasEolGainCalSetABC;
  CurrMeasEolOffsCal3PhaRec1 PimCurrMeasEolOffsCalSetABC;

  CurrMeasEolGainCal3PhaRec1 CurrMeasEolGainCalSetABCDft_data;
  CurrMeasEolOffsCal3PhaRec1 CurrMeasEolOffsCalSetABCDft_data;

  float32 CurrMeasEolGainMax_Val_data;
  float32 CurrMeasEolGainMin_Val_data;
  float32 CurrMeasEolGainNom_Val_data;
  ...
  float32 CurrMeasEolOffsNom_Val_data;
  ...
  *************************************************/
  ...
  PimBrdgVltgSumPrev = *TSC_CDD_CurrMeas_Rte_Pim_BrdgVltgSumPrev();
  *TSC_CDD_CurrMeas_Rte_Pim_BrdgVltgSumPrev() = PimBrdgVltgSumPrev;
  PimEolOffsHiBrdgVltg = *TSC_CDD_CurrMeas_Rte_Pim_EolOffsHiBrdgVltg();
  *TSC_CDD_CurrMeas_Rte_Pim_EolOffsHiBrdgVltg() = PimEolOffsHiBrdgVltg;
  PimMotCurrEolGainA = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrEolGainA();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrEolGainA() = PimMotCurrEolGainA;
  PimMotCurrEolGainB = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrEolGainB();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrEolGainB() = PimMotCurrEolGainB;
  PimMotCurrEolGainC = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrEolGainC();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrEolGainC() = PimMotCurrEolGainC;
  PimMotCurrOffsDeltaA = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsDeltaA();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsDeltaA() = PimMotCurrOffsDeltaA;
  PimMotCurrOffsDeltaB = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsDeltaB();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsDeltaB() = PimMotCurrOffsDeltaB;
  PimMotCurrOffsDeltaC = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsDeltaC();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsDeltaC() = PimMotCurrOffsDeltaC;
  PimMotCurrOffsHiAvrgA = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsHiAvrgA();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsHiAvrgA() = PimMotCurrOffsHiAvrgA;
  PimMotCurrOffsHiAvrgB = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsHiAvrgB();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsHiAvrgB() = PimMotCurrOffsHiAvrgB;
  PimMotCurrOffsHiAvrgC = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsHiAvrgC();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsHiAvrgC() = PimMotCurrOffsHiAvrgC;
  PimMotCurrOffsLoAvrgA = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsLoAvrgA();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsLoAvrgA() = PimMotCurrOffsLoAvrgA;
  PimMotCurrOffsLoAvrgB = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsLoAvrgB();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsLoAvrgB() = PimMotCurrOffsLoAvrgB;
  PimMotCurrOffsLoAvrgC = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsLoAvrgC();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsLoAvrgC() = PimMotCurrOffsLoAvrgC;
  PimMotCurrOffsZeroAvrgA = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsZeroAvrgA();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsZeroAvrgA() = PimMotCurrOffsZeroAvrgA;
  PimMotCurrOffsZeroAvrgB = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsZeroAvrgB();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsZeroAvrgB() = PimMotCurrOffsZeroAvrgB;
  PimMotCurrOffsZeroAvrgC = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsZeroAvrgC();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrOffsZeroAvrgC() = PimMotCurrOffsZeroAvrgC;
  PimMotCurrSumAPrev = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrSumAPrev();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrSumAPrev() = PimMotCurrSumAPrev;
  PimMotCurrSumBPrev = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrSumBPrev();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrSumBPrev() = PimMotCurrSumBPrev;
  PimMotCurrSumCPrev = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrSumCPrev();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrSumCPrev() = PimMotCurrSumCPrev;
  PimTmpMotCurrAdcVlySum1Prev = *TSC_CDD_CurrMeas_Rte_Pim_TmpMotCurrAdcVlySum1Prev();
  *TSC_CDD_CurrMeas_Rte_Pim_TmpMotCurrAdcVlySum1Prev() = PimTmpMotCurrAdcVlySum1Prev;
  PimGainEolAvrgCntrPrev = *TSC_CDD_CurrMeas_Rte_Pim_GainEolAvrgCntrPrev();
  *TSC_CDD_CurrMeas_Rte_Pim_GainEolAvrgCntrPrev() = PimGainEolAvrgCntrPrev;
  PimMotCtrlNtc5DErrCntPrev = *TSC_CDD_CurrMeas_Rte_Pim_MotCtrlNtc5DErrCntPrev();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCtrlNtc5DErrCntPrev() = PimMotCtrlNtc5DErrCntPrev;
  PimNtc5DErrCnt2MilliSecPrev = *TSC_CDD_CurrMeas_Rte_Pim_Ntc5DErrCnt2MilliSecPrev();
  *TSC_CDD_CurrMeas_Rte_Pim_Ntc5DErrCnt2MilliSecPrev() = PimNtc5DErrCnt2MilliSecPrev;
  PimOffsEolAvrgCntrPrev = *TSC_CDD_CurrMeas_Rte_Pim_OffsEolAvrgCntrPrev();
  *TSC_CDD_CurrMeas_Rte_Pim_OffsEolAvrgCntrPrev() = PimOffsEolAvrgCntrPrev;
  PimPhaOnTiErrCntPrev = *TSC_CDD_CurrMeas_Rte_Pim_PhaOnTiErrCntPrev();
  *TSC_CDD_CurrMeas_Rte_Pim_PhaOnTiErrCntPrev() = PimPhaOnTiErrCntPrev;
  PimEolGainSts = *TSC_CDD_CurrMeas_Rte_Pim_EolGainSts();
  *TSC_CDD_CurrMeas_Rte_Pim_EolGainSts() = PimEolGainSts;
  PimEolGainTranCntrPrev = *TSC_CDD_CurrMeas_Rte_Pim_EolGainTranCntrPrev();
  *TSC_CDD_CurrMeas_Rte_Pim_EolGainTranCntrPrev() = PimEolGainTranCntrPrev;
  PimEolOffsSts = *TSC_CDD_CurrMeas_Rte_Pim_EolOffsSts();
  *TSC_CDD_CurrMeas_Rte_Pim_EolOffsSts() = PimEolOffsSts;
  PimEolOffsTranCntrPrev = *TSC_CDD_CurrMeas_Rte_Pim_EolOffsTranCntrPrev();
  *TSC_CDD_CurrMeas_Rte_Pim_EolOffsTranCntrPrev() = PimEolOffsTranCntrPrev;
  PimMotCurrEolCalStPrev = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrEolCalStPrev();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrEolCalStPrev() = PimMotCurrEolCalStPrev;
  PimMotCurrRollgCnt1Prev = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrRollgCnt1Prev();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrRollgCnt1Prev() = PimMotCurrRollgCnt1Prev;
  PimMotCurrEolOffsProcFlg = *TSC_CDD_CurrMeas_Rte_Pim_MotCurrEolOffsProcFlg();
  *TSC_CDD_CurrMeas_Rte_Pim_MotCurrEolOffsProcFlg() = PimMotCurrEolOffsProcFlg;
  PimWrmIninTestCmplPrev = *TSC_CDD_CurrMeas_Rte_Pim_WrmIninTestCmplPrev();
  *TSC_CDD_CurrMeas_Rte_Pim_WrmIninTestCmplPrev() = PimWrmIninTestCmplPrev;
  PimCurrMeasEolGainCalSetABC = *TSC_CDD_CurrMeas_Rte_Pim_CurrMeasEolGainCalSetABC();
  *TSC_CDD_CurrMeas_Rte_Pim_CurrMeasEolGainCalSetABC() = PimCurrMeasEolGainCalSetABC;
  PimCurrMeasEolOffsCalSetABC = *TSC_CDD_CurrMeas_Rte_Pim_CurrMeasEolOffsCalSetABC();
  *TSC_CDD_CurrMeas_Rte_Pim_CurrMeasEolOffsCalSetABC() = PimCurrMeasEolOffsCalSetABC;

  CurrMeasEolGainCalSetABCDft_data = *TSC_CDD_CurrMeas_Rte_CData_CurrMeasEolGainCalSetABCDft();
  CurrMeasEolOffsCalSetABCDft_data = *TSC_CDD_CurrMeas_Rte_CData_CurrMeasEolOffsCalSetABCDft();
  ...
  CurrMeasEolGainNom_Val_data = TSC_CDD_CurrMeas_Rte_Prm_CurrMeasEolGainNom_Val();
  ...
  CurrMeasEolOffsNom_Val_data = TSC_CDD_CurrMeas_Rte_Prm_CurrMeasEolOffsNom_Val();
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_CurrMeasEolGainCalSetABC_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 ...
 *********************************************************************************************************************/
  ...
  *TSC_CDD_CurrMeas_Rte_Pim_CurrMeasEolOffsCalSetABC() = PimCurrMeasEolOffsCalSetABC;
  ...
  fct_status = TSC_CDD_CurrMeas_Rte_Call_CurrMeasEolGainCalSetABC_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_CurrMeasEolGainCalSetABC_GetErrorStatus(NvM_RequestResultType *ErrorStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_Defs_E_NOT_OK
 *   Std_ReturnType Rte_Call_CurrMeasEolOffsCalSetABC_GetErrorStatus(NvM_RequestResultType *ErrorStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_Defs_E_NOT_OK
 *
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  NvM_RequestResultType Call_CurrMeasEolGainCalSetABC_GetErrorStatus_ErrorStatus_Arg = 0U;
  NvM_RequestResultType Call_CurrMeasEolOffsCalSetABC_GetErrorStatus_ErrorStatus_Arg = 0U;
  ...
  *TSC_CDD_CurrMeas_Rte_Pim_CurrMeasEolOffsCalSetABC() = PimCurrMeasEolOffsCalSetABC;
  ...
  fct_status = TSC_CDD_CurrMeas_Rte_Call_CurrMeasEolGainCalSetABC_GetErrorStatus(&Call_CurrMeasEolGainCalSetABC_GetErrorStatus_ErrorStatus_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_CurrMeas_Rte_Call_CurrMeasEolOffsCalSetABC_GetErrorStatus(&Call_CurrMeasEolOffsCalSetABC_GetErrorStatus_ErrorStatus_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_Defs_E_NOT_OK
 *   Std_ReturnType Rte_Call_CurrMeasEolOffsCalSetABC_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_Defs_E_NOT_OK
 *
 **********************************************************************************************************************
 ...
 *********************************************************************************************************************/
  ...
  *TSC_CDD_CurrMeas_Rte_Pim_CurrMeasEolOffsCalSetABC() = PimCurrMeasEolOffsCalSetABC;
  ...
  fct_status = TSC_CDD_CurrMeas_Rte_Call_CurrMeasEolOffsCalSetABC_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
