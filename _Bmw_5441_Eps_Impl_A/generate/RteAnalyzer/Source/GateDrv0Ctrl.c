...
static void GateDrv0Ctrl_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint32 PimGateDrv0PhaOnTiSumAPrev;
  uint32 PimGateDrv0PhaOnTiSumBPrev;
  uint32 PimGateDrv0PhaOnTiSumCPrev;
  uint32 PimGateDrv0SpiTrsmErrCntr;
  uint32 PimdGateDrv0CtrlGateDrv0PhaOnTiSumAExp;
  uint32 PimdGateDrv0CtrlGateDrv0PhaOnTiSumBExp;
  uint32 PimdGateDrv0CtrlGateDrv0PhaOnTiSumCExp;
  uint16 PimGateDrv0Diag0Val;
  uint16 PimGateDrv0Diag1Val;
  uint16 PimGateDrv0Diag2Val;
  uint16 PimGateDrv0StsVal;
  uint16 PimGateDrv0VrfyRes0Val;
  uint16 PimGateDrv0VrfyRes1Val;
  uint16 PimdGateDrv0CtrlGateDrv0Diag0Val;
  uint16 PimdGateDrv0CtrlGateDrv0Diag1Val;
  uint16 PimdGateDrv0CtrlGateDrv0Diag2Val;
  uint16 PimdGateDrv0CtrlGateDrv0StsVal;
  uint16 PimdGateDrv0CtrlGateDrv0VrfyRes0Val;
  uint16 PimdGateDrv0CtrlGateDrv0VrfyRes1Val;
  uint8 PimGateDrv0CfgCnt;
  uint8 PimGateDrv0OffStChkIdx;
  uint8 PimGateDrv0OffStCnt;
  uint8 PimGateDrv0St;
  uint8 PimIvtr0BootstrpSplyFltPrmVal;
  uint8 PimIvtr0GenericFltPrmVal;
  IvtrFetFltPha1 PimIvtrFetFltPhaDataStore;
  IvtrFetFltTyp1 PimIvtrFetFltTypDataStore;
  uint8 PimdGateDrv0CtrlGateDrv0OffsStVrfyPrmBitIdx;
  boolean PimGateDrv0CfgSecAtmpt;
  boolean PimGateDrv0OffStChkSecAtmpt;
  boolean PimGateDrv0SpiErrSecAtmpt;
  boolean PimIvtr0InactvSts;
  boolean PimIvtr0OffStChkCmpl;
  FilLpRec1 PimGateDrv0PhaAFilLp;
  FilLpRec1 PimGateDrv0PhaBFilLp;
  FilLpRec1 PimGateDrv0PhaCFilLp;

  float32 GateDrv0CtrlErrFilFrq_Val_data;
  uint32 GateDrv0CtrlErrOffs_Val_data;
  uint32 GateDrv0CtrlErrThd_Val_data;
  uint16 GateDrv0CtrlNtcNr0x050FailStep_Val_data;
  uint16 GateDrv0CtrlNtcNr0x050PassStep_Val_data;
  uint16 GateDrv0CtrlNtcNr0x051FailStep_Val_data;
  uint16 GateDrv0CtrlNtcNr0x051PassStep_Val_data;
  uint16 GateDrv0CtrlNtcNr0x055FailStep_Val_data;
  uint16 GateDrv0CtrlNtcNr0x055PassStep_Val_data;
  uint16 GateDrv0CtrlUnit0Cfg2WrVal_Val_data;
  uint16 GateDrv0CtrlUnit0Cfg3WrVal_Val_data;
  uint16 GateDrv0CtrlUnit0Cfg4WrVal_Val_data;
  uint16 GateDrv0CtrlUnit0Cfg7WrVal_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimGateDrv0PhaOnTiSumAPrev = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0PhaOnTiSumAPrev();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0PhaOnTiSumAPrev() = PimGateDrv0PhaOnTiSumAPrev;
  PimGateDrv0PhaOnTiSumBPrev = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0PhaOnTiSumBPrev();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0PhaOnTiSumBPrev() = PimGateDrv0PhaOnTiSumBPrev;
  PimGateDrv0PhaOnTiSumCPrev = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0PhaOnTiSumCPrev();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0PhaOnTiSumCPrev() = PimGateDrv0PhaOnTiSumCPrev;
  PimGateDrv0SpiTrsmErrCntr = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0SpiTrsmErrCntr();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0SpiTrsmErrCntr() = PimGateDrv0SpiTrsmErrCntr;
  PimdGateDrv0CtrlGateDrv0PhaOnTiSumAExp = *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0PhaOnTiSumAExp();
  *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0PhaOnTiSumAExp() = PimdGateDrv0CtrlGateDrv0PhaOnTiSumAExp;
  PimdGateDrv0CtrlGateDrv0PhaOnTiSumBExp = *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0PhaOnTiSumBExp();
  *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0PhaOnTiSumBExp() = PimdGateDrv0CtrlGateDrv0PhaOnTiSumBExp;
  PimdGateDrv0CtrlGateDrv0PhaOnTiSumCExp = *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0PhaOnTiSumCExp();
  *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0PhaOnTiSumCExp() = PimdGateDrv0CtrlGateDrv0PhaOnTiSumCExp;
  PimGateDrv0Diag0Val = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0Diag0Val();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0Diag0Val() = PimGateDrv0Diag0Val;
  PimGateDrv0Diag1Val = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0Diag1Val();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0Diag1Val() = PimGateDrv0Diag1Val;
  PimGateDrv0Diag2Val = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0Diag2Val();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0Diag2Val() = PimGateDrv0Diag2Val;
  PimGateDrv0StsVal = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0StsVal();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0StsVal() = PimGateDrv0StsVal;
  PimGateDrv0VrfyRes0Val = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0VrfyRes0Val();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0VrfyRes0Val() = PimGateDrv0VrfyRes0Val;
  PimGateDrv0VrfyRes1Val = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0VrfyRes1Val();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0VrfyRes1Val() = PimGateDrv0VrfyRes1Val;
  PimdGateDrv0CtrlGateDrv0Diag0Val = *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0Diag0Val();
  *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0Diag0Val() = PimdGateDrv0CtrlGateDrv0Diag0Val;
  PimdGateDrv0CtrlGateDrv0Diag1Val = *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0Diag1Val();
  *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0Diag1Val() = PimdGateDrv0CtrlGateDrv0Diag1Val;
  PimdGateDrv0CtrlGateDrv0Diag2Val = *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0Diag2Val();
  *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0Diag2Val() = PimdGateDrv0CtrlGateDrv0Diag2Val;
  PimdGateDrv0CtrlGateDrv0StsVal = *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0StsVal();
  *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0StsVal() = PimdGateDrv0CtrlGateDrv0StsVal;
  PimdGateDrv0CtrlGateDrv0VrfyRes0Val = *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0VrfyRes0Val();
  *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0VrfyRes0Val() = PimdGateDrv0CtrlGateDrv0VrfyRes0Val;
  PimdGateDrv0CtrlGateDrv0VrfyRes1Val = *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0VrfyRes1Val();
  *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0VrfyRes1Val() = PimdGateDrv0CtrlGateDrv0VrfyRes1Val;
  PimGateDrv0CfgCnt = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0CfgCnt();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0CfgCnt() = PimGateDrv0CfgCnt;
  PimGateDrv0OffStChkIdx = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0OffStChkIdx();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0OffStChkIdx() = PimGateDrv0OffStChkIdx;
  PimGateDrv0OffStCnt = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0OffStCnt();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0OffStCnt() = PimGateDrv0OffStCnt;
  PimGateDrv0St = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0St();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0St() = PimGateDrv0St;
  PimIvtr0BootstrpSplyFltPrmVal = *TSC_GateDrv0Ctrl_Rte_Pim_Ivtr0BootstrpSplyFltPrmVal();
  *TSC_GateDrv0Ctrl_Rte_Pim_Ivtr0BootstrpSplyFltPrmVal() = PimIvtr0BootstrpSplyFltPrmVal;
  PimIvtr0GenericFltPrmVal = *TSC_GateDrv0Ctrl_Rte_Pim_Ivtr0GenericFltPrmVal();
  *TSC_GateDrv0Ctrl_Rte_Pim_Ivtr0GenericFltPrmVal() = PimIvtr0GenericFltPrmVal;
  PimIvtrFetFltPhaDataStore = *TSC_GateDrv0Ctrl_Rte_Pim_IvtrFetFltPhaDataStore();
  *TSC_GateDrv0Ctrl_Rte_Pim_IvtrFetFltPhaDataStore() = PimIvtrFetFltPhaDataStore;
  PimIvtrFetFltTypDataStore = *TSC_GateDrv0Ctrl_Rte_Pim_IvtrFetFltTypDataStore();
  *TSC_GateDrv0Ctrl_Rte_Pim_IvtrFetFltTypDataStore() = PimIvtrFetFltTypDataStore;
  PimdGateDrv0CtrlGateDrv0OffsStVrfyPrmBitIdx = *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0OffsStVrfyPrmBitIdx();
  *TSC_GateDrv0Ctrl_Rte_Pim_dGateDrv0CtrlGateDrv0OffsStVrfyPrmBitIdx() = PimdGateDrv0CtrlGateDrv0OffsStVrfyPrmBitIdx;
  PimGateDrv0CfgSecAtmpt = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0CfgSecAtmpt();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0CfgSecAtmpt() = PimGateDrv0CfgSecAtmpt;
  PimGateDrv0OffStChkSecAtmpt = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0OffStChkSecAtmpt();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0OffStChkSecAtmpt() = PimGateDrv0OffStChkSecAtmpt;
  PimGateDrv0SpiErrSecAtmpt = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0SpiErrSecAtmpt();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0SpiErrSecAtmpt() = PimGateDrv0SpiErrSecAtmpt;
  PimIvtr0InactvSts = *TSC_GateDrv0Ctrl_Rte_Pim_Ivtr0InactvSts();
  *TSC_GateDrv0Ctrl_Rte_Pim_Ivtr0InactvSts() = PimIvtr0InactvSts;
  PimIvtr0OffStChkCmpl = *TSC_GateDrv0Ctrl_Rte_Pim_Ivtr0OffStChkCmpl();
  *TSC_GateDrv0Ctrl_Rte_Pim_Ivtr0OffStChkCmpl() = PimIvtr0OffStChkCmpl;
  PimGateDrv0PhaAFilLp = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0PhaAFilLp();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0PhaAFilLp() = PimGateDrv0PhaAFilLp;
  PimGateDrv0PhaBFilLp = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0PhaBFilLp();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0PhaBFilLp() = PimGateDrv0PhaBFilLp;
  PimGateDrv0PhaCFilLp = *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0PhaCFilLp();
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0PhaCFilLp() = PimGateDrv0PhaCFilLp;

  GateDrv0CtrlErrFilFrq_Val_data = TSC_GateDrv0Ctrl_Rte_Prm_GateDrv0CtrlErrFilFrq_Val();
  GateDrv0CtrlErrOffs_Val_data = TSC_GateDrv0Ctrl_Rte_Prm_GateDrv0CtrlErrOffs_Val();
  GateDrv0CtrlErrThd_Val_data = TSC_GateDrv0Ctrl_Rte_Prm_GateDrv0CtrlErrThd_Val();
  GateDrv0CtrlNtcNr0x050FailStep_Val_data = TSC_GateDrv0Ctrl_Rte_Prm_GateDrv0CtrlNtcNr0x050FailStep_Val();
  GateDrv0CtrlNtcNr0x050PassStep_Val_data = TSC_GateDrv0Ctrl_Rte_Prm_GateDrv0CtrlNtcNr0x050PassStep_Val();
  GateDrv0CtrlNtcNr0x051FailStep_Val_data = TSC_GateDrv0Ctrl_Rte_Prm_GateDrv0CtrlNtcNr0x051FailStep_Val();
  GateDrv0CtrlNtcNr0x051PassStep_Val_data = TSC_GateDrv0Ctrl_Rte_Prm_GateDrv0CtrlNtcNr0x051PassStep_Val();
  GateDrv0CtrlNtcNr0x055FailStep_Val_data = TSC_GateDrv0Ctrl_Rte_Prm_GateDrv0CtrlNtcNr0x055FailStep_Val();
  GateDrv0CtrlNtcNr0x055PassStep_Val_data = TSC_GateDrv0Ctrl_Rte_Prm_GateDrv0CtrlNtcNr0x055PassStep_Val();
  GateDrv0CtrlUnit0Cfg2WrVal_Val_data = TSC_GateDrv0Ctrl_Rte_Prm_GateDrv0CtrlUnit0Cfg2WrVal_Val();
  GateDrv0CtrlUnit0Cfg3WrVal_Val_data = TSC_GateDrv0Ctrl_Rte_Prm_GateDrv0CtrlUnit0Cfg3WrVal_Val();
  GateDrv0CtrlUnit0Cfg4WrVal_Val_data = TSC_GateDrv0Ctrl_Rte_Prm_GateDrv0CtrlUnit0Cfg4WrVal_Val();
  GateDrv0CtrlUnit0Cfg7WrVal_Val_data = TSC_GateDrv0Ctrl_Rte_Prm_GateDrv0CtrlUnit0Cfg7WrVal_Val();

  GateDrv0Ctrl_TestDefines();
 ...
 *********************************************************************************************************************/
  ...
  boolean Call_IoHwAb_GetGpioMotDrvr0Diag_Oper_PinSt_Arg = FALSE;
  ...
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0PhaCFilLp() = PimGateDrv0PhaCFilLp;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Read_StrtUpSt_Val(&Read_StrtUpSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Read_SysSt_Val(&Read_SysSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  TSC_GateDrv0Ctrl_Rte_IrvWrite_GateDrv0CtrlPer1_GateDrv0Ena(FALSE);
  TSC_GateDrv0Ctrl_Rte_IrvWrite_GateDrv0CtrlPer1_GateDrv0PhaReasbnDiagcEna(FALSE);
  TSC_GateDrv0Ctrl_Rte_IrvWrite_GateDrv0CtrlPer1_Ivtr0PhyFltInpActv(FALSE);

  fct_status = TSC_GateDrv0Ctrl_Rte_Call_IoHwAb_GetGpioMotDrvr0Diag_Oper(&Call_IoHwAb_GetGpioMotDrvr0Diag_Oper_PinSt_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Call_IoHwAb_SetGpioGateDrv0Rst_Oper(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  boolean Read_Ivtr1PwrDiscnctFltSts_Logl;
  uint32 Read_PhaOnTiMeasdA_Val;
  uint32 Read_PhaOnTiMeasdB_Val;
  uint32 Read_PhaOnTiMeasdC_Val;
  uint32 Read_PhaOnTiSumA_Val;
  uint32 Read_PhaOnTiSumB_Val;
  uint32 Read_PhaOnTiSumC_Val;
  ...
  boolean GateDrv0CtrlPer2_GateDrv0Ena;
  boolean GateDrv0CtrlPer2_GateDrv0PhaReasbnDiagcEna;
  boolean GateDrv0CtrlPer2_Ivtr0PhyFltInpActv;
  ...
  *TSC_GateDrv0Ctrl_Rte_Pim_GateDrv0PhaCFilLp() = PimGateDrv0PhaCFilLp;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Read_Ivtr1PwrDiscnctFltSts_Logl(&Read_Ivtr1PwrDiscnctFltSts_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Read_PhaOnTiMeasdA_Val(&Read_PhaOnTiMeasdA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Read_PhaOnTiMeasdB_Val(&Read_PhaOnTiMeasdB_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Read_PhaOnTiMeasdC_Val(&Read_PhaOnTiMeasdC_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Read_PhaOnTiSumA_Val(&Read_PhaOnTiSumA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Read_PhaOnTiSumB_Val(&Read_PhaOnTiSumB_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Read_PhaOnTiSumC_Val(&Read_PhaOnTiSumC_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Write_DiagcStsIvtr1Inactv_Logl(Rte_InitValue_DiagcStsIvtr1Inactv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Write_IvtrFetFltPha_Val(Rte_InitValue_IvtrFetFltPha_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Write_IvtrFetFltTyp_Val(Rte_InitValue_IvtrFetFltTyp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Write_MotDrvErrA_Val(Rte_InitValue_MotDrvErrA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Write_MotDrvErrB_Val(Rte_InitValue_MotDrvErrB_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Write_MotDrvErrC_Val(Rte_InitValue_MotDrvErrC_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Write_MotDrvr0IninTestCmpl_Logl(Rte_InitValue_MotDrvr0IninTestCmpl_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  GateDrv0CtrlPer2_GateDrv0Ena = TSC_GateDrv0Ctrl_Rte_IrvRead_GateDrv0CtrlPer2_GateDrv0Ena();
  GateDrv0CtrlPer2_GateDrv0PhaReasbnDiagcEna = TSC_GateDrv0Ctrl_Rte_IrvRead_GateDrv0CtrlPer2_GateDrv0PhaReasbnDiagcEna();
  GateDrv0CtrlPer2_Ivtr0PhyFltInpActv = TSC_GateDrv0Ctrl_Rte_IrvRead_GateDrv0CtrlPer2_Ivtr0PhyFltInpActv();

  fct_status = TSC_GateDrv0Ctrl_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Call_IoHwAb_SetGpioSysFlt2A_Oper(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_GateDrv0Ctrl_Rte_Call_SetNtcStsAndSnpshtData_Oper(0U, 0U, 0U, 0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_SetNtcStsAndSnpshtData_PortIf1_E_NOT_OK:
      fct_error = 1;
      break;
  }
