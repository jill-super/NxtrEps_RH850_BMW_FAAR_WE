 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  TSC_BmwMsgSlot51Bas0Repn2BusFrChA.c
 *        Config:  EPS.dpa
 *   ECU-Project:  EPS
 *
...
{
  return Rte_Read_BmwRackCntrToVehCntrOffs_Val(data);
}
...
{
  return Rte_Write_TRGG_ENGTORQ_EPS_Val(data);
}
...
{
  return Rte_Write_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS(data);
}


Std_ReturnType TSC_BmwMsgSlot51Bas0Repn2BusFrChA_Rte_Invalidate_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS(void)
{
  return Rte_Invalidate_sigGroup_AVL_PO_EPS_sigGroup_AVL_PO_EPS();
}
...
{
  return (sint8 ) Rte_Prm_BmwSteerPolarity_Val();
}


     /* BmwMsgSlot51Bas0Repn2BusFrChA */
      /* BmwMsgSlot51Bas0Repn2BusFrChA */
