...
static void HwTqCorrln_TestDefines(void);
 ...
 *     Returnvalue: u5p11* is of type Ary1D_u5p11_17
 *   u6p10 *Rte_Prm_HwTqCorrlnChATraLpFilY_Ary1D(void)
 *     Returnvalue: u6p10* is of type Ary1D_u6p10_17
 *
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  float32 PimHwTqChACmnModCmpLpFilSt;
  uint8 PimHwTqARollgCntrPrev;
  uint8 PimHwTqAStallCntrPrev;
  uint8 PimHwTqBRollgCntrPrev;
  uint8 PimHwTqBStallCntrPrev;
  boolean PimHwTqChAImdtCorrlnChk;
  FilLpRec1 PimHwTqChACmnModCmpLpFil;
  FilLpRec1 PimHwTqChAStabStLpFil;
  FilLpRec1 PimHwTqChATraLpFil;

  float32 HwTqChACmnModCmpLpFilStDft_data;

  float32 HwTqCorrlnChACmnModCmpLpFilActvnThd_Val_data;
  float32 HwTqCorrlnChACmnModCmpLpFilFrq_Val_data;
  float32 HwTqCorrlnChACmnModCmpLpFilOutpLim_Val_data;
  float32 HwTqCorrlnChAImdtCorrlnChkFailThd_Val_data;
  float32 HwTqCorrlnChAImdtCorrlnChkPassThd_Val_data;
  float32 HwTqCorrlnChAStabStClrFltThd_Val_data;
  float32 HwTqCorrlnChAStabStLpFilFrq_Val_data;
  float32 HwTqCorrlnChAStabStSetFltThd_Val_data;
  float32 HwTqCorrlnChATqSumMaxLim_Val_data;
  float32 HwTqCorrlnChATraSumClrFltThd_Val_data;
  float32 HwTqCorrlnChATraSumSetFltThd_Val_data;
  Ary1D_u5p11_17 HwTqCorrlnChATraLpFilX_Ary1D_data;
  Ary1D_u6p10_17 HwTqCorrlnChATraLpFilY_Ary1D_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimHwTqChACmnModCmpLpFilSt = *TSC_HwTqCorrln_Rte_Pim_HwTqChACmnModCmpLpFilSt();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChACmnModCmpLpFilSt() = PimHwTqChACmnModCmpLpFilSt;
  PimHwTqARollgCntrPrev = *TSC_HwTqCorrln_Rte_Pim_HwTqARollgCntrPrev();
  *TSC_HwTqCorrln_Rte_Pim_HwTqARollgCntrPrev() = PimHwTqARollgCntrPrev;
  PimHwTqAStallCntrPrev = *TSC_HwTqCorrln_Rte_Pim_HwTqAStallCntrPrev();
  *TSC_HwTqCorrln_Rte_Pim_HwTqAStallCntrPrev() = PimHwTqAStallCntrPrev;
  PimHwTqBRollgCntrPrev = *TSC_HwTqCorrln_Rte_Pim_HwTqBRollgCntrPrev();
  *TSC_HwTqCorrln_Rte_Pim_HwTqBRollgCntrPrev() = PimHwTqBRollgCntrPrev;
  PimHwTqBStallCntrPrev = *TSC_HwTqCorrln_Rte_Pim_HwTqBStallCntrPrev();
  *TSC_HwTqCorrln_Rte_Pim_HwTqBStallCntrPrev() = PimHwTqBStallCntrPrev;
  PimHwTqChAImdtCorrlnChk = *TSC_HwTqCorrln_Rte_Pim_HwTqChAImdtCorrlnChk();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChAImdtCorrlnChk() = PimHwTqChAImdtCorrlnChk;
  PimHwTqChACmnModCmpLpFil = *TSC_HwTqCorrln_Rte_Pim_HwTqChACmnModCmpLpFil();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChACmnModCmpLpFil() = PimHwTqChACmnModCmpLpFil;
  PimHwTqChAStabStLpFil = *TSC_HwTqCorrln_Rte_Pim_HwTqChAStabStLpFil();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChAStabStLpFil() = PimHwTqChAStabStLpFil;
  PimHwTqChATraLpFil = *TSC_HwTqCorrln_Rte_Pim_HwTqChATraLpFil();
  *TSC_HwTqCorrln_Rte_Pim_HwTqChATraLpFil() = PimHwTqChATraLpFil;

  HwTqChACmnModCmpLpFilStDft_data = TSC_HwTqCorrln_Rte_CData_HwTqChACmnModCmpLpFilStDft();

  HwTqCorrlnChACmnModCmpLpFilActvnThd_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChACmnModCmpLpFilActvnThd_Val();
  HwTqCorrlnChACmnModCmpLpFilFrq_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChACmnModCmpLpFilFrq_Val();
  HwTqCorrlnChACmnModCmpLpFilOutpLim_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChACmnModCmpLpFilOutpLim_Val();
  HwTqCorrlnChAImdtCorrlnChkFailThd_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChAImdtCorrlnChkFailThd_Val();
  HwTqCorrlnChAImdtCorrlnChkPassThd_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChAImdtCorrlnChkPassThd_Val();
  HwTqCorrlnChAStabStClrFltThd_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChAStabStClrFltThd_Val();
  HwTqCorrlnChAStabStLpFilFrq_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChAStabStLpFilFrq_Val();
  HwTqCorrlnChAStabStSetFltThd_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChAStabStSetFltThd_Val();
  HwTqCorrlnChATqSumMaxLim_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChATqSumMaxLim_Val();
  HwTqCorrlnChATraSumClrFltThd_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChATraSumClrFltThd_Val();
  HwTqCorrlnChATraSumSetFltThd_Val_data = TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChATraSumSetFltThd_Val();
  (void)memcpy(HwTqCorrlnChATraLpFilX_Ary1D_data, TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChATraLpFilX_Ary1D(), sizeof(Ary1D_u5p11_17));
  (void)memcpy(HwTqCorrlnChATraLpFilY_Ary1D_data, TSC_HwTqCorrln_Rte_Prm_HwTqCorrlnChATraLpFilY_Ary1D(), sizeof(Ary1D_u6p10_17));

  HwTqCorrln_TestDefines();
 ...
 *********************************************************************************************************************/
  ...
  *TSC_HwTqCorrln_Rte_Pim_HwTqChATraLpFil() = PimHwTqChATraLpFil;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Read_HwTqA_Val(&Read_HwTqA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Read_HwTqAQlfr_Val(&Read_HwTqAQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Read_HwTqARollgCntr_Val(&Read_HwTqARollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Read_HwTqB_Val(&Read_HwTqB_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Read_HwTqBQlfr_Val(&Read_HwTqBQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Read_HwTqBRollgCntr_Val(&Read_HwTqBRollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Write_HwTqCorrlnSts_Val(Rte_InitValue_HwTqCorrlnSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  TSC_HwTqCorrln_Rte_IrvWrite_HwTqCorrlnPer1_HwTqChAAvl(TRUE);

  fct_status = TSC_HwTqCorrln_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  boolean HwTqCorrlnPer2_HwTqChAAvl;

  uint8 Call_FltInj_u08_Oper_SigPah_Arg = 0U;
  SigQlfr1 Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg = 0U;
  ...
  *TSC_HwTqCorrln_Rte_Pim_HwTqChATraLpFil() = PimHwTqChATraLpFil;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Write_HwTqChACorrlnTraErr_Val(Rte_InitValue_HwTqChACorrlnTraErr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Write_HwTqIdptSig_Val(Rte_InitValue_HwTqIdptSig_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  HwTqCorrlnPer2_HwTqChAAvl = TSC_HwTqCorrln_Rte_IrvRead_HwTqCorrlnPer2_HwTqChAAvl();

  TSC_HwTqCorrln_Rte_IrvWrite_HwTqCorrlnPer2_HwTqChATqSumLim(0.0F);

  fct_status = TSC_HwTqCorrln_Rte_Call_FltInj_u08_Oper(&Call_FltInj_u08_Oper_SigPah_Arg, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_HwTqChACmnModCmpLpFilSt_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 ...
 *********************************************************************************************************************/
  ...
  float32 HwTqCorrlnPer3_HwTqChATqSumLim;
  ...
  *TSC_HwTqCorrln_Rte_Pim_HwTqChATraLpFil() = PimHwTqChATraLpFil;
  ...
  fct_status = TSC_HwTqCorrln_Rte_Read_HwTqChA_Val(&Read_HwTqChA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  HwTqCorrlnPer3_HwTqChATqSumLim = TSC_HwTqCorrln_Rte_IrvRead_HwTqCorrlnPer3_HwTqChATqSumLim();

  fct_status = TSC_HwTqCorrln_Rte_Call_HwTqChACmnModCmpLpFilSt_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
