...
static void LoaMgr_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint8 PimPrevCurrMeasIdptSigResp;
  uint8 PimPrevCurrMeasIdptSigVal;
  uint8 PimPrevHwTqIdptSigResp;
  uint8 PimPrevHwTqIdptSigVal;
  uint8 PimPrevIvtrIdptSigResp;
  uint8 PimPrevIvtrIdptSigVal;
  uint8 PimPrevMotAgMeclIdptSigResp;
  uint8 PimPrevMotAgMeclIdptSigVal;
  uint8 PimPrevVltgModSrc;
  boolean PimPrevCurrMeasLoaStSwMtgtnEna;
  boolean PimPrevHwTqLoaStSwMtgtnEna;
  boolean PimPrevIvtrLoaStSwMtgtnEna;
  boolean PimPrevMotAgLoaMtgtnEna;
  boolean PimPrevMotAgLoaStSwMtgtnEna;

  float32 LoaMgrCurrIvtrMtgtnRate_Val_data;
  float32 LoaMgrCurrIvtrMtgtnSca_Val_data;
  float32 LoaMgrCurrMeasMtgtnRate_Val_data;
  float32 LoaMgrCurrMeasMtgtnSca_Val_data;
  float32 LoaMgrFadeOutStRate_Val_data;
  float32 LoaMgrIvtrMtgtnRate_Val_data;
  float32 LoaMgrIvtrMtgtnSca_Val_data;
  float32 LoaMgrLimdStRate_Val_data;
  float32 LoaMgrLimdStSca_Val_data;
  float32 LoaMgrMotAgMtgtnRate_Val_data;
  float32 LoaMgrMotAgMtgtnSca_Val_data;
  uint8 LoaMgrCurrMeasIdptSig0Resp_Val_data;
  uint8 LoaMgrCurrMeasIdptSig1Resp_Val_data;
  uint8 LoaMgrCurrMeasIdptSig2Resp_Val_data;
  uint8 LoaMgrCurrMeasIdptSigFltThd_Val_data;
  uint8 LoaMgrHwTqIdptSig0NoTqLoaResp_Val_data;
  uint8 LoaMgrHwTqIdptSig1NoTqLoaResp_Val_data;
  uint8 LoaMgrHwTqIdptSig2Resp_Val_data;
  uint8 LoaMgrHwTqIdptSig3Resp_Val_data;
  uint8 LoaMgrHwTqIdptSig4Resp_Val_data;
  uint8 LoaMgrHwTqIdptSigFltThd_Val_data;
  uint8 LoaMgrHwTqLoaAvlResp_Val_data;
  uint8 LoaMgrIvtrIdptSig0Resp_Val_data;
  uint8 LoaMgrIvtrIdptSig1Resp_Val_data;
  uint8 LoaMgrIvtrIdptSig2Resp_Val_data;
  uint8 LoaMgrIvtrIdptSigFltThd_Val_data;
  uint8 LoaMgrMotAgAvlSnsrlsResp_Val_data;
  uint8 LoaMgrMotAgIdptSig0NoSnsrlsResp_Val_data;
  uint8 LoaMgrMotAgIdptSig1NoSnsrlsResp_Val_data;
  uint8 LoaMgrMotAgIdptSig2Resp_Val_data;
  uint8 LoaMgrMotAgIdptSig3Resp_Val_data;
  uint8 LoaMgrMotAgIdptSigFltThd_Val_data;
  boolean LoaMgrCurrIvtrMtgtnScaZeroEna_Logl_data;
  boolean LoaMgrCurrMeasMtgtnScaZeroEna_Logl_data;
  boolean LoaMgrIvtrMtgtnScaZeroEna_Logl_data;
  boolean LoaMgrMotAgMtgtnScaZeroEna_Logl_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimPrevCurrMeasIdptSigResp = *TSC_LoaMgr_Rte_Pim_PrevCurrMeasIdptSigResp();
  *TSC_LoaMgr_Rte_Pim_PrevCurrMeasIdptSigResp() = PimPrevCurrMeasIdptSigResp;
  PimPrevCurrMeasIdptSigVal = *TSC_LoaMgr_Rte_Pim_PrevCurrMeasIdptSigVal();
  *TSC_LoaMgr_Rte_Pim_PrevCurrMeasIdptSigVal() = PimPrevCurrMeasIdptSigVal;
  PimPrevHwTqIdptSigResp = *TSC_LoaMgr_Rte_Pim_PrevHwTqIdptSigResp();
  *TSC_LoaMgr_Rte_Pim_PrevHwTqIdptSigResp() = PimPrevHwTqIdptSigResp;
  PimPrevHwTqIdptSigVal = *TSC_LoaMgr_Rte_Pim_PrevHwTqIdptSigVal();
  *TSC_LoaMgr_Rte_Pim_PrevHwTqIdptSigVal() = PimPrevHwTqIdptSigVal;
  PimPrevIvtrIdptSigResp = *TSC_LoaMgr_Rte_Pim_PrevIvtrIdptSigResp();
  *TSC_LoaMgr_Rte_Pim_PrevIvtrIdptSigResp() = PimPrevIvtrIdptSigResp;
  PimPrevIvtrIdptSigVal = *TSC_LoaMgr_Rte_Pim_PrevIvtrIdptSigVal();
  *TSC_LoaMgr_Rte_Pim_PrevIvtrIdptSigVal() = PimPrevIvtrIdptSigVal;
  PimPrevMotAgMeclIdptSigResp = *TSC_LoaMgr_Rte_Pim_PrevMotAgMeclIdptSigResp();
  *TSC_LoaMgr_Rte_Pim_PrevMotAgMeclIdptSigResp() = PimPrevMotAgMeclIdptSigResp;
  PimPrevMotAgMeclIdptSigVal = *TSC_LoaMgr_Rte_Pim_PrevMotAgMeclIdptSigVal();
  *TSC_LoaMgr_Rte_Pim_PrevMotAgMeclIdptSigVal() = PimPrevMotAgMeclIdptSigVal;
  PimPrevVltgModSrc = *TSC_LoaMgr_Rte_Pim_PrevVltgModSrc();
  *TSC_LoaMgr_Rte_Pim_PrevVltgModSrc() = PimPrevVltgModSrc;
  PimPrevCurrMeasLoaStSwMtgtnEna = *TSC_LoaMgr_Rte_Pim_PrevCurrMeasLoaStSwMtgtnEna();
  *TSC_LoaMgr_Rte_Pim_PrevCurrMeasLoaStSwMtgtnEna() = PimPrevCurrMeasLoaStSwMtgtnEna;
  PimPrevHwTqLoaStSwMtgtnEna = *TSC_LoaMgr_Rte_Pim_PrevHwTqLoaStSwMtgtnEna();
  *TSC_LoaMgr_Rte_Pim_PrevHwTqLoaStSwMtgtnEna() = PimPrevHwTqLoaStSwMtgtnEna;
  PimPrevIvtrLoaStSwMtgtnEna = *TSC_LoaMgr_Rte_Pim_PrevIvtrLoaStSwMtgtnEna();
  *TSC_LoaMgr_Rte_Pim_PrevIvtrLoaStSwMtgtnEna() = PimPrevIvtrLoaStSwMtgtnEna;
  PimPrevMotAgLoaMtgtnEna = *TSC_LoaMgr_Rte_Pim_PrevMotAgLoaMtgtnEna();
  *TSC_LoaMgr_Rte_Pim_PrevMotAgLoaMtgtnEna() = PimPrevMotAgLoaMtgtnEna;
  PimPrevMotAgLoaStSwMtgtnEna = *TSC_LoaMgr_Rte_Pim_PrevMotAgLoaStSwMtgtnEna();
  *TSC_LoaMgr_Rte_Pim_PrevMotAgLoaStSwMtgtnEna() = PimPrevMotAgLoaStSwMtgtnEna;

  LoaMgrCurrIvtrMtgtnRate_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrCurrIvtrMtgtnRate_Val();
  LoaMgrCurrIvtrMtgtnSca_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrCurrIvtrMtgtnSca_Val();
  LoaMgrCurrMeasMtgtnRate_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrCurrMeasMtgtnRate_Val();
  LoaMgrCurrMeasMtgtnSca_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrCurrMeasMtgtnSca_Val();
  LoaMgrFadeOutStRate_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrFadeOutStRate_Val();
  LoaMgrIvtrMtgtnRate_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrIvtrMtgtnRate_Val();
  LoaMgrIvtrMtgtnSca_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrIvtrMtgtnSca_Val();
  LoaMgrLimdStRate_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrLimdStRate_Val();
  LoaMgrLimdStSca_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrLimdStSca_Val();
  LoaMgrMotAgMtgtnRate_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrMotAgMtgtnRate_Val();
  LoaMgrMotAgMtgtnSca_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrMotAgMtgtnSca_Val();
  LoaMgrCurrMeasIdptSig0Resp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrCurrMeasIdptSig0Resp_Val();
  LoaMgrCurrMeasIdptSig1Resp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrCurrMeasIdptSig1Resp_Val();
  LoaMgrCurrMeasIdptSig2Resp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrCurrMeasIdptSig2Resp_Val();
  LoaMgrCurrMeasIdptSigFltThd_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrCurrMeasIdptSigFltThd_Val();
  LoaMgrHwTqIdptSig0NoTqLoaResp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrHwTqIdptSig0NoTqLoaResp_Val();
  LoaMgrHwTqIdptSig1NoTqLoaResp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrHwTqIdptSig1NoTqLoaResp_Val();
  LoaMgrHwTqIdptSig2Resp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrHwTqIdptSig2Resp_Val();
  LoaMgrHwTqIdptSig3Resp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrHwTqIdptSig3Resp_Val();
  LoaMgrHwTqIdptSig4Resp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrHwTqIdptSig4Resp_Val();
  LoaMgrHwTqIdptSigFltThd_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrHwTqIdptSigFltThd_Val();
  LoaMgrHwTqLoaAvlResp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrHwTqLoaAvlResp_Val();
  LoaMgrIvtrIdptSig0Resp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrIvtrIdptSig0Resp_Val();
  LoaMgrIvtrIdptSig1Resp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrIvtrIdptSig1Resp_Val();
  LoaMgrIvtrIdptSig2Resp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrIvtrIdptSig2Resp_Val();
  LoaMgrIvtrIdptSigFltThd_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrIvtrIdptSigFltThd_Val();
  LoaMgrMotAgAvlSnsrlsResp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrMotAgAvlSnsrlsResp_Val();
  LoaMgrMotAgIdptSig0NoSnsrlsResp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrMotAgIdptSig0NoSnsrlsResp_Val();
  LoaMgrMotAgIdptSig1NoSnsrlsResp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrMotAgIdptSig1NoSnsrlsResp_Val();
  LoaMgrMotAgIdptSig2Resp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrMotAgIdptSig2Resp_Val();
  LoaMgrMotAgIdptSig3Resp_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrMotAgIdptSig3Resp_Val();
  LoaMgrMotAgIdptSigFltThd_Val_data = TSC_LoaMgr_Rte_Prm_LoaMgrMotAgIdptSigFltThd_Val();
  LoaMgrCurrIvtrMtgtnScaZeroEna_Logl_data = TSC_LoaMgr_Rte_Prm_LoaMgrCurrIvtrMtgtnScaZeroEna_Logl();
  LoaMgrCurrMeasMtgtnScaZeroEna_Logl_data = TSC_LoaMgr_Rte_Prm_LoaMgrCurrMeasMtgtnScaZeroEna_Logl();
  LoaMgrIvtrMtgtnScaZeroEna_Logl_data = TSC_LoaMgr_Rte_Prm_LoaMgrIvtrMtgtnScaZeroEna_Logl();
  LoaMgrMotAgMtgtnScaZeroEna_Logl_data = TSC_LoaMgr_Rte_Prm_LoaMgrMotAgMtgtnScaZeroEna_Logl();

  fct_status = TSC_LoaMgr_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  uint8 Read_CurrMeasIdptSig_Val;
  ...
  boolean Read_LoaScaDi_Logl;
  uint8 Read_MotAgMeclIdptSig_Val;
  boolean Read_MotAgSnsrlsAvl_Logl;
  boolean Read_TqLoaAvl_Logl;
  SteerMod1 Read_VehSteerMod_Val;
  ...
  *TSC_LoaMgr_Rte_Pim_PrevMotAgLoaStSwMtgtnEna() = PimPrevMotAgLoaStSwMtgtnEna;
  ...
  fct_status = TSC_LoaMgr_Rte_Read_CurrMeasIdptSig_Val(&Read_CurrMeasIdptSig_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Read_DiagcStsIvtr1Inactv_Logl(&Read_DiagcStsIvtr1Inactv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Read_DiagcStsIvtr2Inactv_Logl(&Read_DiagcStsIvtr2Inactv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Read_HwTqIdptSig_Val(&Read_HwTqIdptSig_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Read_IvtrFetFltTyp_Val(&Read_IvtrFetFltTyp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Read_LoaScaDi_Logl(&Read_LoaScaDi_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Read_MotAgMeclIdptSig_Val(&Read_MotAgMeclIdptSig_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Read_MotAgSnsrlsAvl_Logl(&Read_MotAgSnsrlsAvl_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Read_TqLoaAvl_Logl(&Read_TqLoaAvl_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Read_VehSteerMod_Val(&Read_VehSteerMod_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Write_HwTqLoaMtgtnEna_Logl(Rte_InitValue_HwTqLoaMtgtnEna_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Write_LoaRateLim_Val(Rte_InitValue_LoaRateLim_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Write_LoaSca_Val(Rte_InitValue_LoaSca_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Write_LoaSt_Val(Rte_InitValue_LoaSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Write_MotAgLoaMtgtnEna_Logl(Rte_InitValue_MotAgLoaMtgtnEna_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_LoaMgr_Rte_Write_MotAndThermProtnLoaMod_Val(Rte_InitValue_MotAndThermProtnLoaMod_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  TSC_LoaMgr_Rte_Enter_LoaMgrExclusiveArea();
  TSC_LoaMgr_Rte_Exit_LoaMgrExclusiveArea();
...
static void LoaMgr_TestDefines(void)
{
  ...
  SteerMod1 Test_SteerMod1_V_1 = STEERMOD_BASEPS;
  SteerMod1 Test_SteerMod1_V_2 = STEERMOD_SEMIATNMS;
  SteerMod1 Test_SteerMod1_V_3 = STEERMOD_FULLYATNMS;
}
