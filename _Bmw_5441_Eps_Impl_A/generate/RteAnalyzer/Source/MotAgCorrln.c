...
#include "Rte_MotAgCorrln.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void MotAgCorrln_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  u0p16 PimMotAgCorrlnErrThd;
  uint8 PimMotAgCorrlnMotAgARollgCntPrev;
  uint8 PimMotAgCorrlnMotAgAStallCntPrev;
  uint8 PimMotAgCorrlnMotAgBRollgCntPrev;
  uint8 PimMotAgCorrlnMotAgBStallCntPrev;
  boolean PimdMotAgCorrlnMotAgABOk;
  ...
  *************************************************/
  ...
  PimMotAgCorrlnErrThd = *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnErrThd();
  *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnErrThd() = PimMotAgCorrlnErrThd;
  PimMotAgCorrlnMotAgARollgCntPrev = *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgARollgCntPrev();
  *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgARollgCntPrev() = PimMotAgCorrlnMotAgARollgCntPrev;
  PimMotAgCorrlnMotAgAStallCntPrev = *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgAStallCntPrev();
  *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgAStallCntPrev() = PimMotAgCorrlnMotAgAStallCntPrev;
  PimMotAgCorrlnMotAgBRollgCntPrev = *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgBRollgCntPrev();
  *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgBRollgCntPrev() = PimMotAgCorrlnMotAgBRollgCntPrev;
  PimMotAgCorrlnMotAgBStallCntPrev = *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgBStallCntPrev();
  *TSC_MotAgCorrln_Rte_Pim_MotAgCorrlnMotAgBStallCntPrev() = PimMotAgCorrlnMotAgBStallCntPrev;
  PimdMotAgCorrlnMotAgABOk = *TSC_MotAgCorrln_Rte_Pim_dMotAgCorrlnMotAgABOk();
  *TSC_MotAgCorrln_Rte_Pim_dMotAgCorrlnMotAgABOk() = PimdMotAgCorrlnMotAgABOk;

  SysGlbPrmMotPoleCnt_Val_data = TSC_MotAgCorrln_Rte_Prm_SysGlbPrmMotPoleCnt_Val();

  MotAgCorrln_TestDefines();
 ...
 *********************************************************************************************************************/
  ...
  u0p16 Read_MotAgAMecl_Val;
  SigQlfr1 Read_MotAgAMeclQlfr_Val;
  uint8 Read_MotAgAMeclRollgCntr_Val;
  u0p16 Read_MotAgBMecl_Val;
  SigQlfr1 Read_MotAgBMeclQlfr_Val;
  uint8 Read_MotAgBMeclRollgCntr_Val;
  ...
  *TSC_MotAgCorrln_Rte_Pim_dMotAgCorrlnMotAgABOk() = PimdMotAgCorrlnMotAgABOk;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Read_MotAgAMecl_Val(&Read_MotAgAMecl_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Read_MotAgAMeclQlfr_Val(&Read_MotAgAMeclQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Read_MotAgAMeclRollgCntr_Val(&Read_MotAgAMeclRollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Read_MotAgBMecl_Val(&Read_MotAgBMecl_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Read_MotAgBMeclQlfr_Val(&Read_MotAgBMeclQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Read_MotAgBMeclRollgCntr_Val(&Read_MotAgBMeclRollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Write_MotAgMeclCorrlnSt_Val(Rte_InitValue_MotAgMeclCorrlnSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Write_MotAgMeclIdptSig_Val(Rte_InitValue_MotAgMeclIdptSig_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Call_FltInj_u08_Oper(&Call_FltInj_u08_Oper_SigPah_Arg, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_MotAgCorrln_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
