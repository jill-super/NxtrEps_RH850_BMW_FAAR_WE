...
#include "Rte_NxtrMath.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
#include "TSC_NxtrMath.h"
...
static void NxtrMath_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  *************************************************/
  ...
  fct_status = TSC_NxtrMath_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
