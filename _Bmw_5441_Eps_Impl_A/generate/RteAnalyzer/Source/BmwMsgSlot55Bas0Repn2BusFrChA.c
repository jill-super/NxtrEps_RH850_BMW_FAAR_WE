...
static void BmwMsgSlot55Bas0Repn2BusFrChA_TestDefines(void);
 ...
 *   boolean Rte_IsUpdated_sigGroup_ACLNY_MASSCNTR_sigGroup_ACLNY_MASSCNTR(void)
 *
 *   E2E Protection Wrapper API:
 *   ---------------------------
 *   uint32 E2EPW_Read_sigGroup_ACLNY_MASSCNTR_sigGroup_ACLNY_MASSCNTR(sigGroup_ACLNY_MASSCNTR1 *data)
 *
 * Output Interfaces:
 * ==================
 *   Explicit S/R API:
 ...
 *********************************************************************************************************************/
  ...
  sigGroup_ACLNY_MASSCNTR1 Read_sigGroup_ACLNY_MASSCNTR_sigGroup_ACLNY_MASSCNTR;
  boolean IsUpdated_sigGroup_ACLNY_MASSCNTR_sigGroup_ACLNY_MASSCNTR;

  float32 PimBmwVehLatAPrev;
  uint8 PimAclnyCogFaildCnt;
  uint8 PimAclnyCogPassdCnt;
  uint8 PimAlvFaildCnt;
  uint8 PimAlvPassdCnt;
  BmwVehLatAQlfr1 PimBmwVehLatAQlfrPrev;
  uint8 PimCrcFaildCnt;
  uint8 PimCrcPassdCnt;
  uint8 PimMissingMsgCnt;
  uint8 PimQuAclnyCogFaildCnt;
  uint8 PimQuAclnyCogPassdCnt;
  uint8 PimRxdMsgCnt;

  sint8 BmwMsgSlot55Bas0Repn2BusFrChABmwLatAPolarity_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimBmwVehLatAPrev = *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_BmwVehLatAPrev();
  *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_BmwVehLatAPrev() = PimBmwVehLatAPrev;
  PimAclnyCogFaildCnt = *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_AclnyCogFaildCnt();
  *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_AclnyCogFaildCnt() = PimAclnyCogFaildCnt;
  PimAclnyCogPassdCnt = *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_AclnyCogPassdCnt();
  *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_AclnyCogPassdCnt() = PimAclnyCogPassdCnt;
  PimAlvFaildCnt = *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_AlvFaildCnt();
  *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_AlvFaildCnt() = PimAlvFaildCnt;
  PimAlvPassdCnt = *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_AlvPassdCnt();
  *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_AlvPassdCnt() = PimAlvPassdCnt;
  PimBmwVehLatAQlfrPrev = *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_BmwVehLatAQlfrPrev();
  *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_BmwVehLatAQlfrPrev() = PimBmwVehLatAQlfrPrev;
  PimCrcFaildCnt = *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_CrcFaildCnt();
  *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_CrcFaildCnt() = PimCrcFaildCnt;
  PimCrcPassdCnt = *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_CrcPassdCnt();
  *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_CrcPassdCnt() = PimCrcPassdCnt;
  PimMissingMsgCnt = *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_MissingMsgCnt();
  *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_MissingMsgCnt() = PimMissingMsgCnt;
  PimQuAclnyCogFaildCnt = *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_QuAclnyCogFaildCnt();
  *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_QuAclnyCogFaildCnt() = PimQuAclnyCogFaildCnt;
  PimQuAclnyCogPassdCnt = *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_QuAclnyCogPassdCnt();
  *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_QuAclnyCogPassdCnt() = PimQuAclnyCogPassdCnt;
  PimRxdMsgCnt = *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_RxdMsgCnt();
  *TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Pim_RxdMsgCnt() = PimRxdMsgCnt;

  BmwMsgSlot55Bas0Repn2BusFrChABmwLatAPolarity_Val_data = TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Prm_BmwMsgSlot55Bas0Repn2BusFrChABmwLatAPolarity_Val();

  IsUpdated_sigGroup_ACLNY_MASSCNTR_sigGroup_ACLNY_MASSCNTR = TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_IsUpdated_sigGroup_ACLNY_MASSCNTR_sigGroup_ACLNY_MASSCNTR();

  fct_status = TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Read_FltCodEnad_Logl(&Read_FltCodEnad_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Read_sigGroup_ACLNY_MASSCNTR_sigGroup_ACLNY_MASSCNTR(&Read_sigGroup_ACLNY_MASSCNTR_sigGroup_ACLNY_MASSCNTR);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Write_BmwVehLatA_Val(Rte_InitValue_BmwVehLatA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Write_BmwVehLatAQlfr_Val(Rte_InitValue_BmwVehLatAQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Write_BmwVehLatAQlfrVld_Logl(Rte_InitValue_BmwVehLatAQlfrVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Write_BmwVehLatAVld_Logl(Rte_InitValue_BmwVehLatAVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot55Bas0Repn2BusFrChA_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  BmwMsgSlot55Bas0Repn2BusFrChA_TestDefines();
...
static void BmwMsgSlot55Bas0Repn2BusFrChA_TestDefines(void)
{
  ...
  ALIV_ACLNY_COG1 Test_ALIV_ACLNY_COG1_V_1 = ALIV_COU_4_Zaehlerstand0DotDotE;
  ALIV_ACLNY_COG1 Test_ALIV_ACLNY_COG1_V_2 = ALIV_COU_4_SignalUngueltig;

  BmwVehLatAQlfr1 Test_BmwVehLatAQlfr1_V_1 = BMWVEHLATAQLFR_SIGVALVLDANDPLAUS;
  BmwVehLatAQlfr1 Test_BmwVehLatAQlfr1_V_2 = BMWVEHLATAQLFR_SIGVALVLD;
  BmwVehLatAQlfr1 Test_BmwVehLatAQlfr1_V_3 = BMWVEHLATAQLFR_SIGQLTMONRSTRCTD;
  BmwVehLatAQlfr1 Test_BmwVehLatAQlfr1_V_4 = BMWVEHLATAQLFR_RESD1;
  BmwVehLatAQlfr1 Test_BmwVehLatAQlfr1_V_5 = BMWVEHLATAQLFR_SIGVALINVLD;
  BmwVehLatAQlfr1 Test_BmwVehLatAQlfr1_V_6 = BMWVEHLATAQLFR_RESD2;
  BmwVehLatAQlfr1 Test_BmwVehLatAQlfr1_V_7 = BMWVEHLATAQLFR_ININ;
  BmwVehLatAQlfr1 Test_BmwVehLatAQlfr1_V_8 = BMWVEHLATAQLFR_SIGVALTMPVLDANDSECUR;
  BmwVehLatAQlfr1 Test_BmwVehLatAQlfr1_V_9 = BMWVEHLATAQLFR_SIGVALTMPVLD;
  BmwVehLatAQlfr1 Test_BmwVehLatAQlfr1_V_10 = BMWVEHLATAQLFR_SIGQLTMONTMPRSTRCTD;
  BmwVehLatAQlfr1 Test_BmwVehLatAQlfr1_V_11 = BMWVEHLATAQLFR_SIGSUBVALVLDTMP;
  BmwVehLatAQlfr1 Test_BmwVehLatAQlfr1_V_12 = BMWVEHLATAQLFR_SIGVALTMPINVLD;
  BmwVehLatAQlfr1 Test_BmwVehLatAQlfr1_V_13 = BMWVEHLATAQLFR_INVLDSIG;
  ...
  QU_ACLNY_COG1 Test_QU_ACLNY_COG1_V_1 = QU_ACLNY_COG_Initialisierung;
  QU_ACLNY_COG1 Test_QU_ACLNY_COG1_V_2 = QU_ACLNY_COG_SignalwertIstGueltigUndAbgesichertUndPlausibilisiert;
  QU_ACLNY_COG1 Test_QU_ACLNY_COG1_V_3 = QU_ACLNY_COG_SignalwertIstGueltigUndAbgesichertZustandSlashStatusTemporaer;
  QU_ACLNY_COG1 Test_QU_ACLNY_COG1_V_4 = QU_ACLNY_COG_SignalwertIstGueltig;
  QU_ACLNY_COG1 Test_QU_ACLNY_COG1_V_5 = QU_ACLNY_COG_SignalwertIstGueltigZustandSlashStatusTemporaer;
  QU_ACLNY_COG1 Test_QU_ACLNY_COG1_V_6 = QU_ACLNY_COG_SignalqualitaetBzwDotUeberwachungEingeschraenkt;
  QU_ACLNY_COG1 Test_QU_ACLNY_COG1_V_7 = QU_ACLNY_COG_SignalqualitaetBzwDotUeberwachungEingeschraenktZustandSlashStatusTemporaer;
  QU_ACLNY_COG1 Test_QU_ACLNY_COG1_V_8 = QU_ACLNY_COG_Reserved;
  QU_ACLNY_COG1 Test_QU_ACLNY_COG1_V_9 = QU_ACLNY_COG_ErsatzwertIstImNutzsignalGesetztZustandSlashStatusTemporaer;
  QU_ACLNY_COG1 Test_QU_ACLNY_COG1_V_10 = QU_ACLNY_COG_SignalwertIstUngueltig;
  QU_ACLNY_COG1 Test_QU_ACLNY_COG1_V_11 = QU_ACLNY_COG_SignalwertIstUngueltigZustandSlashStatusTemporaer;
  QU_ACLNY_COG1 Test_QU_ACLNY_COG1_V_12 = QU_ACLNY_COG_Reserved_bne_18ACE6A1DACA4F44BAB0F4D6BBE8870D_7;
  QU_ACLNY_COG1 Test_QU_ACLNY_COG1_V_13 = QU_ACLNY_COG_SignalUngueltig;
}
