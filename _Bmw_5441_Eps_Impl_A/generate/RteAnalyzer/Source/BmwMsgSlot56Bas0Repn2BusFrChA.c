 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  BmwMsgSlot56Bas0Repn2BusFrChA.c
 *        Config:  EPS.dpa
 ...
 *
 *   Description:  C-Code implementation template for SW-C <BmwMsgSlot56Bas0Repn2BusFrChA>
 *********************************************************************************************************************/
...
#include "Rte_BmwMsgSlot56Bas0Repn2BusFrChA.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void BmwMsgSlot56Bas0Repn2BusFrChA_TestDefines(void);
 ...
 *   BMWVEHYAWQLFR_SIGVALVLDANDPLAUS (1U)
 *   BMWVEHYAWQLFR_SIGVALVLD (2U)
 *   BMWVEHYAWQLFR_SIGQLTMONRSTRCTD (3U)
 *   BMWVEHYAWQLFR_RESD1 (4U)
 *   BMWVEHYAWQLFR_SIGVALINVLD (6U)
 *   BMWVEHYAWQLFR_RESD2 (7U)
 *   BMWVEHYAWQLFR_ININ (8U)
 *   BMWVEHYAWQLFR_SIGVALTMPVLDANDSECUR (9U)
 *   BMWVEHYAWQLFR_SIGVALTMPVLD (10U)
 *   BMWVEHYAWQLFR_SIGQLTMONTMPRSTRCTD (11U)
 *   BMWVEHYAWQLFR_SIGSUBVALTMP (12U)
 *   BMWVEHYAWQLFR_SIGVALTMPINVLD (14U)
 *   BMWVEHYAWQLFR_INVLDSIG (15U)
 ...
 *   QU_VYAW_VEH_Initialisierung (8U)
 *   QU_VYAW_VEH_SignalwertIstGueltigUndAbgesichertUndPlausibilisiert (1U)
 *   QU_VYAW_VEH_SignalwertIstGueltigUndAbgesichertZustandSlashStatusTemporaer (9U)
 *   QU_VYAW_VEH_SignalwertIstGueltig (2U)
 *   QU_VYAW_VEH_SignalwertIstGueltigZustandSlashStatusTemporaer (10U)
 *   QU_VYAW_VEH_SignalqualitaetBzwDotUeberwachungEingeschraenkt (3U)
 *   QU_VYAW_VEH_SignalqualitaetBzwDotUeberwachungEingeschraenktZustandSlashStatusTemporaer (11U)
 *   QU_VYAW_VEH_Reserved (4U)
 *   QU_VYAW_VEH_ErsatzwertColonAbgleichwertIstImNutzsignalGesetztZustandSlashStatusTemporaer (12U)
 *   QU_VYAW_VEH_SignalwertIstUngueltig (6U)
 *   QU_VYAW_VEH_SignalwertIstUngueltigZustandSlashStatusTemporaer (14U)
 *   QU_VYAW_VEH_Reserved_bne_7C322122A3AD4C1BBA9012320D4729F1_7 (7U)
 *   QU_VYAW_VEH_SignalUngueltig (15U)
 *
 * Record Types:
 * =============
 ...
 *   boolean Rte_IsUpdated_sigGroup_VYAW_VEH_sigGroup_VYAW_VEH(void)
 *
 *   E2E Protection Wrapper API:
 *   ---------------------------
 *   uint32 E2EPW_Read_sigGroup_VYAW_VEH_sigGroup_VYAW_VEH(sigGroup_VYAW_VEH1 *data)
 *
 * Output Interfaces:
 * ==================
 *   Explicit S/R API:
 ...
 * Symbol: BmwMsgSlot56Bas0Repn2BusFrChAInit1_doc
 *********************************************************************************************************************/
 ...
 * Symbol: BmwMsgSlot56Bas0Repn2BusFrChAInit1
 *********************************************************************************************************************/
  ...
  sigGroup_VYAW_VEH1 Read_sigGroup_VYAW_VEH_sigGroup_VYAW_VEH;
  boolean IsUpdated_sigGroup_VYAW_VEH_sigGroup_VYAW_VEH;

  float32 PimBmwVehYawRatePrev;
  uint8 PimAlvFaildCnt;
  uint8 PimAlvPassdCnt;
  BmwVehYawQlfr1 PimBmwVehYawQlfrPrev;
  uint8 PimCrcFaildCnt;
  uint8 PimCrcPassdCnt;
  uint8 PimMissingMsgCnt;
  uint8 PimQuVyawVehFaildCnt;
  uint8 PimQuVyawVehPassdCnt;
  uint8 PimRxdMsgCnt;
  uint8 PimVyawVehFaildCnt;
  uint8 PimVyawVehPassdCnt;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimBmwVehYawRatePrev = *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_BmwVehYawRatePrev();
  *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_BmwVehYawRatePrev() = PimBmwVehYawRatePrev;
  PimAlvFaildCnt = *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_AlvFaildCnt();
  *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_AlvFaildCnt() = PimAlvFaildCnt;
  PimAlvPassdCnt = *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_AlvPassdCnt();
  *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_AlvPassdCnt() = PimAlvPassdCnt;
  PimBmwVehYawQlfrPrev = *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_BmwVehYawQlfrPrev();
  *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_BmwVehYawQlfrPrev() = PimBmwVehYawQlfrPrev;
  PimCrcFaildCnt = *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_CrcFaildCnt();
  *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_CrcFaildCnt() = PimCrcFaildCnt;
  PimCrcPassdCnt = *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_CrcPassdCnt();
  *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_CrcPassdCnt() = PimCrcPassdCnt;
  PimMissingMsgCnt = *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_MissingMsgCnt();
  *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_MissingMsgCnt() = PimMissingMsgCnt;
  PimQuVyawVehFaildCnt = *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_QuVyawVehFaildCnt();
  *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_QuVyawVehFaildCnt() = PimQuVyawVehFaildCnt;
  PimQuVyawVehPassdCnt = *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_QuVyawVehPassdCnt();
  *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_QuVyawVehPassdCnt() = PimQuVyawVehPassdCnt;
  PimRxdMsgCnt = *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_RxdMsgCnt();
  *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_RxdMsgCnt() = PimRxdMsgCnt;
  PimVyawVehFaildCnt = *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_VyawVehFaildCnt();
  *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_VyawVehFaildCnt() = PimVyawVehFaildCnt;
  PimVyawVehPassdCnt = *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_VyawVehPassdCnt();
  *TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Pim_VyawVehPassdCnt() = PimVyawVehPassdCnt;

  IsUpdated_sigGroup_VYAW_VEH_sigGroup_VYAW_VEH = TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_IsUpdated_sigGroup_VYAW_VEH_sigGroup_VYAW_VEH();

  fct_status = TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Read_FltCodEnad_Logl(&Read_FltCodEnad_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Read_sigGroup_VYAW_VEH_sigGroup_VYAW_VEH(&Read_sigGroup_VYAW_VEH_sigGroup_VYAW_VEH);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Write_BmwVehYawQlfr_Val(Rte_InitValue_BmwVehYawQlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Write_BmwVehYawQlfrVld_Logl(Rte_InitValue_BmwVehYawQlfrVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Write_BmwVehYawRate_Val(Rte_InitValue_BmwVehYawRate_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Write_BmwVehYawRateVld_Logl(Rte_InitValue_BmwVehYawRateVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot56Bas0Repn2BusFrChA_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  BmwMsgSlot56Bas0Repn2BusFrChA_TestDefines();
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: VYAW_VEH_Missing_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: VYAW_VEH_Received_Oper_doc
 *********************************************************************************************************************/
...
static void BmwMsgSlot56Bas0Repn2BusFrChA_TestDefines(void)
{
  ...
  ALIV_VYAW_VEH1 Test_ALIV_VYAW_VEH1_V_1 = ALIV_COU_4_Zaehlerstand0DotDotE;
  ALIV_VYAW_VEH1 Test_ALIV_VYAW_VEH1_V_2 = ALIV_COU_4_SignalUngueltig;

  BmwVehYawQlfr1 Test_BmwVehYawQlfr1_V_1 = BMWVEHYAWQLFR_SIGVALVLDANDPLAUS;
  BmwVehYawQlfr1 Test_BmwVehYawQlfr1_V_2 = BMWVEHYAWQLFR_SIGVALVLD;
  BmwVehYawQlfr1 Test_BmwVehYawQlfr1_V_3 = BMWVEHYAWQLFR_SIGQLTMONRSTRCTD;
  BmwVehYawQlfr1 Test_BmwVehYawQlfr1_V_4 = BMWVEHYAWQLFR_RESD1;
  BmwVehYawQlfr1 Test_BmwVehYawQlfr1_V_5 = BMWVEHYAWQLFR_SIGVALINVLD;
  BmwVehYawQlfr1 Test_BmwVehYawQlfr1_V_6 = BMWVEHYAWQLFR_RESD2;
  BmwVehYawQlfr1 Test_BmwVehYawQlfr1_V_7 = BMWVEHYAWQLFR_ININ;
  BmwVehYawQlfr1 Test_BmwVehYawQlfr1_V_8 = BMWVEHYAWQLFR_SIGVALTMPVLDANDSECUR;
  BmwVehYawQlfr1 Test_BmwVehYawQlfr1_V_9 = BMWVEHYAWQLFR_SIGVALTMPVLD;
  BmwVehYawQlfr1 Test_BmwVehYawQlfr1_V_10 = BMWVEHYAWQLFR_SIGQLTMONTMPRSTRCTD;
  BmwVehYawQlfr1 Test_BmwVehYawQlfr1_V_11 = BMWVEHYAWQLFR_SIGSUBVALTMP;
  BmwVehYawQlfr1 Test_BmwVehYawQlfr1_V_12 = BMWVEHYAWQLFR_SIGVALTMPINVLD;
  BmwVehYawQlfr1 Test_BmwVehYawQlfr1_V_13 = BMWVEHYAWQLFR_INVLDSIG;
  ...
  QU_VYAW_VEH1 Test_QU_VYAW_VEH1_V_1 = QU_VYAW_VEH_Initialisierung;
  QU_VYAW_VEH1 Test_QU_VYAW_VEH1_V_2 = QU_VYAW_VEH_SignalwertIstGueltigUndAbgesichertUndPlausibilisiert;
  QU_VYAW_VEH1 Test_QU_VYAW_VEH1_V_3 = QU_VYAW_VEH_SignalwertIstGueltigUndAbgesichertZustandSlashStatusTemporaer;
  QU_VYAW_VEH1 Test_QU_VYAW_VEH1_V_4 = QU_VYAW_VEH_SignalwertIstGueltig;
  QU_VYAW_VEH1 Test_QU_VYAW_VEH1_V_5 = QU_VYAW_VEH_SignalwertIstGueltigZustandSlashStatusTemporaer;
  QU_VYAW_VEH1 Test_QU_VYAW_VEH1_V_6 = QU_VYAW_VEH_SignalqualitaetBzwDotUeberwachungEingeschraenkt;
  QU_VYAW_VEH1 Test_QU_VYAW_VEH1_V_7 = QU_VYAW_VEH_SignalqualitaetBzwDotUeberwachungEingeschraenktZustandSlashStatusTemporaer;
  QU_VYAW_VEH1 Test_QU_VYAW_VEH1_V_8 = QU_VYAW_VEH_Reserved;
  QU_VYAW_VEH1 Test_QU_VYAW_VEH1_V_9 = QU_VYAW_VEH_ErsatzwertColonAbgleichwertIstImNutzsignalGesetztZustandSlashStatusTemporaer;
  QU_VYAW_VEH1 Test_QU_VYAW_VEH1_V_10 = QU_VYAW_VEH_SignalwertIstUngueltig;
  QU_VYAW_VEH1 Test_QU_VYAW_VEH1_V_11 = QU_VYAW_VEH_SignalwertIstUngueltigZustandSlashStatusTemporaer;
  QU_VYAW_VEH1 Test_QU_VYAW_VEH1_V_12 = QU_VYAW_VEH_Reserved_bne_7C322122A3AD4C1BBA9012320D4729F1_7;
  QU_VYAW_VEH1 Test_QU_VYAW_VEH1_V_13 = QU_VYAW_VEH_SignalUngueltig;
}
