...
static void CDD_CoreVltgMonr_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint8 PimCoreVltgMonrStrtUpFltPrmByte;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimCoreVltgMonrStrtUpFltPrmByte = *TSC_CDD_CoreVltgMonr_Rte_Pim_CoreVltgMonrStrtUpFltPrmByte();
  *TSC_CDD_CoreVltgMonr_Rte_Pim_CoreVltgMonrStrtUpFltPrmByte() = PimCoreVltgMonrStrtUpFltPrmByte;

  fct_status = TSC_CDD_CoreVltgMonr_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
