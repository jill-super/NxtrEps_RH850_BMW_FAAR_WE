...
static void CDD_HwTq4Meas_TestDefines(void);
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_HwTq4Offs_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 ...
 *********************************************************************************************************************/
  ...
  float32 PimHwTq4PrevHwTq4;
  uint8 PimHwTq4PrevRollgCntr;
  uint8 PimHwTq4RawFastAdcIdxCntr;
  HwTqOffsRec1 PimHwTq4Offs;
  AnHwTqScaFacRec1 PimHwTq4Sca;

  float32 HwTq4MeasHwTqRngHiLim_Val_data;
  float32 HwTq4MeasHwTqRngLoLim_Val_data;
  uint16 HwTq4MeasHwTq4PrtclFltFailStep_Val_data;
  uint16 HwTq4MeasHwTq4PrtclFltPassStep_Val_data;
  boolean HwTq4MeasMovgAvrgFilEna_Logl_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimHwTq4PrevHwTq4 = *TSC_CDD_HwTq4Meas_Rte_Pim_HwTq4PrevHwTq4();
  *TSC_CDD_HwTq4Meas_Rte_Pim_HwTq4PrevHwTq4() = PimHwTq4PrevHwTq4;
  PimHwTq4PrevRollgCntr = *TSC_CDD_HwTq4Meas_Rte_Pim_HwTq4PrevRollgCntr();
  *TSC_CDD_HwTq4Meas_Rte_Pim_HwTq4PrevRollgCntr() = PimHwTq4PrevRollgCntr;
  PimHwTq4RawFastAdcIdxCntr = *TSC_CDD_HwTq4Meas_Rte_Pim_HwTq4RawFastAdcIdxCntr();
  *TSC_CDD_HwTq4Meas_Rte_Pim_HwTq4RawFastAdcIdxCntr() = PimHwTq4RawFastAdcIdxCntr;
  PimHwTq4Offs = *TSC_CDD_HwTq4Meas_Rte_Pim_HwTq4Offs();
  *TSC_CDD_HwTq4Meas_Rte_Pim_HwTq4Offs() = PimHwTq4Offs;
  PimHwTq4Sca = *TSC_CDD_HwTq4Meas_Rte_Pim_HwTq4Sca();
  *TSC_CDD_HwTq4Meas_Rte_Pim_HwTq4Sca() = PimHwTq4Sca;

  HwTq4MeasHwTqRngHiLim_Val_data = TSC_CDD_HwTq4Meas_Rte_Prm_HwTq4MeasHwTqRngHiLim_Val();
  HwTq4MeasHwTqRngLoLim_Val_data = TSC_CDD_HwTq4Meas_Rte_Prm_HwTq4MeasHwTqRngLoLim_Val();
  HwTq4MeasHwTq4PrtclFltFailStep_Val_data = TSC_CDD_HwTq4Meas_Rte_Prm_HwTq4MeasHwTq4PrtclFltFailStep_Val();
  HwTq4MeasHwTq4PrtclFltPassStep_Val_data = TSC_CDD_HwTq4Meas_Rte_Prm_HwTq4MeasHwTq4PrtclFltPassStep_Val();
  HwTq4MeasMovgAvrgFilEna_Logl_data = TSC_CDD_HwTq4Meas_Rte_Prm_HwTq4MeasMovgAvrgFilEna_Logl();

  fct_status = TSC_CDD_HwTq4Meas_Rte_Call_HwTq4Offs_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_HwTq4Sca_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
 *
 **********************************************************************************************************************
 ...
 *********************************************************************************************************************/
  ...
  *TSC_CDD_HwTq4Meas_Rte_Pim_HwTq4Sca() = PimHwTq4Sca;
  ...
  fct_status = TSC_CDD_HwTq4Meas_Rte_Call_HwTq4Sca_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_HwTq4Offs_GetErrorStatus(NvM_RequestResultType *ErrorStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
 *   Std_ReturnType Rte_Call_HwTq4Sca_GetErrorStatus(NvM_RequestResultType *ErrorStatus_Arg)
 *     Synchronous Service Invocation. Timeout: None
 *     Returned Application Errors: RTE_E_NvMService_AC3_SRBS_E_NOT_OK
 *
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  NvM_RequestResultType Call_HwTq4Offs_GetErrorStatus_ErrorStatus_Arg = 0U;
  NvM_RequestResultType Call_HwTq4Sca_GetErrorStatus_ErrorStatus_Arg = 0U;
  ...
  *TSC_CDD_HwTq4Meas_Rte_Pim_HwTq4Sca() = PimHwTq4Sca;
  ...
  fct_status = TSC_CDD_HwTq4Meas_Rte_Call_HwTq4Offs_GetErrorStatus(&Call_HwTq4Offs_GetErrorStatus_ErrorStatus_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq4Meas_Rte_Call_HwTq4Sca_GetErrorStatus(&Call_HwTq4Sca_GetErrorStatus_ErrorStatus_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  sint8 Read_HwTq4Polarity_Val;
  float32 Read_HwTq4RawAdc_Val;
  boolean Read_HwTq4RawAdcAdcFaild_Logl;
  boolean Read_HwTq4RawFastAdcAdcFaild_Logl;
  Ary1D_f32_8 Read_HwTq4RawFastAdcBuf_Ary1D;
  ...
  *TSC_CDD_HwTq4Meas_Rte_Pim_HwTq4Sca() = PimHwTq4Sca;
  ...
  fct_status = TSC_CDD_HwTq4Meas_Rte_Read_HwTq4Polarity_Val(&Read_HwTq4Polarity_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq4Meas_Rte_Read_HwTq4RawAdc_Val(&Read_HwTq4RawAdc_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq4Meas_Rte_Read_HwTq4RawAdcAdcFaild_Logl(&Read_HwTq4RawAdcAdcFaild_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq4Meas_Rte_Read_HwTq4RawFastAdcAdcFaild_Logl(&Read_HwTq4RawFastAdcAdcFaild_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq4Meas_Rte_Read_HwTq4RawFastAdcBuf_Ary1D(Read_HwTq4RawFastAdcBuf_Ary1D);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq4Meas_Rte_Write_HwTq4_Val(Rte_InitValue_HwTq4_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq4Meas_Rte_Write_HwTq4Qlfr_Val(Rte_InitValue_HwTq4Qlfr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq4Meas_Rte_Write_HwTq4RollgCntr_Val(Rte_InitValue_HwTq4RollgCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq4Meas_Rte_Call_GetNtcQlfrSts_Oper(0U, &Call_GetNtcQlfrSts_Oper_NtcQlfr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_HwTq4Meas_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
