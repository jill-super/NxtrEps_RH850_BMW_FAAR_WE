 ...
 *
 *   Description:  C-Code implementation template for BSW Module <FrSM>
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Schedulable Entity Name: FrSM_MainFunction_0
 *
 *********************************************************************************************************************/

FUNC(void, FRSM_CODE) FrSM_MainFunction_0(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: FrSM_MainFunction_0
 *********************************************************************************************************************/

  TSC_FrSM_SchM_Enter_FrSM_FRSM_EXCLUSIVE_AREA_0();
  TSC_FrSM_SchM_Exit_FrSM_FRSM_EXCLUSIVE_AREA_0();
  TSC_FrSM_SchM_Enter_FrSM_FRSM_EXCLUSIVE_AREA_1();
  TSC_FrSM_SchM_Exit_FrSM_FRSM_EXCLUSIVE_AREA_1();
  TSC_FrSM_SchM_Enter_FrSM_FRSM_EXCLUSIVE_AREA_2();
  TSC_FrSM_SchM_Exit_FrSM_FRSM_EXCLUSIVE_AREA_2();
  TSC_FrSM_SchM_Enter_FrSM_FRSM_EXCLUSIVE_AREA_3();
  TSC_FrSM_SchM_Exit_FrSM_FRSM_EXCLUSIVE_AREA_3();
