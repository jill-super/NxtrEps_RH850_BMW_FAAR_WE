 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  BmwMsgSlot107Bas0Repn1BusFrChA.c
 *        Config:  EPS.dpa
 ...
 *
 *   Description:  C-Code implementation template for SW-C <BmwMsgSlot107Bas0Repn1BusFrChA>
 *********************************************************************************************************************/
...
#include "Rte_BmwMsgSlot107Bas0Repn1BusFrChA.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
...
static void BmwMsgSlot107Bas0Repn1BusFrChA_TestDefines(void);
 ...
 *   ST_OFFS_QUAD_PINA_EPS_Algorithmus_Funktion_ImSleep_Modus (0U)
 *   ST_OFFS_QUAD_PINA_EPS_OffsetWirdErmittelt (1U)
 *   ST_OFFS_QUAD_PINA_EPS_OffsetUebernehmenAufsetzenUeberIndex (2U)
 *   ST_OFFS_QUAD_PINA_EPS_OffsetUebernehmenAufsetzenUeberModelvergleich (3U)
 *   ST_OFFS_QUAD_PINA_EPS_OffsetUebernehmenAufsetzenUeberAnschlag_Anschlag (4U)
 *   ST_OFFS_QUAD_PINA_EPS_OffsetUebernehmenAufsetzenUeberSummenlenkwinkel_imAFS_Fall_ (5U)
 *   ST_OFFS_QUAD_PINA_EPS_OffsetInPruefung (6U)
 *   ST_OFFS_QUAD_PINA_EPS_OffsetKorrigieren (7U)
 *   ST_OFFS_QUAD_PINA_EPS_Initialisierung (8U)
 *   ST_OFFS_QUAD_PINA_EPS_RestoffsetWirdErmittelt (9U)
 *   ST_OFFS_QUAD_PINA_EPS_OffsetUebernehmenGroboffsetUeberModell (11U)
 *   ST_OFFS_QUAD_PINA_EPS_SignalUngueltig (15U)
 *
 * Record Types:
 * =============
 ...
 *   ---------------------------
 *   uint32 E2EPW_Read_sigGroup_OFFS_QUAD_EPS_sigGroup_OFFS_QUAD_EPS(sigGroup_OFFS_QUAD_EPS1 *data)
 *
 * Output Interfaces:
 * ==================
 *   Explicit S/R API:
 ...
 * Symbol: BmwMsgSlot107Bas0Repn1BusFrChAInit1_doc
 *********************************************************************************************************************/
 ...
 * Symbol: BmwMsgSlot107Bas0Repn1BusFrChAInit1
 *********************************************************************************************************************/
  ...
  sigGroup_OFFS_QUAD_EPS1 Read_sigGroup_OFFS_QUAD_EPS_sigGroup_OFFS_QUAD_EPS;
  boolean IsUpdated_sigGroup_OFFS_QUAD_EPS_sigGroup_OFFS_QUAD_EPS;

  float32 PimBmwActIntgtdCtrlModlPosnIdxValPrev;
  AVL_PO_IDX_ICM1 PimDummy_PIM1;
  uint8 PimAlvFaildCnt;
  uint8 PimAlvPassdCnt;
  uint8 PimAvlPoIdxIcmFaildCnt;
  uint8 PimAvlPoIdxIcmPassdCnt;
  BmwQuadOffsSts1 PimBmwQuadOffsStsPrev;
  uint8 PimCrcFaildCnt;
  uint8 PimCrcPassdCnt;
  ST_OFFS_QUAD_EPS1 PimDummy_PIM2;
  OFFS_QUAD_RTR_EPS1 PimDummy_PIM3;
  uint8 PimMissMsgCnt;
  uint8 PimOffsQuadRtrEpsFaildCnt;
  uint8 PimOffsQuadRtrEpsPassdCnt;
  uint8 PimRxdMsgCnt;
  uint8 PimStOffsQuadEpsFaildCnt;
  uint8 PimStOffsQuadEpsPassdCnt;
  sint8 PimBmwQuadRtrOffsPrev;
  ...
  *************************************************/
  ...
  PimBmwActIntgtdCtrlModlPosnIdxValPrev = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_BmwActIntgtdCtrlModlPosnIdxValPrev();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_BmwActIntgtdCtrlModlPosnIdxValPrev() = PimBmwActIntgtdCtrlModlPosnIdxValPrev;
  PimDummy_PIM1 = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_Dummy_PIM1();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_Dummy_PIM1() = PimDummy_PIM1;
  PimAlvFaildCnt = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_AlvFaildCnt();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_AlvFaildCnt() = PimAlvFaildCnt;
  PimAlvPassdCnt = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_AlvPassdCnt();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_AlvPassdCnt() = PimAlvPassdCnt;
  PimAvlPoIdxIcmFaildCnt = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_AvlPoIdxIcmFaildCnt();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_AvlPoIdxIcmFaildCnt() = PimAvlPoIdxIcmFaildCnt;
  PimAvlPoIdxIcmPassdCnt = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_AvlPoIdxIcmPassdCnt();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_AvlPoIdxIcmPassdCnt() = PimAvlPoIdxIcmPassdCnt;
  PimBmwQuadOffsStsPrev = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_BmwQuadOffsStsPrev();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_BmwQuadOffsStsPrev() = PimBmwQuadOffsStsPrev;
  PimCrcFaildCnt = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_CrcFaildCnt();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_CrcFaildCnt() = PimCrcFaildCnt;
  PimCrcPassdCnt = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_CrcPassdCnt();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_CrcPassdCnt() = PimCrcPassdCnt;
  PimDummy_PIM2 = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_Dummy_PIM2();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_Dummy_PIM2() = PimDummy_PIM2;
  PimDummy_PIM3 = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_Dummy_PIM3();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_Dummy_PIM3() = PimDummy_PIM3;
  PimMissMsgCnt = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_MissMsgCnt();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_MissMsgCnt() = PimMissMsgCnt;
  PimOffsQuadRtrEpsFaildCnt = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_OffsQuadRtrEpsFaildCnt();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_OffsQuadRtrEpsFaildCnt() = PimOffsQuadRtrEpsFaildCnt;
  PimOffsQuadRtrEpsPassdCnt = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_OffsQuadRtrEpsPassdCnt();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_OffsQuadRtrEpsPassdCnt() = PimOffsQuadRtrEpsPassdCnt;
  PimRxdMsgCnt = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_RxdMsgCnt();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_RxdMsgCnt() = PimRxdMsgCnt;
  PimStOffsQuadEpsFaildCnt = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_StOffsQuadEpsFaildCnt();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_StOffsQuadEpsFaildCnt() = PimStOffsQuadEpsFaildCnt;
  PimStOffsQuadEpsPassdCnt = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_StOffsQuadEpsPassdCnt();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_StOffsQuadEpsPassdCnt() = PimStOffsQuadEpsPassdCnt;
  PimBmwQuadRtrOffsPrev = *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_BmwQuadRtrOffsPrev();
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_BmwQuadRtrOffsPrev() = PimBmwQuadRtrOffsPrev;

  BmwMsgSlot108Bas0Repn2BusFrChABmwSteerPolarity_Val_data = TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Prm_BmwMsgSlot108Bas0Repn2BusFrChABmwSteerPolarity_Val();

  IsUpdated_sigGroup_OFFS_QUAD_EPS_sigGroup_OFFS_QUAD_EPS = TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_IsUpdated_sigGroup_OFFS_QUAD_EPS_sigGroup_OFFS_QUAD_EPS();

  fct_status = TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Read_FltCodEnad_Logl(&Read_FltCodEnad_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Read_sigGroup_OFFS_QUAD_EPS_sigGroup_OFFS_QUAD_EPS(&Read_sigGroup_OFFS_QUAD_EPS_sigGroup_OFFS_QUAD_EPS);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Write_BmwActIntgtdCtrlModlPosnIdxValVld_Logl(Rte_InitValue_BmwActIntgtdCtrlModlPosnIdxValVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Write_BmwQuadOffsSts_Val(Rte_InitValue_BmwQuadOffsSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Write_BmwQuadOffsStsVld_Logl(Rte_InitValue_BmwQuadOffsStsVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Write_BmwQuadRtrOffsVld_Logl(Rte_InitValue_BmwQuadRtrOffsVld_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  BmwMsgSlot107Bas0Repn1BusFrChA_TestDefines();
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: OFFS_QUAD_EPS_Missing_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: OFFS_QUAD_EPS_Missing_Oper
 *********************************************************************************************************************/
  ...
  float32 Write_BmwActIntgtdCtrlModlPosnIdxVal_Val;
  ...
  *TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Pim_BmwQuadRtrOffsPrev() = PimBmwQuadRtrOffsPrev;
  ...
  (void)memset(&Write_BmwActIntgtdCtrlModlPosnIdxVal_Val, 0, sizeof(Write_BmwActIntgtdCtrlModlPosnIdxVal_Val));
  fct_status = TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Write_BmwActIntgtdCtrlModlPosnIdxVal_Val(Write_BmwActIntgtdCtrlModlPosnIdxVal_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_BmwMsgSlot107Bas0Repn1BusFrChA_Rte_Write_BmwQuadRtrOffs_Val(Rte_InitValue_BmwQuadRtrOffs_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: OFFS_QUAD_EPS_Received_Oper_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: OFFS_QUAD_EPS_Received_Oper
 *********************************************************************************************************************/
...
static void BmwMsgSlot107Bas0Repn1BusFrChA_TestDefines(void)
{
  ...
  ALIV_OFFS_QUAD_EPS1 Test_ALIV_OFFS_QUAD_EPS1_V_1 = ALIV_COU_4_Zaehlerstand0DotDotE;
  ALIV_OFFS_QUAD_EPS1 Test_ALIV_OFFS_QUAD_EPS1_V_2 = ALIV_COU_4_SignalUngueltig;
  ...
  ST_OFFS_QUAD_EPS1 Test_ST_OFFS_QUAD_EPS1_V_1 = ST_OFFS_QUAD_PINA_EPS_Algorithmus_Funktion_ImSleep_Modus;
  ST_OFFS_QUAD_EPS1 Test_ST_OFFS_QUAD_EPS1_V_2 = ST_OFFS_QUAD_PINA_EPS_OffsetWirdErmittelt;
  ST_OFFS_QUAD_EPS1 Test_ST_OFFS_QUAD_EPS1_V_3 = ST_OFFS_QUAD_PINA_EPS_OffsetUebernehmenAufsetzenUeberIndex;
  ST_OFFS_QUAD_EPS1 Test_ST_OFFS_QUAD_EPS1_V_4 = ST_OFFS_QUAD_PINA_EPS_OffsetUebernehmenAufsetzenUeberModelvergleich;
  ST_OFFS_QUAD_EPS1 Test_ST_OFFS_QUAD_EPS1_V_5 = ST_OFFS_QUAD_PINA_EPS_OffsetUebernehmenAufsetzenUeberAnschlag_Anschlag;
  ST_OFFS_QUAD_EPS1 Test_ST_OFFS_QUAD_EPS1_V_6 = ST_OFFS_QUAD_PINA_EPS_OffsetUebernehmenAufsetzenUeberSummenlenkwinkel_imAFS_Fall_;
  ST_OFFS_QUAD_EPS1 Test_ST_OFFS_QUAD_EPS1_V_7 = ST_OFFS_QUAD_PINA_EPS_OffsetInPruefung;
  ST_OFFS_QUAD_EPS1 Test_ST_OFFS_QUAD_EPS1_V_8 = ST_OFFS_QUAD_PINA_EPS_OffsetKorrigieren;
  ST_OFFS_QUAD_EPS1 Test_ST_OFFS_QUAD_EPS1_V_9 = ST_OFFS_QUAD_PINA_EPS_Initialisierung;
  ST_OFFS_QUAD_EPS1 Test_ST_OFFS_QUAD_EPS1_V_10 = ST_OFFS_QUAD_PINA_EPS_RestoffsetWirdErmittelt;
  ST_OFFS_QUAD_EPS1 Test_ST_OFFS_QUAD_EPS1_V_11 = ST_OFFS_QUAD_PINA_EPS_OffsetUebernehmenGroboffsetUeberModell;
  ST_OFFS_QUAD_EPS1 Test_ST_OFFS_QUAD_EPS1_V_12 = ST_OFFS_QUAD_PINA_EPS_SignalUngueltig;
}
