...
static void CDD_ExcpnHndlg_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  Ary1D_u32_4 PimMcuDiagcData;

  Ary1D_u32_4 McuDiagcDataDft_data;
  ...
  *************************************************/
  ...
  (void)memcpy(PimMcuDiagcData, TSC_CDD_ExcpnHndlg_Rte_Pim_McuDiagcData(), sizeof(Ary1D_u32_4));
  (void)memcpy(TSC_CDD_ExcpnHndlg_Rte_Pim_McuDiagcData(), PimMcuDiagcData, sizeof(Ary1D_u32_4));


  (void)memcpy(McuDiagcDataDft_data, TSC_CDD_ExcpnHndlg_Rte_CData_McuDiagcDataDft(), sizeof(Ary1D_u32_4));

  CDD_ExcpnHndlg_TestDefines();
 ...
 *   Service Invocation:
 *   -------------------
 *   Std_ReturnType Rte_Call_McuDiagcData_SetRamBlockStatus(boolean RamBlockStatus_Arg)
 ...
 *********************************************************************************************************************/
  ...
  *************************************************/
  ...
  fct_status = TSC_CDD_ExcpnHndlg_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_ExcpnHndlg_Rte_Call_McuDiagcData_SetRamBlockStatus(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
