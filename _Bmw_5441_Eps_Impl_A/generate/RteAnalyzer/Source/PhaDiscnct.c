...
static void PhaDiscnct_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint32 PimDiscnctClsTmr;
  uint32 PimDiscnctOpenTmr;
  uint8 PimDiscnctDiagCurrComp;
  uint8 PimDiscnctDiagFailScan;
  uint8 PimDiscnctDiagFltSts;
  uint8 PimDiscnctDiagItrn;
  uint8 PimDiscnctDiagSt;
  uint8 PimDiscnctDiagTestScan;
  uint8 PimDiscnctFltPrm;
  uint8 PimDiscnctSt;
  uint8 PimPrevDiscnctCmd;
  uint8 PimdPhaDiscnctCmd;
  boolean PimWrmIninTestCmpl;
  boolean PimdPhaDiscnctActvd;

  float32 PhaDiscnctTestCurrTestVal_Val_data;
  uint32 PhaDiscnctFixdPhaOnTi_Val_data;
  uint32 PhaDiscnctFixdPwmPerd_Val_data;
  uint16 PhaDiscnctClsDlyTi_Val_data;
  uint16 PhaDiscnctOpenDlyTi_Val_data;
  uint8 PhaDiscnctTestFailScanMax_Val_data;
  uint8 PhaDiscnctTestIninScan_Val_data;
  uint8 PhaDiscnctTestScanCnt_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimDiscnctClsTmr = *TSC_PhaDiscnct_Rte_Pim_DiscnctClsTmr();
  *TSC_PhaDiscnct_Rte_Pim_DiscnctClsTmr() = PimDiscnctClsTmr;
  PimDiscnctOpenTmr = *TSC_PhaDiscnct_Rte_Pim_DiscnctOpenTmr();
  *TSC_PhaDiscnct_Rte_Pim_DiscnctOpenTmr() = PimDiscnctOpenTmr;
  PimDiscnctDiagCurrComp = *TSC_PhaDiscnct_Rte_Pim_DiscnctDiagCurrComp();
  *TSC_PhaDiscnct_Rte_Pim_DiscnctDiagCurrComp() = PimDiscnctDiagCurrComp;
  PimDiscnctDiagFailScan = *TSC_PhaDiscnct_Rte_Pim_DiscnctDiagFailScan();
  *TSC_PhaDiscnct_Rte_Pim_DiscnctDiagFailScan() = PimDiscnctDiagFailScan;
  PimDiscnctDiagFltSts = *TSC_PhaDiscnct_Rte_Pim_DiscnctDiagFltSts();
  *TSC_PhaDiscnct_Rte_Pim_DiscnctDiagFltSts() = PimDiscnctDiagFltSts;
  PimDiscnctDiagItrn = *TSC_PhaDiscnct_Rte_Pim_DiscnctDiagItrn();
  *TSC_PhaDiscnct_Rte_Pim_DiscnctDiagItrn() = PimDiscnctDiagItrn;
  PimDiscnctDiagSt = *TSC_PhaDiscnct_Rte_Pim_DiscnctDiagSt();
  *TSC_PhaDiscnct_Rte_Pim_DiscnctDiagSt() = PimDiscnctDiagSt;
  PimDiscnctDiagTestScan = *TSC_PhaDiscnct_Rte_Pim_DiscnctDiagTestScan();
  *TSC_PhaDiscnct_Rte_Pim_DiscnctDiagTestScan() = PimDiscnctDiagTestScan;
  PimDiscnctFltPrm = *TSC_PhaDiscnct_Rte_Pim_DiscnctFltPrm();
  *TSC_PhaDiscnct_Rte_Pim_DiscnctFltPrm() = PimDiscnctFltPrm;
  PimDiscnctSt = *TSC_PhaDiscnct_Rte_Pim_DiscnctSt();
  *TSC_PhaDiscnct_Rte_Pim_DiscnctSt() = PimDiscnctSt;
  PimPrevDiscnctCmd = *TSC_PhaDiscnct_Rte_Pim_PrevDiscnctCmd();
  *TSC_PhaDiscnct_Rte_Pim_PrevDiscnctCmd() = PimPrevDiscnctCmd;
  PimdPhaDiscnctCmd = *TSC_PhaDiscnct_Rte_Pim_dPhaDiscnctCmd();
  *TSC_PhaDiscnct_Rte_Pim_dPhaDiscnctCmd() = PimdPhaDiscnctCmd;
  PimWrmIninTestCmpl = *TSC_PhaDiscnct_Rte_Pim_WrmIninTestCmpl();
  *TSC_PhaDiscnct_Rte_Pim_WrmIninTestCmpl() = PimWrmIninTestCmpl;
  PimdPhaDiscnctActvd = *TSC_PhaDiscnct_Rte_Pim_dPhaDiscnctActvd();
  *TSC_PhaDiscnct_Rte_Pim_dPhaDiscnctActvd() = PimdPhaDiscnctActvd;

  PhaDiscnctTestCurrTestVal_Val_data = TSC_PhaDiscnct_Rte_Prm_PhaDiscnctTestCurrTestVal_Val();
  PhaDiscnctFixdPhaOnTi_Val_data = TSC_PhaDiscnct_Rte_Prm_PhaDiscnctFixdPhaOnTi_Val();
  PhaDiscnctFixdPwmPerd_Val_data = TSC_PhaDiscnct_Rte_Prm_PhaDiscnctFixdPwmPerd_Val();
  PhaDiscnctClsDlyTi_Val_data = TSC_PhaDiscnct_Rte_Prm_PhaDiscnctClsDlyTi_Val();
  PhaDiscnctOpenDlyTi_Val_data = TSC_PhaDiscnct_Rte_Prm_PhaDiscnctOpenDlyTi_Val();
  PhaDiscnctTestFailScanMax_Val_data = TSC_PhaDiscnct_Rte_Prm_PhaDiscnctTestFailScanMax_Val();
  PhaDiscnctTestIninScan_Val_data = TSC_PhaDiscnct_Rte_Prm_PhaDiscnctTestIninScan_Val();
  PhaDiscnctTestScanCnt_Val_data = TSC_PhaDiscnct_Rte_Prm_PhaDiscnctTestScanCnt_Val();

  fct_status = TSC_PhaDiscnct_Rte_Call_IoHwAb_SetGpioPhaDiscnctA_Oper(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Call_IoHwAb_SetGpioPhaDiscnctB_Oper(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Call_IoHwAb_SetGpioPhaDiscnctC_Oper(FALSE);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  float32 Read_MotCurrCorrdA_Val;
  float32 Read_MotCurrCorrdB_Val;
  float32 Read_MotCurrCorrdC_Val;
  ...
  *TSC_PhaDiscnct_Rte_Pim_dPhaDiscnctActvd() = PimdPhaDiscnctActvd;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Read_DiagcStsIvtr1Inactv_Logl(&Read_DiagcStsIvtr1Inactv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Read_IvtrFetFltTyp_Val(&Read_IvtrFetFltTyp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Read_MotCurrCorrdA_Val(&Read_MotCurrCorrdA_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Read_MotCurrCorrdB_Val(&Read_MotCurrCorrdB_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Read_MotCurrCorrdC_Val(&Read_MotCurrCorrdC_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Read_MotCurrQlfr1_Val(&Read_MotCurrQlfr1_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Read_StrtUpSt_Val(&Read_StrtUpSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Write_PhaDiscnctDiagcActv_Logl(Rte_InitValue_PhaDiscnctDiagcActv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Write_PhaDiscnctDiagcPwmVect_Val(Rte_InitValue_PhaDiscnctDiagcPwmVect_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Call_SetNtcStsAndSnpshtData_Oper(0U, 0U, 0U, 0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  *TSC_PhaDiscnct_Rte_Pim_dPhaDiscnctActvd() = PimdPhaDiscnctActvd;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Read_IvtrFetFltPha_Val(&Read_IvtrFetFltPha_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Read_SysSt_Val(&Read_SysSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Write_PhaDiscnctInactv_Logl(Rte_InitValue_PhaDiscnctInactv_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Write_PhaDiscnctWrmIninTestCmpl_Logl(Rte_InitValue_PhaDiscnctWrmIninTestCmpl_Logl);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Call_GetRefTmr100MicroSec32bit_Oper(&Call_GetRefTmr100MicroSec32bit_Oper_RefTmr_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_PhaDiscnct_Rte_Call_GetTiSpan100MicroSec32bit_Oper(0U, &Call_GetTiSpan100MicroSec32bit_Oper_TiSpan_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
