...
static void TunSelnMngt_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint8 PimPrevActvIninIdx;
  uint8 PimPrevActvIninOptSetAIdx;
  uint8 PimPrevActvRtIdx;
  uint8 PimPrevRamPageAcs;
  RtIdxChgSts1 PimPrevRtIdxChgSts;
  uint8 PimRamTblSwt;
  OnlineCalStsRec2 PimOnlineCalSts;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimPrevActvIninIdx = *TSC_TunSelnMngt_Rte_Pim_PrevActvIninIdx();
  *TSC_TunSelnMngt_Rte_Pim_PrevActvIninIdx() = PimPrevActvIninIdx;
  PimPrevActvIninOptSetAIdx = *TSC_TunSelnMngt_Rte_Pim_PrevActvIninOptSetAIdx();
  *TSC_TunSelnMngt_Rte_Pim_PrevActvIninOptSetAIdx() = PimPrevActvIninOptSetAIdx;
  PimPrevActvRtIdx = *TSC_TunSelnMngt_Rte_Pim_PrevActvRtIdx();
  *TSC_TunSelnMngt_Rte_Pim_PrevActvRtIdx() = PimPrevActvRtIdx;
  PimPrevRamPageAcs = *TSC_TunSelnMngt_Rte_Pim_PrevRamPageAcs();
  *TSC_TunSelnMngt_Rte_Pim_PrevRamPageAcs() = PimPrevRamPageAcs;
  PimPrevRtIdxChgSts = *TSC_TunSelnMngt_Rte_Pim_PrevRtIdxChgSts();
  *TSC_TunSelnMngt_Rte_Pim_PrevRtIdxChgSts() = PimPrevRtIdxChgSts;
  PimRamTblSwt = *TSC_TunSelnMngt_Rte_Pim_RamTblSwt();
  *TSC_TunSelnMngt_Rte_Pim_RamTblSwt() = PimRamTblSwt;
  PimOnlineCalSts = *TSC_TunSelnMngt_Rte_Pim_OnlineCalSts();
  *TSC_TunSelnMngt_Rte_Pim_OnlineCalSts() = PimOnlineCalSts;

  TSC_TunSelnMngt_Rte_Enter_TunSelnMngtIntDataProtnExclsvArea();
  TSC_TunSelnMngt_Rte_Exit_TunSelnMngtIntDataProtnExclsvArea();

  TunSelnMngt_TestDefines();
 ...
 *********************************************************************************************************************/
  ...
  uint8 Read_DesIninIdx_Val;
  uint8 Read_DesIninOptSetAIdx_Val;
  ...
  uint32 Call_Calc32BitCrc_u32_Oper_DataPtr_Arg = 0U;
  uint32 Call_Calc32BitCrc_u32_Oper_CalcCrcRes_Arg = 0U;
  ...
  *TSC_TunSelnMngt_Rte_Pim_OnlineCalSts() = PimOnlineCalSts;
  ...
  fct_status = TSC_TunSelnMngt_Rte_Read_DesIninIdx_Val(&Read_DesIninIdx_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TunSelnMngt_Rte_Read_DesIninOptSetAIdx_Val(&Read_DesIninOptSetAIdx_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TunSelnMngt_Rte_Read_DesRtIdx_Val(&Read_DesRtIdx_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TunSelnMngt_Rte_Write_ActvGroup_Val(Rte_InitValue_ActvGroup_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TunSelnMngt_Rte_Write_ActvIninIdx_Val(Rte_InitValue_ActvIninIdx_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TunSelnMngt_Rte_Write_ActvIninOptSetAIdx_Val(Rte_InitValue_ActvIninOptSetAIdx_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TunSelnMngt_Rte_Write_ActvRtIdx_Val(Rte_InitValue_ActvRtIdx_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TunSelnMngt_Rte_Write_CalCopySts_Val(Rte_InitValue_CalCopySts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TunSelnMngt_Rte_Write_RtIdxChgSts_Val(Rte_InitValue_RtIdxChgSts_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_TunSelnMngt_Rte_Call_Calc32BitCrc_u32_Oper(&Call_Calc32BitCrc_u32_Oper_DataPtr_Arg, 0U, 0U, FALSE, &Call_Calc32BitCrc_u32_Oper_CalcCrcRes_Arg);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_Calc32BitCrc_u32_PortIf1_E_NOT_OK:
      fct_error = 1;
      break;
  }

  fct_status = TSC_TunSelnMngt_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  *TSC_TunSelnMngt_Rte_Pim_OnlineCalSts() = PimOnlineCalSts;
  ...
  fct_status = TSC_TunSelnMngt_Rte_Call_RtCalChgReq_Oper();
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
    ...
    case RTE_E_TIMEOUT:
      fct_error = 1;
      break;
    case RTE_E_RtCalChgReq_PortIf1_E_NOT_OK:
      fct_error = 1;
      break;
  }
...
static void TunSelnMngt_TestDefines(void)
{
  ...
  RtIdxChgSts1 Test_RtIdxChgSts1_V_1 = RTIDXCHGSTS_IDLE;
  RtIdxChgSts1 Test_RtIdxChgSts1_V_2 = RTIDXCHGSTS_PNDTUNSELNAUTHY;
  RtIdxChgSts1 Test_RtIdxChgSts1_V_3 = RTIDXCHGSTS_DFTMODCHGCMPL;
  RtIdxChgSts1 Test_RtIdxChgSts1_V_4 = RTIDXCHGSTS_ONLINECALRAMMODCHGCMPL;
  RtIdxChgSts1 Test_RtIdxChgSts1_V_5 = RTIDXCHGSTS_ONLINECALFLSMODCHGCMPL;
  RtIdxChgSts1 Test_RtIdxChgSts1_V_6 = RTIDXCHGSTS_FLTACTV;
}
