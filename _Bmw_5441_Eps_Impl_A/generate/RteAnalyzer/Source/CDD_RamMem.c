...
static void CDD_RamMem_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint32 PimLclRamFailrAdr;
  uint32 PimLclRamWordLineRead;
  uint32 PimdRamMemCanRamDblBitEccErrAdr;
  uint32 PimdRamMemCanRamSngBitEccErrAdr;
  uint32 PimdRamMemFrRamDblBitEccErrAdr;
  uint32 PimdRamMemFrRamSngBitEccErrAdr;
  uint32 PimdRamMemFrRamTmpBufADblBitEccErrAdr;
  uint32 PimdRamMemFrRamTmpBufBDblBitEccErrAdr;
  uint32 PimdRamMemSpi0RamEccErrAdr;
  uint32 PimdRamMemSpi1RamEccErrAdr;
  uint32 PimdRamMemSpi2RamEccErrAdr;
  uint32 PimdRamMemSpi3RamEccErrAdr;
  uint32 PimdRamMemSpiRamEccErrAdr;
  uint8 PimLclRamEccSngBitCntr;
  boolean PimLclRamEccSngBitSoftFailr;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimLclRamFailrAdr = *TSC_CDD_RamMem_Rte_Pim_LclRamFailrAdr();
  *TSC_CDD_RamMem_Rte_Pim_LclRamFailrAdr() = PimLclRamFailrAdr;
  PimLclRamWordLineRead = *TSC_CDD_RamMem_Rte_Pim_LclRamWordLineRead();
  *TSC_CDD_RamMem_Rte_Pim_LclRamWordLineRead() = PimLclRamWordLineRead;
  PimdRamMemCanRamDblBitEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemCanRamDblBitEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemCanRamDblBitEccErrAdr() = PimdRamMemCanRamDblBitEccErrAdr;
  PimdRamMemCanRamSngBitEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemCanRamSngBitEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemCanRamSngBitEccErrAdr() = PimdRamMemCanRamSngBitEccErrAdr;
  PimdRamMemFrRamDblBitEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamDblBitEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamDblBitEccErrAdr() = PimdRamMemFrRamDblBitEccErrAdr;
  PimdRamMemFrRamSngBitEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamSngBitEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamSngBitEccErrAdr() = PimdRamMemFrRamSngBitEccErrAdr;
  PimdRamMemFrRamTmpBufADblBitEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamTmpBufADblBitEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamTmpBufADblBitEccErrAdr() = PimdRamMemFrRamTmpBufADblBitEccErrAdr;
  PimdRamMemFrRamTmpBufBDblBitEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamTmpBufBDblBitEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemFrRamTmpBufBDblBitEccErrAdr() = PimdRamMemFrRamTmpBufBDblBitEccErrAdr;
  PimdRamMemSpi0RamEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi0RamEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi0RamEccErrAdr() = PimdRamMemSpi0RamEccErrAdr;
  PimdRamMemSpi1RamEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi1RamEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi1RamEccErrAdr() = PimdRamMemSpi1RamEccErrAdr;
  PimdRamMemSpi2RamEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi2RamEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi2RamEccErrAdr() = PimdRamMemSpi2RamEccErrAdr;
  PimdRamMemSpi3RamEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi3RamEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemSpi3RamEccErrAdr() = PimdRamMemSpi3RamEccErrAdr;
  PimdRamMemSpiRamEccErrAdr = *TSC_CDD_RamMem_Rte_Pim_dRamMemSpiRamEccErrAdr();
  *TSC_CDD_RamMem_Rte_Pim_dRamMemSpiRamEccErrAdr() = PimdRamMemSpiRamEccErrAdr;
  PimLclRamEccSngBitCntr = *TSC_CDD_RamMem_Rte_Pim_LclRamEccSngBitCntr();
  *TSC_CDD_RamMem_Rte_Pim_LclRamEccSngBitCntr() = PimLclRamEccSngBitCntr;
  PimLclRamEccSngBitSoftFailr = *TSC_CDD_RamMem_Rte_Pim_LclRamEccSngBitSoftFailr();
  *TSC_CDD_RamMem_Rte_Pim_LclRamEccSngBitSoftFailr() = PimLclRamEccSngBitSoftFailr;

  fct_status = TSC_CDD_RamMem_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
 ...
 *********************************************************************************************************************/
  ...
  *TSC_CDD_RamMem_Rte_Pim_LclRamEccSngBitSoftFailr() = PimLclRamEccSngBitSoftFailr;
  ...
  fct_status = TSC_CDD_RamMem_Rte_Write_LclRamEccSngBitCntrOutp_Val(Rte_InitValue_LclRamEccSngBitCntrOutp_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
