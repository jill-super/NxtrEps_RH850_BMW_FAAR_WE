...
static void CDD_McuDiagc_TestDefines(void);
 ...
 *********************************************************************************************************************/
  ...
  uint16 PimFastLoopCntrPrev;
  uint16 PimLoopCntr2MilliSecStore;
  uint16 PimLoopCntrPrev;
  uint16 PimdMcuDiagcFastLoopCntrMax;
  uint16 PimdMcuDiagcFastLoopCntrMin;
  uint16 PimdMcuDiagcLoopCntr2MilliSecMotCtrlDif;
  uint8 PimFastLoopCntrDiagcCfgd;

  uint16 McuDiagc2MilliSecCntrCompThd_Val_data;
  uint16 McuDiagcFltFailStep_Val_data;
  uint16 McuDiagcFltPassStep_Val_data;

  /*************************************************
  * Direct Function Accesses
  *************************************************/

  PimFastLoopCntrPrev = *TSC_CDD_McuDiagc_Rte_Pim_FastLoopCntrPrev();
  *TSC_CDD_McuDiagc_Rte_Pim_FastLoopCntrPrev() = PimFastLoopCntrPrev;
  PimLoopCntr2MilliSecStore = *TSC_CDD_McuDiagc_Rte_Pim_LoopCntr2MilliSecStore();
  *TSC_CDD_McuDiagc_Rte_Pim_LoopCntr2MilliSecStore() = PimLoopCntr2MilliSecStore;
  PimLoopCntrPrev = *TSC_CDD_McuDiagc_Rte_Pim_LoopCntrPrev();
  *TSC_CDD_McuDiagc_Rte_Pim_LoopCntrPrev() = PimLoopCntrPrev;
  PimdMcuDiagcFastLoopCntrMax = *TSC_CDD_McuDiagc_Rte_Pim_dMcuDiagcFastLoopCntrMax();
  *TSC_CDD_McuDiagc_Rte_Pim_dMcuDiagcFastLoopCntrMax() = PimdMcuDiagcFastLoopCntrMax;
  PimdMcuDiagcFastLoopCntrMin = *TSC_CDD_McuDiagc_Rte_Pim_dMcuDiagcFastLoopCntrMin();
  *TSC_CDD_McuDiagc_Rte_Pim_dMcuDiagcFastLoopCntrMin() = PimdMcuDiagcFastLoopCntrMin;
  PimdMcuDiagcLoopCntr2MilliSecMotCtrlDif = *TSC_CDD_McuDiagc_Rte_Pim_dMcuDiagcLoopCntr2MilliSecMotCtrlDif();
  *TSC_CDD_McuDiagc_Rte_Pim_dMcuDiagcLoopCntr2MilliSecMotCtrlDif() = PimdMcuDiagcLoopCntr2MilliSecMotCtrlDif;
  PimFastLoopCntrDiagcCfgd = *TSC_CDD_McuDiagc_Rte_Pim_FastLoopCntrDiagcCfgd();
  *TSC_CDD_McuDiagc_Rte_Pim_FastLoopCntrDiagcCfgd() = PimFastLoopCntrDiagcCfgd;

  McuDiagc2MilliSecCntrCompThd_Val_data = TSC_CDD_McuDiagc_Rte_Prm_McuDiagc2MilliSecCntrCompThd_Val();
  McuDiagcFltFailStep_Val_data = TSC_CDD_McuDiagc_Rte_Prm_McuDiagcFltFailStep_Val();
  McuDiagcFltPassStep_Val_data = TSC_CDD_McuDiagc_Rte_Prm_McuDiagcFltPassStep_Val();

  CDD_McuDiagc_TestDefines();
 ...
 *********************************************************************************************************************/
  ...
  uint16 Read_FastLoopCntr_Val;
  uint16 Read_SlowLoopCntr_Val;
  ...
  *TSC_CDD_McuDiagc_Rte_Pim_FastLoopCntrDiagcCfgd() = PimFastLoopCntrDiagcCfgd;
  ...
  fct_status = TSC_CDD_McuDiagc_Rte_Read_FastLoopCntr_Val(&Read_FastLoopCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_McuDiagc_Rte_Read_SlowLoopCntr_Val(&Read_SlowLoopCntr_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_McuDiagc_Rte_Read_SysSt_Val(&Read_SysSt_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_McuDiagc_Rte_Write_LoopCntr2MilliSec_Val(Rte_InitValue_LoopCntr2MilliSec_Val);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_CDD_McuDiagc_Rte_Call_SetNtcSts_Oper(0U, 0U, 0U, 0U);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
