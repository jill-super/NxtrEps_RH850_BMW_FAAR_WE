...
extern CONST(Os_IsrCat1ConfigType, OS_CONST) OsCfg_Cat1Isr_AlgnErrIrq;
...
extern CONST(Os_IsrCat1ConfigType, OS_CONST) OsCfg_Cat1Isr_ResdOperIrq;
...
extern CONST(Os_TimerIsrConfigType, OS_CONST) OsCfg_Isr_CounterIsr_OsCounter;

/*! ISR configuration data: Fr_IrqLine0 */
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_Fr_IrqLine0;

/*! ISR configuration data: Fr_IrqTimer0 */
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_Fr_IrqTimer0;
...
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_SPI_CSIG0_TIC_CAT2_ISR;

/*! ISR configuration data: SPI_CSIG0_TIRE_CAT2_ISR */
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_SPI_CSIG0_TIRE_CAT2_ISR;

/*! ISR configuration data: SPI_CSIG0_TIR_CAT2_ISR */
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_SPI_CSIG0_TIR_CAT2_ISR;

/*! ISR configuration data: SPI_CSIH2_TIC_CAT2_ISR */
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_SPI_CSIH2_TIC_CAT2_ISR;

/*! ISR configuration data: SPI_CSIH2_TIRE_CAT2_ISR */
extern CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_SPI_CSIH2_TIRE_CAT2_ISR;
