 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_SteerCmdArbnAndLim_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <SteerCmdArbnAndLim> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_STEERCMDARBNANDLIM_TYPE_H
# define _RTE_STEERCMDARBNANDLIM_TYPE_H
...
#endif /* _RTE_STEERCMDARBNANDLIM_TYPE_H */
