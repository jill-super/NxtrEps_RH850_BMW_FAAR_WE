...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\CM640B_MotAg1Meas_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\CM640B_MotAg1Meas_Impl
...
XCOPY ..\..\autosar\CDD_MotAg1Meas_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
