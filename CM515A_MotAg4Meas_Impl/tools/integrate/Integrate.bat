...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\CM515A_MotAg4Meas_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\CM515A_MotAg4Meas_Impl
...
XCOPY ..\..\autosar\MotAg4Meas_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
