 ...
 *
 *   Description:  Application types header file for SW-C <LoaMgr> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_LOAMGR_TYPE_H
# define _RTE_LOAMGR_TYPE_H
...
# ifndef STEERMOD_BASEPS
#  define STEERMOD_BASEPS (0U)
# endif

# ifndef STEERMOD_SEMIATNMS
#  define STEERMOD_SEMIATNMS (1U)
# endif

# ifndef STEERMOD_FULLYATNMS
