 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_TurnCntrCorrln_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <TurnCntrCorrln> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_TURNCNTRCORRLN_TYPE_H
# define _RTE_TURNCNTRCORRLN_TYPE_H
...
#endif /* _RTE_TURNCNTRCORRLN_TYPE_H */
