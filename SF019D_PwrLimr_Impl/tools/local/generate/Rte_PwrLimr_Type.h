 ...
 *
 *   Description:  Application types header file for SW-C <PwrLimr> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_PWRLIMR_TYPE_H
# define _RTE_PWRLIMR_TYPE_H
