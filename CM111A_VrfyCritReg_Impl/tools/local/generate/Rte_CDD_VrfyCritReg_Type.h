 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_CDD_VrfyCritReg_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <CDD_VrfyCritReg> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CDD_VRFYCRITREG_TYPE_H
# define _RTE_CDD_VRFYCRITREG_TYPE_H
...
#endif /* _RTE_CDD_VRFYCRITREG_TYPE_H */
