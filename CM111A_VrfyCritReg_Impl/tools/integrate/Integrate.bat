...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\CM111A_VrfyCritReg_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\CM111A_VrfyCritReg_Impl
...
XCOPY ..\..\autosar\CDD_VrfyCritReg_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
