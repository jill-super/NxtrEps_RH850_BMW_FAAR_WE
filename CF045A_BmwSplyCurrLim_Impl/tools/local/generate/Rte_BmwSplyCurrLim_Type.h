 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_BmwSplyCurrLim_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <BmwSplyCurrLim> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_BMWSPLYCURRLIM_TYPE_H
# define _RTE_BMWSPLYCURRLIM_TYPE_H
...
#endif /* _RTE_BMWSPLYCURRLIM_TYPE_H */
