...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\CM101A_ExcpnHndlg_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\CM101A_ExcpnHndlg_Impl
...
XCOPY ..\..\autosar\ExcpnHndlg_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
