 ...
 *
 *  If the platform does not support high resolution, check this by an error directive in the corresponding c-File:
 *
...
struct Os_Hal_TimerConfigType_Tag
{
  ...
  uint32 TimerChannel;
  /*! The timer unit index. */
  uint32 TimerIndex; 
  /*! The timer compare value. */
  uint32 CompareValue;
  /*! The timer interrupt configuration. */
